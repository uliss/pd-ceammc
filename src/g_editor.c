...
void glist_deselectline(t_glist *x)
{
    if (x->gl_editor)
    {
        ...
        g_cord_deselect(x, x->gl_editor->e_selectline_tag);
    }
}
...
static void canvas_rightclick(t_canvas *x, int xpos, int ypos, t_gobj *y)
{
    ...
    sys_vgui("pdtk_canvas_popup .x%lx %d %d %d %d %d %d\n",
        x, xpos, ypos, canprop, canopen, absx, absy);
}
    ...
    int mod, int doit)
{
    ...
    if (doit)
    {
        ...
        g_selection_draw(x, xpos, ypos, xpos, ypos);
        x->gl_editor->e_xwas = xpos;
        x->gl_editor->e_ywas = ypos;
...
static void canvas_doconnect(t_canvas *x, int xpos, int ypos, int mod, int doit)
{
    ...
    if (doit)
        ...
        g_selection_move(x, xwas, ywas, xpos, ypos);
