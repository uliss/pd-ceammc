...
elseif(UNIX)
    ...
    set(LINUX_DEBIAN_PACKAGE_FILE_NAME "${LINUX_DEBIAN_PACKAGE_NAME}-${CEAMMC_DISTRIB_VERSION}${LINUX_DEBIAN_PACKAGE_REVISION}-${PD_TEXT_VERSION_SHORT}_${LSB_CODENAME}_${LSB_PROCESSOR_ARCH}.deb")
elseif(WIN32)
