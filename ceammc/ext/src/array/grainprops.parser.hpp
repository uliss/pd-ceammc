...
#ifndef YY_YY_GRAINPROPS_PARSER_HPP_INCLUDED
# define YY_YY_GRAINPROPS_PARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 13 "grain_properties.yy"
...
switch (yykind)
    {
      ...
      {
        return GrainPropertiesParser::symbol_name (this->kind ());
      }
    ...
    GrainPropertiesParser (ceammc::GrainPropertiesLexer& lexer_yyarg);
    virtual ~GrainPropertiesParser ();

#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    GrainPropertiesParser (const GrainPropertiesParser&) = delete;
    /// Non copyable.
    GrainPropertiesParser& operator= (const GrainPropertiesParser&) = delete;
#endif
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      make_PROP_AT ()
      {
        return symbol_type (token::PROP_AT);
      }
#else
      static
      symbol_type
      ...
      make_PROP_WHEN ()
      {
        return symbol_type (token::PROP_WHEN);
      }
#else
      static
      symbol_type
    ...
    {
    public:
      context (const GrainPropertiesParser& yyparser, const symbol_type& yyla);
    ...
    private:
      const GrainPropertiesParser& yyparser_;
...
#if YY_CPLUSPLUS < 201103L
    /// Non copyable.
    GrainPropertiesParser (const GrainPropertiesParser&);
    /// Non copyable.
    GrainPropertiesParser& operator= (const GrainPropertiesParser&);
#endif
  ...
  private:
    ...
    // User arguments.
    ceammc::GrainPropertiesLexer& lexer;

  };

  inline
  GrainPropertiesParser::symbol_kind_type
  GrainPropertiesParser::yytranslate_ (int t)
  {
  ...
  // basic_symbol.
  template <typename Base>
  GrainPropertiesParser::basic_symbol<Base>::basic_symbol (const basic_symbol& that)
    : Base (that)
    , value ()
  {
    switch (this->kind ())
  ...
  template <typename Base>
  GrainPropertiesParser::symbol_kind_type
  GrainPropertiesParser::basic_symbol<Base>::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
  ...
  template <typename Base>
  bool
  GrainPropertiesParser::basic_symbol<Base>::empty () const YY_NOEXCEPT
  {
  ...
  template <typename Base>
  void
  GrainPropertiesParser::basic_symbol<Base>::move (basic_symbol& s)
  {
    super_type::move (s);
    switch (this->kind ())
    {
  ...
  // by_kind.
  inline
  GrainPropertiesParser::by_kind::by_kind ()
    : kind_ (symbol_kind::S_YYEMPTY)
  {}

#if 201103L <= YY_CPLUSPLUS
  inline
  GrainPropertiesParser::by_kind::by_kind (by_kind&& that)
    : kind_ (that.kind_)
  {
    that.clear ();
  }
  ...
  inline
  GrainPropertiesParser::by_kind::by_kind (const by_kind& that)
    : kind_ (that.kind_)
  {}

  inline
  GrainPropertiesParser::by_kind::by_kind (token_kind_type t)
    : kind_ (yytranslate_ (t))
  {}

  inline
  void
  GrainPropertiesParser::by_kind::clear ()
  {
    kind_ = symbol_kind::S_YYEMPTY;
  }
  ...
  inline
  void
  GrainPropertiesParser::by_kind::move (by_kind& that)
  {
    kind_ = that.kind_;
    that.clear ();
  }
  ...
  inline
  GrainPropertiesParser::symbol_kind_type
  GrainPropertiesParser::by_kind::kind () const YY_NOEXCEPT
  {
    return kind_;
  }
  ...
  inline
  GrainPropertiesParser::symbol_kind_type
  GrainPropertiesParser::by_kind::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
...
#endif // !YY_YY_GRAINPROPS_PARSER_HPP_INCLUDED
