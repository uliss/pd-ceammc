...
static const int grain_expr_start = 106;
static const int grain_expr_first_final = 106;
static const int grain_expr_error = 0;

static const int grain_expr_en_symbol = 129;
static const int grain_expr_en_main = 106;
...
#line 184 "grain_expr.rl"
	{te = p+1;{ pushToken(TK_PROP_TAG); curtok_ = TK_PROP_TAG; {goto st129;} }}
	goto st106;
tr208:
#line 183 "grain_expr.rl"
