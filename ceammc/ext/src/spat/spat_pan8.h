...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn spat_pan8 -scn spat_pan8_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __spat_pan8_H__
#define  __spat_pan8_H__
...
class FAUST_API spat_pan8_dsp {

    public:

        spat_pan8_dsp() = default;
        virtual ~spat_pan8_dsp() = default;
...
class FAUST_API decorator_dsp : public ::spat_pan8_dsp {
...
/**
 The base class of Meta handler to be used in spat_pan8_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
class spat_pan8 : public spat_pan8_dsp {
 ...
 public:
	...
	spat_pan8(const spat_pan8&) = default;
	
	virtual ~spat_pan8() = default;
	
	spat_pan8& operator=(const spat_pan8&) = default;
	
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn spat_pan8 -scn spat_pan8_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("angle", &fVslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(6.2831855f), FAUSTFLOAT(0.0001f));
		ui_interface->addVerticalSlider("radius", &fVslider0, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0001f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = 0.15915494f * static_cast<float>(fVslider1);
		float fSlow3 = 5e-05f * fSlow1 * q8_sqrt(std::max<float>(0.0f, 1.0f - 8.0f * fSlow0 * std::fabs(std::fmod(fSlow2 + 1.5f, 1.0f) + -0.5f)));
		float fSlow4 = 5e-05f * fSlow1 * q8_sqrt(std::max<float>(0.0f, 1.0f - 8.0f * fSlow0 * std::fabs(std::fmod(fSlow2 + 1.375f, 1.0f) + -0.5f)));
		float fSlow5 = 5e-05f * fSlow1 * q8_sqrt(std::max<float>(0.0f, 1.0f - 8.0f * fSlow0 * std::fabs(std::fmod(fSlow2 + 1.25f, 1.0f) + -0.5f)));
		float fSlow6 = 5e-05f * fSlow1 * q8_sqrt(std::max<float>(0.0f, 1.0f - 8.0f * fSlow0 * std::fabs(std::fmod(fSlow2 + 1.125f, 1.0f) + -0.5f)));
		float fSlow7 = 5e-05f * fSlow1 * q8_sqrt(std::max<float>(0.0f, 1.0f - 8.0f * fSlow0 * std::fabs(std::fmod(fSlow2 + 1.0f, 1.0f) + -0.5f)));
		float fSlow8 = 5e-05f * fSlow1 * q8_sqrt(std::max<float>(0.0f, 1.0f - 8.0f * fSlow0 * std::fabs(std::fmod(fSlow2 + 0.875f, 1.0f) + -0.5f)));
		float fSlow9 = 5e-05f * fSlow1 * q8_sqrt(std::max<float>(0.0f, 1.0f - 8.0f * fSlow0 * std::fabs(std::fmod(fSlow2 + 0.75f, 1.0f) + -0.5f)));
		float fSlow10 = 5e-05f * fSlow1 * q8_sqrt(std::max<float>(0.0f, 1.0f - 8.0f * fSlow0 * std::fabs(std::fmod(fSlow2 + 0.625f, 1.0f) + -0.5f)));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec1[0]);
			fRec2[0] = fSlow5 + 0.9999f * fRec2[1];
			output2[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec2[0]);
			fRec3[0] = fSlow6 + 0.9999f * fRec3[1];
			output3[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec3[0]);
			fRec4[0] = fSlow7 + 0.9999f * fRec4[1];
			output4[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec4[0]);
			fRec5[0] = fSlow8 + 0.9999f * fRec5[1];
			output5[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec5[0]);
			fRec6[0] = fSlow9 + 0.9999f * fRec6[1];
			output6[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec6[0]);
			fRec7[0] = fSlow10 + 0.9999f * fRec7[1];
			output7[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec7[0]);
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
...
class faust_spat_pan8_tilde : public FaustExternal<spat_pan8> {
public:
    faust_spat_pan8_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(spat_pan8))
    {
    }
};
