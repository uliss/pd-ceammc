...
class spat_zita6x8 : public spat_zita6x8_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst7 = std::floor(((0.256891012f * fConst0) + 0.5f));
		fConst8 = ((0.0f - (6.90775537f * fConst7)) / fConst0);
		float fConst9 = std::floor(((0.0273330007f * fConst0) + 0.5f));
		...
		float fConst12 = std::floor(((0.192303002f * fConst0) + 0.5f));
		fConst13 = ((0.0f - (6.90775537f * fConst12)) / fConst0);
		float fConst14 = std::floor(((0.0292910002f * fConst0) + 0.5f));
		...
		float fConst17 = std::floor(((0.210389003f * fConst0) + 0.5f));
		fConst18 = ((0.0f - (6.90775537f * fConst17)) / fConst0);
		float fConst19 = std::floor(((0.0244210009f * fConst0) + 0.5f));
		...
		float fConst24 = std::floor(((0.0134579996f * fConst0) + 0.5f));
		iConst25 = int(std::min<float>(8192.0f, std::max<float>(0.0f, (fConst22 - fConst24))));
		iConst26 = int(std::min<float>(8192.0f, std::max<float>(0.0f, (0.0399999991f * fConst0))));
		iConst27 = int(std::min<float>(1024.0f, std::max<float>(0.0f, (fConst24 + -1.0f))));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("a0", &fVslider16, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		ui_interface->addVerticalSlider("a1", &fVslider11, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		ui_interface->addVerticalSlider("a2", &fVslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		ui_interface->addVerticalSlider("a3", &fVslider6, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		ui_interface->addVerticalSlider("a4", &fVslider21, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		ui_interface->addVerticalSlider("a5", &fVslider26, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		...
		ui_interface->addVerticalSlider("dry0", &fVslider19, FAUSTFLOAT(-3.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
		...
		ui_interface->addVerticalSlider("dry1", &fVslider14, FAUSTFLOAT(-3.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->declare(&fVslider4, "scale", "log");
		ui_interface->declare(&fVslider4, "style", "knob");
		ui_interface->declare(&fVslider4, "unit", "db");
		ui_interface->addVerticalSlider("dry2", &fVslider4, FAUSTFLOAT(-3.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->declare(&fVslider9, "scale", "log");
		ui_interface->declare(&fVslider9, "style", "knob");
		ui_interface->declare(&fVslider9, "unit", "db");
		ui_interface->addVerticalSlider("dry3", &fVslider9, FAUSTFLOAT(-3.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
		...
		ui_interface->addVerticalSlider("dry4", &fVslider24, FAUSTFLOAT(-3.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
		...
		ui_interface->addVerticalSlider("dry5", &fVslider29, FAUSTFLOAT(-3.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->addVerticalSlider("r0", &fVslider15, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		ui_interface->addVerticalSlider("r1", &fVslider10, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		ui_interface->addVerticalSlider("r2", &fVslider0, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		ui_interface->addVerticalSlider("r3", &fVslider5, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		ui_interface->addVerticalSlider("r4", &fVslider20, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		ui_interface->addVerticalSlider("r5", &fVslider25, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(9.99999975e-05f));
		...
		ui_interface->addVerticalSlider("t0", &fVslider18, FAUSTFLOAT(2.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(90.0f), FAUSTFLOAT(0.100000001f));
		...
		ui_interface->addVerticalSlider("t1", &fVslider13, FAUSTFLOAT(2.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(90.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->declare(&fVslider3, "scale", "log");
		ui_interface->declare(&fVslider3, "style", "knob");
		ui_interface->declare(&fVslider3, "unit", "sec");
		ui_interface->addVerticalSlider("t2", &fVslider3, FAUSTFLOAT(2.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(90.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->declare(&fVslider8, "scale", "log");
		ui_interface->declare(&fVslider8, "style", "knob");
		ui_interface->declare(&fVslider8, "unit", "sec");
		ui_interface->addVerticalSlider("t3", &fVslider8, FAUSTFLOAT(2.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(90.0f), FAUSTFLOAT(0.100000001f));
		...
		ui_interface->addVerticalSlider("t4", &fVslider23, FAUSTFLOAT(2.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(90.0f), FAUSTFLOAT(0.100000001f));
		...
		ui_interface->addVerticalSlider("t5", &fVslider28, FAUSTFLOAT(2.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(90.0f), FAUSTFLOAT(0.100000001f));
		...
		ui_interface->addVerticalSlider("wet0", &fVslider17, FAUSTFLOAT(-8.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
		...
		ui_interface->addVerticalSlider("wet1", &fVslider12, FAUSTFLOAT(-8.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->declare(&fVslider2, "scale", "log");
		ui_interface->declare(&fVslider2, "style", "knob");
		ui_interface->declare(&fVslider2, "unit", "db");
		ui_interface->addVerticalSlider("wet2", &fVslider2, FAUSTFLOAT(-8.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
		ui_interface->declare(&fVslider7, "scale", "log");
		ui_interface->declare(&fVslider7, "style", "knob");
		ui_interface->declare(&fVslider7, "unit", "db");
		ui_interface->addVerticalSlider("wet3", &fVslider7, FAUSTFLOAT(-8.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
		...
		ui_interface->addVerticalSlider("wet4", &fVslider22, FAUSTFLOAT(-8.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
		...
		ui_interface->addVerticalSlider("wet5", &fVslider27, FAUSTFLOAT(-8.0f), FAUSTFLOAT(-60.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.100000001f));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow38 = std::exp((fConst23 / fSlow5));
		...
		float fSlow77 = std::exp((fConst29 / fSlow76));
		...
		float fSlow85 = std::exp((fConst34 / fSlow76));
		...
		float fSlow93 = std::exp((fConst39 / fSlow76));
		...
		float fSlow101 = std::exp((fConst3 / fSlow76));
		...
		float fSlow109 = std::exp((fConst8 / fSlow76));
		...
		float fSlow117 = std::exp((fConst13 / fSlow76));
		...
		float fSlow125 = std::exp((fConst18 / fSlow76));
		...
		float fSlow133 = std::exp((fConst23 / fSlow76));
		...
		float fSlow148 = std::exp((fConst3 / fSlow147));
		...
		float fSlow156 = std::exp((fConst8 / fSlow147));
		...
		float fSlow164 = std::exp((fConst13 / fSlow147));
		...
		float fSlow172 = std::exp((fConst18 / fSlow147));
		...
		float fSlow180 = std::exp((fConst23 / fSlow147));
		...
		float fSlow219 = std::exp((fConst3 / fSlow218));
		...
		float fSlow227 = std::exp((fConst8 / fSlow218));
		...
		float fSlow235 = std::exp((fConst13 / fSlow218));
		...
		float fSlow251 = std::exp((fConst23 / fSlow218));
		...
		float fSlow259 = std::exp((fConst29 / fSlow218));
		...
		float fSlow267 = std::exp((fConst34 / fSlow218));
		...
		float fSlow290 = std::exp((fConst3 / fSlow289));
		...
		float fSlow298 = std::exp((fConst8 / fSlow289));
		...
		float fSlow306 = std::exp((fConst13 / fSlow289));
		...
		float fSlow314 = std::exp((fConst18 / fSlow289));
		...
		float fSlow322 = std::exp((fConst23 / fSlow289));
		...
		float fSlow330 = std::exp((fConst29 / fSlow289));
		...
		float fSlow338 = std::exp((fConst34 / fSlow289));
		...
		float fSlow361 = std::exp((fConst3 / fSlow360));
		...
		float fSlow369 = std::exp((fConst8 / fSlow360));
		...
		float fSlow377 = std::exp((fConst13 / fSlow360));
		...
		float fSlow385 = std::exp((fConst18 / fSlow360));
		...
		float fSlow393 = std::exp((fConst23 / fSlow360));
		...
		float fSlow426 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 1.375f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow429 = (0.000500000024f * (fSlow72 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow71 * std::fabs((std::fmod((fSlow73 + 1.375f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow432 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 1.25f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow435 = (0.000500000024f * (fSlow72 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow71 * std::fabs((std::fmod((fSlow73 + 1.25f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow438 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 1.125f), 1.0f) + -0.5f)))))))))));
		float fSlow439 = (0.000500000024f * (fSlow143 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow142 * std::fabs((std::fmod((fSlow144 + 1.125f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow444 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 1.0f), 1.0f) + -0.5f)))))))))));
		float fSlow445 = (0.000500000024f * (fSlow143 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow142 * std::fabs((std::fmod((fSlow144 + 1.0f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow450 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 0.875f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow453 = (0.000500000024f * (fSlow72 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow71 * std::fabs((std::fmod((fSlow73 + 0.875f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow456 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 0.75f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow460 = (0.000500000024f * (fSlow285 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow284 * std::fabs((std::fmod((fSlow286 + 0.75f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow462 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 0.625f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow465 = (0.000500000024f * (fSlow72 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow71 * std::fabs((std::fmod((fSlow73 + 0.625f), 1.0f) + -0.5f)))))))))));
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			fRec17[0] = ((fSlow28 * fRec17[1]) + (fSlow29 * fRec6[1]));
			fVec4[(IOTA & 16383)] = ((0.353553385f * fRec17[0]) + 9.99999968e-21f);
			float fTemp2 = ((0.600000024f * fRec15[1]) + fVec4[((IOTA - iConst15) & 16383)]);
			fVec5[(IOTA & 4095)] = fTemp2;
			fRec15[0] = fVec5[((IOTA - iConst16) & 4095)];
			float fRec16 = (0.0f - (0.600000024f * fTemp2));
			fRec20[0] = ((fSlow36 * fRec20[1]) + (fSlow37 * fRec2[1]));
			fVec6[(IOTA & 32767)] = ((0.353553385f * fRec20[0]) + 9.99999968e-21f);
			float fTemp3 = ((0.600000024f * fRec18[1]) + fVec6[((IOTA - iConst20) & 32767)]);
			fVec7[(IOTA & 4095)] = fTemp3;
			fRec18[0] = fVec7[((IOTA - iConst21) & 4095)];
			float fRec19 = (0.0f - (0.600000024f * fTemp3));
			fRec23[0] = ((fSlow44 * fRec23[1]) + (fSlow45 * fRec7[1]));
			fVec8[(IOTA & 16383)] = ((0.353553385f * fRec23[0]) + 9.99999968e-21f);
			float fTemp4 = float(input2[i0]);
			fVec9[(IOTA & 8191)] = fTemp4;
			float fTemp5 = (0.300000012f * fVec9[((IOTA - iConst26) & 8191)]);
			float fTemp6 = (fVec8[((IOTA - iConst25) & 16383)] - (fTemp5 + (0.600000024f * fRec21[1])));
			fVec10[(IOTA & 2047)] = fTemp6;
			fRec21[0] = fVec10[((IOTA - iConst27) & 2047)];
			float fRec22 = (0.600000024f * fTemp6);
			fRec26[0] = ((fSlow52 * fRec26[1]) + (fSlow53 * fRec3[1]));
			fVec11[(IOTA & 16383)] = ((0.353553385f * fRec26[0]) + 9.99999968e-21f);
			float fTemp7 = (fVec11[((IOTA - iConst31) & 16383)] - (fTemp5 + (0.600000024f * fRec24[1])));
			fVec12[(IOTA & 4095)] = fTemp7;
			fRec24[0] = fVec12[((IOTA - iConst32) & 4095)];
			float fRec25 = (0.600000024f * fTemp7);
			fRec29[0] = ((fSlow60 * fRec29[1]) + (fSlow61 * fRec5[1]));
			fVec13[(IOTA & 16383)] = ((0.353553385f * fRec29[0]) + 9.99999968e-21f);
			float fTemp8 = ((fTemp5 + fVec13[((IOTA - iConst36) & 16383)]) - (0.600000024f * fRec27[1]));
			...
			float fTemp9 = ((fVec15[((IOTA - iConst41) & 16383)] + fTemp5) - (0.600000024f * fRec30[1]));
			fVec16[(IOTA & 2047)] = fTemp9;
			fRec30[0] = fVec16[((IOTA - iConst42) & 2047)];
			float fRec31 = (0.600000024f * fTemp9);
			float fTemp10 = (fRec31 + fRec28);
			float fTemp11 = (fRec22 + (fRec25 + fTemp10));
			fRec1[0] = (fRec9[1] + (fRec12[1] + (fRec15[1] + (fRec18[1] + (fRec21[1] + (fRec24[1] + (fRec27[1] + (fRec30[1] + (fRec10 + (fRec13 + (fRec16 + (fRec19 + fTemp11))))))))))));
			fRec2[0] = ((fRec21[1] + (fRec24[1] + (fRec27[1] + (fRec30[1] + fTemp11)))) - (fRec9[1] + (fRec12[1] + (fRec15[1] + (fRec18[1] + (fRec10 + (fRec13 + (fRec19 + fRec16))))))));
			float fTemp12 = (fRec25 + fRec22);
			fRec3[0] = ((fRec15[1] + (fRec18[1] + (fRec27[1] + (fRec30[1] + (fRec16 + (fRec19 + fTemp10)))))) - (fRec9[1] + (fRec12[1] + (fRec21[1] + (fRec24[1] + (fRec10 + (fRec13 + fTemp12)))))));
			fRec4[0] = ((fRec9[1] + (fRec12[1] + (fRec27[1] + (fRec30[1] + (fRec10 + (fRec13 + fTemp10)))))) - (fRec15[1] + (fRec18[1] + (fRec21[1] + (fRec24[1] + (fRec16 + (fRec19 + fTemp12)))))));
			float fTemp13 = (fRec31 + fRec25);
			float fTemp14 = (fRec28 + fRec22);
			fRec5[0] = ((fRec12[1] + (fRec18[1] + (fRec24[1] + (fRec30[1] + (fRec13 + (fRec19 + fTemp13)))))) - (fRec9[1] + (fRec15[1] + (fRec21[1] + (fRec27[1] + (fRec10 + (fRec16 + fTemp14)))))));
			fRec6[0] = ((fRec9[1] + (fRec15[1] + (fRec24[1] + (fRec30[1] + (fRec10 + (fRec16 + fTemp13)))))) - (fRec12[1] + (fRec18[1] + (fRec21[1] + (fRec27[1] + (fRec13 + (fRec19 + fTemp14)))))));
			float fTemp15 = (fRec31 + fRec22);
			float fTemp16 = (fRec28 + fRec25);
			fRec7[0] = ((fRec9[1] + (fRec18[1] + (fRec21[1] + (fRec30[1] + (fRec10 + (fRec19 + fTemp15)))))) - (fRec12[1] + (fRec15[1] + (fRec24[1] + (fRec27[1] + (fRec13 + (fRec16 + fTemp16)))))));
			fRec8[0] = ((fRec12[1] + (fRec15[1] + (fRec21[1] + (fRec30[1] + (fRec13 + (fRec16 + fTemp15)))))) - (fRec9[1] + (fRec18[1] + (fRec24[1] + (fRec27[1] + (fRec10 + (fRec19 + fTemp16)))))));
			float fTemp17 = ((fSlow4 * (fRec2[0] + fRec3[0])) + (fSlow70 * fTemp4));
			fRec33[0] = (fSlow74 + (0.999000013f * fRec33[1]));
			fRec44[0] = ((fSlow83 * fRec44[1]) + (fSlow84 * fRec36[1]));
			fVec17[(IOTA & 16383)] = ((0.353553385f * fRec44[0]) + 9.99999968e-21f);
			float fTemp18 = float(input3[i0]);
			fVec18[(IOTA & 8191)] = fTemp18;
			float fTemp19 = (0.300000012f * fVec18[((IOTA - iConst26) & 8191)]);
			float fTemp20 = (fVec17[((IOTA - iConst31) & 16383)] - (fTemp19 + (0.600000024f * fRec42[1])));
			fVec19[(IOTA & 4095)] = fTemp20;
			fRec42[0] = fVec19[((IOTA - iConst32) & 4095)];
			float fRec43 = (0.600000024f * fTemp20);
			fRec47[0] = ((fSlow91 * fRec47[1]) + (fSlow92 * fRec38[1]));
			fVec20[(IOTA & 16383)] = ((0.353553385f * fRec47[0]) + 9.99999968e-21f);
			float fTemp21 = ((fTemp19 + fVec20[((IOTA - iConst36) & 16383)]) - (0.600000024f * fRec45[1]));
			fVec21[(IOTA & 4095)] = fTemp21;
			fRec45[0] = fVec21[((IOTA - iConst37) & 4095)];
			float fRec46 = (0.600000024f * fTemp21);
			fRec50[0] = ((fSlow99 * fRec50[1]) + (fSlow100 * fRec34[1]));
			fVec22[(IOTA & 16383)] = ((0.353553385f * fRec50[0]) + 9.99999968e-21f);
			float fTemp22 = ((fVec22[((IOTA - iConst41) & 16383)] + fTemp19) - (0.600000024f * fRec48[1]));
			fVec23[(IOTA & 2047)] = fTemp22;
			fRec48[0] = fVec23[((IOTA - iConst42) & 2047)];
			float fRec49 = (0.600000024f * fTemp22);
			fRec53[0] = ((fSlow107 * fRec53[1]) + (fSlow108 * fRec41[1]));
			fVec24[(IOTA & 32767)] = ((0.353553385f * fRec53[0]) + 9.99999968e-21f);
			float fTemp23 = ((0.600000024f * fRec51[1]) + fVec24[((IOTA - iConst5) & 32767)]);
			fVec25[(IOTA & 2047)] = fTemp23;
			fRec51[0] = fVec25[((IOTA - iConst6) & 2047)];
			float fRec52 = (0.0f - (0.600000024f * fTemp23));
			fRec56[0] = ((fSlow115 * fRec56[1]) + (fSlow116 * fRec37[1]));
			fVec26[(IOTA & 32767)] = ((0.353553385f * fRec56[0]) + 9.99999968e-21f);
			float fTemp24 = ((0.600000024f * fRec54[1]) + fVec26[((IOTA - iConst10) & 32767)]);
			fVec27[(IOTA & 4095)] = fTemp24;
			fRec54[0] = fVec27[((IOTA - iConst11) & 4095)];
			float fRec55 = (0.0f - (0.600000024f * fTemp24));
			fRec59[0] = ((fSlow123 * fRec59[1]) + (fSlow124 * fRec39[1]));
			fVec28[(IOTA & 16383)] = ((0.353553385f * fRec59[0]) + 9.99999968e-21f);
			float fTemp25 = ((0.600000024f * fRec57[1]) + fVec28[((IOTA - iConst15) & 16383)]);
			fVec29[(IOTA & 4095)] = fTemp25;
			fRec57[0] = fVec29[((IOTA - iConst16) & 4095)];
			float fRec58 = (0.0f - (0.600000024f * fTemp25));
			fRec62[0] = ((fSlow131 * fRec62[1]) + (fSlow132 * fRec35[1]));
			fVec30[(IOTA & 32767)] = ((0.353553385f * fRec62[0]) + 9.99999968e-21f);
			float fTemp26 = ((0.600000024f * fRec60[1]) + fVec30[((IOTA - iConst20) & 32767)]);
			fVec31[(IOTA & 4095)] = fTemp26;
			fRec60[0] = fVec31[((IOTA - iConst21) & 4095)];
			float fRec61 = (0.0f - (0.600000024f * fTemp26));
			fRec65[0] = ((fSlow139 * fRec65[1]) + (fSlow140 * fRec40[1]));
			fVec32[(IOTA & 16383)] = ((0.353553385f * fRec65[0]) + 9.99999968e-21f);
			float fTemp27 = (fVec32[((IOTA - iConst25) & 16383)] - (fTemp19 + (0.600000024f * fRec63[1])));
			fVec33[(IOTA & 2047)] = fTemp27;
			fRec63[0] = fVec33[((IOTA - iConst27) & 2047)];
			float fRec64 = (0.600000024f * fTemp27);
			float fTemp28 = (fRec49 + fRec46);
			float fTemp29 = (fRec64 + (fRec43 + fTemp28));
			fRec34[0] = (fRec42[1] + (fRec45[1] + (fRec48[1] + (fRec51[1] + (fRec54[1] + (fRec57[1] + (fRec60[1] + (fRec63[1] + (fRec52 + (fRec55 + (fRec58 + (fRec61 + fTemp29))))))))))));
			fRec35[0] = ((fRec42[1] + (fRec45[1] + (fRec48[1] + (fRec63[1] + fTemp29)))) - (fRec51[1] + (fRec54[1] + (fRec57[1] + (fRec60[1] + (fRec52 + (fRec55 + (fRec61 + fRec58))))))));
			float fTemp30 = (fRec43 + fRec64);
			fRec36[0] = ((fRec45[1] + (fRec48[1] + (fRec57[1] + (fRec60[1] + (fRec58 + (fRec61 + fTemp28)))))) - (fRec42[1] + (fRec51[1] + (fRec54[1] + (fRec63[1] + (fRec52 + (fRec55 + fTemp30)))))));
			fRec37[0] = ((fRec45[1] + (fRec48[1] + (fRec51[1] + (fRec54[1] + (fRec52 + (fRec55 + fTemp28)))))) - (fRec42[1] + (fRec57[1] + (fRec60[1] + (fRec63[1] + (fRec58 + (fRec61 + fTemp30)))))));
			float fTemp31 = (fRec49 + fRec43);
			float fTemp32 = (fRec46 + fRec64);
			fRec38[0] = ((fRec42[1] + (fRec48[1] + (fRec54[1] + (fRec60[1] + (fRec55 + (fRec61 + fTemp31)))))) - (fRec45[1] + (fRec51[1] + (fRec57[1] + (fRec63[1] + (fRec52 + (fRec58 + fTemp32)))))));
			fRec39[0] = ((fRec42[1] + (fRec48[1] + (fRec51[1] + (fRec57[1] + (fRec52 + (fRec58 + fTemp31)))))) - (fRec45[1] + (fRec54[1] + (fRec60[1] + (fRec63[1] + (fRec55 + (fRec61 + fTemp32)))))));
			float fTemp33 = (fRec49 + fRec64);
			float fTemp34 = (fRec46 + fRec43);
			fRec40[0] = ((fRec48[1] + (fRec51[1] + (fRec60[1] + (fRec63[1] + (fRec52 + (fRec61 + fTemp33)))))) - (fRec42[1] + (fRec45[1] + (fRec54[1] + (fRec57[1] + (fRec55 + (fRec58 + fTemp34)))))));
			fRec41[0] = ((fRec48[1] + (fRec54[1] + (fRec57[1] + (fRec63[1] + (fRec55 + (fRec58 + fTemp33)))))) - (fRec42[1] + (fRec45[1] + (fRec51[1] + (fRec60[1] + (fRec52 + (fRec61 + fTemp34)))))));
			float fTemp35 = ((fSlow75 * (fRec35[0] + fRec36[0])) + (fSlow141 * fTemp18));
			...
			float fTemp36 = ((0.600000024f * fRec75[1]) + fVec34[((IOTA - iConst5) & 32767)]);
			fVec35[(IOTA & 2047)] = fTemp36;
			fRec75[0] = fVec35[((IOTA - iConst6) & 2047)];
			...
			float fTemp37 = ((0.600000024f * fRec78[1]) + fVec36[((IOTA - iConst10) & 32767)]);
			fVec37[(IOTA & 4095)] = fTemp37;
			fRec78[0] = fVec37[((IOTA - iConst11) & 4095)];
			...
			float fTemp38 = ((0.600000024f * fRec81[1]) + fVec38[((IOTA - iConst15) & 16383)]);
			fVec39[(IOTA & 4095)] = fTemp38;
			fRec81[0] = fVec39[((IOTA - iConst16) & 4095)];
			float fRec82 = (0.0f - (0.600000024f * fTemp38));
			fRec86[0] = ((fSlow178 * fRec86[1]) + (fSlow179 * fRec68[1]));
			fVec40[(IOTA & 32767)] = ((0.353553385f * fRec86[0]) + 9.99999968e-21f);
			float fTemp39 = ((0.600000024f * fRec84[1]) + fVec40[((IOTA - iConst20) & 32767)]);
			fVec41[(IOTA & 4095)] = fTemp39;
			fRec84[0] = fVec41[((IOTA - iConst21) & 4095)];
			float fRec85 = (0.0f - (0.600000024f * fTemp39));
			fRec89[0] = ((fSlow186 * fRec89[1]) + (fSlow187 * fRec73[1]));
			fVec42[(IOTA & 16383)] = ((0.353553385f * fRec89[0]) + 9.99999968e-21f);
			float fTemp40 = float(input1[i0]);
			fVec43[(IOTA & 8191)] = fTemp40;
			float fTemp41 = (0.300000012f * fVec43[((IOTA - iConst26) & 8191)]);
			float fTemp42 = (fVec42[((IOTA - iConst25) & 16383)] - (fTemp41 + (0.600000024f * fRec87[1])));
			fVec44[(IOTA & 2047)] = fTemp42;
			fRec87[0] = fVec44[((IOTA - iConst27) & 2047)];
			float fRec88 = (0.600000024f * fTemp42);
			fRec92[0] = ((fSlow194 * fRec92[1]) + (fSlow195 * fRec69[1]));
			fVec45[(IOTA & 16383)] = ((0.353553385f * fRec92[0]) + 9.99999968e-21f);
			float fTemp43 = (fVec45[((IOTA - iConst31) & 16383)] - (fTemp41 + (0.600000024f * fRec90[1])));
			fVec46[(IOTA & 4095)] = fTemp43;
			fRec90[0] = fVec46[((IOTA - iConst32) & 4095)];
			float fRec91 = (0.600000024f * fTemp43);
			fRec95[0] = ((fSlow202 * fRec95[1]) + (fSlow203 * fRec71[1]));
			fVec47[(IOTA & 16383)] = ((0.353553385f * fRec95[0]) + 9.99999968e-21f);
			float fTemp44 = ((fTemp41 + fVec47[((IOTA - iConst36) & 16383)]) - (0.600000024f * fRec93[1]));
			fVec48[(IOTA & 4095)] = fTemp44;
			fRec93[0] = fVec48[((IOTA - iConst37) & 4095)];
			float fRec94 = (0.600000024f * fTemp44);
			fRec98[0] = ((fSlow210 * fRec98[1]) + (fSlow211 * fRec67[1]));
			fVec49[(IOTA & 16383)] = ((0.353553385f * fRec98[0]) + 9.99999968e-21f);
			float fTemp45 = ((fVec49[((IOTA - iConst41) & 16383)] + fTemp41) - (0.600000024f * fRec96[1]));
			fVec50[(IOTA & 2047)] = fTemp45;
			fRec96[0] = fVec50[((IOTA - iConst42) & 2047)];
			float fRec97 = (0.600000024f * fTemp45);
			float fTemp46 = (fRec97 + fRec94);
			float fTemp47 = (fRec88 + (fRec91 + fTemp46));
			fRec67[0] = (fRec75[1] + (fRec78[1] + (fRec81[1] + (fRec84[1] + (fRec87[1] + (fRec90[1] + (fRec93[1] + (fRec96[1] + (fRec76 + (fRec79 + (fRec82 + (fRec85 + fTemp47))))))))))));
			fRec68[0] = ((fRec87[1] + (fRec90[1] + (fRec93[1] + (fRec96[1] + fTemp47)))) - (fRec75[1] + (fRec78[1] + (fRec81[1] + (fRec84[1] + (fRec76 + (fRec79 + (fRec85 + fRec82))))))));
			float fTemp48 = (fRec91 + fRec88);
			fRec69[0] = ((fRec81[1] + (fRec84[1] + (fRec93[1] + (fRec96[1] + (fRec82 + (fRec85 + fTemp46)))))) - (fRec75[1] + (fRec78[1] + (fRec87[1] + (fRec90[1] + (fRec76 + (fRec79 + fTemp48)))))));
			fRec70[0] = ((fRec75[1] + (fRec78[1] + (fRec93[1] + (fRec96[1] + (fRec76 + (fRec79 + fTemp46)))))) - (fRec81[1] + (fRec84[1] + (fRec87[1] + (fRec90[1] + (fRec82 + (fRec85 + fTemp48)))))));
			float fTemp49 = (fRec97 + fRec91);
			float fTemp50 = (fRec94 + fRec88);
			fRec71[0] = ((fRec78[1] + (fRec84[1] + (fRec90[1] + (fRec96[1] + (fRec79 + (fRec85 + fTemp49)))))) - (fRec75[1] + (fRec81[1] + (fRec87[1] + (fRec93[1] + (fRec76 + (fRec82 + fTemp50)))))));
			fRec72[0] = ((fRec75[1] + (fRec81[1] + (fRec90[1] + (fRec96[1] + (fRec76 + (fRec82 + fTemp49)))))) - (fRec78[1] + (fRec84[1] + (fRec87[1] + (fRec93[1] + (fRec79 + (fRec85 + fTemp50)))))));
			float fTemp51 = (fRec97 + fRec88);
			float fTemp52 = (fRec94 + fRec91);
			fRec73[0] = ((fRec75[1] + (fRec84[1] + (fRec87[1] + (fRec96[1] + (fRec76 + (fRec85 + fTemp51)))))) - (fRec78[1] + (fRec81[1] + (fRec90[1] + (fRec93[1] + (fRec79 + (fRec82 + fTemp52)))))));
			fRec74[0] = ((fRec78[1] + (fRec81[1] + (fRec87[1] + (fRec96[1] + (fRec79 + (fRec82 + fTemp51)))))) - (fRec75[1] + (fRec84[1] + (fRec90[1] + (fRec93[1] + (fRec76 + (fRec85 + fTemp52)))))));
			float fTemp53 = ((fSlow146 * (fRec68[0] + fRec69[0])) + (fSlow212 * fTemp40));
			...
			float fTemp54 = ((0.600000024f * fRec108[1]) + fVec51[((IOTA - iConst5) & 32767)]);
			fVec52[(IOTA & 2047)] = fTemp54;
			fRec108[0] = fVec52[((IOTA - iConst6) & 2047)];
			...
			float fTemp55 = ((0.600000024f * fRec111[1]) + fVec53[((IOTA - iConst10) & 32767)]);
			fVec54[(IOTA & 4095)] = fTemp55;
			fRec111[0] = fVec54[((IOTA - iConst11) & 4095)];
			...
			float fTemp56 = ((0.600000024f * fRec114[1]) + fVec55[((IOTA - iConst15) & 16383)]);
			fVec56[(IOTA & 4095)] = fTemp56;
			fRec114[0] = fVec56[((IOTA - iConst16) & 4095)];
			...
			float fTemp57 = ((0.600000024f * fRec117[1]) + fVec57[((IOTA - iConst20) & 32767)]);
			fVec58[(IOTA & 4095)] = fTemp57;
			fRec117[0] = fVec58[((IOTA - iConst21) & 4095)];
			...
			float fTemp59 = (0.300000012f * fVec60[((IOTA - iConst26) & 8191)]);
			float fTemp60 = (fVec59[((IOTA - iConst25) & 16383)] - (fTemp59 + (0.600000024f * fRec120[1])));
			fVec61[(IOTA & 2047)] = fTemp60;
			fRec120[0] = fVec61[((IOTA - iConst27) & 2047)];
			...
			float fTemp61 = (fVec62[((IOTA - iConst31) & 16383)] - (fTemp59 + (0.600000024f * fRec123[1])));
			...
			float fTemp62 = ((fTemp59 + fVec64[((IOTA - iConst36) & 16383)]) - (0.600000024f * fRec126[1]));
			...
			float fTemp72 = ((0.600000024f * fRec141[1]) + fVec68[((IOTA - iConst5) & 32767)]);
			fVec69[(IOTA & 2047)] = fTemp72;
			fRec141[0] = fVec69[((IOTA - iConst6) & 2047)];
			...
			float fTemp73 = ((0.600000024f * fRec144[1]) + fVec70[((IOTA - iConst10) & 32767)]);
			fVec71[(IOTA & 4095)] = fTemp73;
			fRec144[0] = fVec71[((IOTA - iConst11) & 4095)];
			...
			float fTemp74 = ((0.600000024f * fRec147[1]) + fVec72[((IOTA - iConst15) & 16383)]);
			fVec73[(IOTA & 4095)] = fTemp74;
			fRec147[0] = fVec73[((IOTA - iConst16) & 4095)];
			float fRec148 = (0.0f - (0.600000024f * fTemp74));
			fRec152[0] = ((fSlow320 * fRec152[1]) + (fSlow321 * fRec134[1]));
			fVec74[(IOTA & 32767)] = ((0.353553385f * fRec152[0]) + 9.99999968e-21f);
			float fTemp75 = ((0.600000024f * fRec150[1]) + fVec74[((IOTA - iConst20) & 32767)]);
			fVec75[(IOTA & 4095)] = fTemp75;
			fRec150[0] = fVec75[((IOTA - iConst21) & 4095)];
			float fRec151 = (0.0f - (0.600000024f * fTemp75));
			fRec155[0] = ((fSlow328 * fRec155[1]) + (fSlow329 * fRec139[1]));
			fVec76[(IOTA & 16383)] = ((0.353553385f * fRec155[0]) + 9.99999968e-21f);
			float fTemp76 = float(input4[i0]);
			fVec77[(IOTA & 8191)] = fTemp76;
			float fTemp77 = (0.300000012f * fVec77[((IOTA - iConst26) & 8191)]);
			float fTemp78 = (fVec76[((IOTA - iConst25) & 16383)] - (fTemp77 + (0.600000024f * fRec153[1])));
			fVec78[(IOTA & 2047)] = fTemp78;
			fRec153[0] = fVec78[((IOTA - iConst27) & 2047)];
			float fRec154 = (0.600000024f * fTemp78);
			fRec158[0] = ((fSlow336 * fRec158[1]) + (fSlow337 * fRec135[1]));
			fVec79[(IOTA & 16383)] = ((0.353553385f * fRec158[0]) + 9.99999968e-21f);
			float fTemp79 = (fVec79[((IOTA - iConst31) & 16383)] - (fTemp77 + (0.600000024f * fRec156[1])));
			fVec80[(IOTA & 4095)] = fTemp79;
			fRec156[0] = fVec80[((IOTA - iConst32) & 4095)];
			float fRec157 = (0.600000024f * fTemp79);
			fRec161[0] = ((fSlow344 * fRec161[1]) + (fSlow345 * fRec137[1]));
			fVec81[(IOTA & 16383)] = ((0.353553385f * fRec161[0]) + 9.99999968e-21f);
			float fTemp80 = ((fTemp77 + fVec81[((IOTA - iConst36) & 16383)]) - (0.600000024f * fRec159[1]));
			fVec82[(IOTA & 4095)] = fTemp80;
			fRec159[0] = fVec82[((IOTA - iConst37) & 4095)];
			float fRec160 = (0.600000024f * fTemp80);
			fRec164[0] = ((fSlow352 * fRec164[1]) + (fSlow353 * fRec133[1]));
			fVec83[(IOTA & 16383)] = ((0.353553385f * fRec164[0]) + 9.99999968e-21f);
			float fTemp81 = ((fVec83[((IOTA - iConst41) & 16383)] + fTemp77) - (0.600000024f * fRec162[1]));
			fVec84[(IOTA & 2047)] = fTemp81;
			fRec162[0] = fVec84[((IOTA - iConst42) & 2047)];
			float fRec163 = (0.600000024f * fTemp81);
			float fTemp82 = (fRec163 + fRec160);
			float fTemp83 = (fRec154 + (fRec157 + fTemp82));
			fRec133[0] = (fRec141[1] + (fRec144[1] + (fRec147[1] + (fRec150[1] + (fRec153[1] + (fRec156[1] + (fRec159[1] + (fRec162[1] + (fRec142 + (fRec145 + (fRec148 + (fRec151 + fTemp83))))))))))));
			fRec134[0] = ((fRec153[1] + (fRec156[1] + (fRec159[1] + (fRec162[1] + fTemp83)))) - (fRec141[1] + (fRec144[1] + (fRec147[1] + (fRec150[1] + (fRec142 + (fRec145 + (fRec151 + fRec148))))))));
			float fTemp84 = (fRec157 + fRec154);
			fRec135[0] = ((fRec147[1] + (fRec150[1] + (fRec159[1] + (fRec162[1] + (fRec148 + (fRec151 + fTemp82)))))) - (fRec141[1] + (fRec144[1] + (fRec153[1] + (fRec156[1] + (fRec142 + (fRec145 + fTemp84)))))));
			fRec136[0] = ((fRec141[1] + (fRec144[1] + (fRec159[1] + (fRec162[1] + (fRec142 + (fRec145 + fTemp82)))))) - (fRec147[1] + (fRec150[1] + (fRec153[1] + (fRec156[1] + (fRec148 + (fRec151 + fTemp84)))))));
			float fTemp85 = (fRec163 + fRec157);
			float fTemp86 = (fRec160 + fRec154);
			fRec137[0] = ((fRec144[1] + (fRec150[1] + (fRec156[1] + (fRec162[1] + (fRec145 + (fRec151 + fTemp85)))))) - (fRec141[1] + (fRec147[1] + (fRec153[1] + (fRec159[1] + (fRec142 + (fRec148 + fTemp86)))))));
			fRec138[0] = ((fRec141[1] + (fRec147[1] + (fRec156[1] + (fRec162[1] + (fRec142 + (fRec148 + fTemp85)))))) - (fRec144[1] + (fRec150[1] + (fRec153[1] + (fRec159[1] + (fRec145 + (fRec151 + fTemp86)))))));
			float fTemp87 = (fRec163 + fRec154);
			float fTemp88 = (fRec160 + fRec157);
			fRec139[0] = ((fRec141[1] + (fRec150[1] + (fRec153[1] + (fRec162[1] + (fRec142 + (fRec151 + fTemp87)))))) - (fRec144[1] + (fRec147[1] + (fRec156[1] + (fRec159[1] + (fRec145 + (fRec148 + fTemp88)))))));
			fRec140[0] = ((fRec144[1] + (fRec147[1] + (fRec153[1] + (fRec162[1] + (fRec145 + (fRec148 + fTemp87)))))) - (fRec141[1] + (fRec150[1] + (fRec156[1] + (fRec159[1] + (fRec142 + (fRec151 + fTemp88)))))));
			float fTemp89 = ((fSlow288 * (fRec134[0] + fRec135[0])) + (fSlow354 * fTemp76));
			fRec165[0] = (fSlow358 + (0.999000013f * fRec165[1]));
			fRec176[0] = ((fSlow367 * fRec176[1]) + (fSlow368 * fRec173[1]));
			fVec85[(IOTA & 32767)] = ((0.353553385f * fRec176[0]) + 9.99999968e-21f);
			float fTemp90 = ((0.600000024f * fRec174[1]) + fVec85[((IOTA - iConst5) & 32767)]);
			fVec86[(IOTA & 2047)] = fTemp90;
			fRec174[0] = fVec86[((IOTA - iConst6) & 2047)];
			float fRec175 = (0.0f - (0.600000024f * fTemp90));
			fRec179[0] = ((fSlow375 * fRec179[1]) + (fSlow376 * fRec169[1]));
			fVec87[(IOTA & 32767)] = ((0.353553385f * fRec179[0]) + 9.99999968e-21f);
			float fTemp91 = ((0.600000024f * fRec177[1]) + fVec87[((IOTA - iConst10) & 32767)]);
			fVec88[(IOTA & 4095)] = fTemp91;
			fRec177[0] = fVec88[((IOTA - iConst11) & 4095)];
			float fRec178 = (0.0f - (0.600000024f * fTemp91));
			fRec182[0] = ((fSlow383 * fRec182[1]) + (fSlow384 * fRec171[1]));
			fVec89[(IOTA & 16383)] = ((0.353553385f * fRec182[0]) + 9.99999968e-21f);
			float fTemp92 = ((0.600000024f * fRec180[1]) + fVec89[((IOTA - iConst15) & 16383)]);
			fVec90[(IOTA & 4095)] = fTemp92;
			fRec180[0] = fVec90[((IOTA - iConst16) & 4095)];
			float fRec181 = (0.0f - (0.600000024f * fTemp92));
			fRec185[0] = ((fSlow391 * fRec185[1]) + (fSlow392 * fRec167[1]));
			fVec91[(IOTA & 32767)] = ((0.353553385f * fRec185[0]) + 9.99999968e-21f);
			float fTemp93 = ((0.600000024f * fRec183[1]) + fVec91[((IOTA - iConst20) & 32767)]);
			fVec92[(IOTA & 4095)] = fTemp93;
			fRec183[0] = fVec92[((IOTA - iConst21) & 4095)];
			float fRec184 = (0.0f - (0.600000024f * fTemp93));
			fRec188[0] = ((fSlow399 * fRec188[1]) + (fSlow400 * fRec172[1]));
			fVec93[(IOTA & 16383)] = ((0.353553385f * fRec188[0]) + 9.99999968e-21f);
			float fTemp94 = float(input5[i0]);
			fVec94[(IOTA & 8191)] = fTemp94;
			float fTemp95 = (0.300000012f * fVec94[((IOTA - iConst26) & 8191)]);
			float fTemp96 = (fVec93[((IOTA - iConst25) & 16383)] - (fTemp95 + (0.600000024f * fRec186[1])));
			fVec95[(IOTA & 2047)] = fTemp96;
			fRec186[0] = fVec95[((IOTA - iConst27) & 2047)];
			float fRec187 = (0.600000024f * fTemp96);
			fRec191[0] = ((fSlow407 * fRec191[1]) + (fSlow408 * fRec168[1]));
			fVec96[(IOTA & 16383)] = ((0.353553385f * fRec191[0]) + 9.99999968e-21f);
			float fTemp97 = (fVec96[((IOTA - iConst31) & 16383)] - (fTemp95 + (0.600000024f * fRec189[1])));
			fVec97[(IOTA & 4095)] = fTemp97;
			fRec189[0] = fVec97[((IOTA - iConst32) & 4095)];
			float fRec190 = (0.600000024f * fTemp97);
			fRec194[0] = ((fSlow415 * fRec194[1]) + (fSlow416 * fRec170[1]));
			fVec98[(IOTA & 16383)] = ((0.353553385f * fRec194[0]) + 9.99999968e-21f);
			float fTemp98 = ((fTemp95 + fVec98[((IOTA - iConst36) & 16383)]) - (0.600000024f * fRec192[1]));
			fVec99[(IOTA & 4095)] = fTemp98;
			fRec192[0] = fVec99[((IOTA - iConst37) & 4095)];
			float fRec193 = (0.600000024f * fTemp98);
			fRec197[0] = ((fSlow423 * fRec197[1]) + (fSlow424 * fRec166[1]));
			fVec100[(IOTA & 16383)] = ((0.353553385f * fRec197[0]) + 9.99999968e-21f);
			float fTemp99 = ((fVec100[((IOTA - iConst41) & 16383)] + fTemp95) - (0.600000024f * fRec195[1]));
			fVec101[(IOTA & 2047)] = fTemp99;
			fRec195[0] = fVec101[((IOTA - iConst42) & 2047)];
			float fRec196 = (0.600000024f * fTemp99);
			float fTemp100 = (fRec196 + fRec193);
			float fTemp101 = (fRec187 + (fRec190 + fTemp100));
			fRec166[0] = (fRec174[1] + (fRec177[1] + (fRec180[1] + (fRec183[1] + (fRec186[1] + (fRec189[1] + (fRec192[1] + (fRec195[1] + (fRec175 + (fRec178 + (fRec181 + (fRec184 + fTemp101))))))))))));
			fRec167[0] = ((fRec186[1] + (fRec189[1] + (fRec192[1] + (fRec195[1] + fTemp101)))) - (fRec174[1] + (fRec177[1] + (fRec180[1] + (fRec183[1] + (fRec175 + (fRec178 + (fRec184 + fRec181))))))));
			float fTemp102 = (fRec190 + fRec187);
			fRec168[0] = ((fRec180[1] + (fRec183[1] + (fRec192[1] + (fRec195[1] + (fRec181 + (fRec184 + fTemp100)))))) - (fRec174[1] + (fRec177[1] + (fRec186[1] + (fRec189[1] + (fRec175 + (fRec178 + fTemp102)))))));
			fRec169[0] = ((fRec174[1] + (fRec177[1] + (fRec192[1] + (fRec195[1] + (fRec175 + (fRec178 + fTemp100)))))) - (fRec180[1] + (fRec183[1] + (fRec186[1] + (fRec189[1] + (fRec181 + (fRec184 + fTemp102)))))));
			float fTemp103 = (fRec196 + fRec190);
			float fTemp104 = (fRec193 + fRec187);
			fRec170[0] = ((fRec177[1] + (fRec183[1] + (fRec189[1] + (fRec195[1] + (fRec178 + (fRec184 + fTemp103)))))) - (fRec174[1] + (fRec180[1] + (fRec186[1] + (fRec192[1] + (fRec175 + (fRec181 + fTemp104)))))));
			fRec171[0] = ((fRec174[1] + (fRec180[1] + (fRec189[1] + (fRec195[1] + (fRec175 + (fRec181 + fTemp103)))))) - (fRec177[1] + (fRec183[1] + (fRec186[1] + (fRec192[1] + (fRec178 + (fRec184 + fTemp104)))))));
			float fTemp105 = (fRec196 + fRec187);
			float fTemp106 = (fRec193 + fRec190);
			fRec172[0] = ((fRec174[1] + (fRec183[1] + (fRec186[1] + (fRec195[1] + (fRec175 + (fRec184 + fTemp105)))))) - (fRec177[1] + (fRec180[1] + (fRec189[1] + (fRec192[1] + (fRec178 + (fRec181 + fTemp106)))))));
			fRec173[0] = ((fRec177[1] + (fRec180[1] + (fRec186[1] + (fRec195[1] + (fRec178 + (fRec181 + fTemp105)))))) - (fRec174[1] + (fRec183[1] + (fRec189[1] + (fRec192[1] + (fRec175 + (fRec184 + fTemp106)))))));
			float fTemp107 = ((fSlow359 * (fRec167[0] + fRec168[0])) + (fSlow425 * fTemp94));
			output0[i0] = FAUSTFLOAT(((fRec0[0] * fTemp17) + ((fRec33[0] * fTemp35) + ((fRec66[0] * fTemp53) + ((fRec99[0] * fTemp71) + ((fRec132[0] * fTemp89) + (fRec165[0] * fTemp107)))))));
			...
			output1[i0] = FAUSTFLOAT(((((((fRec198[0] * fTemp71) + (fRec199[0] * fTemp53)) + (fRec200[0] * fTemp17)) + (fRec201[0] * fTemp35)) + (fRec202[0] * fTemp89)) + (fRec203[0] * fTemp107)));
			...
			output2[i0] = FAUSTFLOAT(((((((fRec204[0] * fTemp71) + (fRec205[0] * fTemp53)) + (fRec206[0] * fTemp17)) + (fRec207[0] * fTemp35)) + (fRec208[0] * fTemp89)) + (fRec209[0] * fTemp107)));
			...
			output3[i0] = FAUSTFLOAT(((((((fRec210[0] * fTemp71) + (fRec211[0] * fTemp53)) + (fRec212[0] * fTemp17)) + (fRec213[0] * fTemp35)) + (fRec214[0] * fTemp89)) + (fRec215[0] * fTemp107)));
			...
			output4[i0] = FAUSTFLOAT(((((((fRec216[0] * fTemp71) + (fRec217[0] * fTemp53)) + (fRec218[0] * fTemp17)) + (fRec219[0] * fTemp35)) + (fRec220[0] * fTemp89)) + (fRec221[0] * fTemp107)));
			...
			output5[i0] = FAUSTFLOAT(((((((fRec222[0] * fTemp71) + (fRec223[0] * fTemp53)) + (fRec224[0] * fTemp17)) + (fRec225[0] * fTemp35)) + (fRec226[0] * fTemp89)) + (fRec227[0] * fTemp107)));
			...
			output6[i0] = FAUSTFLOAT(((((((fRec228[0] * fTemp71) + (fRec229[0] * fTemp53)) + (fRec230[0] * fTemp17)) + (fRec231[0] * fTemp35)) + (fRec232[0] * fTemp89)) + (fRec233[0] * fTemp107)));
			...
			output7[i0] = FAUSTFLOAT(((((((fRec234[0] * fTemp71) + (fRec235[0] * fTemp53)) + (fRec236[0] * fTemp17)) + (fRec237[0] * fTemp35)) + (fRec238[0] * fTemp89)) + (fRec239[0] * fTemp107)));
			fRec0[1] = fRec0[0];
			fRec11[1] = fRec11[0];
			IOTA = (IOTA + 1);
			fRec9[1] = fRec9[0];
