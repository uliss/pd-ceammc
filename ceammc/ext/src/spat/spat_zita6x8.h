...
class spat_zita6x8 : public spat_zita6x8_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst4 = std::floor(((0.0203460008f * fConst0) + 0.5f));
		iConst5 = int(std::min<float>(8192.0f, std::max<float>(0.0f, (fConst2 - fConst4))));
		iConst6 = int(std::min<float>(8192.0f, std::max<float>(0.0f, (0.0399999991f * fConst0))));
		iConst7 = int(std::min<float>(1024.0f, std::max<float>(0.0f, (fConst4 + -1.0f))));
		...
		float fConst38 = std::floor(((0.174713001f * fConst0) + 0.5f));
		fConst39 = ((0.0f - (6.90775537f * fConst38)) / fConst0);
		float fConst40 = std::floor(((0.0229039993f * fConst0) + 0.5f));
	...
	virtual void instanceClear() {
		...
		#pragma clang loop vectorize(enable) interleave(enable)
		for (int l182 = 0; (l182 < 32768); l182 = (l182 + 1)) {
			fVec74[l182] = 0.0f;
		}
		#pragma clang loop vectorize(enable) interleave(enable)
		...
		#pragma clang loop vectorize(enable) interleave(enable)
		for (int l217 = 0; (l217 < 2048); l217 = (l217 + 1)) {
			fVec88[l217] = 0.0f;
		}
		#pragma clang loop vectorize(enable) interleave(enable)
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("a0", &fVslider11, 0.0f, 0.0f, 1.0f, 9.99999975e-05f);
		ui_interface->addVerticalSlider("a1", &fVslider6, 0.0f, 0.0f, 1.0f, 9.99999975e-05f);
		ui_interface->addVerticalSlider("a2", &fVslider1, 0.0f, 0.0f, 1.0f, 9.99999975e-05f);
		ui_interface->addVerticalSlider("a3", &fVslider16, 0.0f, 0.0f, 1.0f, 9.99999975e-05f);
		ui_interface->addVerticalSlider("a4", &fVslider21, 0.0f, 0.0f, 1.0f, 9.99999975e-05f);
		...
		ui_interface->addVerticalSlider("dry0", &fVslider14, -3.0f, -60.0f, 0.0f, 0.100000001f);
		ui_interface->declare(&fVslider9, "scale", "log");
		ui_interface->declare(&fVslider9, "style", "knob");
		ui_interface->declare(&fVslider9, "unit", "db");
		ui_interface->addVerticalSlider("dry1", &fVslider9, -3.0f, -60.0f, 0.0f, 0.100000001f);
		ui_interface->declare(&fVslider4, "scale", "log");
		ui_interface->declare(&fVslider4, "style", "knob");
		ui_interface->declare(&fVslider4, "unit", "db");
		ui_interface->addVerticalSlider("dry2", &fVslider4, -3.0f, -60.0f, 0.0f, 0.100000001f);
		...
		ui_interface->addVerticalSlider("dry3", &fVslider19, -3.0f, -60.0f, 0.0f, 0.100000001f);
		...
		ui_interface->addVerticalSlider("dry4", &fVslider24, -3.0f, -60.0f, 0.0f, 0.100000001f);
		...
		ui_interface->addVerticalSlider("r0", &fVslider10, 1.0f, 0.0f, 1.0f, 9.99999975e-05f);
		ui_interface->addVerticalSlider("r1", &fVslider5, 1.0f, 0.0f, 1.0f, 9.99999975e-05f);
		ui_interface->addVerticalSlider("r2", &fVslider0, 1.0f, 0.0f, 1.0f, 9.99999975e-05f);
		ui_interface->addVerticalSlider("r3", &fVslider15, 1.0f, 0.0f, 1.0f, 9.99999975e-05f);
		ui_interface->addVerticalSlider("r4", &fVslider20, 1.0f, 0.0f, 1.0f, 9.99999975e-05f);
		...
		ui_interface->addVerticalSlider("t0", &fVslider13, 2.0f, 0.0f, 90.0f, 0.100000001f);
		ui_interface->declare(&fVslider8, "scale", "log");
		ui_interface->declare(&fVslider8, "style", "knob");
		ui_interface->declare(&fVslider8, "unit", "sec");
		ui_interface->addVerticalSlider("t1", &fVslider8, 2.0f, 0.0f, 90.0f, 0.100000001f);
		ui_interface->declare(&fVslider3, "scale", "log");
		ui_interface->declare(&fVslider3, "style", "knob");
		ui_interface->declare(&fVslider3, "unit", "sec");
		ui_interface->addVerticalSlider("t2", &fVslider3, 2.0f, 0.0f, 90.0f, 0.100000001f);
		...
		ui_interface->addVerticalSlider("t3", &fVslider18, 2.0f, 0.0f, 90.0f, 0.100000001f);
		...
		ui_interface->addVerticalSlider("t4", &fVslider23, 2.0f, 0.0f, 90.0f, 0.100000001f);
		...
		ui_interface->addVerticalSlider("wet0", &fVslider12, -8.0f, -60.0f, 0.0f, 0.100000001f);
		ui_interface->declare(&fVslider7, "scale", "log");
		ui_interface->declare(&fVslider7, "style", "knob");
		ui_interface->declare(&fVslider7, "unit", "db");
		ui_interface->addVerticalSlider("wet1", &fVslider7, -8.0f, -60.0f, 0.0f, 0.100000001f);
		ui_interface->declare(&fVslider2, "scale", "log");
		ui_interface->declare(&fVslider2, "style", "knob");
		ui_interface->declare(&fVslider2, "unit", "db");
		ui_interface->addVerticalSlider("wet2", &fVslider2, -8.0f, -60.0f, 0.0f, 0.100000001f);
		...
		ui_interface->addVerticalSlider("wet3", &fVslider17, -8.0f, -60.0f, 0.0f, 0.100000001f);
		...
		ui_interface->addVerticalSlider("wet4", &fVslider22, -8.0f, -60.0f, 0.0f, 0.100000001f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow32 = (1.0f - (fConst1 * fSlow31));
		...
		float fSlow77 = std::exp((fConst9 / fSlow76));
		float fSlow78 = spat_zita6x8_faustpower2_f(fSlow77);
		float fSlow79 = (1.0f - (fConst1 * fSlow78));
		...
		float fSlow85 = std::exp((fConst14 / fSlow76));
		...
		float fSlow93 = std::exp((fConst19 / fSlow76));
		...
		float fSlow101 = std::exp((fConst24 / fSlow76));
		...
		float fSlow109 = std::exp((fConst3 / fSlow76));
		...
		float fSlow117 = std::exp((fConst29 / fSlow76));
		float fSlow118 = spat_zita6x8_faustpower2_f(fSlow117);
		float fSlow119 = (1.0f - (fConst1 * fSlow118));
		...
		float fSlow125 = std::exp((fConst34 / fSlow76));
		...
		float fSlow148 = std::exp((fConst9 / fSlow147));
		float fSlow149 = spat_zita6x8_faustpower2_f(fSlow148);
		float fSlow150 = (1.0f - (fConst1 * fSlow149));
		...
		float fSlow156 = std::exp((fConst14 / fSlow147));
		float fSlow157 = spat_zita6x8_faustpower2_f(fSlow156);
		float fSlow158 = (1.0f - (fConst1 * fSlow157));
		...
		float fSlow164 = std::exp((fConst19 / fSlow147));
		...
		float fSlow172 = std::exp((fConst3 / fSlow147));
		...
		float fSlow180 = std::exp((fConst24 / fSlow147));
		...
		float fSlow188 = std::exp((fConst29 / fSlow147));
		float fSlow189 = spat_zita6x8_faustpower2_f(fSlow188);
		float fSlow190 = (1.0f - (fConst1 * fSlow189));
		...
		float fSlow196 = std::exp((fConst34 / fSlow147));
		...
		float fSlow204 = std::exp((fConst39 / fSlow147));
		...
		float fSlow221 = (1.0f - (fConst1 * fSlow220));
		...
		float fSlow227 = std::exp((fConst39 / fSlow218));
		float fSlow228 = spat_zita6x8_faustpower2_f(fSlow227);
		float fSlow229 = (1.0f - (fConst1 * fSlow228));
		...
		float fSlow235 = std::exp((fConst3 / fSlow218));
		float fSlow236 = spat_zita6x8_faustpower2_f(fSlow235);
		float fSlow237 = (1.0f - (fConst1 * fSlow236));
		...
		float fSlow243 = std::exp((fConst14 / fSlow218));
		float fSlow244 = spat_zita6x8_faustpower2_f(fSlow243);
		float fSlow245 = (1.0f - (fConst1 * fSlow244));
		...
		float fSlow251 = std::exp((fConst19 / fSlow218));
		float fSlow252 = spat_zita6x8_faustpower2_f(fSlow251);
		float fSlow253 = (1.0f - (fConst1 * fSlow252));
		...
		float fSlow261 = (1.0f - (fConst1 * fSlow260));
		...
		float fSlow267 = std::exp((fConst29 / fSlow218));
		float fSlow268 = spat_zita6x8_faustpower2_f(fSlow267);
		float fSlow269 = (1.0f - (fConst1 * fSlow268));
		...
		float fSlow275 = std::exp((fConst34 / fSlow218));
		...
		float fSlow290 = std::exp((fConst9 / fSlow289));
		float fSlow291 = spat_zita6x8_faustpower2_f(fSlow290);
		float fSlow292 = (1.0f - (fConst1 * fSlow291));
		...
		float fSlow298 = std::exp((fConst14 / fSlow289));
		float fSlow299 = spat_zita6x8_faustpower2_f(fSlow298);
		float fSlow300 = (1.0f - (fConst1 * fSlow299));
		...
		float fSlow306 = std::exp((fConst19 / fSlow289));
		float fSlow307 = spat_zita6x8_faustpower2_f(fSlow306);
		float fSlow308 = (1.0f - (fConst1 * fSlow307));
		...
		float fSlow314 = std::exp((fConst24 / fSlow289));
		float fSlow315 = spat_zita6x8_faustpower2_f(fSlow314);
		float fSlow316 = (1.0f - (fConst1 * fSlow315));
		...
		float fSlow322 = std::exp((fConst39 / fSlow289));
		float fSlow323 = spat_zita6x8_faustpower2_f(fSlow322);
		float fSlow324 = (1.0f - (fConst1 * fSlow323));
		...
		float fSlow330 = std::exp((fConst3 / fSlow289));
		float fSlow331 = spat_zita6x8_faustpower2_f(fSlow330);
		float fSlow332 = (1.0f - (fConst1 * fSlow331));
		...
		float fSlow338 = std::exp((fConst29 / fSlow289));
		float fSlow339 = spat_zita6x8_faustpower2_f(fSlow338);
		float fSlow340 = (1.0f - (fConst1 * fSlow339));
		...
		float fSlow346 = std::exp((fConst34 / fSlow289));
		...
		float fSlow361 = std::exp((fConst24 / fSlow360));
		float fSlow362 = spat_zita6x8_faustpower2_f(fSlow361);
		float fSlow363 = (1.0f - (fConst1 * fSlow362));
		...
		float fSlow369 = std::exp((fConst9 / fSlow360));
		float fSlow370 = spat_zita6x8_faustpower2_f(fSlow369);
		float fSlow371 = (1.0f - (fConst1 * fSlow370));
		...
		float fSlow377 = std::exp((fConst14 / fSlow360));
		float fSlow378 = spat_zita6x8_faustpower2_f(fSlow377);
		float fSlow379 = (1.0f - (fConst1 * fSlow378));
		...
		float fSlow385 = std::exp((fConst19 / fSlow360));
		float fSlow386 = spat_zita6x8_faustpower2_f(fSlow385);
		float fSlow387 = (1.0f - (fConst1 * fSlow386));
		...
		float fSlow393 = std::exp((fConst3 / fSlow360));
		float fSlow394 = spat_zita6x8_faustpower2_f(fSlow393);
		float fSlow395 = (1.0f - (fConst1 * fSlow394));
		...
		float fSlow401 = std::exp((fConst29 / fSlow360));
		float fSlow402 = spat_zita6x8_faustpower2_f(fSlow401);
		float fSlow403 = (1.0f - (fConst1 * fSlow402));
		...
		float fSlow409 = std::exp((fConst34 / fSlow360));
		float fSlow410 = spat_zita6x8_faustpower2_f(fSlow409);
		float fSlow411 = (1.0f - (fConst1 * fSlow410));
		...
		float fSlow419 = (1.0f - (fConst1 * fSlow418));
		...
		float fSlow426 = (0.000500000024f * (fSlow143 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow142 * std::fabs((std::fmod((fSlow144 + 1.375f), 1.0f) + -0.5f)))))))))));
		float fSlow427 = (0.000500000024f * (fSlow72 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow71 * std::fabs((std::fmod((fSlow73 + 1.375f), 1.0f) + -0.5f)))))))))));
		float fSlow428 = (0.000500000024f * (fSlow1 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow0 * std::fabs((std::fmod((fSlow2 + 1.375f), 1.0f) + -0.5f)))))))))));
		float fSlow429 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 1.375f), 1.0f) + -0.5f)))))))))));
		float fSlow430 = (0.000500000024f * (fSlow285 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow284 * std::fabs((std::fmod((fSlow286 + 1.375f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow432 = (0.000500000024f * (fSlow143 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow142 * std::fabs((std::fmod((fSlow144 + 1.25f), 1.0f) + -0.5f)))))))))));
		float fSlow433 = (0.000500000024f * (fSlow72 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow71 * std::fabs((std::fmod((fSlow73 + 1.25f), 1.0f) + -0.5f)))))))))));
		float fSlow434 = (0.000500000024f * (fSlow1 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow0 * std::fabs((std::fmod((fSlow2 + 1.25f), 1.0f) + -0.5f)))))))))));
		float fSlow435 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 1.25f), 1.0f) + -0.5f)))))))))));
		float fSlow436 = (0.000500000024f * (fSlow285 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow284 * std::fabs((std::fmod((fSlow286 + 1.25f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow438 = (0.000500000024f * (fSlow143 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow142 * std::fabs((std::fmod((fSlow144 + 1.125f), 1.0f) + -0.5f)))))))))));
		float fSlow439 = (0.000500000024f * (fSlow72 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow71 * std::fabs((std::fmod((fSlow73 + 1.125f), 1.0f) + -0.5f)))))))))));
		float fSlow440 = (0.000500000024f * (fSlow1 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow0 * std::fabs((std::fmod((fSlow2 + 1.125f), 1.0f) + -0.5f)))))))))));
		float fSlow441 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 1.125f), 1.0f) + -0.5f)))))))))));
		float fSlow442 = (0.000500000024f * (fSlow285 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow284 * std::fabs((std::fmod((fSlow286 + 1.125f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow444 = (0.000500000024f * (fSlow143 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow142 * std::fabs((std::fmod((fSlow144 + 1.0f), 1.0f) + -0.5f)))))))))));
		float fSlow445 = (0.000500000024f * (fSlow72 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow71 * std::fabs((std::fmod((fSlow73 + 1.0f), 1.0f) + -0.5f)))))))))));
		float fSlow446 = (0.000500000024f * (fSlow1 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow0 * std::fabs((std::fmod((fSlow2 + 1.0f), 1.0f) + -0.5f)))))))))));
		float fSlow447 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 1.0f), 1.0f) + -0.5f)))))))))));
		float fSlow448 = (0.000500000024f * (fSlow285 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow284 * std::fabs((std::fmod((fSlow286 + 1.0f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow450 = (0.000500000024f * (fSlow143 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow142 * std::fabs((std::fmod((fSlow144 + 0.875f), 1.0f) + -0.5f)))))))))));
		float fSlow451 = (0.000500000024f * (fSlow72 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow71 * std::fabs((std::fmod((fSlow73 + 0.875f), 1.0f) + -0.5f)))))))))));
		float fSlow452 = (0.000500000024f * (fSlow1 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow0 * std::fabs((std::fmod((fSlow2 + 0.875f), 1.0f) + -0.5f)))))))))));
		float fSlow453 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 0.875f), 1.0f) + -0.5f)))))))))));
		float fSlow454 = (0.000500000024f * (fSlow285 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow284 * std::fabs((std::fmod((fSlow286 + 0.875f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow456 = (0.000500000024f * (fSlow285 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow284 * std::fabs((std::fmod((fSlow286 + 0.75f), 1.0f) + -0.5f)))))))))));
		float fSlow457 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 0.75f), 1.0f) + -0.5f)))))))))));
		float fSlow458 = (0.000500000024f * (fSlow1 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow0 * std::fabs((std::fmod((fSlow2 + 0.75f), 1.0f) + -0.5f)))))))))));
		float fSlow459 = (0.000500000024f * (fSlow72 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow71 * std::fabs((std::fmod((fSlow73 + 0.75f), 1.0f) + -0.5f)))))))))));
		float fSlow460 = (0.000500000024f * (fSlow143 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow142 * std::fabs((std::fmod((fSlow144 + 0.75f), 1.0f) + -0.5f)))))))))));
		...
		float fSlow462 = (0.000500000024f * (fSlow143 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow142 * std::fabs((std::fmod((fSlow144 + 0.625f), 1.0f) + -0.5f)))))))))));
		float fSlow463 = (0.000500000024f * (fSlow72 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow71 * std::fabs((std::fmod((fSlow73 + 0.625f), 1.0f) + -0.5f)))))))))));
		float fSlow464 = (0.000500000024f * (fSlow1 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow0 * std::fabs((std::fmod((fSlow2 + 0.625f), 1.0f) + -0.5f)))))))))));
		float fSlow465 = (0.000500000024f * (fSlow214 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow213 * std::fabs((std::fmod((fSlow215 + 0.625f), 1.0f) + -0.5f)))))))))));
		float fSlow466 = (0.000500000024f * (fSlow285 * float(q8_sqrt(float(std::max<float>(0.0f, (1.0f - (8.0f * (fSlow284 * std::fabs((std::fmod((fSlow286 + 0.625f), 1.0f) + -0.5f)))))))))));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec11[0] = ((fSlow12 * fRec11[1]) + (fSlow13 * fRec1[1]));
			fVec0[(IOTA & 16383)] = ((0.353553385f * fRec11[0]) + 9.99999968e-21f);
			float fTemp0 = float(input2[i]);
			fVec1[(IOTA & 8191)] = fTemp0;
			float fTemp1 = (0.300000012f * fVec1[((IOTA - iConst6) & 8191)]);
			float fTemp2 = ((fVec0[((IOTA - iConst5) & 16383)] + fTemp1) - (0.600000024f * fRec9[1]));
			fVec2[(IOTA & 2047)] = fTemp2;
			fRec9[0] = fVec2[((IOTA - iConst7) & 2047)];
			...
			fRec32[0] = ((fSlow68 * fRec32[1]) + (fSlow69 * fRec5[1]));
			fVec15[(IOTA & 16383)] = ((0.353553385f * fRec32[0]) + 9.99999968e-21f);
			float fTemp9 = ((fTemp1 + fVec15[((IOTA - iConst41) & 16383)]) - (0.600000024f * fRec30[1]));
			fVec16[(IOTA & 4095)] = fTemp9;
			fRec30[0] = fVec16[((IOTA - iConst42) & 4095)];
			float fRec31 = (0.600000024f * fTemp9);
			float fTemp10 = (fRec10 + fRec31);
			float fTemp11 = (fRec25 + (fRec28 + fTemp10));
			fRec1[0] = (fRec9[1] + (fRec12[1] + (fRec15[1] + (fRec18[1] + (fRec21[1] + (fRec24[1] + (fRec27[1] + (fRec30[1] + (fRec13 + (fRec16 + (fRec19 + (fRec22 + fTemp11))))))))))));
			fRec2[0] = ((fRec9[1] + (fRec24[1] + (fRec27[1] + (fRec30[1] + fTemp11)))) - (fRec12[1] + (fRec15[1] + (fRec18[1] + (fRec21[1] + (fRec13 + (fRec16 + (fRec22 + fRec19))))))));
			float fTemp12 = (fRec28 + fRec25);
			fRec3[0] = ((fRec9[1] + (fRec18[1] + (fRec21[1] + (fRec30[1] + (fRec19 + (fRec22 + fTemp10)))))) - (fRec12[1] + (fRec15[1] + (fRec24[1] + (fRec27[1] + (fRec13 + (fRec16 + fTemp12)))))));
			fRec4[0] = ((fRec9[1] + (fRec12[1] + (fRec15[1] + (fRec30[1] + (fRec13 + (fRec16 + fTemp10)))))) - (fRec18[1] + (fRec21[1] + (fRec24[1] + (fRec27[1] + (fRec19 + (fRec22 + fTemp12)))))));
			float fTemp13 = (fRec10 + fRec28);
			float fTemp14 = (fRec31 + fRec25);
			fRec5[0] = ((fRec9[1] + (fRec15[1] + (fRec21[1] + (fRec27[1] + (fRec16 + (fRec22 + fTemp13)))))) - (fRec12[1] + (fRec18[1] + (fRec24[1] + (fRec30[1] + (fRec13 + (fRec19 + fTemp14)))))));
			fRec6[0] = ((fRec9[1] + (fRec12[1] + (fRec18[1] + (fRec27[1] + (fRec13 + (fRec19 + fTemp13)))))) - (fRec15[1] + (fRec21[1] + (fRec24[1] + (fRec30[1] + (fRec16 + (fRec22 + fTemp14)))))));
			float fTemp15 = (fRec10 + fRec25);
			float fTemp16 = (fRec31 + fRec28);
			fRec7[0] = ((fRec9[1] + (fRec12[1] + (fRec21[1] + (fRec24[1] + (fRec13 + (fRec22 + fTemp15)))))) - (fRec15[1] + (fRec18[1] + (fRec27[1] + (fRec30[1] + (fRec16 + (fRec19 + fTemp16)))))));
			fRec8[0] = ((fRec9[1] + (fRec15[1] + (fRec18[1] + (fRec24[1] + (fRec16 + (fRec19 + fTemp15)))))) - (fRec12[1] + (fRec21[1] + (fRec27[1] + (fRec30[1] + (fRec13 + (fRec22 + fTemp16)))))));
			float fTemp17 = ((fSlow4 * (fRec2[0] + fRec3[0])) + (fSlow70 * fTemp0));
			fRec33[0] = (fSlow74 + (0.999000013f * fRec33[1]));
			fRec44[0] = ((fSlow83 * fRec44[1]) + (fSlow84 * fRec41[1]));
			fVec17[(IOTA & 32767)] = ((0.353553385f * fRec44[0]) + 9.99999968e-21f);
			float fTemp18 = ((0.600000024f * fRec42[1]) + fVec17[((IOTA - iConst11) & 32767)]);
			fVec18[(IOTA & 2047)] = fTemp18;
			fRec42[0] = fVec18[((IOTA - iConst12) & 2047)];
			float fRec43 = (0.0f - (0.600000024f * fTemp18));
			fRec47[0] = ((fSlow91 * fRec47[1]) + (fSlow92 * fRec37[1]));
			fVec19[(IOTA & 32767)] = ((0.353553385f * fRec47[0]) + 9.99999968e-21f);
			float fTemp19 = ((0.600000024f * fRec45[1]) + fVec19[((IOTA - iConst16) & 32767)]);
			fVec20[(IOTA & 4095)] = fTemp19;
			fRec45[0] = fVec20[((IOTA - iConst17) & 4095)];
			float fRec46 = (0.0f - (0.600000024f * fTemp19));
			fRec50[0] = ((fSlow99 * fRec50[1]) + (fSlow100 * fRec39[1]));
			fVec21[(IOTA & 16383)] = ((0.353553385f * fRec50[0]) + 9.99999968e-21f);
			float fTemp20 = ((0.600000024f * fRec48[1]) + fVec21[((IOTA - iConst21) & 16383)]);
			fVec22[(IOTA & 4095)] = fTemp20;
			fRec48[0] = fVec22[((IOTA - iConst22) & 4095)];
			float fRec49 = (0.0f - (0.600000024f * fTemp20));
			fRec53[0] = ((fSlow107 * fRec53[1]) + (fSlow108 * fRec35[1]));
			fVec23[(IOTA & 32767)] = ((0.353553385f * fRec53[0]) + 9.99999968e-21f);
			float fTemp21 = ((0.600000024f * fRec51[1]) + fVec23[((IOTA - iConst26) & 32767)]);
			fVec24[(IOTA & 4095)] = fTemp21;
			fRec51[0] = fVec24[((IOTA - iConst27) & 4095)];
			float fRec52 = (0.0f - (0.600000024f * fTemp21));
			fRec56[0] = ((fSlow115 * fRec56[1]) + (fSlow116 * fRec34[1]));
			fVec25[(IOTA & 16383)] = ((0.353553385f * fRec56[0]) + 9.99999968e-21f);
			float fTemp22 = float(input1[i]);
			fVec26[(IOTA & 8191)] = fTemp22;
			float fTemp23 = (0.300000012f * fVec26[((IOTA - iConst6) & 8191)]);
			float fTemp24 = ((fVec25[((IOTA - iConst5) & 16383)] + fTemp23) - (0.600000024f * fRec54[1]));
			fVec27[(IOTA & 2047)] = fTemp24;
			fRec54[0] = fVec27[((IOTA - iConst7) & 2047)];
			float fRec55 = (0.600000024f * fTemp24);
			fRec59[0] = ((fSlow123 * fRec59[1]) + (fSlow124 * fRec40[1]));
			fVec28[(IOTA & 16383)] = ((0.353553385f * fRec59[0]) + 9.99999968e-21f);
			float fTemp25 = (fVec28[((IOTA - iConst31) & 16383)] - (fTemp23 + (0.600000024f * fRec57[1])));
			fVec29[(IOTA & 2047)] = fTemp25;
			fRec57[0] = fVec29[((IOTA - iConst32) & 2047)];
			float fRec58 = (0.600000024f * fTemp25);
			fRec62[0] = ((fSlow131 * fRec62[1]) + (fSlow132 * fRec36[1]));
			fVec30[(IOTA & 16383)] = ((0.353553385f * fRec62[0]) + 9.99999968e-21f);
			float fTemp26 = (fVec30[((IOTA - iConst36) & 16383)] - (fTemp23 + (0.600000024f * fRec60[1])));
			fVec31[(IOTA & 4095)] = fTemp26;
			fRec60[0] = fVec31[((IOTA - iConst37) & 4095)];
			float fRec61 = (0.600000024f * fTemp26);
			fRec65[0] = ((fSlow139 * fRec65[1]) + (fSlow140 * fRec38[1]));
			fVec32[(IOTA & 16383)] = ((0.353553385f * fRec65[0]) + 9.99999968e-21f);
			float fTemp27 = ((fTemp23 + fVec32[((IOTA - iConst41) & 16383)]) - (0.600000024f * fRec63[1]));
			fVec33[(IOTA & 4095)] = fTemp27;
			fRec63[0] = fVec33[((IOTA - iConst42) & 4095)];
			float fRec64 = (0.600000024f * fTemp27);
			float fTemp28 = (fRec61 + fRec58);
			float fTemp29 = (fRec49 + (fRec52 + fTemp28));
			fRec34[0] = (fRec42[1] + (fRec45[1] + (fRec48[1] + (fRec51[1] + (fRec54[1] + (fRec57[1] + (fRec60[1] + (fRec63[1] + (fRec55 + (fRec64 + (fRec43 + (fRec46 + fTemp29))))))))))));
			float fTemp30 = (fRec52 + fRec49);
			fRec35[0] = ((fRec54[1] + (fRec57[1] + (fRec60[1] + (fRec63[1] + (fRec55 + (fRec64 + fTemp28)))))) - (fRec42[1] + (fRec45[1] + (fRec48[1] + (fRec51[1] + (fRec43 + (fRec46 + fTemp30)))))));
			fRec36[0] = ((fRec48[1] + (fRec51[1] + (fRec54[1] + (fRec63[1] + (fRec55 + (fRec64 + fTemp30)))))) - (fRec42[1] + (fRec45[1] + (fRec57[1] + (fRec60[1] + (fRec43 + (fRec46 + fTemp28)))))));
			fRec37[0] = ((fRec42[1] + (fRec45[1] + (fRec54[1] + (fRec63[1] + (fRec55 + (fRec64 + (fRec46 + fRec43))))))) - (fRec48[1] + (fRec51[1] + (fRec57[1] + (fRec60[1] + fTemp29)))));
			float fTemp31 = (fRec61 + fRec52);
			float fTemp32 = (fRec58 + fRec49);
			fRec38[0] = ((fRec45[1] + (fRec51[1] + (fRec54[1] + (fRec60[1] + (fRec55 + (fRec46 + fTemp31)))))) - (fRec42[1] + (fRec48[1] + (fRec57[1] + (fRec63[1] + (fRec64 + (fRec43 + fTemp32)))))));
			float fTemp33 = (fRec61 + fRec49);
			float fTemp34 = (fRec58 + fRec52);
			fRec39[0] = ((fRec42[1] + (fRec48[1] + (fRec54[1] + (fRec60[1] + (fRec55 + (fRec43 + fTemp33)))))) - (fRec45[1] + (fRec51[1] + (fRec57[1] + (fRec63[1] + (fRec64 + (fRec46 + fTemp34)))))));
			fRec40[0] = ((fRec42[1] + (fRec51[1] + (fRec54[1] + (fRec57[1] + (fRec55 + (fRec43 + fTemp34)))))) - (fRec45[1] + (fRec48[1] + (fRec60[1] + (fRec63[1] + (fRec64 + (fRec46 + fTemp33)))))));
			fRec41[0] = ((fRec45[1] + (fRec48[1] + (fRec54[1] + (fRec57[1] + (fRec55 + (fRec46 + fTemp32)))))) - (fRec42[1] + (fRec51[1] + (fRec60[1] + (fRec63[1] + (fRec64 + (fRec43 + fTemp31)))))));
			float fTemp35 = ((fSlow75 * (fRec35[0] + fRec36[0])) + (fSlow141 * fTemp22));
			fRec66[0] = (fSlow145 + (0.999000013f * fRec66[1]));
			fRec77[0] = ((fSlow154 * fRec77[1]) + (fSlow155 * fRec74[1]));
			fVec34[(IOTA & 32767)] = ((0.353553385f * fRec77[0]) + 9.99999968e-21f);
			float fTemp36 = ((0.600000024f * fRec75[1]) + fVec34[((IOTA - iConst11) & 32767)]);
			fVec35[(IOTA & 2047)] = fTemp36;
			fRec75[0] = fVec35[((IOTA - iConst12) & 2047)];
			float fRec76 = (0.0f - (0.600000024f * fTemp36));
			fRec80[0] = ((fSlow162 * fRec80[1]) + (fSlow163 * fRec70[1]));
			fVec36[(IOTA & 32767)] = ((0.353553385f * fRec80[0]) + 9.99999968e-21f);
			float fTemp37 = ((0.600000024f * fRec78[1]) + fVec36[((IOTA - iConst16) & 32767)]);
			fVec37[(IOTA & 4095)] = fTemp37;
			fRec78[0] = fVec37[((IOTA - iConst17) & 4095)];
			float fRec79 = (0.0f - (0.600000024f * fTemp37));
			fRec83[0] = ((fSlow170 * fRec83[1]) + (fSlow171 * fRec72[1]));
			fVec38[(IOTA & 16383)] = ((0.353553385f * fRec83[0]) + 9.99999968e-21f);
			float fTemp38 = ((0.600000024f * fRec81[1]) + fVec38[((IOTA - iConst21) & 16383)]);
			fVec39[(IOTA & 4095)] = fTemp38;
			fRec81[0] = fVec39[((IOTA - iConst22) & 4095)];
			float fRec82 = (0.0f - (0.600000024f * fTemp38));
			fRec86[0] = ((fSlow178 * fRec86[1]) + (fSlow179 * fRec67[1]));
			fVec40[(IOTA & 16383)] = ((0.353553385f * fRec86[0]) + 9.99999968e-21f);
			float fTemp39 = float(input0[i]);
			fVec41[(IOTA & 8191)] = fTemp39;
			float fTemp40 = (0.300000012f * fVec41[((IOTA - iConst6) & 8191)]);
			float fTemp41 = ((fVec40[((IOTA - iConst5) & 16383)] + fTemp40) - (0.600000024f * fRec84[1]));
			fVec42[(IOTA & 2047)] = fTemp41;
			fRec84[0] = fVec42[((IOTA - iConst7) & 2047)];
			float fRec85 = (0.600000024f * fTemp41);
			fRec89[0] = ((fSlow186 * fRec89[1]) + (fSlow187 * fRec68[1]));
			fVec43[(IOTA & 32767)] = ((0.353553385f * fRec89[0]) + 9.99999968e-21f);
			float fTemp42 = ((0.600000024f * fRec87[1]) + fVec43[((IOTA - iConst26) & 32767)]);
			fVec44[(IOTA & 4095)] = fTemp42;
			fRec87[0] = fVec44[((IOTA - iConst27) & 4095)];
			float fRec88 = (0.0f - (0.600000024f * fTemp42));
			fRec92[0] = ((fSlow194 * fRec92[1]) + (fSlow195 * fRec73[1]));
			fVec45[(IOTA & 16383)] = ((0.353553385f * fRec92[0]) + 9.99999968e-21f);
			float fTemp43 = (fVec45[((IOTA - iConst31) & 16383)] - (fTemp40 + (0.600000024f * fRec90[1])));
			fVec46[(IOTA & 2047)] = fTemp43;
			fRec90[0] = fVec46[((IOTA - iConst32) & 2047)];
			float fRec91 = (0.600000024f * fTemp43);
			fRec95[0] = ((fSlow202 * fRec95[1]) + (fSlow203 * fRec69[1]));
			fVec47[(IOTA & 16383)] = ((0.353553385f * fRec95[0]) + 9.99999968e-21f);
			float fTemp44 = (fVec47[((IOTA - iConst36) & 16383)] - (fTemp40 + (0.600000024f * fRec93[1])));
			fVec48[(IOTA & 4095)] = fTemp44;
			fRec93[0] = fVec48[((IOTA - iConst37) & 4095)];
			float fRec94 = (0.600000024f * fTemp44);
			fRec98[0] = ((fSlow210 * fRec98[1]) + (fSlow211 * fRec71[1]));
			fVec49[(IOTA & 16383)] = ((0.353553385f * fRec98[0]) + 9.99999968e-21f);
			float fTemp45 = ((fTemp40 + fVec49[((IOTA - iConst41) & 16383)]) - (0.600000024f * fRec96[1]));
			fVec50[(IOTA & 4095)] = fTemp45;
			fRec96[0] = fVec50[((IOTA - iConst42) & 4095)];
			float fRec97 = (0.600000024f * fTemp45);
			float fTemp46 = (fRec96[1] + fRec93[1]);
			float fTemp47 = (fRec90[1] + fTemp46);
			fRec67[0] = (fRec75[1] + (fRec78[1] + (fRec81[1] + (fRec84[1] + (fRec76 + (fRec79 + (fRec82 + (fRec88 + (fRec91 + (fRec94 + (fRec97 + (fRec85 + (fTemp47 + fRec87[1])))))))))))));
			fRec68[0] = ((fRec84[1] + (fRec91 + (fRec94 + (fRec97 + (fRec85 + fTemp47))))) - (fRec75[1] + (fRec78[1] + (fRec81[1] + (fRec76 + (fRec79 + (fRec82 + (fRec88 + fRec87[1]))))))));
			float fTemp48 = (fRec93[1] + fRec90[1]);
			fRec69[0] = ((fRec81[1] + (fRec84[1] + (fRec82 + (fRec88 + (fRec97 + (fRec85 + (fRec96[1] + fRec87[1]))))))) - (fRec75[1] + (fRec78[1] + (fRec76 + (fRec79 + (fRec91 + (fRec94 + fTemp48)))))));
			fRec70[0] = ((fRec75[1] + (fRec78[1] + (fRec84[1] + (fRec76 + (fRec79 + (fRec97 + (fRec85 + fRec96[1]))))))) - (fRec81[1] + (fRec82 + (fRec88 + (fRec91 + (fRec94 + (fTemp48 + fRec87[1])))))));
			float fTemp49 = (fRec96[1] + fRec90[1]);
			fRec71[0] = ((fRec78[1] + (fRec84[1] + (fRec79 + (fRec88 + (fRec94 + (fRec85 + (fRec93[1] + fRec87[1]))))))) - (fRec75[1] + (fRec81[1] + (fRec76 + (fRec82 + (fRec91 + (fRec97 + fTemp49)))))));
			fRec72[0] = ((fRec75[1] + (fRec81[1] + (fRec84[1] + (fRec76 + (fRec82 + (fRec94 + (fRec85 + fRec93[1]))))))) - (fRec78[1] + (fRec79 + (fRec88 + (fRec91 + (fRec97 + (fRec87[1] + fTemp49)))))));
			fRec73[0] = ((fRec75[1] + (fRec84[1] + (fRec76 + (fRec88 + (fRec91 + (fRec85 + (fRec90[1] + fRec87[1]))))))) - (fRec78[1] + (fRec81[1] + (fRec79 + (fRec82 + (fRec94 + (fRec97 + fTemp46)))))));
			fRec74[0] = ((fRec78[1] + (fRec81[1] + (fRec84[1] + (fRec79 + (fRec82 + (fRec91 + (fRec85 + fRec90[1]))))))) - (fRec75[1] + (fRec76 + (fRec88 + (fRec94 + (fRec97 + (fTemp46 + fRec87[1])))))));
			float fTemp50 = ((fSlow146 * (fRec68[0] + fRec69[0])) + (fSlow212 * fTemp39));
			...
			float fTemp51 = ((0.600000024f * fRec108[1]) + fVec51[((IOTA - iConst11) & 32767)]);
			fVec52[(IOTA & 2047)] = fTemp51;
			fRec108[0] = fVec52[((IOTA - iConst12) & 2047)];
			float fRec109 = (0.0f - (0.600000024f * fTemp51));
			float fTemp52 = float(input3[i]);
			fVec53[(IOTA & 8191)] = fTemp52;
			float fTemp53 = (0.300000012f * fVec53[((IOTA - iConst6) & 8191)]);
			fRec113[0] = ((fSlow233 * fRec113[1]) + (fSlow234 * fRec104[1]));
			fVec54[(IOTA & 16383)] = ((0.353553385f * fRec113[0]) + 9.99999968e-21f);
			float fTemp54 = ((fTemp53 + fVec54[((IOTA - iConst41) & 16383)]) - (0.600000024f * fRec111[1]));
			fVec55[(IOTA & 4095)] = fTemp54;
			fRec111[0] = fVec55[((IOTA - iConst42) & 4095)];
			float fRec112 = (0.600000024f * fTemp54);
			fRec116[0] = ((fSlow241 * fRec116[1]) + (fSlow242 * fRec100[1]));
			fVec56[(IOTA & 16383)] = ((0.353553385f * fRec116[0]) + 9.99999968e-21f);
			float fTemp55 = ((fVec56[((IOTA - iConst5) & 16383)] + fTemp53) - (0.600000024f * fRec114[1]));
			fVec57[(IOTA & 2047)] = fTemp55;
			fRec114[0] = fVec57[((IOTA - iConst7) & 2047)];
			float fRec115 = (0.600000024f * fTemp55);
			fRec119[0] = ((fSlow249 * fRec119[1]) + (fSlow250 * fRec103[1]));
			fVec58[(IOTA & 32767)] = ((0.353553385f * fRec119[0]) + 9.99999968e-21f);
			float fTemp56 = ((0.600000024f * fRec117[1]) + fVec58[((IOTA - iConst16) & 32767)]);
			fVec59[(IOTA & 4095)] = fTemp56;
			fRec117[0] = fVec59[((IOTA - iConst17) & 4095)];
			float fRec118 = (0.0f - (0.600000024f * fTemp56));
			fRec122[0] = ((fSlow257 * fRec122[1]) + (fSlow258 * fRec105[1]));
			fVec60[(IOTA & 16383)] = ((0.353553385f * fRec122[0]) + 9.99999968e-21f);
			float fTemp57 = ((0.600000024f * fRec120[1]) + fVec60[((IOTA - iConst21) & 16383)]);
			fVec61[(IOTA & 4095)] = fTemp57;
			fRec120[0] = fVec61[((IOTA - iConst22) & 4095)];
			float fRec121 = (0.0f - (0.600000024f * fTemp57));
			fRec125[0] = ((fSlow265 * fRec125[1]) + (fSlow266 * fRec101[1]));
			fVec62[(IOTA & 32767)] = ((0.353553385f * fRec125[0]) + 9.99999968e-21f);
			float fTemp58 = ((0.600000024f * fRec123[1]) + fVec62[((IOTA - iConst26) & 32767)]);
			fVec63[(IOTA & 4095)] = fTemp58;
			fRec123[0] = fVec63[((IOTA - iConst27) & 4095)];
			float fRec124 = (0.0f - (0.600000024f * fTemp58));
			fRec128[0] = ((fSlow273 * fRec128[1]) + (fSlow274 * fRec106[1]));
			fVec64[(IOTA & 16383)] = ((0.353553385f * fRec128[0]) + 9.99999968e-21f);
			float fTemp59 = (fVec64[((IOTA - iConst31) & 16383)] - (fTemp53 + (0.600000024f * fRec126[1])));
			fVec65[(IOTA & 2047)] = fTemp59;
			fRec126[0] = fVec65[((IOTA - iConst32) & 2047)];
			float fRec127 = (0.600000024f * fTemp59);
			fRec131[0] = ((fSlow281 * fRec131[1]) + (fSlow282 * fRec102[1]));
			fVec66[(IOTA & 16383)] = ((0.353553385f * fRec131[0]) + 9.99999968e-21f);
			float fTemp60 = (fVec66[((IOTA - iConst36) & 16383)] - (fTemp53 + (0.600000024f * fRec129[1])));
			fVec67[(IOTA & 4095)] = fTemp60;
			fRec129[0] = fVec67[((IOTA - iConst37) & 4095)];
			float fRec130 = (0.600000024f * fTemp60);
			float fTemp61 = (fRec129[1] + fRec126[1]);
			float fTemp62 = (fRec120[1] + (fTemp61 + fRec123[1]));
			fRec100[0] = (fRec108[1] + (fRec111[1] + (fRec114[1] + (fRec109 + (fRec118 + (fRec121 + (fRec124 + (fRec127 + (fRec130 + (fRec112 + (fRec115 + (fRec117[1] + fTemp62))))))))))));
			float fTemp63 = (fRec123[1] + fRec120[1]);
			fRec101[0] = ((fRec111[1] + (fRec114[1] + (fRec127 + (fRec130 + (fRec112 + (fRec115 + fTemp61)))))) - (fRec108[1] + (fRec109 + (fRec118 + (fRec121 + (fRec124 + (fTemp63 + fRec117[1])))))));
			fRec102[0] = ((fRec111[1] + (fRec114[1] + (fRec121 + (fRec124 + (fRec112 + (fRec115 + fTemp63)))))) - (fRec108[1] + (fRec109 + (fRec118 + (fRec127 + (fRec130 + (fTemp61 + fRec117[1])))))));
			fRec103[0] = ((fRec108[1] + (fRec111[1] + (fRec114[1] + (fRec109 + (fRec118 + (fRec112 + (fRec115 + fRec117[1]))))))) - (fRec121 + (fRec124 + (fRec127 + (fRec130 + fTemp62)))));
			float fTemp64 = (fRec129[1] + fRec123[1]);
			float fTemp65 = (fRec126[1] + fRec120[1]);
			fRec104[0] = ((fRec114[1] + (fRec118 + (fRec124 + (fRec130 + (fRec115 + (fRec117[1] + fTemp64)))))) - (fRec108[1] + (fRec111[1] + (fRec109 + (fRec121 + (fRec127 + (fRec112 + fTemp65)))))));
			float fTemp66 = (fRec129[1] + fRec120[1]);
			float fTemp67 = (fRec126[1] + fRec123[1]);
			fRec105[0] = ((fRec108[1] + (fRec114[1] + (fRec109 + (fRec121 + (fRec130 + (fRec115 + fTemp66)))))) - (fRec111[1] + (fRec118 + (fRec124 + (fRec127 + (fRec112 + (fRec117[1] + fTemp67)))))));
			fRec106[0] = ((fRec108[1] + (fRec114[1] + (fRec109 + (fRec124 + (fRec127 + (fRec115 + fTemp67)))))) - (fRec111[1] + (fRec118 + (fRec121 + (fRec130 + (fRec112 + (fRec117[1] + fTemp66)))))));
			fRec107[0] = ((fRec114[1] + (fRec118 + (fRec121 + (fRec127 + (fRec115 + (fRec117[1] + fTemp65)))))) - (fRec108[1] + (fRec111[1] + (fRec109 + (fRec124 + (fRec130 + (fRec112 + fTemp64)))))));
			float fTemp68 = ((fSlow217 * (fRec101[0] + fRec102[0])) + (fSlow283 * fTemp52));
			fRec132[0] = (fSlow287 + (0.999000013f * fRec132[1]));
			fRec143[0] = ((fSlow296 * fRec143[1]) + (fSlow297 * fRec140[1]));
			fVec68[(IOTA & 32767)] = ((0.353553385f * fRec143[0]) + 9.99999968e-21f);
			float fTemp69 = ((0.600000024f * fRec141[1]) + fVec68[((IOTA - iConst11) & 32767)]);
			fVec69[(IOTA & 2047)] = fTemp69;
			fRec141[0] = fVec69[((IOTA - iConst12) & 2047)];
			float fRec142 = (0.0f - (0.600000024f * fTemp69));
			fRec146[0] = ((fSlow304 * fRec146[1]) + (fSlow305 * fRec136[1]));
			fVec70[(IOTA & 32767)] = ((0.353553385f * fRec146[0]) + 9.99999968e-21f);
			float fTemp70 = ((0.600000024f * fRec144[1]) + fVec70[((IOTA - iConst16) & 32767)]);
			fVec71[(IOTA & 4095)] = fTemp70;
			fRec144[0] = fVec71[((IOTA - iConst17) & 4095)];
			float fRec145 = (0.0f - (0.600000024f * fTemp70));
			fRec149[0] = ((fSlow312 * fRec149[1]) + (fSlow313 * fRec138[1]));
			fVec72[(IOTA & 16383)] = ((0.353553385f * fRec149[0]) + 9.99999968e-21f);
			float fTemp71 = ((0.600000024f * fRec147[1]) + fVec72[((IOTA - iConst21) & 16383)]);
			fVec73[(IOTA & 4095)] = fTemp71;
			fRec147[0] = fVec73[((IOTA - iConst22) & 4095)];
			float fRec148 = (0.0f - (0.600000024f * fTemp71));
			fRec152[0] = ((fSlow320 * fRec152[1]) + (fSlow321 * fRec134[1]));
			fVec74[(IOTA & 32767)] = ((0.353553385f * fRec152[0]) + 9.99999968e-21f);
			float fTemp72 = ((0.600000024f * fRec150[1]) + fVec74[((IOTA - iConst26) & 32767)]);
			fVec75[(IOTA & 4095)] = fTemp72;
			fRec150[0] = fVec75[((IOTA - iConst27) & 4095)];
			float fRec151 = (0.0f - (0.600000024f * fTemp72));
			float fTemp73 = float(input4[i]);
			fVec76[(IOTA & 8191)] = fTemp73;
			float fTemp74 = (0.300000012f * fVec76[((IOTA - iConst6) & 8191)]);
			fRec155[0] = ((fSlow328 * fRec155[1]) + (fSlow329 * fRec137[1]));
			fVec77[(IOTA & 16383)] = ((0.353553385f * fRec155[0]) + 9.99999968e-21f);
			float fTemp75 = ((fTemp74 + fVec77[((IOTA - iConst41) & 16383)]) - (0.600000024f * fRec153[1]));
			fVec78[(IOTA & 4095)] = fTemp75;
			fRec153[0] = fVec78[((IOTA - iConst42) & 4095)];
			float fRec154 = (0.600000024f * fTemp75);
			fRec158[0] = ((fSlow336 * fRec158[1]) + (fSlow337 * fRec133[1]));
			fVec79[(IOTA & 16383)] = ((0.353553385f * fRec158[0]) + 9.99999968e-21f);
			float fTemp76 = ((fVec79[((IOTA - iConst5) & 16383)] + fTemp74) - (0.600000024f * fRec156[1]));
			fVec80[(IOTA & 2047)] = fTemp76;
			fRec156[0] = fVec80[((IOTA - iConst7) & 2047)];
			float fRec157 = (0.600000024f * fTemp76);
			fRec161[0] = ((fSlow344 * fRec161[1]) + (fSlow345 * fRec139[1]));
			fVec81[(IOTA & 16383)] = ((0.353553385f * fRec161[0]) + 9.99999968e-21f);
			float fTemp77 = (fVec81[((IOTA - iConst31) & 16383)] - (fTemp74 + (0.600000024f * fRec159[1])));
			fVec82[(IOTA & 2047)] = fTemp77;
			fRec159[0] = fVec82[((IOTA - iConst32) & 2047)];
			float fRec160 = (0.600000024f * fTemp77);
			fRec164[0] = ((fSlow352 * fRec164[1]) + (fSlow353 * fRec135[1]));
			fVec83[(IOTA & 16383)] = ((0.353553385f * fRec164[0]) + 9.99999968e-21f);
			float fTemp78 = (fVec83[((IOTA - iConst36) & 16383)] - (fTemp74 + (0.600000024f * fRec162[1])));
			fVec84[(IOTA & 4095)] = fTemp78;
			fRec162[0] = fVec84[((IOTA - iConst37) & 4095)];
			float fRec163 = (0.600000024f * fTemp78);
			float fTemp79 = (fRec145 + fRec142);
			float fTemp80 = (fRec159[1] + (fRec162[1] + fTemp79));
			fRec133[0] = (fRec141[1] + (fRec144[1] + (fRec147[1] + (fRec150[1] + (fRec153[1] + (fRec156[1] + (fRec148 + (fRec151 + (fRec160 + (fRec163 + (fRec154 + (fRec157 + fTemp80))))))))))));
			float fTemp81 = (fRec162[1] + fRec159[1]);
			fRec134[0] = ((fRec153[1] + (fRec156[1] + (fRec160 + (fRec163 + (fRec154 + (fRec157 + fTemp81)))))) - (fRec141[1] + (fRec144[1] + (fRec147[1] + (fRec150[1] + (fRec148 + (fRec151 + fTemp79)))))));
			fRec135[0] = ((fRec147[1] + (fRec150[1] + (fRec153[1] + (fRec156[1] + (fRec148 + (fRec151 + (fRec157 + fRec154))))))) - (fRec141[1] + (fRec144[1] + (fRec160 + (fRec163 + fTemp80)))));
			fRec136[0] = ((fRec141[1] + (fRec144[1] + (fRec153[1] + (fRec156[1] + (fRec154 + (fRec157 + fTemp79)))))) - (fRec147[1] + (fRec150[1] + (fRec148 + (fRec151 + (fRec160 + (fRec163 + fTemp81)))))));
			float fTemp82 = (fRec145 + fRec162[1]);
			float fTemp83 = (fRec142 + fRec159[1]);
			fRec137[0] = ((fRec144[1] + (fRec150[1] + (fRec156[1] + (fRec151 + (fRec163 + (fRec157 + fTemp82)))))) - (fRec141[1] + (fRec147[1] + (fRec153[1] + (fRec148 + (fRec160 + (fRec154 + fTemp83)))))));
			float fTemp84 = (fRec142 + fRec162[1]);
			float fTemp85 = (fRec145 + fRec159[1]);
			fRec138[0] = ((fRec141[1] + (fRec147[1] + (fRec156[1] + (fRec148 + (fRec163 + (fRec157 + fTemp84)))))) - (fRec144[1] + (fRec150[1] + (fRec153[1] + (fRec151 + (fRec160 + (fRec154 + fTemp85)))))));
			fRec139[0] = ((fRec141[1] + (fRec150[1] + (fRec156[1] + (fRec151 + (fRec160 + (fRec157 + fTemp83)))))) - (fRec144[1] + (fRec147[1] + (fRec153[1] + (fRec148 + (fRec163 + (fRec154 + fTemp82)))))));
			fRec140[0] = ((fRec144[1] + (fRec147[1] + (fRec156[1] + (fRec148 + (fRec160 + (fRec157 + fTemp85)))))) - (fRec141[1] + (fRec150[1] + (fRec153[1] + (fRec151 + (fRec163 + (fRec154 + fTemp84)))))));
			float fTemp86 = ((fSlow288 * (fRec134[0] + fRec135[0])) + (fSlow354 * fTemp73));
			fRec165[0] = (fSlow358 + (0.999000013f * fRec165[1]));
			fRec176[0] = ((fSlow367 * fRec176[1]) + (fSlow368 * fRec167[1]));
			fVec85[(IOTA & 32767)] = ((0.353553385f * fRec176[0]) + 9.99999968e-21f);
			float fTemp87 = ((0.600000024f * fRec174[1]) + fVec85[((IOTA - iConst26) & 32767)]);
			fVec86[(IOTA & 4095)] = fTemp87;
			fRec174[0] = fVec86[((IOTA - iConst27) & 4095)];
			float fRec175 = (0.0f - (0.600000024f * fTemp87));
			fRec179[0] = ((fSlow375 * fRec179[1]) + (fSlow376 * fRec173[1]));
			fVec87[(IOTA & 32767)] = ((0.353553385f * fRec179[0]) + 9.99999968e-21f);
			float fTemp88 = ((0.600000024f * fRec177[1]) + fVec87[((IOTA - iConst11) & 32767)]);
			fVec88[(IOTA & 2047)] = fTemp88;
			fRec177[0] = fVec88[((IOTA - iConst12) & 2047)];
			float fRec178 = (0.0f - (0.600000024f * fTemp88));
			fRec182[0] = ((fSlow383 * fRec182[1]) + (fSlow384 * fRec169[1]));
			fVec89[(IOTA & 32767)] = ((0.353553385f * fRec182[0]) + 9.99999968e-21f);
			float fTemp89 = ((0.600000024f * fRec180[1]) + fVec89[((IOTA - iConst16) & 32767)]);
			fVec90[(IOTA & 4095)] = fTemp89;
			fRec180[0] = fVec90[((IOTA - iConst17) & 4095)];
			float fRec181 = (0.0f - (0.600000024f * fTemp89));
			fRec185[0] = ((fSlow391 * fRec185[1]) + (fSlow392 * fRec171[1]));
			fVec91[(IOTA & 16383)] = ((0.353553385f * fRec185[0]) + 9.99999968e-21f);
			float fTemp90 = ((0.600000024f * fRec183[1]) + fVec91[((IOTA - iConst21) & 16383)]);
			fVec92[(IOTA & 4095)] = fTemp90;
			fRec183[0] = fVec92[((IOTA - iConst22) & 4095)];
			float fRec184 = (0.0f - (0.600000024f * fTemp90));
			fRec188[0] = ((fSlow399 * fRec188[1]) + (fSlow400 * fRec166[1]));
			fVec93[(IOTA & 16383)] = ((0.353553385f * fRec188[0]) + 9.99999968e-21f);
			float fTemp91 = float(input5[i]);
			fVec94[(IOTA & 8191)] = fTemp91;
			float fTemp92 = (0.300000012f * fVec94[((IOTA - iConst6) & 8191)]);
			float fTemp93 = ((fVec93[((IOTA - iConst5) & 16383)] + fTemp92) - (0.600000024f * fRec186[1]));
			fVec95[(IOTA & 2047)] = fTemp93;
			fRec186[0] = fVec95[((IOTA - iConst7) & 2047)];
			float fRec187 = (0.600000024f * fTemp93);
			fRec191[0] = ((fSlow407 * fRec191[1]) + (fSlow408 * fRec172[1]));
			fVec96[(IOTA & 16383)] = ((0.353553385f * fRec191[0]) + 9.99999968e-21f);
			float fTemp94 = (fVec96[((IOTA - iConst31) & 16383)] - (fTemp92 + (0.600000024f * fRec189[1])));
			fVec97[(IOTA & 2047)] = fTemp94;
			fRec189[0] = fVec97[((IOTA - iConst32) & 2047)];
			float fRec190 = (0.600000024f * fTemp94);
			fRec194[0] = ((fSlow415 * fRec194[1]) + (fSlow416 * fRec168[1]));
			fVec98[(IOTA & 16383)] = ((0.353553385f * fRec194[0]) + 9.99999968e-21f);
			float fTemp95 = (fVec98[((IOTA - iConst36) & 16383)] - (fTemp92 + (0.600000024f * fRec192[1])));
			fVec99[(IOTA & 4095)] = fTemp95;
			fRec192[0] = fVec99[((IOTA - iConst37) & 4095)];
			float fRec193 = (0.600000024f * fTemp95);
			fRec197[0] = ((fSlow423 * fRec197[1]) + (fSlow424 * fRec170[1]));
			fVec100[(IOTA & 16383)] = ((0.353553385f * fRec197[0]) + 9.99999968e-21f);
			float fTemp96 = ((fTemp92 + fVec100[((IOTA - iConst41) & 16383)]) - (0.600000024f * fRec195[1]));
			fVec101[(IOTA & 4095)] = fTemp96;
			fRec195[0] = fVec101[((IOTA - iConst42) & 4095)];
			float fRec196 = (0.600000024f * fTemp96);
			float fTemp97 = (fRec187 + fRec196);
			float fTemp98 = (fRec190 + (fRec193 + fTemp97));
			fRec166[0] = (fRec174[1] + (fRec177[1] + (fRec180[1] + (fRec183[1] + (fRec186[1] + (fRec189[1] + (fRec192[1] + (fRec195[1] + (fRec178 + (fRec181 + (fRec184 + (fRec175 + fTemp98))))))))))));
			fRec167[0] = ((fRec186[1] + (fRec189[1] + (fRec192[1] + (fRec195[1] + fTemp98)))) - (fRec174[1] + (fRec177[1] + (fRec180[1] + (fRec183[1] + (fRec178 + (fRec181 + (fRec175 + fRec184))))))));
			float fTemp99 = (fRec193 + fRec190);
			fRec168[0] = ((fRec174[1] + (fRec183[1] + (fRec186[1] + (fRec195[1] + (fRec184 + (fRec175 + fTemp97)))))) - (fRec177[1] + (fRec180[1] + (fRec189[1] + (fRec192[1] + (fRec178 + (fRec181 + fTemp99)))))));
			fRec169[0] = ((fRec177[1] + (fRec180[1] + (fRec186[1] + (fRec195[1] + (fRec178 + (fRec181 + fTemp97)))))) - (fRec174[1] + (fRec183[1] + (fRec189[1] + (fRec192[1] + (fRec184 + (fRec175 + fTemp99)))))));
			float fTemp100 = (fRec187 + fRec193);
			float fTemp101 = (fRec196 + fRec190);
			fRec170[0] = ((fRec174[1] + (fRec180[1] + (fRec186[1] + (fRec192[1] + (fRec181 + (fRec175 + fTemp100)))))) - (fRec177[1] + (fRec183[1] + (fRec189[1] + (fRec195[1] + (fRec178 + (fRec184 + fTemp101)))))));
			fRec171[0] = ((fRec177[1] + (fRec183[1] + (fRec186[1] + (fRec192[1] + (fRec178 + (fRec184 + fTemp100)))))) - (fRec174[1] + (fRec180[1] + (fRec189[1] + (fRec195[1] + (fRec181 + (fRec175 + fTemp101)))))));
			float fTemp102 = (fRec187 + fRec190);
			float fTemp103 = (fRec196 + fRec193);
			fRec172[0] = ((fRec174[1] + (fRec177[1] + (fRec186[1] + (fRec189[1] + (fRec178 + (fRec175 + fTemp102)))))) - (fRec180[1] + (fRec183[1] + (fRec192[1] + (fRec195[1] + (fRec181 + (fRec184 + fTemp103)))))));
			fRec173[0] = ((fRec180[1] + (fRec183[1] + (fRec186[1] + (fRec189[1] + (fRec181 + (fRec184 + fTemp102)))))) - (fRec174[1] + (fRec177[1] + (fRec192[1] + (fRec195[1] + (fRec178 + (fRec175 + fTemp103)))))));
			float fTemp104 = ((fSlow359 * (fRec167[0] + fRec168[0])) + (fSlow425 * fTemp91));
			output0[i] = FAUSTFLOAT(((fRec0[0] * fTemp17) + ((fRec33[0] * fTemp35) + ((fRec66[0] * fTemp50) + (((fRec99[0] * fTemp68) + (fRec132[0] * fTemp86)) + (fRec165[0] * fTemp104))))));
			...
			output1[i] = FAUSTFLOAT(((((((fRec198[0] * fTemp50) + (fRec199[0] * fTemp35)) + (fRec200[0] * fTemp17)) + (fRec201[0] * fTemp68)) + (fRec202[0] * fTemp86)) + (fRec203[0] * fTemp104)));
			...
			output2[i] = FAUSTFLOAT(((((((fRec204[0] * fTemp50) + (fRec205[0] * fTemp35)) + (fRec206[0] * fTemp17)) + (fRec207[0] * fTemp68)) + (fRec208[0] * fTemp86)) + (fRec209[0] * fTemp104)));
			...
			output3[i] = FAUSTFLOAT(((((((fRec210[0] * fTemp50) + (fRec211[0] * fTemp35)) + (fRec212[0] * fTemp17)) + (fRec213[0] * fTemp68)) + (fRec214[0] * fTemp86)) + (fRec215[0] * fTemp104)));
			...
			output4[i] = FAUSTFLOAT(((((((fRec216[0] * fTemp50) + (fRec217[0] * fTemp35)) + (fRec218[0] * fTemp17)) + (fRec219[0] * fTemp68)) + (fRec220[0] * fTemp86)) + (fRec221[0] * fTemp104)));
			...
			output5[i] = FAUSTFLOAT(((((((fRec222[0] * fTemp50) + (fRec223[0] * fTemp35)) + (fRec224[0] * fTemp17)) + (fRec225[0] * fTemp68)) + (fRec226[0] * fTemp86)) + (fRec227[0] * fTemp104)));
			...
			output6[i] = FAUSTFLOAT(((fRec228[0] * fTemp86) + ((fRec229[0] * fTemp68) + ((fRec230[0] * fTemp17) + ((fRec231[0] * fTemp35) + ((fRec232[0] * fTemp50) + (fRec233[0] * fTemp104)))))));
			...
			output7[i] = FAUSTFLOAT(((((((fRec234[0] * fTemp50) + (fRec235[0] * fTemp35)) + (fRec236[0] * fTemp17)) + (fRec237[0] * fTemp68)) + (fRec238[0] * fTemp86)) + (fRec239[0] * fTemp104)));
			fRec0[1] = fRec0[0];
			fRec11[1] = fRec11[0];
			IOTA = (IOTA + 1);
			fRec9[1] = fRec9[0];
