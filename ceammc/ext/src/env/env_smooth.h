...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn env_smooth -scn env_smooth_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __env_smooth_H__
#define  __env_smooth_H__
...
class FAUST_API env_smooth_dsp {

    public:

        env_smooth_dsp() = default;
        virtual ~env_smooth_dsp() = default;
         ...
         */
        virtual ::env_smooth_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::env_smooth_dsp {
    ...
    public:
        ...
        decorator_dsp(::env_smooth_dsp* env_smooth_dsp = nullptr):fDSP(env_smooth_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::env_smooth_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in env_smooth_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct env_smooth : public env_smooth_dsp {
};
#endif
// clang-format on
...
class env_smooth : public env_smooth_dsp {
 ...
 public:
	...
	env_smooth(const env_smooth&) = default;
	
	virtual ~env_smooth() = default;
	
	env_smooth& operator=(const env_smooth&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn env_smooth -scn env_smooth_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		...
		m->declare("filename", "env_smooth.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.9.0");
		m->declare("name", "env.smooth");
	...
	virtual env_smooth* clone() {
		return new env_smooth(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("env.smooth");
		ui_interface->declare(&fHslider0, "unit", "ms");
		ui_interface->addHorizontalSlider("duration", &fHslider0, FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+05f), FAUSTFLOAT(1.0f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = 0.00014471781f * static_cast<float>(fHslider0);
		int iSlow1 = std::fabs(fSlow0) < 1.1920929e-07f;
		float fSlow2 = ((iSlow1) ? 0.0f : std::exp(-(fConst0 / ((iSlow1) ? 1.0f : fSlow0))));
		float fSlow3 = static_cast<float>(fCheckbox0) * (1.0f - fSlow2);
...
class faust_env_smooth_tilde : public FaustExternal<env_smooth> {
public:
    faust_env_smooth_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(env_smooth))
    {
    }
};
