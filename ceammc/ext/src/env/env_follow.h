...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn env_follow -scn env_follow_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API env_follow_dsp {
    ...
    public:
        ...
        env_follow_dsp() = default;
        virtual ~env_follow_dsp() = default;
...
class env_follow : public env_follow_dsp {
 ...
 public:
	...
	env_follow(const env_follow&) = default;
	
	virtual ~env_follow() = default;
	
	env_follow& operator=(const env_follow&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn env_follow -scn env_follow_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = std::fabs(static_cast<float>(input0[i0]));
...
class faust_env_follow_tilde : public FaustExternal<env_follow> {
public:
    faust_env_follow_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(env_follow))
    {
    }
};
