...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn env_adsr -scn env_adsr_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __env_adsr_H__
#define  __env_adsr_H__
...
class FAUST_API env_adsr_dsp {

    public:

        env_adsr_dsp() = default;
        virtual ~env_adsr_dsp() = default;
...
class FAUST_API decorator_dsp : public ::env_adsr_dsp {
    ...
    public:
        ...
        decorator_dsp(::env_adsr_dsp* env_adsr_dsp = nullptr):fDSP(env_adsr_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::env_adsr_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in env_adsr_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct env_adsr : public env_adsr_dsp {
};
#endif
// clang-format on
...
class env_adsr : public env_adsr_dsp {
 ...
 public:
	...
	env_adsr(const env_adsr&) = default;
	
	virtual ~env_adsr() = default;
	
	env_adsr& operator=(const env_adsr&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn env_adsr -scn env_adsr_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		...
		m->declare("filename", "env_adsr.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.9.0");
		m->declare("name", "env.adsr");
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider3 = static_cast<FAUSTFLOAT>(3e+02f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("env.adsr");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->declare(&fHslider0, "unit", "ms");
		ui_interface->addHorizontalSlider("attack", &fHslider0, FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+05f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fHslider2, "style", "knob");
		ui_interface->declare(&fHslider2, "unit", "ms");
		ui_interface->addHorizontalSlider("decay", &fHslider2, FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+05f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addHorizontalSlider("release", &fHslider3, FAUSTFLOAT(3e+02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+05f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fHslider1, "style", "knob");
		ui_interface->declare(&fHslider1, "unit", "percent");
		ui_interface->addHorizontalSlider("sustain", &fHslider1, FAUSTFLOAT(5e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.001f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow5 = fConst1 * static_cast<float>(fHslider3);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fVec0[0] = fSlow0;
			fRec0[0] = fSlow0 + fRec0[1] * static_cast<float>(fVec0[1] >= fSlow0);
			...
			output0[i0] = static_cast<FAUSTFLOAT>(static_cast<float>(input0[i0]) * std::max<float>(0.0f, std::min<float>(fRec0[0] / fTemp0, std::max<float>((1.0f - fRec2[0]) * (fTemp0 - fRec0[0]) / std::max<float>(1.0f, fConst0 * fRec3[0]) + 1.0f, fRec2[0])) * (1.0f - static_cast<float>(iRec4[0]) / std::max<float>(1.0f, fConst0 * fRec5[0]))));
			fVec0[1] = fVec0[0];
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
...
class faust_env_adsr_tilde : public FaustExternal<env_adsr> {
public:
    faust_env_adsr_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(env_adsr))
    {
    }
};
