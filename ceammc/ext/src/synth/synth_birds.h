...
class synth_birds : public synth_birds_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst29 = (0.00170000002f * fConst0);
		fConst30 = (0.001646586f * fConst0);
		fConst31 = (0.001305221f * fConst0);
		fConst32 = (2929.41577f / fConst0);
		fConst33 = (0.000865000009f * fConst0);
		fConst34 = (2271.58643f / fConst0);
		fConst35 = (0.000863454014f * fConst0);
		fConst36 = (646830.5f / fConst0);
		fConst37 = (567.48822f / fConst0);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec18[0] = ((0.999000013f * fRec18[1]) + (fConst28 * ((fTemp31 - (fVec5[((IOTA - iTemp33) & 4095)] * (fTemp34 + (1.0f - fTemp32)))) - ((fTemp32 - fTemp34) * fVec5[((IOTA - (iTemp33 + 1)) & 4095)]))));
			...
			fRec24[0] = ((0.999000013f * fRec24[1]) + (0.00100000005f * (iTemp36 ? (iTemp38 ? ((iRec25[0] < 0) ? 0.0f : (iTemp38 ? (fConst43 * (fTemp35 / fTemp4)) : 0.55400002f)) : (iTemp36 ? ((fConst42 * ((0.0f - (0.55400002f * (fTemp35 - fTemp37))) / fTemp4)) + 0.55400002f) : 0.0f)) : 0.0f)));
			fRec23[0] = (0.0f - (fConst4 * ((fConst5 * fRec23[1]) - (fRec24[0] + fRec24[1]))));
			...
			float fTemp64 = (fRec15[1] + (fConst26 * ((fTemp15 * ((fConst27 * ((fRec18[0] * fTemp24) * (fRec23[0] + 1.0f))) + 440.0f)) * (fRec26[0] + 1.0f))));
			...
			fVec6[0] = fTemp68;
			fRec0[0] = (fConst2 * ((fTemp68 + fVec6[1]) - (fConst67 * fRec0[1])));
