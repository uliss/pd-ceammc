...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/ceammc_dsp_ext.cpp -lang cpp -i -cn synth_hat -scn synth_hat_dsp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class synth_hat : public synth_hat_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/ceammc_dsp_ext.cpp -lang cpp -i -cn synth_hat -scn synth_hat_dsp -es 1 -mcd 16 -single -ftz 0");
...
// clang-format on
    ...
    template <class T>
    struct _synth_hat_UI : public UI {
    static std::string name;
};

template <class T>
std::string _synth_hat_UI<T>::name(sym(synth_hat));

typedef _synth_hat_UI<synth_hat> synth_hat_UI;

class faust_synth_hat_tilde : public FaustExternal<synth_hat, synth_hat_UI> {
public:
