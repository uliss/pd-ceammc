...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn synth_hat -scn synth_hat_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API synth_hat_dsp {
    ...
    public:
        ...
        synth_hat_dsp() = default;
        virtual ~synth_hat_dsp() = default;
...
class synth_hat : public synth_hat_dsp {
 ...
 public:
	...
	synth_hat(const synth_hat&) = default;
	
	virtual ~synth_hat() = default;
	
	synth_hat& operator=(const synth_hat&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn synth_hat -scn synth_hat_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceResetUserInterface() {
		fVslider0 = static_cast<FAUSTFLOAT>(317.0f);
		fVslider1 = static_cast<FAUSTFLOAT>(6.4e+03f);
		fCheckbox0 = static_cast<FAUSTFLOAT>(0.0f);
		fVslider2 = static_cast<FAUSTFLOAT>(2e+01f);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow3 = fConst6 * static_cast<float>(fVslider2);
		float fSlow4 = fConst6 * static_cast<float>(fVslider3);
		int iSlow5 = fSlow2 == 0.0f;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec2[0] = fSlow0 + fConst3 * fRec2[1];
			float fTemp0 = fRec1[1] + fConst1 * fRec2[0];
			fRec1[0] = fTemp0 - static_cast<float>(static_cast<int>(fTemp0));
			float fTemp1 = fRec3[1] + fConst4 * fRec2[0];
			fRec3[0] = fTemp1 - static_cast<float>(static_cast<int>(fTemp1));
			iRec4[0] = 1103515245 * iRec4[1] + 12345;
			float fTemp2 = fRec3[0] + 9.313226e-10f * static_cast<float>(iRec4[0]);
			...
			fVec0[0] = fSlow2;
			fRec6[0] = fSlow2 + fRec6[1] * static_cast<float>(fVec0[1] >= fSlow2);
			...
			output0[i0] = static_cast<FAUSTFLOAT>((fRec0[2] + fRec0[0] + 2.0f * fRec0[1]) * std::max<float>(0.0f, std::min<float>(fRec6[0] / fTemp7, std::max<float>((fTemp7 - fRec6[0]) / std::max<float>(1.0f, fConst0 * fRec8[0]) + 1.0f, 0.0f)) * (1.0f - fConst7 * static_cast<float>(iRec9[0]))) / fTemp6);
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
			fRec3[1] = fRec3[0];
			iRec4[1] = iRec4[0];
