 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp28 = (fRec14[1] + (fConst0 * (fRec2[0] - (4.0f * fRec3[0]))));
			...
			float fTemp40 = (0.5f * (fRec12[0] + -1.0f));
			...
			float fTemp80 = (fRec18[1] + (fConst0 * (fRec2[0] + fTemp0)));
			...
			output0[i] = FAUSTFLOAT((0.0500000007f * ((fTemp12 * (0.5f - fTemp13)) + ((fTemp26 * (0.5f - fTemp27)) + ((fTemp39 * (0.0f - fTemp40)) + (((((fTemp52 * (0.5f - fTemp53)) + (fTemp65 * (fTemp66 + 0.5f))) + (fTemp78 * (fTemp79 + 0.5f))) + (fTemp91 * (fTemp92 + 0.5f))) + (0.5f * (fTemp104 * fTemp105))))))));
			output1[i] = FAUSTFLOAT((0.0500000007f * ((((((((fTemp39 * (fTemp40 + 1.0f)) + (fTemp26 * (fTemp27 + 0.5f))) + (fTemp12 * (fTemp13 + 0.5f))) + (fTemp52 * (fTemp53 + 0.5f))) + (fTemp65 * (0.5f - fTemp66))) + (fTemp78 * (0.5f - fTemp79))) + (fTemp91 * (0.5f - fTemp92))) + (fTemp104 * (1.0f - (0.5f * fTemp105))))));
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			fRec1[1] = fRec1[0];
			fRec4[1] = fRec4[0];
