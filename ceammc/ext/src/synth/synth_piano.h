...
class synth_piano : public synth_piano_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("ceammc_instruments.lib/version", "0.2");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp74 = (fRec70 + fRec66);
			float fTemp75 = (fRec58 + (fRec62 + fTemp74));
			fRec0[0] = (fRec8[1] + (fRec45[1] + (fRec49[1] + (fRec53[1] + (fRec57[1] + (fRec61[1] + (fRec65[1] + (fRec69[1] + (fRec9 + (fRec46 + (fRec50 + (fRec54 + fTemp75))))))))))));
			fRec1[0] = ((fRec57[1] + (fRec61[1] + (fRec65[1] + (fRec69[1] + fTemp75)))) - (fRec8[1] + (fRec45[1] + (fRec49[1] + (fRec53[1] + (fRec9 + (fRec46 + (fRec54 + fRec50))))))));
			float fTemp76 = (fRec62 + fRec58);
			fRec2[0] = ((fRec49[1] + (fRec53[1] + (fRec65[1] + (fRec69[1] + (fRec50 + (fRec54 + fTemp74)))))) - (fRec8[1] + (fRec45[1] + (fRec57[1] + (fRec61[1] + (fRec9 + (fRec46 + fTemp76)))))));
			fRec3[0] = ((fRec8[1] + (fRec45[1] + (fRec65[1] + (fRec69[1] + (fRec9 + (fRec46 + fTemp74)))))) - (fRec49[1] + (fRec53[1] + (fRec57[1] + (fRec61[1] + (fRec50 + (fRec54 + fTemp76)))))));
			float fTemp77 = (fRec70 + fRec62);
			float fTemp78 = (fRec66 + fRec58);
			fRec4[0] = ((fRec45[1] + (fRec53[1] + (fRec61[1] + (fRec69[1] + (fRec46 + (fRec54 + fTemp77)))))) - (fRec8[1] + (fRec49[1] + (fRec57[1] + (fRec65[1] + (fRec9 + (fRec50 + fTemp78)))))));
			fRec5[0] = ((fRec8[1] + (fRec49[1] + (fRec61[1] + (fRec69[1] + (fRec9 + (fRec50 + fTemp77)))))) - (fRec45[1] + (fRec53[1] + (fRec57[1] + (fRec65[1] + (fRec46 + (fRec54 + fTemp78)))))));
			float fTemp79 = (fRec70 + fRec58);
			float fTemp80 = (fRec66 + fRec62);
			fRec6[0] = ((fRec8[1] + (fRec53[1] + (fRec57[1] + (fRec69[1] + (fRec9 + (fRec54 + fTemp79)))))) - (fRec45[1] + (fRec49[1] + (fRec61[1] + (fRec65[1] + (fRec46 + (fRec50 + fTemp80)))))));
			fRec7[0] = ((fRec45[1] + (fRec49[1] + (fRec57[1] + (fRec69[1] + (fRec46 + (fRec50 + fTemp79)))))) - (fRec8[1] + (fRec53[1] + (fRec61[1] + (fRec65[1] + (fRec9 + (fRec54 + fTemp80)))))));
			float fTemp81 = (1.0f - fRec13[0]);
			output0[i] = FAUSTFLOAT(((0.370000005f * (fRec1[0] + fRec2[0])) + (fSlow117 * (fTemp81 * fTemp20))));
			output1[i] = FAUSTFLOAT(((0.370000005f * (fRec1[0] - fRec2[0])) + (fSlow2 * (fTemp81 * fTemp21))));
			fRec11[1] = fRec11[0];
			fRec12[1] = fRec12[0];
			fRec10[1] = fRec10[0];
			IOTA = (IOTA + 1);
