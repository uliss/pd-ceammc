...
class synth_piano : public synth_piano_dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow66 = (1.39698386e-09f * (fSlow65 * float((fSlow13 < 88.0f))));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp14 = ((fSlow17 * (fRec13[0] - fRec13[2])) + (fRec16 + fRec34[0]));
			...
			output0[i] = FAUSTFLOAT(((0.370000005f * (fRec1[0] + fRec2[0])) + (fSlow162 * (fTemp33 * fTemp14))));
			output1[i] = FAUSTFLOAT(((0.370000005f * (fRec1[0] - fRec2[0])) + (fSlow11 * (fTemp33 * fTemp15))));
			fRec11[1] = fRec11[0];
			fRec10[1] = fRec10[0];
			IOTA = (IOTA + 1);
			fRec12[1] = fRec12[0];
