...
class synth_piano : public synth_piano_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst29 = (0.333333343f * fConst27);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("room_size", &fHslider0, 0.720000029f, 0.00999999978f, 2.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = (12.0f * (1.0f - fSlow1));
		...
		float fSlow115 = (12.0f * fSlow1);
		int iSlow116 = int(std::min<float>(4096.0f, std::max<float>(0.0f, (fConst32 * (float(fHslider8) / fSlow4)))));
		#pragma clang loop vectorize(enable) interleave(enable)
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec12[0] = (0.0f - (fConst6 * ((fConst7 * fRec12[1]) - (fRec0[1] + fRec0[2]))));
			fRec10[0] = ((fRec10[1] * (fTemp4 - fTemp5)) + ((fTemp0 * (fRec0[1] + (fRec12[0] * ((std::exp((fConst8 / fRec11[0])) / fTemp0) + -1.0f)))) * (fTemp5 + (1.0f - fTemp4))));
			...
			fVec7[(IOTA & 4095)] = (fSlow2 * (fRec13[0] * fTemp19));
			float fTemp20 = (0.300000012f * fVec7[((IOTA - iConst24) & 4095)]);
			float fTemp21 = ((fVec0[((IOTA - iConst10) & 16383)] + fTemp20) - (0.600000024f * fRec8[1]));
			fVec8[(IOTA & 2047)] = fTemp21;
			fRec8[0] = fVec8[((IOTA - iConst25) & 2047)];
			float fRec9 = (0.600000024f * fTemp21);
			float fTemp22 = std::exp((fConst28 / fRec11[0]));
			float fTemp23 = synth_piano_faustpower2_f(fTemp22);
			float fTemp24 = (1.0f - (fConst1 * fTemp23));
			float fTemp25 = (1.0f - fTemp23);
			float fTemp26 = (fTemp24 / fTemp25);
			float fTemp27 = std::sqrt(std::max<float>(0.0f, ((synth_piano_faustpower2_f(fTemp24) / synth_piano_faustpower2_f(fTemp25)) + -1.0f)));
			fRec48[0] = (0.0f - (fConst6 * ((fConst7 * fRec48[1]) - (fRec7[1] + fRec7[2]))));
			fRec47[0] = ((fRec47[1] * (fTemp26 - fTemp27)) + ((fTemp22 * (fRec7[1] + (fRec48[0] * ((std::exp((fConst29 / fRec11[0])) / fTemp22) + -1.0f)))) * (fTemp27 + (1.0f - fTemp26))));
			fVec9[(IOTA & 32767)] = ((0.353553385f * fRec47[0]) + 9.99999968e-21f);
			float fTemp28 = fVec6[((IOTA - iSlow116) & 4095)];
			fVec10[(IOTA & 4095)] = (fSlow115 * (fRec13[0] * fTemp28));
			float fTemp29 = (0.300000012f * fVec10[((IOTA - iConst24) & 4095)]);
			float fTemp30 = (((0.600000024f * fRec45[1]) + fVec9[((IOTA - iConst31) & 32767)]) - fTemp29);
			fVec11[(IOTA & 2047)] = fTemp30;
			fRec45[0] = fVec11[((IOTA - iConst33) & 2047)];
			...
			fRec52[0] = (0.0f - (fConst6 * ((fConst7 * fRec52[1]) - (fRec3[1] + fRec3[2]))));
			fRec51[0] = ((fRec51[1] * (fTemp35 - fTemp36)) + ((fTemp31 * (fRec3[1] + (fRec52[0] * ((std::exp((fConst37 / fRec11[0])) / fTemp31) + -1.0f)))) * (fTemp36 + (1.0f - fTemp35))));
			fVec12[(IOTA & 32767)] = ((0.353553385f * fRec51[0]) + 9.99999968e-21f);
			float fTemp37 = (((0.600000024f * fRec49[1]) + fVec12[((IOTA - iConst39) & 32767)]) - fTemp29);
			fVec13[(IOTA & 4095)] = fTemp37;
			fRec49[0] = fVec13[((IOTA - iConst40) & 4095)];
			...
			fRec56[0] = (0.0f - (fConst6 * ((fConst7 * fRec56[1]) - (fRec5[1] + fRec5[2]))));
			fRec55[0] = ((fRec55[1] * (fTemp42 - fTemp43)) + ((fTemp38 * (fRec5[1] + (fRec56[0] * ((std::exp((fConst44 / fRec11[0])) / fTemp38) + -1.0f)))) * (fTemp43 + (1.0f - fTemp42))));
			fVec14[(IOTA & 16383)] = ((0.353553385f * fRec55[0]) + 9.99999968e-21f);
			float fTemp44 = (fVec14[((IOTA - iConst46) & 16383)] + (fTemp29 + (0.600000024f * fRec53[1])));
			fVec15[(IOTA & 4095)] = fTemp44;
			fRec53[0] = fVec15[((IOTA - iConst47) & 4095)];
			...
			fRec60[0] = (0.0f - (fConst6 * ((fConst7 * fRec60[1]) - (fRec1[1] + fRec1[2]))));
			fRec59[0] = ((fRec59[1] * (fTemp49 - fTemp50)) + ((fTemp45 * (fRec1[1] + (fRec60[0] * ((std::exp((fConst51 / fRec11[0])) / fTemp45) + -1.0f)))) * (fTemp50 + (1.0f - fTemp49))));
			fVec16[(IOTA & 32767)] = ((0.353553385f * fRec59[0]) + 9.99999968e-21f);
			float fTemp51 = (fTemp29 + ((0.600000024f * fRec57[1]) + fVec16[((IOTA - iConst53) & 32767)]));
			fVec17[(IOTA & 4095)] = fTemp51;
			fRec57[0] = fVec17[((IOTA - iConst54) & 4095)];
			float fRec58 = (0.0f - (0.600000024f * fTemp51));
			...
			fRec64[0] = (0.0f - (fConst6 * ((fConst7 * fRec64[1]) - (fRec6[1] + fRec6[2]))));
			fRec63[0] = ((fRec63[1] * (fTemp56 - fTemp57)) + ((fTemp52 * (fRec6[1] + (fRec64[0] * ((std::exp((fConst58 / fRec11[0])) / fTemp52) + -1.0f)))) * (fTemp57 + (1.0f - fTemp56))));
			fVec18[(IOTA & 16383)] = ((0.353553385f * fRec63[0]) + 9.99999968e-21f);
			float fTemp58 = (fVec18[((IOTA - iConst60) & 16383)] - (fTemp20 + (0.600000024f * fRec61[1])));
			fVec19[(IOTA & 2047)] = fTemp58;
			fRec61[0] = fVec19[((IOTA - iConst61) & 2047)];
			...
			fRec68[0] = (0.0f - (fConst6 * ((fConst7 * fRec68[1]) - (fRec2[1] + fRec2[2]))));
			fRec67[0] = ((fRec67[1] * (fTemp63 - fTemp64)) + ((fTemp59 * (fRec2[1] + (fRec68[0] * ((std::exp((fConst65 / fRec11[0])) / fTemp59) + -1.0f)))) * (fTemp64 + (1.0f - fTemp63))));
			fVec20[(IOTA & 16383)] = ((0.353553385f * fRec67[0]) + 9.99999968e-21f);
			float fTemp65 = (fVec20[((IOTA - iConst67) & 16383)] - (fTemp20 + (0.600000024f * fRec65[1])));
			...
			fRec72[0] = (0.0f - (fConst6 * ((fConst7 * fRec72[1]) - (fRec4[1] + fRec4[2]))));
			fRec71[0] = ((fRec71[1] * (fTemp70 - fTemp71)) + ((fTemp66 * (fRec4[1] + (fRec72[0] * ((std::exp((fConst72 / fRec11[0])) / fTemp66) + -1.0f)))) * (fTemp71 + (1.0f - fTemp70))));
			fVec22[(IOTA & 16383)] = ((0.353553385f * fRec71[0]) + 9.99999968e-21f);
			float fTemp72 = ((fTemp20 + fVec22[((IOTA - iConst74) & 16383)]) - (0.600000024f * fRec69[1]));
			fVec23[(IOTA & 4095)] = fTemp72;
			fRec69[0] = fVec23[((IOTA - iConst75) & 4095)];
			float fRec70 = (0.600000024f * fTemp72);
			float fTemp73 = (fRec69[1] + fRec65[1]);
			float fTemp74 = (fRec61[1] + fTemp73);
			fRec0[0] = (fRec8[1] + (fRec46 + (fRec50 + (fRec54 + (fRec58 + (fRec62 + (fRec66 + (fRec70 + (fRec9 + (fRec45[1] + (fRec49[1] + (fRec53[1] + (fTemp74 + fRec57[1])))))))))))));
			fRec1[0] = ((fRec8[1] + (fRec62 + (fRec66 + (fRec70 + (fRec9 + fTemp74))))) - (fRec46 + (fRec50 + (fRec54 + (fRec58 + (fRec45[1] + ((fRec57[1] + fRec53[1]) + fRec49[1])))))));
			float fTemp75 = (fRec65[1] + fRec61[1]);
			fRec2[0] = ((fRec8[1] + (fRec54 + (fRec58 + (fRec70 + (fRec9 + (fRec53[1] + (fRec69[1] + fRec57[1]))))))) - (fRec46 + (fRec50 + (fRec62 + (fRec66 + (fRec45[1] + (fTemp75 + fRec49[1])))))));
			fRec3[0] = ((fRec8[1] + (fRec46 + (fRec50 + (fRec70 + (fRec9 + (fRec45[1] + (fRec69[1] + fRec49[1]))))))) - (fRec54 + (fRec58 + (fRec62 + (fRec66 + (fRec53[1] + (fTemp75 + fRec57[1])))))));
			float fTemp76 = (fRec69[1] + fRec61[1]);
			fRec4[0] = ((fRec8[1] + (fRec50 + (fRec58 + (fRec66 + (fRec9 + (fRec49[1] + (fRec65[1] + fRec57[1]))))))) - (fRec46 + (fRec54 + (fRec62 + (fRec70 + (fRec45[1] + (fRec53[1] + fTemp76)))))));
			fRec5[0] = ((fRec8[1] + (fRec46 + (fRec54 + (fRec66 + (fRec9 + (fRec45[1] + (fRec65[1] + fRec53[1]))))))) - (fRec50 + (fRec58 + (fRec62 + (fRec70 + (fRec49[1] + (fRec57[1] + fTemp76)))))));
			fRec6[0] = ((fRec8[1] + (fRec46 + (fRec58 + (fRec62 + (fRec9 + (fRec45[1] + (fRec61[1] + fRec57[1]))))))) - (fRec50 + (fRec54 + (fRec66 + (fRec70 + (fRec49[1] + (fTemp73 + fRec53[1])))))));
			fRec7[0] = ((fRec8[1] + (fRec50 + (fRec54 + (fRec62 + (fRec9 + (fRec49[1] + (fRec61[1] + fRec53[1]))))))) - (fRec46 + (fRec58 + (fRec66 + (fRec70 + (fRec45[1] + (fTemp73 + fRec57[1])))))));
			float fTemp77 = (1.0f - fRec13[0]);
			output0[i] = FAUSTFLOAT(((0.370000005f * (fRec1[0] + fRec2[0])) + (fSlow2 * (fTemp77 * fTemp19))));
			output1[i] = FAUSTFLOAT(((0.370000005f * (fRec1[0] - fRec2[0])) + (fSlow115 * (fTemp77 * fTemp28))));
			fRec11[1] = fRec11[0];
			fRec12[1] = fRec12[0];
			fRec10[1] = fRec10[0];
			IOTA = (IOTA + 1);
