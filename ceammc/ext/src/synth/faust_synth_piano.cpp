...
/* PianoDriver.sb */
const static double noteOffDelayTime_points[5 * 2] = {
    89.000,
    3.000,
    93.000,
    2.000,
...
const static double singleStringDecayRate_points[17 * 2] = {
    21.000, -1.500,
    24.000, -1.500,
    28.000, -1.500,
    29.000, -6.000,
...
const static double singleStringZero_points[17 * 2] = {
    21.000, -1.000,
    24.000, -1.000,
    28.000, -1.000,
    29.000, -1.000,
...
const static double singleStringPole_points[17 * 2] = {
    21.000, 0.350,
    24.604, 0.318,
    26.335, 0.279,
    28.000, 0.250,
...
const static double releaseLoopGain_points[10 * 2] = {
    21.000, 0.865,
    24.000, 0.880,
    29.000, 0.896,
    36.000, 0.910,
...
const static double detuningHz_points[18 * 2] = {
    21.000, 0.003,
    24.000, 0.003,
    28.000, 0.003,
    29.000, 0.060,
...
const static double stiffnessCoefficient_points[10 * 2] = {
    21.000, -0.850,
    23.595, -0.850,
    27.055, -0.830,
    29.000, -0.700,
...
const static double EQGain_points[14 * 2] = {
    21.000, 2.000,
    24.000, 2.000,
    28.000, 2.000,
    30.000, 2.000,
...
static const double EQBandwidthFactor_points[13 * 2] = {
    21.000, 5.000,
    24.112, 5.000,
    28.000, 5.000,
    35.000, 4.956,
...
static const double loudPole_points[19 * 2] = {
    21.000, 0.875,
    23.719, 0.871,
    27.237, 0.836,
    28.996, 0.828,
...
static double softPole_points[16 * 2] = {
    21.000, 0.990,
    24.000, 0.990,
    28.000, 0.990,
    29.000, 0.990,
...
const static double loudGain_points[16 * 2] = {
    21.873, 0.891,
    25.194, 0.870,
    30.538, 0.848,
    35.448, 0.853,
...
const static double softGain_points[15 * 2] = {
    20.865, 0.400,
    22.705, 0.400,
    25.960, 0.400,
    28.224, 0.400,
...
const static double sustainPedalLevel_points[13 * 2] = {
    21.000, 0.050,
    24.000, 0.050,
    31.000, 0.030,
    36.000, 0.025,
...
static const double DryTapAmpT60_points[16 * 2] = {
    21.001, 0.491,
    26.587, 0.498,
    34.249, 0.470,
    40.794, 0.441,
...
const static double DCBa1_points[18 * 2] = {
    21.000, -0.999,
    24.000, -0.999,
    30.000, -0.999,
    36.000, -0.999,
...
const static double secondStageAmpRatio_points[6 * 2] = {
    82.277, -18.508,
    88.000, -30.000,
    90.000, -30.000,
    93.451, -30.488,
...
const static double r1_1db_points[3 * 2] = {
    100.000, -75.000,
    103.802, -237.513,
    108.000, -400.000
};
...
const static double r1_2db_points[4 * 2] = {
    98.388, -16.562,
    100.743, -75.531,
    103.242, -154.156,
    108.000, -300.000
...
const static double r2db_points[2 * 2] = {
    100.000, -115.898,
    107.858, -250.000
};
const LookupTable r2db(&r2db_points[0], 2);

const static double r3db_points[2 * 2] = {
    100.000, -150.000,
    108.000, -400.000
};
const LookupTable r3db(&r3db_points[0], 2);

const static double secondPartialFactor_points[2 * 2] = {
    88.000, 2.000,
    108.000, 2.100
};
const LookupTable secondPartialFactor(&secondPartialFactor_points[0], 2);

const static double thirdPartialFactor_points[2 * 2] = {
    88.000, 3.100,
    108.000, 3.100
};
const LookupTable thirdPartialFactor(&thirdPartialFactor_points[0], 2);

const static double bq4_gEarBalled_points[6 * 2] = {
    100.000, 0.040,
    102.477, 0.100,
    104.518, 0.300,
    106.000, 0.500,
...
const static double loopFilterb0_points[18 * 2] = {
    35.000,
    0.94373,
    36.000,
    0.94731,
...
const static double loopFilterb1_points[18 * 2] = {
    35.000,
    0.60010,
    36.000,
    -0.59124,
...
const static double loopFilterb2_points[18 * 2] = {
    35.000,
    -0.00360,
    36.000,
    -0.12249,
...
const static double loopFiltera1_points[18 * 2] = {
    35.000,
    0.5941,
    36.000,
    -0.65928,
...
const static double loopFiltera2_points[18 * 2] = {
    35.000,
    -0.02641,
    36.000,
    -0.10275,
...
const static double bassLoopFilterb0_points[19 * 2] = {
    24.000,
    0.54355,
    26.000,
    0.54355,
...
const static double bassLoopFilterb1_points[19 * 2] = {
    24.000,
    -0.36586,
    26.000,
    -0.36586,
...
const static double bassLoopFiltera1_points[19 * 2] = {
    24.000,
    -0.81486,
    26.000,
    -0.81486,
