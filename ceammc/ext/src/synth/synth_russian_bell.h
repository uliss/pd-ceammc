...
class synth_russian_bell : public synth_russian_bell_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst5 = synth_russian_bell_faustpower2_f(fConst2);
		...
		fConst11 = std::cos((5069.01025f / fConst0));
		fConst12 = (1.0f / fConst0);
		fConst13 = std::cos((5028.73486f / fConst0));
		fConst14 = std::cos((4960.34229f / fConst0));
		fConst15 = std::cos((4956.33984f / fConst0));
		fConst16 = std::cos((4922.64941f / fConst0));
		fConst17 = std::cos((4921.9707f / fConst0));
		fConst18 = std::cos((4876.1665f / fConst0));
		fConst19 = std::cos((4874.74023f / fConst0));
		fConst20 = std::cos((4506.48877f / fConst0));
		fConst21 = std::cos((4504.50977f / fConst0));
		fConst22 = std::cos((4450.63135f / fConst0));
		fConst23 = std::cos((4147.06543f / fConst0));
		fConst24 = std::cos((3643.38672f / fConst0));
		fConst25 = std::cos((3633.78589f / fConst0));
		fConst26 = std::cos((3431.61182f / fConst0));
		fConst27 = std::cos((3400.2085f / fConst0));
		fConst28 = std::cos((3336.6604f / fConst0));
		fConst29 = std::cos((3332.97852f / fConst0));
		fConst30 = std::cos((3164.44458f / fConst0));
		fConst31 = std::cos((3164.17432f / fConst0));
		fConst32 = std::cos((2937.34521f / fConst0));
		fConst33 = std::cos((2856.81982f / fConst0));
		fConst34 = std::cos((2475.25464f / fConst0));
		fConst35 = std::cos((2474.64502f / fConst0));
		fConst36 = std::cos((2000.63538f / fConst0));
		fConst37 = std::cos((1988.55908f / fConst0));
		fConst38 = std::cos((1636.26086f / fConst0));
		fConst39 = std::cos((1627.08105f / fConst0));
		fConst40 = std::cos((860.746094f / fConst0));
		fConst41 = std::cos((857.598267f / fConst0));
		fConst42 = std::cos((5509.02148f / fConst0));
		fConst43 = std::cos((5531.8042f / fConst0));
		fConst44 = std::cos((5575.05127f / fConst0));
		fConst45 = std::cos((5580.86328f / fConst0));
		fConst46 = std::cos((5760.51855f / fConst0));
		fConst47 = std::cos((5778.71484f / fConst0));
		fConst48 = std::cos((5891.65479f / fConst0));
		fConst49 = std::cos((6186.46191f / fConst0));
		fConst50 = std::cos((6642.5835f / fConst0));
		fConst51 = std::cos((6650.4375f / fConst0));
		fConst52 = std::cos((6694.6084f / fConst0));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("cutoff", &fHslider1, 7000.0f, 20.0f, 20000.0f, 1.0f);
		...
		ui_interface->addHorizontalSlider("t60", &fHslider3, 5.0f, 0.100000001f, 30.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow12 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.671732962f * fSlow10)), fSlow11))));
		...
		float fSlow16 = ftbl0synth_russian_bellSIG0[(iSlow15 + 29)];
		float fSlow17 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.666395783f * fSlow10)), fSlow11))));
		float fSlow18 = (fConst13 * (0.0f - (2.0f * fSlow17)));
		float fSlow19 = synth_russian_bell_faustpower2_f(fSlow17);
		float fSlow20 = ftbl0synth_russian_bellSIG0[(iSlow15 + 28)];
		float fSlow21 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.657332599f * fSlow10)), fSlow11))));
		float fSlow22 = (fConst14 * (0.0f - (2.0f * fSlow21)));
		float fSlow23 = synth_russian_bell_faustpower2_f(fSlow21);
		float fSlow24 = ftbl0synth_russian_bellSIG0[(iSlow15 + 27)];
		float fSlow25 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.656802177f * fSlow10)), fSlow11))));
		float fSlow26 = (fConst15 * (0.0f - (2.0f * fSlow25)));
		float fSlow27 = synth_russian_bell_faustpower2_f(fSlow25);
		float fSlow28 = ftbl0synth_russian_bellSIG0[(iSlow15 + 26)];
		float fSlow29 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.652337611f * fSlow10)), fSlow11))));
		float fSlow30 = (fConst16 * (0.0f - (2.0f * fSlow29)));
		float fSlow31 = synth_russian_bell_faustpower2_f(fSlow29);
		float fSlow32 = ftbl0synth_russian_bellSIG0[(iSlow15 + 25)];
		float fSlow33 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.652247667f * fSlow10)), fSlow11))));
		float fSlow34 = (fConst17 * (0.0f - (2.0f * fSlow33)));
		float fSlow35 = synth_russian_bell_faustpower2_f(fSlow33);
		float fSlow36 = ftbl0synth_russian_bellSIG0[(iSlow15 + 24)];
		float fSlow37 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.646177828f * fSlow10)), fSlow11))));
		float fSlow38 = (fConst18 * (0.0f - (2.0f * fSlow37)));
		float fSlow39 = synth_russian_bell_faustpower2_f(fSlow37);
		float fSlow40 = ftbl0synth_russian_bellSIG0[(iSlow15 + 23)];
		float fSlow41 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.645988822f * fSlow10)), fSlow11))));
		float fSlow42 = (fConst19 * (0.0f - (2.0f * fSlow41)));
		float fSlow43 = synth_russian_bell_faustpower2_f(fSlow41);
		float fSlow44 = ftbl0synth_russian_bellSIG0[(iSlow15 + 22)];
		float fSlow45 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.597189009f * fSlow10)), fSlow11))));
		float fSlow46 = (fConst20 * (0.0f - (2.0f * fSlow45)));
		float fSlow47 = synth_russian_bell_faustpower2_f(fSlow45);
		float fSlow48 = ftbl0synth_russian_bellSIG0[(iSlow15 + 21)];
		float fSlow49 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.596926749f * fSlow10)), fSlow11))));
		float fSlow50 = (fConst21 * (0.0f - (2.0f * fSlow49)));
		float fSlow51 = synth_russian_bell_faustpower2_f(fSlow49);
		float fSlow52 = ftbl0synth_russian_bellSIG0[(iSlow15 + 20)];
		float fSlow53 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.589786947f * fSlow10)), fSlow11))));
		float fSlow54 = (fConst22 * (0.0f - (2.0f * fSlow53)));
		float fSlow55 = synth_russian_bell_faustpower2_f(fSlow53);
		float fSlow56 = ftbl0synth_russian_bellSIG0[(iSlow15 + 19)];
		float fSlow57 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.549559116f * fSlow10)), fSlow11))));
		float fSlow58 = (fConst23 * (0.0f - (2.0f * fSlow57)));
		float fSlow59 = synth_russian_bell_faustpower2_f(fSlow57);
		float fSlow60 = ftbl0synth_russian_bellSIG0[(iSlow15 + 18)];
		float fSlow61 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.482812792f * fSlow10)), fSlow11))));
		float fSlow62 = (fConst24 * (0.0f - (2.0f * fSlow61)));
		float fSlow63 = synth_russian_bell_faustpower2_f(fSlow61);
		float fSlow64 = ftbl0synth_russian_bellSIG0[(iSlow15 + 17)];
		float fSlow65 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.481540531f * fSlow10)), fSlow11))));
		float fSlow66 = (fConst25 * (0.0f - (2.0f * fSlow65)));
		float fSlow67 = synth_russian_bell_faustpower2_f(fSlow65);
		float fSlow68 = ftbl0synth_russian_bellSIG0[(iSlow15 + 16)];
		float fSlow69 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.454748929f * fSlow10)), fSlow11))));
		float fSlow70 = (fConst26 * (0.0f - (2.0f * fSlow69)));
		float fSlow71 = synth_russian_bell_faustpower2_f(fSlow69);
		float fSlow72 = ftbl0synth_russian_bellSIG0[(iSlow15 + 15)];
		float fSlow73 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.450587422f * fSlow10)), fSlow11))));
		float fSlow74 = (fConst27 * (0.0f - (2.0f * fSlow73)));
		float fSlow75 = synth_russian_bell_faustpower2_f(fSlow73);
		float fSlow76 = ftbl0synth_russian_bellSIG0[(iSlow15 + 14)];
		float fSlow77 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.442166179f * fSlow10)), fSlow11))));
		float fSlow78 = (fConst28 * (0.0f - (2.0f * fSlow77)));
		float fSlow79 = synth_russian_bell_faustpower2_f(fSlow77);
		float fSlow80 = ftbl0synth_russian_bellSIG0[(iSlow15 + 13)];
		float fSlow81 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.441678256f * fSlow10)), fSlow11))));
		float fSlow82 = (fConst29 * (0.0f - (2.0f * fSlow81)));
		float fSlow83 = synth_russian_bell_faustpower2_f(fSlow81);
		float fSlow84 = ftbl0synth_russian_bellSIG0[(iSlow15 + 12)];
		float fSlow85 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.419344544f * fSlow10)), fSlow11))));
		float fSlow86 = (fConst30 * (0.0f - (2.0f * fSlow85)));
		float fSlow87 = synth_russian_bell_faustpower2_f(fSlow85);
		float fSlow88 = ftbl0synth_russian_bellSIG0[(iSlow15 + 11)];
		float fSlow89 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.419308752f * fSlow10)), fSlow11))));
		float fSlow90 = (fConst31 * (0.0f - (2.0f * fSlow89)));
		float fSlow91 = synth_russian_bell_faustpower2_f(fSlow89);
		float fSlow92 = ftbl0synth_russian_bellSIG0[(iSlow15 + 10)];
		float fSlow93 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.389249891f * fSlow10)), fSlow11))));
		float fSlow94 = (fConst32 * (0.0f - (2.0f * fSlow93)));
		float fSlow95 = synth_russian_bell_faustpower2_f(fSlow93);
		float fSlow96 = ftbl0synth_russian_bellSIG0[(iSlow15 + 9)];
		float fSlow97 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.378578871f * fSlow10)), fSlow11))));
		float fSlow98 = (fConst33 * (0.0f - (2.0f * fSlow97)));
		float fSlow99 = synth_russian_bell_faustpower2_f(fSlow97);
		float fSlow100 = ftbl0synth_russian_bellSIG0[(iSlow15 + 8)];
		float fSlow101 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.328014761f * fSlow10)), fSlow11))));
		float fSlow102 = (fConst34 * (0.0f - (2.0f * fSlow101)));
		float fSlow103 = synth_russian_bell_faustpower2_f(fSlow101);
		float fSlow104 = ftbl0synth_russian_bellSIG0[(iSlow15 + 7)];
		float fSlow105 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.327933997f * fSlow10)), fSlow11))));
		float fSlow106 = (fConst35 * (0.0f - (2.0f * fSlow105)));
		float fSlow107 = synth_russian_bell_faustpower2_f(fSlow105);
		float fSlow108 = ftbl0synth_russian_bellSIG0[(iSlow15 + 6)];
		float fSlow109 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.265119344f * fSlow10)), fSlow11))));
		float fSlow110 = (fConst36 * (0.0f - (2.0f * fSlow109)));
		float fSlow111 = synth_russian_bell_faustpower2_f(fSlow109);
		float fSlow112 = ftbl0synth_russian_bellSIG0[(iSlow15 + 5)];
		float fSlow113 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.263519049f * fSlow10)), fSlow11))));
		float fSlow114 = (fConst37 * (0.0f - (2.0f * fSlow113)));
		float fSlow115 = synth_russian_bell_faustpower2_f(fSlow113);
		float fSlow116 = ftbl0synth_russian_bellSIG0[(iSlow15 + 4)];
		float fSlow117 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.216833338f * fSlow10)), fSlow11))));
		float fSlow118 = (fConst38 * (0.0f - (2.0f * fSlow117)));
		float fSlow119 = synth_russian_bell_faustpower2_f(fSlow117);
		float fSlow120 = ftbl0synth_russian_bellSIG0[(iSlow15 + 3)];
		float fSlow121 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.215616852f * fSlow10)), fSlow11))));
		float fSlow122 = (fConst39 * (0.0f - (2.0f * fSlow121)));
		float fSlow123 = synth_russian_bell_faustpower2_f(fSlow121);
		float fSlow124 = ftbl0synth_russian_bellSIG0[(iSlow15 + 2)];
		float fSlow125 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.114063993f * fSlow10)), fSlow11))));
		float fSlow126 = (fConst40 * (0.0f - (2.0f * fSlow125)));
		float fSlow127 = synth_russian_bell_faustpower2_f(fSlow125);
		float fSlow128 = ftbl0synth_russian_bellSIG0[(iSlow15 + 1)];
		float fSlow129 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.11364685f * fSlow10)), fSlow11))));
		float fSlow130 = (fConst41 * (0.0f - (2.0f * fSlow129)));
		float fSlow131 = synth_russian_bell_faustpower2_f(fSlow129);
		float fSlow132 = ftbl0synth_russian_bellSIG0[iSlow15];
		float fSlow133 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.730042219f * fSlow10)), fSlow11))));
		...
		float fSlow137 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.733061314f * fSlow10)), fSlow11))));
		...
		float fSlow141 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.73879236f * fSlow10)), fSlow11))));
		...
		float fSlow145 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.739562511f * fSlow10)), fSlow11))));
		...
		float fSlow149 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.763369977f * fSlow10)), fSlow11))));
		...
		float fSlow153 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.765781283f * fSlow10)), fSlow11))));
		...
		float fSlow157 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.78074789f * fSlow10)), fSlow11))));
		...
		float fSlow161 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.81981498f * fSlow10)), fSlow11))));
		...
		float fSlow165 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.880259097f * fSlow10)), fSlow11))));
		...
		float fSlow169 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.881299913f * fSlow10)), fSlow11))));
		...
		float fSlow173 = std::pow(0.00100000005f, (fConst12 / (fSlow9 * std::pow((1.0f - (0.887153327f * fSlow10)), fSlow11))));
