 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = fRec13[(IOTA0 - 1) & 8191];
			...
			float fTemp7 = fTemp5 * fTemp6 - fTemp4 * fRec21[1];
			float fTemp8 = fTemp5 * fTemp7 - fTemp4 * fRec22[1];
			float fTemp9 = fTemp5 * fTemp8 - fTemp4 * fRec23[1];
			float fTemp10 = fTemp5 * fTemp9 - fTemp4 * fRec24[1];
			fRec25[0] = fTemp5 * fTemp10 - fTemp4 * fRec25[1];
			fRec24[0] = fTemp4 * fTemp10 + fTemp5 * fRec25[1];
			fRec23[0] = fTemp4 * fTemp9 + fTemp5 * fRec24[1];
			fRec22[0] = fTemp4 * fTemp8 + fTemp5 * fRec23[1];
			fRec21[0] = fTemp4 * fTemp7 + fTemp5 * fRec22[1];
			fRec20[0] = fTemp4 * fTemp6 + fTemp5 * fRec21[1];
			float fTemp11 = fRec16[0] * (fSlow27 * fTemp1 + fSlow28 * (fTemp1 + fRec13[(IOTA0 - 2) & 8191]) + fSlow29 * synth_harpsichord_faustpower2_f(fTemp1));
			float fTemp12 = std::sin(fTemp11);
			float fTemp13 = std::cos(fTemp11);
			float fTemp14 = fTemp1 * fTemp13 - fTemp12 * fRec26[1];
			float fTemp15 = fTemp13 * fTemp14 - fTemp12 * fRec27[1];
			float fTemp16 = fTemp13 * fTemp15 - fTemp12 * fRec28[1];
			float fTemp17 = fTemp13 * fTemp16 - fTemp12 * fRec29[1];
			float fTemp18 = fTemp13 * fTemp17 - fTemp12 * fRec30[1];
			fRec31[0] = fTemp13 * fTemp18 - fTemp12 * fRec31[1];
			fRec30[0] = fTemp12 * fTemp18 + fTemp13 * fRec31[1];
			fRec29[0] = fTemp12 * fTemp17 + fTemp13 * fRec30[1];
			fRec28[0] = fTemp12 * fTemp16 + fTemp13 * fRec29[1];
			...
			float fTemp24 = ((fTemp23 > fRec37[1]) ? fConst19 : fConst18);
			fRec37[0] = fTemp23 * (1.0f - fTemp24) + fRec37[1] * fTemp24;
			fRec36[0] = fConst16 * fRec36[1] - fConst17 * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec37[0])) + -1e+02f, 0.0f);
			fRec13[IOTA0 & 8191] = fTemp22 * std::pow(1e+01f, 0.05f * fRec36[0]);
			float fTemp25 = fRec13[(IOTA0 - iSlow38) & 8191];
			fVec4[IOTA0 & 4095] = fSlow11 * fRec12[0] * fTemp25;
			float fTemp26 = 0.3f * fVec4[(IOTA0 - iConst21) & 4095];
			fVec5[IOTA0 & 2047] = fTemp0 - fTemp26;
			fRec8[0] = fVec5[(IOTA0 - iConst22) & 2047];
			float fRec9 = 0.6f * (fTemp26 - fTemp0);
			fRec41[0] = -(fConst7 * (fConst8 * fRec41[1] - (fRec3[1] + fRec3[2])));
			fRec40[0] = fSlow45 * (fRec3[1] + fSlow46 * fRec41[0]) + fSlow47 * fRec40[1];
			fVec6[IOTA0 & 32767] = 0.35355338f * fRec40[0] + 1e-20f;
			float fTemp27 = 0.6f * fRec38[1] + fVec6[(IOTA0 - iConst28) & 32767];
