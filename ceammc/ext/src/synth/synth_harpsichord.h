...
class synth_harpsichord : public synth_harpsichord_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst25 = std::floor(((0.0134579996f * fConst0) + 0.5f));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow48 = (4.0f * (1.0f - fSlow10));
		float fSlow49 = std::exp((fConst30 / fSlow0));
		float fSlow50 = synth_harpsichord_faustpower2_f(fSlow49);
		float fSlow51 = (1.0f - (fConst1 * fSlow50));
		...
		float fSlow57 = ((std::exp((fConst31 / fSlow0)) / fSlow49) + -1.0f);
		float fSlow58 = std::exp((fConst37 / fSlow0));
		float fSlow59 = synth_harpsichord_faustpower2_f(fSlow58);
		float fSlow60 = (1.0f - (fConst1 * fSlow59));
		...
		float fSlow66 = ((std::exp((fConst38 / fSlow0)) / fSlow58) + -1.0f);
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec42[0] = (0.0f - (fConst7 * ((fConst8 * fRec42[1]) - (fRec6[1] + fRec6[2]))));
			fRec41[0] = ((fSlow45 * fRec41[1]) + (fSlow46 * (fRec6[1] + (fSlow47 * fRec42[0]))));
			fVec4[(IOTA & 16383)] = ((0.353553385f * fRec41[0]) + 9.99999968e-21f);
			float fTemp27 = fRec13[((IOTA - 0) & 8191)];
			fVec5[(IOTA & 4095)] = (fSlow48 * (fTemp27 * fRec12[0]));
			float fTemp28 = (0.300000012f * fVec5[((IOTA - iConst19) & 4095)]);
			...
			fRec45[0] = ((fSlow55 * fRec45[1]) + (fSlow56 * (fRec3[1] + (fSlow57 * fRec46[0]))));
			fVec7[(IOTA & 32767)] = ((0.353553385f * fRec45[0]) + 9.99999968e-21f);
			float fTemp30 = (((0.600000024f * fRec43[1]) + fVec7[((IOTA - iConst33) & 32767)]) - fTemp25);
			...
			fRec49[0] = ((fSlow64 * fRec49[1]) + (fSlow65 * (fRec5[1] + (fSlow66 * fRec50[0]))));
			fVec9[(IOTA & 16383)] = ((0.353553385f * fRec49[0]) + 9.99999968e-21f);
			float fTemp31 = (fVec9[((IOTA - iConst40) & 16383)] + (fTemp25 + (0.600000024f * fRec47[1])));
			...
			float fTemp34 = ((fTemp28 + fVec15[((IOTA - iConst61) & 16383)]) - (0.600000024f * fRec59[1]));
			...
			float fTemp35 = ((fVec17[((IOTA - iConst68) & 16383)] + fTemp28) - (0.600000024f * fRec63[1]));
			fVec18[(IOTA & 2047)] = fTemp35;
			fRec63[0] = fVec18[((IOTA - iConst69) & 2047)];
			float fRec64 = (0.600000024f * fTemp35);
			float fTemp36 = (fRec63[1] + fRec51[1]);
			float fTemp37 = (fRec47[1] + fTemp36);
			fRec0[0] = (fRec8[1] + (fRec39[1] + (fRec9 + (fRec44 + (fRec48 + (fRec52 + (fRec40 + (fRec56 + (fRec60 + (fRec64 + (fRec55[1] + (fRec59[1] + (fRec43[1] + fTemp37)))))))))))));
			float fTemp38 = (fRec51[1] + fRec47[1]);
			fRec1[0] = ((fRec39[1] + (fRec40 + (fRec56 + (fRec60 + (fRec64 + ((fRec63[1] + fRec59[1]) + fRec55[1])))))) - (fRec8[1] + (fRec9 + (fRec44 + (fRec48 + (fRec52 + (fTemp38 + fRec43[1])))))));
			fRec2[0] = ((fRec48 + (fRec52 + (fRec60 + (fRec64 + (fRec59[1] + fTemp37))))) - (fRec8[1] + (fRec39[1] + (fRec9 + (fRec44 + (fRec40 + (fRec56 + (fRec55[1] + fRec43[1]))))))));
			fRec3[0] = ((fRec8[1] + (fRec9 + (fRec44 + (fRec60 + (fRec64 + (fRec59[1] + (fRec63[1] + fRec43[1]))))))) - (fRec39[1] + (fRec48 + (fRec52 + (fRec40 + (fRec56 + (fRec55[1] + fTemp38)))))));
			fRec4[0] = ((fRec44 + (fRec52 + (fRec56 + (fRec64 + (fRec55[1] + (fRec43[1] + fTemp36)))))) - (fRec8[1] + (fRec39[1] + (fRec9 + (fRec48 + (fRec40 + (fRec60 + (fRec59[1] + fRec47[1]))))))));
			float fTemp39 = (fRec63[1] + fRec47[1]);
			fRec5[0] = ((fRec8[1] + (fRec9 + (fRec48 + (fRec56 + (fRec64 + (fRec55[1] + fTemp39)))))) - (fRec39[1] + (fRec44 + (fRec52 + (fRec40 + (fRec60 + (fRec59[1] + (fRec51[1] + fRec43[1]))))))));
			fRec6[0] = ((fRec8[1] + (fRec39[1] + (fRec9 + (fRec52 + (fRec40 + (fRec64 + fTemp36)))))) - (fRec44 + (fRec48 + (fRec56 + (fRec60 + (fRec55[1] + (fRec59[1] + (fRec47[1] + fRec43[1]))))))));
			fRec7[0] = ((fRec39[1] + (fRec44 + (fRec48 + (fRec40 + (fRec64 + (fRec43[1] + fTemp39)))))) - (fRec8[1] + (fRec9 + (fRec52 + (fRec56 + (fRec60 + (fRec55[1] + (fRec59[1] + fRec51[1]))))))));
			float fTemp40 = (1.0f - fRec12[0]);
			output0[i] = FAUSTFLOAT(((0.370000005f * (fRec1[0] + fRec2[0])) + (fSlow48 * (fTemp27 * fTemp40))));
			output1[i] = FAUSTFLOAT(((0.370000005f * (fRec1[0] - fRec2[0])) + (fSlow11 * (fTemp40 * fTemp24))));
			fRec11[1] = fRec11[0];
			fRec10[1] = fRec10[0];
			IOTA = (IOTA + 1);
			fRec12[1] = fRec12[0];
