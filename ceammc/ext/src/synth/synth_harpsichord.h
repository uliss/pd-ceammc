  ...
  public:
	...
	void fillsynth_harpsichordSIG0(int count, float* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iVec2[0] = 1;
			iRec16[0] = (iVec2[1] + iRec16[1]) % 65536;
...
class synth_harpsichord : public synth_harpsichord_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst16 = std::exp(-(0.2f / fConst0));
		fConst17 = 0.5f * (1.0f - fConst16);
		...
		fConst22 = std::floor(0.219991f * fConst0 + 0.5f);
		fConst23 = fConst22 / fConst0;
		fConst24 = 1.7269388f * fConst23;
		fConst25 = 1.1512926f * fConst23;
		fConst26 = std::floor(0.019123f * fConst0 + 0.5f);
		...
		fConst30 = std::floor(0.256891f * fConst0 + 0.5f);
		fConst31 = fConst30 / fConst0;
		fConst32 = 1.7269388f * fConst31;
		fConst33 = 1.1512926f * fConst31;
		fConst34 = std::floor(0.027333f * fConst0 + 0.5f);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = ((1 - iVec0[1]) ? 0.0f : fRec17[1] + fConst13 * (fSlow22 + fSlow23 * fRec18[0]));
			fRec17[0] = fTemp1 - std::floor(fTemp1);
			float fTemp2 = 3.1415927f * fRec15[0] * ftbl0synth_harpsichordSIG0[std::max<int>(0, std::min<int>(int(65536.0f * fRec17[0]), 65535))];
			...
			float fTemp20 = 0.030197384f * fTemp19 + float((fTemp18 >= 2.0f) | iSlow17) * std::exp(-(fSlow30 / fRec33[0]));
			fRec31[0] = fRec31[1] * fTemp20 + 0.15f * fTemp19 * (1.0f - fTemp20);
			iRec34[0] = 1103515245 * iRec34[1] + 12345;
			fVec3[IOTA0 & 8191] = fRec14[0] * (fSlow20 * (fTemp0 * fTemp3 + fRec19[1] * fTemp4) + fSlow25 * (fRec15[0] * (fTemp0 * fTemp11 + fRec25[1] * fTemp12) + (1.0f - fRec15[0]) * fTemp0)) + 4.656613e-10f * fRec31[0] * float(iRec34[0]);
			fRec13[0] = fVec3[(IOTA0 - iSlow32) & 8191] - (fSlow33 * fRec13[1] + fSlow34 * fRec13[2]);
			...
			fRec35[0] = fConst16 * fRec35[1] - fConst17 * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec36[0])) + -1e+02f, 0.0f);
			fRec12[IOTA0 & 8191] = fTemp21 * std::pow(1e+01f, 0.05f * fRec35[0]);
			float fTemp24 = fRec12[IOTA0 & 8191];
			fRec37[0] = fSlow37 + fConst12 * fRec37[1];
			fVec4[IOTA0 & 4095] = fSlow11 * fTemp24 * fRec37[0];
			float fTemp25 = 0.3f * fVec4[(IOTA0 - iConst20) & 4095];
			float fTemp26 = fVec1[(IOTA0 - iConst10) & 16383] + fTemp25 - 0.6f * fRec8[1];
			fVec5[IOTA0 & 2047] = fTemp26;
			fRec8[0] = fVec5[(IOTA0 - iConst21) & 2047];
			float fRec9 = 0.6f * fTemp26;
			fRec41[0] = -(fConst7 * (fConst8 * fRec41[1] - (fRec7[1] + fRec7[2])));
			fRec40[0] = fSlow44 * (fRec7[1] + fSlow45 * fRec41[0]) + fSlow46 * fRec40[1];
			fVec6[IOTA0 & 32767] = 0.35355338f * fRec40[0] + 1e-20f;
			float fTemp27 = 0.6f * fRec38[1] + fVec6[(IOTA0 - iConst27) & 32767];
			float fTemp28 = fRec12[(IOTA0 - iSlow48) & 8191];
			fVec7[IOTA0 & 4095] = fSlow47 * fRec37[0] * fTemp28;
			float fTemp29 = 0.3f * fVec7[(IOTA0 - iConst20) & 4095];
			fVec8[IOTA0 & 2047] = fTemp27 - fTemp29;
			fRec38[0] = fVec8[(IOTA0 - iConst29) & 2047];
			float fRec39 = 0.6f * (fTemp29 - fTemp27);
			fRec45[0] = -(fConst7 * (fConst8 * fRec45[1] - (fRec3[1] + fRec3[2])));
			fRec44[0] = fSlow55 * (fRec3[1] + fSlow56 * fRec45[0]) + fSlow57 * fRec44[1];
			fVec9[IOTA0 & 32767] = 0.35355338f * fRec44[0] + 1e-20f;
			float fTemp30 = 0.6f * fRec42[1] + fVec9[(IOTA0 - iConst35) & 32767];
			fVec10[IOTA0 & 4095] = fTemp30 - fTemp29;
			fRec42[0] = fVec10[(IOTA0 - iConst36) & 4095];
			float fRec43 = 0.6f * (fTemp29 - fTemp30);
			...
			float fTemp31 = 0.6f * fRec46[1] + fTemp29 + fVec11[(IOTA0 - iConst42) & 16383];
			...
			float fTemp32 = fTemp29 + 0.6f * fRec50[1] + fVec13[(IOTA0 - iConst49) & 32767];
			...
			float fTemp33 = fVec15[(IOTA0 - iConst56) & 16383] - (fTemp25 + 0.6f * fRec54[1]);
			...
			float fTemp34 = fVec17[(IOTA0 - iConst63) & 16383] - (fTemp25 + 0.6f * fRec58[1]);
			...
			float fTemp35 = fTemp25 + fVec19[(IOTA0 - iConst70) & 16383] - 0.6f * fRec62[1];
			fVec20[IOTA0 & 4095] = fTemp35;
			fRec62[0] = fVec20[(IOTA0 - iConst71) & 4095];
			float fRec63 = 0.6f * fTemp35;
			float fTemp36 = fRec8[1] + fRec62[1];
			float fTemp37 = fRec38[1] + fTemp36 + fRec42[1];
			fRec0[0] = fRec9 + fRec39 + fRec43 + fRec47 + fRec51 + fRec55 + fRec59 + fRec63 + fRec46[1] + fRec50[1] + fRec54[1] + fRec58[1] + fTemp37;
			float fTemp38 = fRec42[1] + fRec38[1];
			fRec1[0] = fRec9 + fRec55 + fRec59 + fRec63 + fRec54[1] + fTemp36 + fRec58[1] - (fRec39 + fRec43 + fRec47 + fRec51 + fRec46[1] + fRec50[1] + fTemp38);
			fRec2[0] = fRec9 + fRec47 + fRec51 + fRec63 + fRec46[1] + fTemp36 + fRec50[1] - (fRec39 + fRec43 + fRec55 + fRec59 + fRec54[1] + fRec58[1] + fTemp38);
			fRec3[0] = fRec9 + fRec39 + fRec43 + fRec63 + fTemp37 - (fRec47 + fRec51 + fRec55 + fRec59 + fRec46[1] + fRec58[1] + fRec54[1] + fRec50[1]);
			float fTemp39 = fRec8[1] + fRec42[1];
			float fTemp40 = fRec62[1] + fRec38[1];
			fRec4[0] = fRec9 + fRec43 + fRec51 + fRec59 + fRec50[1] + fRec58[1] + fTemp39 - (fRec39 + fRec47 + fRec55 + fRec63 + fRec46[1] + fRec54[1] + fTemp40);
			float fTemp41 = fRec8[1] + fRec38[1];
			float fTemp42 = fRec62[1] + fRec42[1];
			fRec5[0] = fRec9 + fRec39 + fRec47 + fRec59 + fRec46[1] + fRec58[1] + fTemp41 - (fRec43 + fRec51 + fRec55 + fRec63 + fRec50[1] + fRec54[1] + fTemp42);
			fRec6[0] = fRec9 + fRec39 + fRec51 + fRec55 + fRec50[1] + fRec54[1] + fTemp41 - (fRec43 + fRec47 + fRec59 + fRec63 + fRec46[1] + fRec58[1] + fTemp42);
			fRec7[0] = fRec9 + fRec43 + fRec47 + fRec55 + fRec46[1] + fRec54[1] + fTemp39 - (fRec39 + fRec51 + fRec59 + fRec63 + fRec50[1] + fRec58[1] + fTemp40);
			float fTemp43 = 1.0f - fRec37[0];
			output0[i0] = FAUSTFLOAT(0.37f * (fRec1[0] + fRec2[0]) + fSlow11 * fTemp24 * fTemp43);
			output1[i0] = FAUSTFLOAT(0.37f * (fRec1[0] - fRec2[0]) + fSlow47 * fTemp43 * fTemp28);
			iVec0[1] = iVec0[0];
			fRec11[1] = fRec11[0];
			fRec10[1] = fRec10[0];
			IOTA0 = IOTA0 + 1;
