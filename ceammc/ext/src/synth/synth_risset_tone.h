...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn synth_risset_tone -scn synth_risset_tone_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API synth_risset_tone_dsp {
    ...
    public:
        ...
        synth_risset_tone_dsp() = default;
        virtual ~synth_risset_tone_dsp() = default;
  ...
  public:
	...
	void fillsynth_risset_toneSIG1(int count, float* table) {
		for (int i2 = 0; i2 < count; i2 = i2 + 1) {
			iRec3[0] = iRec3[1] + 1;
			table[i2] = std::exp(4.8283f * (std::cos(9.58738e-05f * (static_cast<float>(iRec3[1]) + -32768.0f)) - 1.0f));
			iRec3[1] = iRec3[0];
		}
	}
...
class synth_risset_tone : public synth_risset_tone_dsp {
 ...
 public:
	...
	synth_risset_tone(const synth_risset_tone&) = default;
	
	virtual ~synth_risset_tone() = default;
	
	synth_risset_tone& operator=(const synth_risset_tone&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn synth_risset_tone -scn synth_risset_tone_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider2 = static_cast<FAUSTFLOAT>(0.01f);
	}
	...
	virtual synth_risset_tone* clone() {
		return new synth_risset_tone(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp16 = std::fmod(fRec2[0] + 0.3f, 1.0f);
			...
			float fTemp21 = std::fmod(fRec2[0] + 0.4f, 1.0f);
			...
			float fTemp26 = std::fmod(fRec2[0] + 0.5f, 1.0f);
			...
			float fTemp36 = std::fmod(fRec2[0] + 0.7f, 1.0f);
			...
			output0[i0] = static_cast<FAUSTFLOAT>(0.1f * (ftbl0synth_risset_toneSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec1[0]), 65535))] * (fTemp5 + (fTemp3 - std::floor(fTemp3)) * (ftbl1synth_risset_toneSIG1[std::max<int>(0, std::min<int>(iTemp4 + 1, 65536))] - fTemp5)) + ftbl0synth_risset_toneSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec4[0]), 65535))] * (fTemp10 + (fTemp8 - std::floor(fTemp8)) * (ftbl1synth_risset_toneSIG1[std::max<int>(0, std::min<int>(iTemp9 + 1, 65536))] - fTemp10)) + ftbl0synth_risset_toneSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec5[0]), 65535))] * (fTemp15 + (fTemp13 - std::floor(fTemp13)) * (ftbl1synth_risset_toneSIG1[std::max<int>(0, std::min<int>(iTemp14 + 1, 65536))] - fTemp15)) + ftbl0synth_risset_toneSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec6[0]), 65535))] * (fTemp20 + (fTemp18 - std::floor(fTemp18)) * (ftbl1synth_risset_toneSIG1[std::max<int>(0, std::min<int>(iTemp19 + 1, 65536))] - fTemp20)) + ftbl0synth_risset_toneSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec7[0]), 65535))] * (fTemp25 + (fTemp23 - std::floor(fTemp23)) * (ftbl1synth_risset_toneSIG1[std::max<int>(0, std::min<int>(iTemp24 + 1, 65536))] - fTemp25)) + ftbl0synth_risset_toneSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec8[0]), 65535))] * (fTemp30 + (fTemp28 - std::floor(fTemp28)) * (ftbl1synth_risset_toneSIG1[std::max<int>(0, std::min<int>(iTemp29 + 1, 65536))] - fTemp30)) + ftbl0synth_risset_toneSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec9[0]), 65535))] * (fTemp35 + (fTemp33 - std::floor(fTemp33)) * (ftbl1synth_risset_toneSIG1[std::max<int>(0, std::min<int>(iTemp34 + 1, 65536))] - fTemp35)) + ftbl0synth_risset_toneSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec10[0]), 65535))] * (fTemp40 + (fTemp38 - std::floor(fTemp38)) * (ftbl1synth_risset_toneSIG1[std::max<int>(0, std::min<int>(iTemp39 + 1, 65536))] - fTemp40)) + ftbl0synth_risset_toneSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec11[0]), 65535))] * (fTemp45 + (fTemp43 - std::floor(fTemp43)) * (ftbl1synth_risset_toneSIG1[std::max<int>(0, std::min<int>(iTemp44 + 1, 65536))] - fTemp45)) + ftbl0synth_risset_toneSIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec12[0]), 65535))] * (fTemp50 + (fTemp48 - std::floor(fTemp48)) * (ftbl1synth_risset_toneSIG1[std::max<int>(0, std::min<int>(iTemp49 + 1, 65536))] - fTemp50))));
			iVec1[1] = iVec1[0];
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
			fRec4[1] = fRec4[0];
