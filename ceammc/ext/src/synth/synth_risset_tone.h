 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp0 = std::fmod((fRec2[0] + 0.5f), 1.0f);
			...
			float fTemp5 = std::fmod((fRec2[0] + 0.400000006f), 1.0f);
			...
			float fTemp10 = std::fmod((fRec2[0] + 0.300000012f), 1.0f);
			...
			float fTemp15 = std::fmod((fRec2[0] + 0.200000003f), 1.0f);
