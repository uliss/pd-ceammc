...
class synth_dx7 : public synth_dx7_dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addNumEntry("op0:detune", &fEntry36, FAUSTFLOAT(1.0f), FAUSTFLOAT(-1e+01f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op0:egL1", &fEntry39, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op0:egL2", &fEntry41, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op0:egL3", &fEntry31, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op0:egL4", &fEntry33, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op0:egR1", &fEntry40, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op0:egR2", &fEntry42, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op0:egR3", &fEntry43, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op0:egR4", &fEntry34, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fEntry38, "unit", "Hz");
		ui_interface->addNumEntry("op0:freq", &fEntry38, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.01f));
		ui_interface->addNumEntry("op0:key_vel_sens", &fEntry32, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(8.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op0:level", &fEntry30, FAUSTFLOAT(95.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op0:mode", &fEntry37, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op0:rate_scale", &fEntry35, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:detune", &fEntry50, FAUSTFLOAT(1.0f), FAUSTFLOAT(-1e+01f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:egL1", &fEntry53, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:egL2", &fEntry55, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:egL3", &fEntry45, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:egL4", &fEntry47, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:egR1", &fEntry54, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:egR2", &fEntry56, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:egR3", &fEntry57, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:egR4", &fEntry48, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fEntry52, "unit", "Hz");
		ui_interface->addNumEntry("op1:freq", &fEntry52, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.01f));
		ui_interface->addNumEntry("op1:key_vel_sens", &fEntry46, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(8.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:level", &fEntry44, FAUSTFLOAT(95.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:mode", &fEntry51, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op1:rate_scale", &fEntry49, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:detune", &fEntry64, FAUSTFLOAT(1.0f), FAUSTFLOAT(-1e+01f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:egL1", &fEntry67, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:egL2", &fEntry69, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:egL3", &fEntry59, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:egL4", &fEntry61, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:egR1", &fEntry68, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:egR2", &fEntry70, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:egR3", &fEntry71, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:egR4", &fEntry62, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fEntry66, "unit", "Hz");
		ui_interface->addNumEntry("op2:freq", &fEntry66, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.01f));
		ui_interface->addNumEntry("op2:key_vel_sens", &fEntry60, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(8.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:level", &fEntry58, FAUSTFLOAT(95.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:mode", &fEntry65, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op2:rate_scale", &fEntry63, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addNumEntry("op4:detune", &fEntry7, FAUSTFLOAT(1.0f), FAUSTFLOAT(-1e+01f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op4:egL1", &fEntry10, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op4:egL2", &fEntry12, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op4:egL3", &fEntry2, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op4:egL4", &fEntry4, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op4:egR1", &fEntry11, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op4:egR2", &fEntry13, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op4:egR3", &fEntry14, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op4:egR4", &fEntry5, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->declare(&fEntry9, "unit", "Hz");
		ui_interface->addNumEntry("op4:freq", &fEntry9, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.01f));
		ui_interface->addNumEntry("op4:key_vel_sens", &fEntry3, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(8.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op4:level", &fEntry1, FAUSTFLOAT(95.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op4:mode", &fEntry8, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op4:rate_scale", &fEntry6, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:detune", &fEntry21, FAUSTFLOAT(1.0f), FAUSTFLOAT(-1e+01f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:egL1", &fEntry24, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:egL2", &fEntry26, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:egL3", &fEntry16, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:egL4", &fEntry18, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:egR1", &fEntry25, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:egR2", &fEntry27, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:egR3", &fEntry28, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:egR4", &fEntry19, FAUSTFLOAT(9e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addNumEntry("op5:key_vel_sens", &fEntry17, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(8.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:level", &fEntry15, FAUSTFLOAT(95.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(99.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:mode", &fEntry22, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
		ui_interface->addNumEntry("op5:rate_scale", &fEntry20, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		int iSlow1 = float(iSlow0 == 5) != 0.0f;
		int iSlow2 = float(iSlow0 == 4) != 0.0f;
		int iSlow3 = float(iSlow0 == 1) != 0.0f;
		int iSlow4 = float(iSlow0 == 3) != 0.0f;
		int iSlow5 = float(iSlow0 == 2) != 0.0f;
		int iSlow6 = float(iSlow0 == 0) != 0.0f;
		int iSlow7 = float(iSlow0 == 15) != 0.0f;
		int iSlow8 = float(iSlow0 == 14) != 0.0f;
		int iSlow9 = float(iSlow0 == 13) != 0.0f;
		int iSlow10 = float(iSlow0 == 9) != 0.0f;
		int iSlow11 = float(iSlow0 == 7) != 0.0f;
		int iSlow12 = float(iSlow0 == 10) != 0.0f;
		int iSlow13 = float(iSlow0 == 11) != 0.0f;
		int iSlow14 = float(iSlow0 == 12) != 0.0f;
		int iSlow15 = float(iSlow0 == 8) != 0.0f;
		int iSlow16 = float(iSlow0 == 6) != 0.0f;
		...
		float fSlow72 = 0.0012626263f * fSlow22 * fSlow71 + 0.01010101f * (1.0f - 0.125f * fSlow71);
		...
		float fSlow78 = 0.25f * float(fEntry21) + ((int(float(fEntry22))) ? fSlow77 : 4.4e+02f * fSlow29 * fSlow77);
		...
		float fSlow110 = fConst1 * (fSlow87 - fSlow94);
		float fSlow111 = fSlow93 - fSlow100;
		float fSlow112 = fConst1 * (fSlow87 - fSlow74);
		...
		float fSlow115 = 9126.581f * fSlow114;
		...
		float fSlow154 = fConst1 * (fSlow141 - fSlow117);
		float fSlow155 = fSlow147 - fSlow150;
		float fSlow156 = fConst0 * fSlow140;
		int iTemp11 = iTempPerm11;
		float fSlow157 = fConst1 * (fSlow134 - fSlow141);
		float fSlow158 = fSlow140 - fSlow147;
		float fSlow159 = fConst1 * (fSlow134 - fSlow121);
		...
		float fSlow164 = 0.0012626263f * fSlow163 * fSlow22 + 0.01010101f * (1.0f - 0.125f * fSlow163);
		...
		float fSlow170 = 0.25f * float(fEntry50) + ((int(float(fEntry51))) ? fSlow169 : 4.4e+02f * fSlow169 * fSlow29);
		...
		float fSlow199 = fConst1 * (fSlow162 - fSlow186);
		float fSlow200 = fSlow195 - fSlow192;
		float fSlow201 = fConst0 * fSlow185;
		int iTemp15 = iTempPerm15;
		float fSlow202 = fConst1 * (fSlow179 - fSlow186);
		float fSlow203 = fSlow185 - fSlow192;
		float fSlow204 = fConst1 * (fSlow166 - fSlow179);
		...
		float fSlow244 = fConst1 * (fSlow231 - fSlow207);
		float fSlow245 = fSlow237 - fSlow240;
		float fSlow246 = fConst0 * fSlow230;
		int iTemp22 = iTempPerm22;
		float fSlow247 = fConst1 * (fSlow224 - fSlow231);
		float fSlow248 = fSlow230 - fSlow237;
		float fSlow249 = fConst1 * (fSlow224 - fSlow211);
		...
		float fSlow289 = fConst1 * (fSlow252 - fSlow276);
		float fSlow290 = fSlow282 - fSlow285;
		float fSlow291 = fConst0 * fSlow275;
		int iTemp26 = iTempPerm26;
		float fSlow292 = fConst1 * (fSlow269 - fSlow276);
		float fSlow293 = fSlow275 - fSlow282;
		float fSlow294 = fConst1 * (fSlow256 - fSlow269);
		...
		float fSlow297 = 1825.3162f * fSlow114;
		...
		float fSlow298 = 3650.6323f * fSlow114;
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			if (iSlow1 | (iSlow2 | (iSlow3 | (iSlow4 | (iSlow5 | (iSlow6 | (iSlow7 | (iSlow8 | (iSlow9 | (iSlow10 | (iSlow11 | (iSlow12 | (iSlow13 | (iSlow14 | (iSlow15 | iSlow16))))))))))))))) {
				fRec1[0] = ((iSlow19) ? 0.0f : std::min<float>(fSlow39, fRec1[1] + 1.0f));
				fRec3[0] = ((iSlow41) ? 0.0f : std::min<float>(fSlow59, fRec3[1] + 1.0f));
				iTemp0 = fRec3[0] < fSlow60;
				iTemp1 = fRec3[0] < fSlow64;
				fRec2[0] = ((iSlow18) ? fSlow40 * ((iTemp0) ? ((iTemp1) ? ((fRec3[0] < 0.0f) ? fSlow27 : ((iTemp1) ? fSlow61 * (fSlow26 - fSlow67 * (fRec3[0] / fSlow48)) : fSlow43)) : ((iTemp0) ? fSlow61 * (fSlow42 - fSlow65 * ((fRec3[0] - fSlow64) / fSlow66)) : fSlow50)) : ((fRec3[0] < fSlow59) ? fSlow61 * (fSlow49 - fSlow62 * ((fRec3[0] - fSlow60) / fSlow63)) : fSlow25)) : fRec2[1]);
				fTemp2 = synth_dx7_faustpower8_f(0.010204081f * std::min<float>(98.0f, ((fRec1[0] < 0.0f) ? fRec2[0] : ((fRec1[0] < fSlow39) ? fRec2[0] + fConst1 * (fRec1[0] * (fSlow27 - fRec2[0]) / fSlow38) : fSlow27))));
				iTemp3 = 1 - iVec0[1];
				fTemp4 = ((iTemp3) ? 0.0f : fRec5[1] + fSlow68);
				...
				iTemp5 = fRec8[0] < fSlow105;
				iTemp6 = fRec8[0] < fSlow109;
				fRec7[0] = ((iSlow18) ? fSlow40 * ((iTemp5) ? ((iTemp6) ? ((fRec8[0] < 0.0f) ? fSlow75 : ((iTemp6) ? fSlow106 * (fSlow74 + fSlow112 * (fRec8[0] / fSlow93)) : fSlow88)) : ((iTemp5) ? fSlow106 * (fSlow87 + fSlow110 * ((fRec8[0] - fSlow109) / fSlow111)) : fSlow95)) : ((fRec8[0] < fSlow104) ? fSlow106 * (fSlow94 + fSlow107 * ((fRec8[0] - fSlow105) / fSlow108)) : fSlow73)) : fRec7[1]);
				fTemp7 = synth_dx7_faustpower8_f(0.010204081f * std::min<float>(98.0f, ((fRec6[0] < 0.0f) ? fRec7[0] : ((fRec6[0] < fSlow86) ? fRec7[0] + fConst1 * (fRec6[0] * (fSlow75 - fRec7[0]) / fSlow85) : fSlow75))));
				fTemp8 = ((iTemp3) ? 0.0f : fRec9[1] + fSlow113);
				fRec9[0] = fTemp8 - std::floor(fTemp8);
				fTemp9 = 65536.0f * fRec9[0];
			}
			if (iSlow1) {
				fRec0[0] = 2.08795f * fTemp2 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec5[0] + fTemp7 * ftbl0synth_dx7SIG0[(int(fTemp9 + fSlow115 * fRec0[1]) % 65536 + 65536) % 65536])) % 65536 + 65536) % 65536];
			}
			if (iSlow1 | (iSlow2 | (iSlow3 | (iSlow4 | (iSlow5 | (iSlow6 | (iSlow7 | (iSlow8 | (iSlow9 | (iSlow10 | (iSlow11 | (iSlow12 | (iSlow13 | (iSlow14 | (iSlow15 | iSlow16))))))))))))))) {
				...
				fRec11[0] = ((iSlow18) ? fSlow40 * ((iTemp10) ? ((iTemp11) ? ((fRec12[0] < 0.0f) ? fSlow122 : ((iTemp11) ? fSlow153 * (fSlow121 + fSlow159 * (fRec12[0] / fSlow140)) : fSlow135)) : ((iTemp10) ? fSlow153 * (fSlow134 + fSlow157 * ((fRec12[0] - fSlow156) / fSlow158)) : fSlow142)) : ((fRec12[0] < fSlow151) ? fSlow153 * (fSlow141 + fSlow154 * ((fRec12[0] - fSlow152) / fSlow155)) : fSlow120)) : fRec11[1]);
				...
				fTemp13 = ((iTemp3) ? 0.0f : fRec13[1] + fSlow160);
				...
				fRec15[0] = ((iSlow18) ? fSlow40 * ((iTemp14) ? ((iTemp15) ? ((fRec16[0] < 0.0f) ? fSlow167 : ((iTemp15) ? fSlow198 * (fSlow166 - fSlow204 * (fRec16[0] / fSlow185)) : fSlow180)) : ((iTemp14) ? fSlow198 * (fSlow179 + fSlow202 * ((fRec16[0] - fSlow201) / fSlow203)) : fSlow187)) : ((fRec16[0] < fSlow196) ? fSlow198 * (fSlow186 + fSlow199 * ((fRec16[0] - fSlow197) / fSlow200)) : fSlow165)) : fRec15[1]);
				...
				fTemp17 = ((iTemp3) ? 0.0f : fRec17[1] + fSlow205);
				fRec17[0] = fTemp17 - std::floor(fTemp17);
			}
			if (iSlow1 | (iSlow2 | (iSlow3 | (iSlow6 | (iSlow7 | (iSlow8 | (iSlow9 | (iSlow11 | (iSlow13 | (iSlow14 | (iSlow15 | iSlow16))))))))))) {
				fTemp18 = 65536.0f * fRec17[0];
			}
			if (iSlow1 | (iSlow2 | (iSlow6 | (iSlow7 | (iSlow9 | (iSlow11 | (iSlow14 | iSlow16))))))) {
				fTemp19 = fRec13[0] + fTemp16 * ftbl0synth_dx7SIG0[(int(fTemp18) % 65536 + 65536) % 65536];
			}
			if (iSlow1 | (iSlow2 | (iSlow6 | (iSlow9 | (iSlow11 | (iSlow14 | iSlow16)))))) {
				fTemp20 = fTemp12 * ftbl0synth_dx7SIG0[(int(65536.0f * fTemp19) % 65536 + 65536) % 65536];
			}
			if (iSlow1 | (iSlow2 | (iSlow3 | (iSlow4 | (iSlow5 | (iSlow6 | (iSlow7 | (iSlow8 | (iSlow9 | (iSlow10 | (iSlow11 | (iSlow12 | (iSlow13 | (iSlow14 | (iSlow15 | iSlow16))))))))))))))) {
				fRec18[0] = ((iSlow19) ? 0.0f : std::min<float>(fSlow223, fRec18[1] + 1.0f));
				fRec20[0] = ((iSlow41) ? 0.0f : std::min<float>(fSlow241, fRec20[1] + 1.0f));
				iTemp21 = fRec20[0] < fSlow242;
				iTemp22 = fRec20[0] < fSlow246;
				fRec19[0] = ((iSlow18) ? fSlow40 * ((iTemp21) ? ((iTemp22) ? ((fRec20[0] < 0.0f) ? fSlow212 : ((iTemp22) ? fSlow243 * (fSlow211 + fSlow249 * (fRec20[0] / fSlow230)) : fSlow225)) : ((iTemp21) ? fSlow243 * (fSlow224 + fSlow247 * ((fRec20[0] - fSlow246) / fSlow248)) : fSlow232)) : ((fRec20[0] < fSlow241) ? fSlow243 * (fSlow231 + fSlow244 * ((fRec20[0] - fSlow242) / fSlow245)) : fSlow210)) : fRec19[1]);
				fTemp23 = synth_dx7_faustpower8_f(0.010204081f * std::min<float>(98.0f, ((fRec18[0] < 0.0f) ? fRec19[0] : ((fRec18[0] < fSlow223) ? fRec19[0] + fConst1 * (fRec18[0] * (fSlow212 - fRec19[0]) / fSlow222) : fSlow212))));
				fTemp24 = ((iTemp3) ? 0.0f : fRec21[1] + fSlow250);
				...
				fRec23[0] = ((iSlow18) ? fSlow40 * ((iTemp25) ? ((iTemp26) ? ((fRec24[0] < 0.0f) ? fSlow257 : ((iTemp26) ? fSlow288 * (fSlow256 - fSlow294 * (fRec24[0] / fSlow275)) : fSlow270)) : ((iTemp25) ? fSlow288 * (fSlow269 + fSlow292 * ((fRec24[0] - fSlow291) / fSlow293)) : fSlow277)) : ((fRec24[0] < fSlow286) ? -(fSlow288 * (fSlow289 * ((fRec24[0] - fSlow287) / fSlow290) - fSlow276)) : fSlow255)) : fRec23[1]);
				...
				fTemp28 = ((iTemp3) ? 0.0f : fRec25[1] + fSlow295);
				fRec25[0] = fTemp28 - std::floor(fTemp28);
			}
			if (iSlow1 | (iSlow2 | (iSlow7 | (iSlow11 | (iSlow13 | (iSlow14 | (iSlow15 | iSlow16))))))) {
				fTemp29 = 65536.0f * fRec25[0];
			}
			if (iSlow1 | (iSlow2 | (iSlow7 | (iSlow13 | (iSlow14 | (iSlow15 | iSlow16)))))) {
				fTemp30 = fTemp27 * ftbl0synth_dx7SIG0[(int(fTemp29) % 65536 + 65536) % 65536];
			}
			if (iSlow1 | (iSlow2 | (iSlow7 | (iSlow13 | iSlow15)))) {
				fTemp31 = fRec21[0] + fTemp30;
			}
			if (iSlow1 | (iSlow2 | iSlow7)) {
				fTemp32 = fTemp23 * ftbl0synth_dx7SIG0[(int(65536.0f * fTemp31) % 65536 + 65536) % 65536];
			}
			if (iSlow1 | iSlow2) {
				fTemp33 = fTemp20 + fTemp32;
			}
			if (iSlow1) {
				fTemp34 = fRec0[0] + 2.08795f * fTemp33;
			}
			if (iSlow2) {
				fRec26[0] = fTemp7 * ftbl0synth_dx7SIG0[(int(fTemp9 + fSlow296 * fRec26[1]) % 65536 + 65536) % 65536];
				fTemp35 = 2.08795f * (fTemp33 + fTemp2 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec5[0] + fRec26[0])) % 65536 + 65536) % 65536]);
			}
			if (iSlow3 | iSlow13) {
				fRec27[0] = fTemp16 * ftbl0synth_dx7SIG0[(int(fTemp18 + fSlow297 * fRec27[1]) % 65536 + 65536) % 65536];
				fTemp36 = fTemp12 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec13[0] + fRec27[0])) % 65536 + 65536) % 65536];
			}
			if (iSlow3 | (iSlow8 | (iSlow10 | (iSlow11 | (iSlow13 | iSlow15))))) {
				fTemp37 = fTemp7 * ftbl0synth_dx7SIG0[(int(fTemp9) % 65536 + 65536) % 65536];
			}
			if (iSlow3 | (iSlow11 | iSlow15)) {
				fTemp38 = fTemp2 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec5[0] + fTemp37)) % 65536 + 65536) % 65536];
			}
			if (iSlow3) {
				fTemp39 = 2.08795f * (fTemp36 + fTemp23 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec21[0] + fTemp27 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec25[0] + fTemp38)) % 65536 + 65536) % 65536])) % 65536 + 65536) % 65536]);
			}
			if (iSlow4) {
				fRec28[0] = 2.08795f * fTemp27 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec25[0] + fTemp2 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec5[0] + fTemp7 * ftbl0synth_dx7SIG0[(int(fTemp9 + fSlow115 * fRec28[1]) % 65536 + 65536) % 65536])) % 65536 + 65536) % 65536])) % 65536 + 65536) % 65536];
			}
			if (iSlow4 | (iSlow5 | (iSlow10 | iSlow12))) {
				fTemp40 = 65536.0f * fRec21[0];
			}
			if (iSlow4 | (iSlow5 | iSlow12)) {
				fTemp41 = fTemp12 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec13[0] + fTemp16 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec17[0] + fTemp23 * ftbl0synth_dx7SIG0[(int(fTemp40) % 65536 + 65536) % 65536])) % 65536 + 65536) % 65536])) % 65536 + 65536) % 65536];
			}
			if (iSlow4) {
				fTemp42 = fRec28[0] + 2.08795f * fTemp41;
			}
			if (iSlow5 | (iSlow7 | (iSlow9 | (iSlow14 | iSlow16)))) {
				fRec29[0] = fTemp7 * ftbl0synth_dx7SIG0[(int(fTemp9 + fSlow115 * fRec29[1]) % 65536 + 65536) % 65536];
			}
			if (iSlow5 | (iSlow7 | iSlow16)) {
				fTemp43 = fTemp2 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec5[0] + fRec29[0])) % 65536 + 65536) % 65536];
			}
			if (iSlow5) {
				fTemp44 = 2.08795f * (fTemp41 + fTemp27 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec25[0] + fTemp43)) % 65536 + 65536) % 65536]);
			}
			if (iSlow6 | iSlow12) {
				fRec30[0] = fTemp7 * ftbl0synth_dx7SIG0[(int(fTemp9 + fSlow297 * fRec30[1]) % 65536 + 65536) % 65536];
			}
			if (iSlow6) {
				fTemp45 = 2.08795f * (fTemp20 + fTemp23 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec21[0] + fTemp27 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec25[0] + fTemp2 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec5[0] + fRec30[0])) % 65536 + 65536) % 65536])) % 65536 + 65536) % 65536])) % 65536 + 65536) % 65536]);
			}
			if (iSlow7) {
				fTemp46 = 2.08795f * fTemp12 * ftbl0synth_dx7SIG0[(int(65536.0f * (fTemp32 + fTemp19 + fTemp43)) % 65536 + 65536) % 65536];
			}
			if (iSlow8 | iSlow15) {
				fRec31[0] = fTemp16 * ftbl0synth_dx7SIG0[(int(fTemp18 + fSlow298 * fRec31[1]) % 65536 + 65536) % 65536];
				fTemp47 = fTemp12 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec13[0] + fRec31[0])) % 65536 + 65536) % 65536];
			}
			if (iSlow8 | (iSlow9 | (iSlow10 | (iSlow12 | (iSlow13 | iSlow14))))) {
				fTemp48 = fTemp2 * ftbl0synth_dx7SIG0[(int(65536.0f * fRec5[0]) % 65536 + 65536) % 65536];
			}
			if (iSlow8 | iSlow10) {
				fTemp49 = fTemp27 * ftbl0synth_dx7SIG0[(int(65536.0f * (fTemp48 + fRec25[0] + fTemp37)) % 65536 + 65536) % 65536];
			}
			if (iSlow8) {
				fTemp50 = 2.08795f * (fTemp47 + fTemp23 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec21[0] + fTemp49)) % 65536 + 65536) % 65536]);
			}
			if (iSlow9) {
				fTemp51 = 2.08795f * (fTemp20 + fTemp23 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec21[0] + fTemp27 * ftbl0synth_dx7SIG0[(int(65536.0f * (fTemp48 + fRec25[0] + fRec29[0])) % 65536 + 65536) % 65536])) % 65536 + 65536) % 65536]);
			}
			if (iSlow12) {
				fTemp52 = 2.08795f * (fTemp41 + fTemp27 * ftbl0synth_dx7SIG0[(int(65536.0f * (fTemp48 + fRec25[0] + fRec30[0])) % 65536 + 65536) % 65536]);
			}
			if (iSlow13) {
				fTemp53 = 2.08795f * (fTemp36 + fTemp23 * ftbl0synth_dx7SIG0[(int(65536.0f * (fTemp48 + fTemp37 + fTemp31)) % 65536 + 65536) % 65536]);
			}
			if (iSlow14) {
				fTemp54 = 2.08795f * (fTemp20 + fTemp23 * ftbl0synth_dx7SIG0[(int(65536.0f * (fTemp48 + fTemp30 + fRec21[0] + fRec29[0])) % 65536 + 65536) % 65536]);
			}
			if (iSlow15) {
				fTemp55 = 2.08795f * (fTemp47 + fTemp23 * ftbl0synth_dx7SIG0[(int(65536.0f * (fTemp38 + fTemp31)) % 65536 + 65536) % 65536]);
			}
			if (iSlow10) {
				fRec32[0] = fTemp23 * ftbl0synth_dx7SIG0[(int(fTemp40 + fSlow297 * fRec32[1]) % 65536 + 65536) % 65536];
				fTemp56 = 2.08795f * (fTemp12 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec13[0] + fTemp16 * ftbl0synth_dx7SIG0[(int(65536.0f * (fRec17[0] + fRec32[0])) % 65536 + 65536) % 65536])) % 65536 + 65536) % 65536] + fTemp49);
			}
			if (iSlow11) {
				fRec33[0] = fTemp27 * ftbl0synth_dx7SIG0[(int(fTemp29 + fSlow296 * fRec33[1]) % 65536 + 65536) % 65536];
				fTemp57 = 2.08795f * (fTemp20 + fTemp23 * ftbl0synth_dx7SIG0[(int(65536.0f * (fTemp38 + fRec21[0] + fRec33[0])) % 65536 + 65536) % 65536]);
			}
			if (iSlow16) {
				fTemp58 = 2.08795f * (fTemp20 + fTemp23 * ftbl0synth_dx7SIG0[(int(65536.0f * (fTemp30 + fRec21[0] + fTemp43)) % 65536 + 65536) % 65536]);
			}
			output0[i0] = FAUSTFLOAT(fTemp34 + fTemp35 + fTemp39 + fTemp42 + fTemp44 + fTemp45 + fTemp46 + fTemp50 + fTemp51 + fTemp52 + fTemp53 + fTemp54 + fTemp55 + fTemp56 + fTemp57 + fTemp58);
			iVec0[1] = iVec0[0];
			if (iSlow1 | (iSlow2 | (iSlow3 | (iSlow4 | (iSlow5 | (iSlow6 | (iSlow7 | (iSlow8 | (iSlow9 | (iSlow10 | (iSlow11 | (iSlow12 | (iSlow13 | (iSlow14 | (iSlow15 | iSlow16))))))))))))))) {
				fRec1[1] = fRec1[0];
				fRec3[1] = fRec3[0];
