...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -ct 1 -cn synth_metro -scn synth_metro_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class synth_metro : public synth_metro_dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = std::tan(fConst3 * float(fHslider3));
		...
		float fSlow11 = std::tan(fConst3 * float(fHslider6));
		...
		float fSlow20 = std::tan(fConst3 * float(fHslider9));
		...
		float fSlow29 = std::tan(fConst3 * float(fHslider12));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec2[0] = fTemp0 * float(fTemp0 > 0.0f) - fSlow7 * (fSlow8 * fRec2[2] + fSlow9 * fRec2[1]);
			float fTemp1 = 2.0f * fRec2[1];
			fVec1[0] = fSlow15;
			float fTemp2 = fSlow15 - fVec1[1];
			fRec3[0] = fTemp2 * float(fTemp2 > 0.0f) - fSlow16 * (fSlow17 * fRec3[2] + fSlow18 * fRec3[1]);
			float fTemp3 = 2.0f * fRec3[1];
			fVec2[0] = fSlow24;
			float fTemp4 = fSlow24 - fVec2[1];
			fRec4[0] = fTemp4 * float(fTemp4 > 0.0f) - fSlow25 * (fSlow26 * fRec4[2] + fSlow27 * fRec4[1]);
			float fTemp5 = 2.0f * fRec4[1];
			fVec3[0] = fSlow33;
			float fTemp6 = fSlow33 - fVec3[1];
			fRec5[0] = fTemp6 * float(fTemp6 > 0.0f) - fSlow34 * (fSlow35 * fRec5[2] + fSlow36 * fRec5[1]);
			float fTemp7 = 2.0f * fRec5[1];
			float fTemp8 = std::fabs(fSlow0 * (fSlow5 * (fRec2[2] + fRec2[0] + fTemp1) + fSlow14 * (fRec3[2] + fRec3[0] + fTemp3) + fSlow23 * (fRec4[2] + fRec4[0] + fTemp5) + fSlow32 * (fRec5[2] + fRec5[0] + fTemp7)));
