...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn synth_metro -scn synth_metro_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API synth_metro_dsp {
    ...
    public:
        ...
        synth_metro_dsp() = default;
        virtual ~synth_metro_dsp() = default;
...
class synth_metro : public synth_metro_dsp {
 ...
 public:
	...
	synth_metro(const synth_metro&) = default;
	
	virtual ~synth_metro() = default;
	
	synth_metro& operator=(const synth_metro&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn synth_metro -scn synth_metro_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst2 = std::exp(-(2.5e+03f / fConst0));
		fConst3 = 0.75f * (1.0f - fConst2);
		fConst4 = std::exp(-(2.0f / fConst0));
		fConst5 = std::exp(-(1.25e+03f / fConst0));
	}
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider3 = static_cast<FAUSTFLOAT>(1.5e+03f);
		fButton0 = static_cast<FAUSTFLOAT>(0.0f);
		fHslider4 = static_cast<FAUSTFLOAT>(6.0f);
		fHslider5 = static_cast<FAUSTFLOAT>(3e+01f);
		fHslider6 = static_cast<FAUSTFLOAT>(1e+03f);
		fButton1 = static_cast<FAUSTFLOAT>(0.0f);
		fHslider7 = static_cast<FAUSTFLOAT>(6.0f);
		fHslider8 = static_cast<FAUSTFLOAT>(1e+01f);
		fHslider9 = static_cast<FAUSTFLOAT>(5e+02f);
		fButton2 = static_cast<FAUSTFLOAT>(0.0f);
		fHslider10 = static_cast<FAUSTFLOAT>(6.0f);
		fHslider11 = static_cast<FAUSTFLOAT>(5e+02f);
		fHslider12 = static_cast<FAUSTFLOAT>(2e+03f);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = 1.0f / static_cast<float>(fHslider2);
		float fSlow2 = std::tan(fConst1 * static_cast<float>(fHslider3));
		float fSlow3 = 1.0f / fSlow2;
		float fSlow4 = (fSlow1 + fSlow3) / fSlow2 + 1.0f;
		float fSlow5 = std::pow(1e+01f, 0.05f * static_cast<float>(fHslider1)) / fSlow4;
		...
		float fSlow10 = 1.0f / static_cast<float>(fHslider5);
		float fSlow11 = std::tan(fConst1 * static_cast<float>(fHslider6));
		float fSlow12 = 1.0f / fSlow11;
		float fSlow13 = (fSlow10 + fSlow12) / fSlow11 + 1.0f;
		float fSlow14 = std::pow(1e+01f, 0.05f * static_cast<float>(fHslider4)) / fSlow13;
		float fSlow15 = static_cast<float>(fButton1);
		...
		float fSlow19 = 1.0f / static_cast<float>(fHslider8);
		float fSlow20 = std::tan(fConst1 * static_cast<float>(fHslider9));
		float fSlow21 = 1.0f / fSlow20;
		float fSlow22 = (fSlow19 + fSlow21) / fSlow20 + 1.0f;
		float fSlow23 = std::pow(1e+01f, 0.05f * static_cast<float>(fHslider7)) / fSlow22;
		float fSlow24 = static_cast<float>(fButton2);
		...
		float fSlow28 = 1.0f / static_cast<float>(fHslider11);
		float fSlow29 = std::tan(fConst1 * static_cast<float>(fHslider12));
		float fSlow30 = 1.0f / fSlow29;
		float fSlow31 = (fSlow28 + fSlow30) / fSlow29 + 1.0f;
		float fSlow32 = std::pow(1e+01f, 0.05f * static_cast<float>(fHslider10)) / fSlow31;
		float fSlow33 = static_cast<float>(fButton3);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec0[0] = fTemp0 * static_cast<float>(fTemp0 > 0.0f) - fSlow7 * (fSlow8 * fRec0[2] + fSlow9 * fRec0[1]);
			fVec1[0] = fSlow15;
			float fTemp1 = fSlow15 - fVec1[1];
			fRec1[0] = fTemp1 * static_cast<float>(fTemp1 > 0.0f) - fSlow16 * (fSlow17 * fRec1[2] + fSlow18 * fRec1[1]);
			fVec2[0] = fSlow24;
			float fTemp2 = fSlow24 - fVec2[1];
			fRec2[0] = fTemp2 * static_cast<float>(fTemp2 > 0.0f) - fSlow25 * (fSlow26 * fRec2[2] + fSlow27 * fRec2[1]);
			fVec3[0] = fSlow33;
			float fTemp3 = fSlow33 - fVec3[1];
			fRec3[0] = fTemp3 * static_cast<float>(fTemp3 > 0.0f) - fSlow34 * (fSlow35 * fRec3[2] + fSlow36 * fRec3[1]);
			...
			fRec4[0] = fConst2 * fRec4[1] - fConst3 * std::max<float>(2e+01f * std::log10(std::max<float>(1.1754944e-38f, fRec5[0])) + 6.0f, 0.0f);
			output0[i0] = static_cast<FAUSTFLOAT>(fSlow0 * fTemp4 * std::pow(1e+01f, 0.05f * fRec4[0]));
			fVec0[1] = fVec0[0];
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
			fVec1[1] = fVec1[0];
