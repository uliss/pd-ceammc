...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -cn synth_english_bell -scn synth_english_bell_dsp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class synth_english_bell : public synth_english_bell_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -cn synth_english_bell -scn synth_english_bell_dsp -es 1 -mcd 16 -single -ftz 0");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst11 = std::cos(11476.929f / fConst0);
		fConst12 = 1.0f / fConst0;
		fConst13 = std::cos(10665.519f / fConst0);
		fConst14 = std::cos(9908.27f / fConst0);
		fConst15 = std::cos(9839.154f / fConst0);
		fConst16 = std::cos(9721.784f / fConst0);
		fConst17 = std::cos(9547.614f / fConst0);
		fConst18 = std::cos(9318.215f / fConst0);
		fConst19 = std::cos(9316.77f / fConst0);
		fConst20 = std::cos(9177.849f / fConst0);
		fConst21 = std::cos(9168.612f / fConst0);
		fConst22 = std::cos(9157.429f / fConst0);
		fConst23 = std::cos(9134.307f / fConst0);
		fConst24 = std::cos(9131.855f / fConst0);
		fConst25 = std::cos(9127.144f / fConst0);
		fConst26 = std::cos(8426.694f / fConst0);
		fConst27 = std::cos(8420.788f / fConst0);
		fConst28 = std::cos(7767.7764f / fConst0);
		fConst29 = std::cos(7616.54f / fConst0);
		fConst30 = std::cos(7612.6445f / fConst0);
		fConst31 = std::cos(6502.2173f / fConst0);
		fConst32 = std::cos(6435.4897f / fConst0);
		fConst33 = std::cos(5986.506f / fConst0);
		fConst34 = std::cos(5950.8613f / fConst0);
		fConst35 = std::cos(5947.242f / fConst0);
		fConst36 = std::cos(5927.7393f / fConst0);
		fConst37 = std::cos(5861.244f / fConst0);
		fConst38 = std::cos(5855.2563f / fConst0);
		fConst39 = std::cos(4944.7725f / fConst0);
		fConst40 = std::cos(4553.908f / fConst0);
		fConst41 = std::cos(4552.5825f / fConst0);
		fConst42 = std::cos(3799.706f / fConst0);
		fConst43 = std::cos(3789.0623f / fConst0);
		fConst44 = std::cos(3106.8591f / fConst0);
		fConst45 = std::cos(3099.6902f / fConst0);
		fConst46 = std::cos(1645.2834f / fConst0);
		fConst47 = std::cos(1630.0405f / fConst0);
		fConst48 = std::cos(11891.306f / fConst0);
		fConst49 = std::cos(11913.484f / fConst0);
		fConst50 = std::cos(11937.173f / fConst0);
		fConst51 = std::cos(11990.14f / fConst0);
		fConst52 = std::cos(12591.189f / fConst0);
		fConst53 = std::cos(12598.227f / fConst0);
		fConst54 = std::cos(12603.379f / fConst0);
		fConst55 = std::cos(12604.007f / fConst0);
		fConst56 = std::cos(12989.983f / fConst0);
		fConst57 = std::cos(13084.23f / fConst0);
		fConst58 = std::cos(13111.813f / fConst0);
		fConst59 = std::cos(13323.871f / fConst0);
		fConst60 = std::cos(13381.865f / fConst0);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow12 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.85473835f * fSlow10, fSlow11)));
		...
		float fSlow16 = ftbl0synth_english_bellSIG0[iSlow15 + 35];
		float fSlow17 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.79430896f * fSlow10, fSlow11)));
		float fSlow18 = fConst13 * (0.0f - 2.0f * fSlow17);
		float fSlow19 = synth_english_bell_faustpower2_f(fSlow17);
		float fSlow20 = ftbl0synth_english_bellSIG0[iSlow15 + 34];
		float fSlow21 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.7379132f * fSlow10, fSlow11)));
		float fSlow22 = fConst14 * (0.0f - 2.0f * fSlow21);
		float fSlow23 = synth_english_bell_faustpower2_f(fSlow21);
		float fSlow24 = ftbl0synth_english_bellSIG0[iSlow15 + 33];
		float fSlow25 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.73276585f * fSlow10, fSlow11)));
		float fSlow26 = fConst15 * (0.0f - 2.0f * fSlow25);
		float fSlow27 = synth_english_bell_faustpower2_f(fSlow25);
		float fSlow28 = ftbl0synth_english_bellSIG0[iSlow15 + 32];
		float fSlow29 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.72402483f * fSlow10, fSlow11)));
		float fSlow30 = fConst16 * (0.0f - 2.0f * fSlow29);
		float fSlow31 = synth_english_bell_faustpower2_f(fSlow29);
		float fSlow32 = ftbl0synth_english_bellSIG0[iSlow15 + 31];
		float fSlow33 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.7110536f * fSlow10, fSlow11)));
		float fSlow34 = fConst17 * (0.0f - 2.0f * fSlow33);
		float fSlow35 = synth_english_bell_faustpower2_f(fSlow33);
		float fSlow36 = ftbl0synth_english_bellSIG0[iSlow15 + 30];
		float fSlow37 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.69396925f * fSlow10, fSlow11)));
		float fSlow38 = fConst18 * (0.0f - 2.0f * fSlow37);
		float fSlow39 = synth_english_bell_faustpower2_f(fSlow37);
		float fSlow40 = ftbl0synth_english_bellSIG0[iSlow15 + 29];
		float fSlow41 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.6938616f * fSlow10, fSlow11)));
		float fSlow42 = fConst19 * (0.0f - 2.0f * fSlow41);
		float fSlow43 = synth_english_bell_faustpower2_f(fSlow41);
		float fSlow44 = ftbl0synth_english_bellSIG0[iSlow15 + 28];
		float fSlow45 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.6835155f * fSlow10, fSlow11)));
		float fSlow46 = fConst20 * (0.0f - 2.0f * fSlow45);
		float fSlow47 = synth_english_bell_faustpower2_f(fSlow45);
		float fSlow48 = ftbl0synth_english_bellSIG0[iSlow15 + 27];
		float fSlow49 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.68282765f * fSlow10, fSlow11)));
		float fSlow50 = fConst21 * (0.0f - 2.0f * fSlow49);
		float fSlow51 = synth_english_bell_faustpower2_f(fSlow49);
		float fSlow52 = ftbl0synth_english_bellSIG0[iSlow15 + 26];
		float fSlow53 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.68199474f * fSlow10, fSlow11)));
		float fSlow54 = fConst22 * (0.0f - 2.0f * fSlow53);
		float fSlow55 = synth_english_bell_faustpower2_f(fSlow53);
		float fSlow56 = ftbl0synth_english_bellSIG0[iSlow15 + 25];
		float fSlow57 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.6802727f * fSlow10, fSlow11)));
		float fSlow58 = fConst23 * (0.0f - 2.0f * fSlow57);
		float fSlow59 = synth_english_bell_faustpower2_f(fSlow57);
		float fSlow60 = ftbl0synth_english_bellSIG0[iSlow15 + 24];
		float fSlow61 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.6800902f * fSlow10, fSlow11)));
		float fSlow62 = fConst24 * (0.0f - 2.0f * fSlow61);
		float fSlow63 = synth_english_bell_faustpower2_f(fSlow61);
		float fSlow64 = ftbl0synth_english_bellSIG0[iSlow15 + 23];
		float fSlow65 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.67973924f * fSlow10, fSlow11)));
		float fSlow66 = fConst25 * (0.0f - 2.0f * fSlow65);
		float fSlow67 = synth_english_bell_faustpower2_f(fSlow65);
		float fSlow68 = ftbl0synth_english_bellSIG0[iSlow15 + 22];
		float fSlow69 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.62757367f * fSlow10, fSlow11)));
		float fSlow70 = fConst26 * (0.0f - 2.0f * fSlow69);
		float fSlow71 = synth_english_bell_faustpower2_f(fSlow69);
		float fSlow72 = ftbl0synth_english_bellSIG0[iSlow15 + 21];
		float fSlow73 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.6271338f * fSlow10, fSlow11)));
		float fSlow74 = fConst27 * (0.0f - 2.0f * fSlow73);
		float fSlow75 = synth_english_bell_faustpower2_f(fSlow73);
		float fSlow76 = ftbl0synth_english_bellSIG0[iSlow15 + 20];
		float fSlow77 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.5785011f * fSlow10, fSlow11)));
		float fSlow78 = fConst28 * (0.0f - 2.0f * fSlow77);
		float fSlow79 = synth_english_bell_faustpower2_f(fSlow77);
		float fSlow80 = ftbl0synth_english_bellSIG0[iSlow15 + 19];
		float fSlow81 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.56723785f * fSlow10, fSlow11)));
		float fSlow82 = fConst29 * (0.0f - 2.0f * fSlow81);
		float fSlow83 = synth_english_bell_faustpower2_f(fSlow81);
		float fSlow84 = ftbl0synth_english_bellSIG0[iSlow15 + 18];
		float fSlow85 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.56694776f * fSlow10, fSlow11)));
		float fSlow86 = fConst30 * (0.0f - 2.0f * fSlow85);
		float fSlow87 = synth_english_bell_faustpower2_f(fSlow85);
		float fSlow88 = ftbl0synth_english_bellSIG0[iSlow15 + 17];
		float fSlow89 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.48424923f * fSlow10, fSlow11)));
		float fSlow90 = fConst31 * (0.0f - 2.0f * fSlow89);
		float fSlow91 = synth_english_bell_faustpower2_f(fSlow89);
		float fSlow92 = ftbl0synth_english_bellSIG0[iSlow15 + 16];
		float fSlow93 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.47927976f * fSlow10, fSlow11)));
		float fSlow94 = fConst32 * (0.0f - 2.0f * fSlow93);
		float fSlow95 = synth_english_bell_faustpower2_f(fSlow93);
		float fSlow96 = ftbl0synth_english_bellSIG0[iSlow15 + 15];
		float fSlow97 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.4458419f * fSlow10, fSlow11)));
		float fSlow98 = fConst33 * (0.0f - 2.0f * fSlow97);
		float fSlow99 = synth_english_bell_faustpower2_f(fSlow97);
		float fSlow100 = ftbl0synth_english_bellSIG0[iSlow15 + 14];
		float fSlow101 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.4431873f * fSlow10, fSlow11)));
		float fSlow102 = fConst34 * (0.0f - 2.0f * fSlow101);
		float fSlow103 = synth_english_bell_faustpower2_f(fSlow101);
		float fSlow104 = ftbl0synth_english_bellSIG0[iSlow15 + 13];
		float fSlow105 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.44291776f * fSlow10, fSlow11)));
		float fSlow106 = fConst35 * (0.0f - 2.0f * fSlow105);
		float fSlow107 = synth_english_bell_faustpower2_f(fSlow105);
		float fSlow108 = ftbl0synth_english_bellSIG0[iSlow15 + 12];
		float fSlow109 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.4414653f * fSlow10, fSlow11)));
		float fSlow110 = fConst36 * (0.0f - 2.0f * fSlow109);
		float fSlow111 = synth_english_bell_faustpower2_f(fSlow109);
		float fSlow112 = ftbl0synth_english_bellSIG0[iSlow15 + 11];
		float fSlow113 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.43651313f * fSlow10, fSlow11)));
		float fSlow114 = fConst37 * (0.0f - 2.0f * fSlow113);
		float fSlow115 = synth_english_bell_faustpower2_f(fSlow113);
		float fSlow116 = ftbl0synth_english_bellSIG0[iSlow15 + 10];
		float fSlow117 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.43606716f * fSlow10, fSlow11)));
		float fSlow118 = fConst38 * (0.0f - 2.0f * fSlow117);
		float fSlow119 = synth_english_bell_faustpower2_f(fSlow117);
		float fSlow120 = ftbl0synth_english_bellSIG0[iSlow15 + 9];
		float fSlow121 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.36825937f * fSlow10, fSlow11)));
		float fSlow122 = fConst39 * (0.0f - 2.0f * fSlow121);
		float fSlow123 = synth_english_bell_faustpower2_f(fSlow121);
		float fSlow124 = ftbl0synth_english_bellSIG0[iSlow15 + 8];
		float fSlow125 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.33914995f * fSlow10, fSlow11)));
		float fSlow126 = fConst40 * (0.0f - 2.0f * fSlow125);
		float fSlow127 = synth_english_bell_faustpower2_f(fSlow125);
		float fSlow128 = ftbl0synth_english_bellSIG0[iSlow15 + 7];
		float fSlow129 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.33905122f * fSlow10, fSlow11)));
		float fSlow130 = fConst41 * (0.0f - 2.0f * fSlow129);
		float fSlow131 = synth_english_bell_faustpower2_f(fSlow129);
		float fSlow132 = ftbl0synth_english_bellSIG0[iSlow15 + 6];
		float fSlow133 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.28298113f * fSlow10, fSlow11)));
		float fSlow134 = fConst42 * (0.0f - 2.0f * fSlow133);
		float fSlow135 = synth_english_bell_faustpower2_f(fSlow133);
		float fSlow136 = ftbl0synth_english_bellSIG0[iSlow15 + 5];
		float fSlow137 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.28218845f * fSlow10, fSlow11)));
		float fSlow138 = fConst43 * (0.0f - 2.0f * fSlow137);
		float fSlow139 = synth_english_bell_faustpower2_f(fSlow137);
		float fSlow140 = ftbl0synth_english_bellSIG0[iSlow15 + 4];
		float fSlow141 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.23138173f * fSlow10, fSlow11)));
		float fSlow142 = fConst44 * (0.0f - 2.0f * fSlow141);
		float fSlow143 = synth_english_bell_faustpower2_f(fSlow141);
		float fSlow144 = ftbl0synth_english_bellSIG0[iSlow15 + 3];
		float fSlow145 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.2308478f * fSlow10, fSlow11)));
		float fSlow146 = fConst45 * (0.0f - 2.0f * fSlow145);
		float fSlow147 = synth_english_bell_faustpower2_f(fSlow145);
		float fSlow148 = ftbl0synth_english_bellSIG0[iSlow15 + 2];
		float fSlow149 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.12253163f * fSlow10, fSlow11)));
		float fSlow150 = fConst46 * (0.0f - 2.0f * fSlow149);
		float fSlow151 = synth_english_bell_faustpower2_f(fSlow149);
		float fSlow152 = ftbl0synth_english_bellSIG0[iSlow15 + 1];
		float fSlow153 = std::pow(0.001f, fConst12 / (fSlow9 * std::pow(1.0f - 0.121396415f * fSlow10, fSlow11)));
