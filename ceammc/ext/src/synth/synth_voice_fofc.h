 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec56[0] = ((iTemp6) ? fTemp156 : fRec56[1]);
			float fTemp157 = std::exp(fConst3 * (0.0f - 3.1415927f * fRec56[0]));
			fRec57[0] = ((iTemp6) ? fTemp155 : fRec57[1]);
			float fTemp158 = std::exp(fConst3 * (0.0f - 3.1415927f * fRec57[0]));
			fRec55[0] = fVec1[2] - (fRec55[1] * (0.0f - (fTemp157 + fTemp158)) + fTemp157 * fTemp158 * fRec55[2]);
			...
			float fTemp162 = ((iTemp73) ? 0.0f : fRec58[1] + fTemp161);
			fRec58[0] = fTemp162 - std::floor(fTemp162);
			fRec60[0] = ((iTemp85) ? fTemp156 : fRec60[1]);
			float fTemp163 = std::exp(fConst3 * (0.0f - 3.1415927f * fRec60[0]));
			fRec61[0] = ((iTemp85) ? fTemp155 : fRec61[1]);
			float fTemp164 = std::exp(fConst3 * (0.0f - 3.1415927f * fRec61[0]));
			fRec59[0] = fVec2[2] - (fRec59[1] * (0.0f - (fTemp163 + fTemp164)) + fTemp163 * fTemp164 * fRec59[2]);
			float fTemp165 = ((iTemp88) ? 0.0f : fTemp161 + fRec62[1]);
			...
			fRec152[0] = ((iTemp6) ? fTemp247 : fRec152[1]);
			float fTemp248 = std::exp(fConst3 * (0.0f - 3.1415927f * fRec152[0]));
			fRec153[0] = ((iTemp6) ? fTemp246 : fRec153[1]);
			...
			float fTemp252 = ((iTemp73) ? 0.0f : fRec154[1] + fTemp251);
			fRec154[0] = fTemp252 - std::floor(fTemp252);
			fRec156[0] = ((iTemp85) ? fTemp247 : fRec156[1]);
			float fTemp253 = std::exp(fConst3 * (0.0f - 3.1415927f * fRec156[0]));
			fRec157[0] = ((iTemp85) ? fTemp246 : fRec157[1]);
			...
			float fTemp255 = ((iTemp88) ? 0.0f : fTemp251 + fRec158[1]);
