...
class synth_church_bell : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst11 = std::pow(0.00100000005f, (0.0448570587f / fConst0));
		fConst12 = (std::cos((2839.48462f / fConst0)) * (0.0f - (2.0f * fConst11)));
		fConst13 = synth_church_bell_faustpower2_f(fConst11);
		fConst14 = std::pow(0.00100000005f, (0.0449536517f / fConst0));
		fConst15 = (std::cos((2858.84937f / fConst0)) * (0.0f - (2.0f * fConst14)));
		fConst16 = synth_church_bell_faustpower2_f(fConst14);
		fConst17 = std::pow(0.00100000005f, (0.0609094799f / fConst0));
		fConst18 = (std::cos((5432.7124f / fConst0)) * (0.0f - (2.0f * fConst17)));
		fConst19 = synth_church_bell_faustpower2_f(fConst17);
		fConst20 = std::pow(0.00100000005f, (0.0612352863f / fConst0));
		fConst21 = (std::cos((5475.18018f / fConst0)) * (0.0f - (2.0f * fConst20)));
		fConst22 = synth_church_bell_faustpower2_f(fConst20);
		fConst23 = std::pow(0.00100000005f, (0.0721585602f / fConst0));
		fConst24 = (std::cos((6738.52783f / fConst0)) * (0.0f - (2.0f * fConst23)));
		fConst25 = synth_church_bell_faustpower2_f(fConst23);
		fConst26 = std::pow(0.00100000005f, (0.0722505748f / fConst0));
		fConst27 = (std::cos((6748.01514f / fConst0)) * (0.0f - (2.0f * fConst26)));
		fConst28 = synth_church_bell_faustpower2_f(fConst26);
		fConst29 = std::pow(0.00100000005f, (0.0874899849f / fConst0));
		fConst30 = (std::cos((8119.32031f / fConst0)) * (0.0f - (2.0f * fConst29)));
		fConst31 = synth_church_bell_faustpower2_f(fConst29);
		fConst32 = std::pow(0.00100000005f, (0.0875099227f / fConst0));
		fConst33 = (std::cos((8120.89111f / fConst0)) * (0.0f - (2.0f * fConst32)));
		fConst34 = synth_church_bell_faustpower2_f(fConst32);
		fConst35 = std::pow(0.00100000005f, (0.107014902f / fConst0));
		fConst36 = (std::cos((9453.68066f / fConst0)) * (0.0f - (2.0f * fConst35)));
		fConst37 = synth_church_bell_faustpower2_f(fConst35);
		fConst38 = std::pow(0.00100000005f, (0.110012196f / fConst0));
		fConst39 = (std::cos((9628.41602f / fConst0)) * (0.0f - (2.0f * fConst38)));
		fConst40 = synth_church_bell_faustpower2_f(fConst38);
		fConst41 = std::pow(0.00100000005f, (0.123582378f / fConst0));
		fConst42 = (std::cos((10343.3799f / fConst0)) * (0.0f - (2.0f * fConst41)));
		fConst43 = synth_church_bell_faustpower2_f(fConst41);
		fConst44 = std::pow(0.00100000005f, (0.123685889f / fConst0));
		fConst45 = (std::cos((10348.4062f / fConst0)) * (0.0f - (2.0f * fConst44)));
		fConst46 = synth_church_bell_faustpower2_f(fConst44);
		fConst47 = std::pow(0.00100000005f, (0.127769172f / fConst0));
		fConst48 = (std::cos((10542.1172f / fConst0)) * (0.0f - (2.0f * fConst47)));
		fConst49 = synth_church_bell_faustpower2_f(fConst47);
		fConst50 = std::pow(0.00100000005f, (0.127809823f / fConst0));
		fConst51 = (std::cos((10544.002f / fConst0)) * (0.0f - (2.0f * fConst50)));
		fConst52 = synth_church_bell_faustpower2_f(fConst50);
		fConst53 = std::pow(0.00100000005f, (0.157417208f / fConst0));
		fConst54 = (std::cos((11728.3818f / fConst0)) * (0.0f - (2.0f * fConst53)));
		fConst55 = synth_church_bell_faustpower2_f(fConst53);
		fConst56 = std::pow(0.00100000005f, (0.160256028f / fConst0));
		fConst57 = (std::cos((11825.457f / fConst0)) * (0.0f - (2.0f * fConst56)));
		fConst58 = synth_church_bell_faustpower2_f(fConst56);
		fConst59 = std::pow(0.00100000005f, (0.18117331f / fConst0));
		fConst60 = (std::cos((12473.3799f / fConst0)) * (0.0f - (2.0f * fConst59)));
		fConst61 = synth_church_bell_faustpower2_f(fConst59);
		fConst62 = std::pow(0.00100000005f, (0.182209119f / fConst0));
		fConst63 = (std::cos((12502.7217f / fConst0)) * (0.0f - (2.0f * fConst62)));
		fConst64 = synth_church_bell_faustpower2_f(fConst62);
		fConst65 = std::pow(0.00100000005f, (0.2133362f / fConst0));
		fConst66 = (std::cos((13288.4971f / fConst0)) * (0.0f - (2.0f * fConst65)));
		fConst67 = synth_church_bell_faustpower2_f(fConst65);
		fConst68 = std::pow(0.00100000005f, (0.298688531f / fConst0));
		fConst69 = (std::cos((14808.2744f / fConst0)) * (0.0f - (2.0f * fConst68)));
		fConst70 = synth_church_bell_faustpower2_f(fConst68);
		fConst71 = std::pow(0.00100000005f, (0.341466933f / fConst0));
		fConst72 = (std::cos((15358.1152f / fConst0)) * (0.0f - (2.0f * fConst71)));
		fConst73 = synth_church_bell_faustpower2_f(fConst71);
		fConst74 = std::pow(0.00100000005f, (0.342488438f / fConst0));
		fConst75 = (std::cos((15370.0537f / fConst0)) * (0.0f - (2.0f * fConst74)));
		...
		fConst80 = std::pow(0.00100000005f, (0.392745376f / fConst0));
		fConst81 = (std::cos((15902.2393f / fConst0)) * (0.0f - (2.0f * fConst80)));
		fConst82 = synth_church_bell_faustpower2_f(fConst80);
		fConst83 = std::pow(0.00100000005f, (0.499480247f / fConst0));
		fConst84 = (std::cos((16768.9414f / fConst0)) * (0.0f - (2.0f * fConst83)));
		fConst85 = synth_church_bell_faustpower2_f(fConst83);
		fConst86 = std::pow(0.00100000005f, (0.500184536f / fConst0));
		fConst87 = (std::cos((16773.7793f / fConst0)) * (0.0f - (2.0f * fConst86)));
		fConst88 = synth_church_bell_faustpower2_f(fConst86);
		fConst89 = std::pow(0.00100000005f, (0.56877172f / fConst0));
		fConst90 = (std::cos((17203.7383f / fConst0)) * (0.0f - (2.0f * fConst89)));
		fConst91 = synth_church_bell_faustpower2_f(fConst89);
		fConst92 = std::pow(0.00100000005f, (0.580974996f / fConst0));
		fConst93 = (std::cos((17272.6641f / fConst0)) * (0.0f - (2.0f * fConst92)));
		fConst94 = synth_church_bell_faustpower2_f(fConst92);
		fConst95 = std::pow(0.00100000005f, (0.58267206f / fConst0));
		fConst96 = (std::cos((17282.0898f / fConst0)) * (0.0f - (2.0f * fConst95)));
		fConst97 = synth_church_bell_faustpower2_f(fConst95);
		fConst98 = std::pow(0.00100000005f, (0.58560729f / fConst0));
		fConst99 = (std::cos((17298.3008f / fConst0)) * (0.0f - (2.0f * fConst98)));
		fConst100 = synth_church_bell_faustpower2_f(fConst98);
		fConst101 = std::pow(0.00100000005f, (0.679538369f / fConst0));
		fConst102 = (std::cos((17763.7578f / fConst0)) * (0.0f - (2.0f * fConst101)));
		fConst103 = synth_church_bell_faustpower2_f(fConst101);
		fConst104 = std::pow(0.00100000005f, (0.701286793f / fConst0));
		fConst105 = (std::cos((17858.8242f / fConst0)) * (0.0f - (2.0f * fConst104)));
		fConst106 = synth_church_bell_faustpower2_f(fConst104);
		fConst107 = std::pow(0.00100000005f, (0.981793463f / fConst0));
		fConst108 = (std::cos((18802.8086f / fConst0)) * (0.0f - (2.0f * fConst107)));
		fConst109 = synth_church_bell_faustpower2_f(fConst107);
		fConst110 = std::pow(0.00100000005f, (0.991939485f / fConst0));
		fConst111 = (std::cos((18829.7012f / fConst0)) * (0.0f - (2.0f * fConst110)));
		fConst112 = synth_church_bell_faustpower2_f(fConst110);
		fConst113 = std::pow(0.00100000005f, (1.57685912f / fConst0));
		fConst114 = (std::cos((19934.0957f / fConst0)) * (0.0f - (2.0f * fConst113)));
		fConst115 = synth_church_bell_faustpower2_f(fConst113);
		fConst116 = std::pow(0.00100000005f, (2.61620831f / fConst0));
		fConst117 = (std::cos((20927.9707f / fConst0)) * (0.0f - (2.0f * fConst116)));
		fConst118 = synth_church_bell_faustpower2_f(fConst116);
		fConst119 = std::pow(0.00100000005f, (3.26228237f / fConst0));
		fConst120 = (std::cos((21302.0723f / fConst0)) * (0.0f - (2.0f * fConst119)));
		fConst121 = synth_church_bell_faustpower2_f(fConst119);
		fConst122 = std::pow(0.00100000005f, (3.42948842f / fConst0));
		fConst123 = (std::cos((21382.3086f / fConst0)) * (0.0f - (2.0f * fConst122)));
		fConst124 = synth_church_bell_faustpower2_f(fConst122);
		fConst125 = std::pow(0.00100000005f, (5.61909866f / fConst0));
		fConst126 = (std::cos((22094.3809f / fConst0)) * (0.0f - (2.0f * fConst125)));
		fConst127 = synth_church_bell_faustpower2_f(fConst125);
		fConst128 = std::pow(0.00100000005f, (6.26517916f / fConst0));
		fConst129 = (std::cos((22233.3027f / fConst0)) * (0.0f - (2.0f * fConst128)));
		fConst130 = synth_church_bell_faustpower2_f(fConst128);
		fConst131 = std::pow(0.00100000005f, (7.91042233f / fConst0));
		fConst132 = (std::cos((22511.334f / fConst0)) * (0.0f - (2.0f * fConst131)));
		fConst133 = synth_church_bell_faustpower2_f(fConst131);
		fConst134 = std::pow(0.00100000005f, (7.95560217f / fConst0));
		fConst135 = (std::cos((22517.8047f / fConst0)) * (0.0f - (2.0f * fConst134)));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow10 = ftbl0synth_church_bellSIG0[iSlow9];
		float fSlow11 = ftbl0synth_church_bellSIG0[(iSlow9 + 1)];
		float fSlow12 = ftbl0synth_church_bellSIG0[(iSlow9 + 2)];
		float fSlow13 = ftbl0synth_church_bellSIG0[(iSlow9 + 3)];
		float fSlow14 = ftbl0synth_church_bellSIG0[(iSlow9 + 4)];
		float fSlow15 = ftbl0synth_church_bellSIG0[(iSlow9 + 5)];
		float fSlow16 = ftbl0synth_church_bellSIG0[(iSlow9 + 6)];
		float fSlow17 = ftbl0synth_church_bellSIG0[(iSlow9 + 7)];
		float fSlow18 = ftbl0synth_church_bellSIG0[(iSlow9 + 8)];
		float fSlow19 = ftbl0synth_church_bellSIG0[(iSlow9 + 9)];
		float fSlow20 = ftbl0synth_church_bellSIG0[(iSlow9 + 10)];
		float fSlow21 = ftbl0synth_church_bellSIG0[(iSlow9 + 11)];
		float fSlow22 = ftbl0synth_church_bellSIG0[(iSlow9 + 12)];
		float fSlow23 = ftbl0synth_church_bellSIG0[(iSlow9 + 13)];
		float fSlow24 = ftbl0synth_church_bellSIG0[(iSlow9 + 14)];
		float fSlow25 = ftbl0synth_church_bellSIG0[(iSlow9 + 15)];
		float fSlow26 = ftbl0synth_church_bellSIG0[(iSlow9 + 16)];
		float fSlow27 = ftbl0synth_church_bellSIG0[(iSlow9 + 17)];
		float fSlow28 = ftbl0synth_church_bellSIG0[(iSlow9 + 18)];
		float fSlow29 = ftbl0synth_church_bellSIG0[(iSlow9 + 19)];
		float fSlow30 = ftbl0synth_church_bellSIG0[(iSlow9 + 20)];
		float fSlow31 = ftbl0synth_church_bellSIG0[(iSlow9 + 21)];
		float fSlow32 = ftbl0synth_church_bellSIG0[(iSlow9 + 22)];
		float fSlow33 = ftbl0synth_church_bellSIG0[(iSlow9 + 23)];
		float fSlow34 = ftbl0synth_church_bellSIG0[(iSlow9 + 24)];
		float fSlow35 = ftbl0synth_church_bellSIG0[(iSlow9 + 25)];
		float fSlow36 = ftbl0synth_church_bellSIG0[(iSlow9 + 26)];
		float fSlow37 = ftbl0synth_church_bellSIG0[(iSlow9 + 27)];
		float fSlow38 = ftbl0synth_church_bellSIG0[(iSlow9 + 28)];
		float fSlow39 = ftbl0synth_church_bellSIG0[(iSlow9 + 29)];
		float fSlow40 = ftbl0synth_church_bellSIG0[(iSlow9 + 30)];
		float fSlow41 = ftbl0synth_church_bellSIG0[(iSlow9 + 31)];
		float fSlow42 = ftbl0synth_church_bellSIG0[(iSlow9 + 32)];
		float fSlow43 = ftbl0synth_church_bellSIG0[(iSlow9 + 33)];
		float fSlow44 = ftbl0synth_church_bellSIG0[(iSlow9 + 34)];
		float fSlow45 = ftbl0synth_church_bellSIG0[(iSlow9 + 35)];
		float fSlow46 = ftbl0synth_church_bellSIG0[(iSlow9 + 36)];
		float fSlow47 = ftbl0synth_church_bellSIG0[(iSlow9 + 37)];
		float fSlow48 = ftbl0synth_church_bellSIG0[(iSlow9 + 38)];
		float fSlow49 = ftbl0synth_church_bellSIG0[(iSlow9 + 39)];
		float fSlow50 = ftbl0synth_church_bellSIG0[(iSlow9 + 40)];
		float fSlow51 = ftbl0synth_church_bellSIG0[(iSlow9 + 41)];
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fVec0[0] = fSlow8;
			iRec4[0] = ((iRec4[1] * (fVec0[1] >= fSlow8)) + 1);
			float fTemp0 = std::min<float>((fSlow7 * float(iRec4[0])), 1.0f);
			iRec5[0] = ((iRec5[1] + 1) * (fTemp0 >= 1.0f));
			float fTemp1 = (fSlow3 * ((fRec1[2] + (fRec1[0] + (2.0f * fRec1[1]))) * std::max<float>(0.0f, (fTemp0 - (fSlow7 * float(iRec5[0]))))));
			fRec0[0] = (fTemp1 - ((fConst12 * fRec0[1]) + (fConst13 * fRec0[2])));
			fRec6[0] = (fTemp1 - ((fConst15 * fRec6[1]) + (fConst16 * fRec6[2])));
			fRec7[0] = (fTemp1 - ((fConst18 * fRec7[1]) + (fConst19 * fRec7[2])));
			fRec8[0] = (fTemp1 - ((fConst21 * fRec8[1]) + (fConst22 * fRec8[2])));
			fRec9[0] = (fTemp1 - ((fConst24 * fRec9[1]) + (fConst25 * fRec9[2])));
			...
			fRec14[0] = (fTemp1 - ((fConst39 * fRec14[1]) + (fConst40 * fRec14[2])));
			fRec15[0] = (fTemp1 - ((fConst42 * fRec15[1]) + (fConst43 * fRec15[2])));
			fRec16[0] = (fTemp1 - ((fConst45 * fRec16[1]) + (fConst46 * fRec16[2])));
			fRec17[0] = (fTemp1 - ((fConst48 * fRec17[1]) + (fConst49 * fRec17[2])));
			fRec18[0] = (fTemp1 - ((fConst51 * fRec18[1]) + (fConst52 * fRec18[2])));
			fRec19[0] = (fTemp1 - ((fConst54 * fRec19[1]) + (fConst55 * fRec19[2])));
			fRec20[0] = (fTemp1 - ((fConst57 * fRec20[1]) + (fConst58 * fRec20[2])));
			fRec21[0] = (fTemp1 - ((fConst60 * fRec21[1]) + (fConst61 * fRec21[2])));
			fRec22[0] = (fTemp1 - ((fConst63 * fRec22[1]) + (fConst64 * fRec22[2])));
			fRec23[0] = (fTemp1 - ((fConst66 * fRec23[1]) + (fConst67 * fRec23[2])));
			fRec24[0] = (fTemp1 - ((fConst69 * fRec24[1]) + (fConst70 * fRec24[2])));
			fRec25[0] = (fTemp1 - ((fConst72 * fRec25[1]) + (fConst73 * fRec25[2])));
			fRec26[0] = (fTemp1 - ((fConst75 * fRec26[1]) + (fConst76 * fRec26[2])));
			fRec27[0] = (fTemp1 - ((fConst78 * fRec27[1]) + (fConst79 * fRec27[2])));
			fRec28[0] = (fTemp1 - ((fConst81 * fRec28[1]) + (fConst82 * fRec28[2])));
			fRec29[0] = (fTemp1 - ((fConst84 * fRec29[1]) + (fConst85 * fRec29[2])));
			fRec30[0] = (fTemp1 - ((fConst87 * fRec30[1]) + (fConst88 * fRec30[2])));
			fRec31[0] = (fTemp1 - ((fConst90 * fRec31[1]) + (fConst91 * fRec31[2])));
			fRec32[0] = (fTemp1 - ((fConst93 * fRec32[1]) + (fConst94 * fRec32[2])));
			...
			fRec36[0] = (fTemp1 - ((fConst105 * fRec36[1]) + (fConst106 * fRec36[2])));
			fRec37[0] = (fTemp1 - ((fConst108 * fRec37[1]) + (fConst109 * fRec37[2])));
			fRec38[0] = (fTemp1 - ((fConst111 * fRec38[1]) + (fConst112 * fRec38[2])));
			fRec39[0] = (fTemp1 - ((fConst114 * fRec39[1]) + (fConst115 * fRec39[2])));
			fRec40[0] = (fTemp1 - ((fConst117 * fRec40[1]) + (fConst118 * fRec40[2])));
			fRec41[0] = (fTemp1 - ((fConst120 * fRec41[1]) + (fConst121 * fRec41[2])));
			fRec42[0] = (fTemp1 - ((fConst123 * fRec42[1]) + (fConst124 * fRec42[2])));
			fRec43[0] = (fTemp1 - ((fConst126 * fRec43[1]) + (fConst127 * fRec43[2])));
			fRec44[0] = (fTemp1 - ((fConst129 * fRec44[1]) + (fConst130 * fRec44[2])));
			fRec45[0] = (fTemp1 - ((fConst132 * fRec45[1]) + (fConst133 * fRec45[2])));
			fRec46[0] = (fTemp1 - ((fConst135 * fRec46[1]) + (fConst136 * fRec46[2])));
			fRec47[0] = (fTemp1 - ((fConst138 * fRec47[1]) + (fConst139 * fRec47[2])));
			fRec48[0] = (fTemp1 - ((fConst141 * fRec48[1]) + (fConst142 * fRec48[2])));
			fRec49[0] = (fTemp1 - ((fConst144 * fRec49[1]) + (fConst145 * fRec49[2])));
			fRec50[0] = (fTemp1 - ((fConst147 * fRec50[1]) + (fConst148 * fRec50[2])));
			fRec51[0] = (fTemp1 - ((fConst150 * fRec51[1]) + (fConst151 * fRec51[2])));
			fRec52[0] = (fTemp1 - ((fConst153 * fRec52[1]) + (fConst154 * fRec52[2])));
			fRec53[0] = (fTemp1 - ((fConst156 * fRec53[1]) + (fConst157 * fRec53[2])));
			fRec54[0] = (fTemp1 - ((fConst159 * fRec54[1]) + (fConst160 * fRec54[2])));
			output0[i] = FAUSTFLOAT((0.0199999996f * (((((((((((((((((((((((((((((((((((((((((((((((((((fRec0[0] - fRec0[2]) * fSlow10) + ((fRec6[0] - fRec6[2]) * fSlow11)) + ((fRec7[0] - fRec7[2]) * fSlow12)) + ((fRec8[0] - fRec8[2]) * fSlow13)) + ((fRec9[0] - fRec9[2]) * fSlow14)) + ((fRec10[0] - fRec10[2]) * fSlow15)) + ((fRec11[0] - fRec11[2]) * fSlow16)) + ((fRec12[0] - fRec12[2]) * fSlow17)) + ((fRec13[0] - fRec13[2]) * fSlow18)) + ((fRec14[0] - fRec14[2]) * fSlow19)) + ((fRec15[0] - fRec15[2]) * fSlow20)) + ((fRec16[0] - fRec16[2]) * fSlow21)) + ((fRec17[0] - fRec17[2]) * fSlow22)) + ((fRec18[0] - fRec18[2]) * fSlow23)) + ((fRec19[0] - fRec19[2]) * fSlow24)) + ((fRec20[0] - fRec20[2]) * fSlow25)) + ((fRec21[0] - fRec21[2]) * fSlow26)) + ((fRec22[0] - fRec22[2]) * fSlow27)) + ((fRec23[0] - fRec23[2]) * fSlow28)) + ((fRec24[0] - fRec24[2]) * fSlow29)) + ((fRec25[0] - fRec25[2]) * fSlow30)) + ((fRec26[0] - fRec26[2]) * fSlow31)) + ((fRec27[0] - fRec27[2]) * fSlow32)) + ((fRec28[0] - fRec28[2]) * fSlow33)) + ((fRec29[0] - fRec29[2]) * fSlow34)) + ((fRec30[0] - fRec30[2]) * fSlow35)) + ((fRec31[0] - fRec31[2]) * fSlow36)) + ((fRec32[0] - fRec32[2]) * fSlow37)) + ((fRec33[0] - fRec33[2]) * fSlow38)) + ((fRec34[0] - fRec34[2]) * fSlow39)) + ((fRec35[0] - fRec35[2]) * fSlow40)) + ((fRec36[0] - fRec36[2]) * fSlow41)) + ((fRec37[0] - fRec37[2]) * fSlow42)) + ((fRec38[0] - fRec38[2]) * fSlow43)) + ((fRec39[0] - fRec39[2]) * fSlow44)) + ((fRec40[0] - fRec40[2]) * fSlow45)) + ((fRec41[0] - fRec41[2]) * fSlow46)) + ((fRec42[0] - fRec42[2]) * fSlow47)) + ((fRec43[0] - fRec43[2]) * fSlow48)) + ((fRec44[0] - fRec44[2]) * fSlow49)) + ((fRec45[0] - fRec45[2]) * fSlow50)) + ((fRec46[0] - fRec46[2]) * fSlow51)) + ((fRec47[0] - fRec47[2]) * fSlow52)) + ((fRec48[0] - fRec48[2]) * fSlow53)) + ((fRec49[0] - fRec49[2]) * fSlow54)) + ((fRec50[0] - fRec50[2]) * fSlow55)) + ((fRec51[0] - fRec51[2]) * fSlow56)) + ((fRec52[0] - fRec52[2]) * fSlow57)) + ((fRec53[0] - fRec53[2]) * fSlow58)) + ((fRec54[0] - fRec54[2]) * fSlow59))));
			iRec3[1] = iRec3[0];
			fRec2[2] = fRec2[1];
			fRec2[1] = fRec2[0];
			fRec1[2] = fRec1[1];
