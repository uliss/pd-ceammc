...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn synth_kick2 -scn synth_kick2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __synth_kick2_H__
#define  __synth_kick2_H__
...
class FAUST_API synth_kick2_dsp {

    public:

        synth_kick2_dsp() = default;
        virtual ~synth_kick2_dsp() = default;
...
class FAUST_API decorator_dsp : public ::synth_kick2_dsp {

    protected:

        ::synth_kick2_dsp* fDSP;

    public:

        decorator_dsp(::synth_kick2_dsp* synth_kick2_dsp = nullptr):fDSP(synth_kick2_dsp) {}
...
/**
 The base class of Meta handler to be used in synth_kick2_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct synth_kick2 : public synth_kick2_dsp {
};
#endif
// clang-format on
...
class synth_kick2SIG0 {
  ...
  public:
	...
	int getNumInputssynth_kick2SIG0() {
		return 0;
	}
	int getNumOutputssynth_kick2SIG0() {
		return 1;
	}
...
static synth_kick2SIG0* newsynth_kick2SIG0() { return (synth_kick2SIG0*)new synth_kick2SIG0(); }
static void deletesynth_kick2SIG0(synth_kick2SIG0* dsp) { delete dsp; }

static float ftbl0synth_kick2SIG0[65536];

class synth_kick2 : public synth_kick2_dsp {
 ...
 public:
	...
	synth_kick2(const synth_kick2&) = default;
	
	virtual ~synth_kick2() = default;
	
	synth_kick2& operator=(const synth_kick2&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn synth_kick2 -scn synth_kick2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	static void classInit(int sample_rate) {
		synth_kick2SIG0* sig0 = newsynth_kick2SIG0();
		sig0->instanceInitsynth_kick2SIG0(sample_rate);
		sig0->fillsynth_kick2SIG0(65536, ftbl0synth_kick2SIG0);
		deletesynth_kick2SIG0(sig0);
	}
	...
	virtual void instanceResetUserInterface() {
		fVslider0 = static_cast<FAUSTFLOAT>(2.5f);
		fCheckbox0 = static_cast<FAUSTFLOAT>(0.0f);
		fVslider1 = static_cast<FAUSTFLOAT>(2e+01f);
		fVslider2 = static_cast<FAUSTFLOAT>(1e+02f);
		fVslider3 = static_cast<FAUSTFLOAT>(44.0f);
		fVslider4 = static_cast<FAUSTFLOAT>(2e+01f);
	}
	...
	virtual synth_kick2* clone() {
		return new synth_kick2(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = fConst3 * static_cast<float>(fVslider1);
		float fSlow3 = fConst3 * static_cast<float>(fVslider2);
		int iSlow4 = fSlow1 == 0.0f;
		float fSlow5 = fConst1 * static_cast<float>(fVslider3);
		float fSlow6 = fConst3 * static_cast<float>(fVslider4);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec0[0] = 1;
			fRec0[0] = fSlow0 + fConst2 * fRec0[1];
			fVec1[0] = fSlow1;
			fRec1[0] = fSlow1 + fRec1[1] * static_cast<float>(fVec1[1] >= fSlow1);
			...
			float fTemp1 = 1.0f - fConst4 * static_cast<float>(iRec4[0]);
			...
			output0[i0] = static_cast<FAUSTFLOAT>(tanhf(fRec0[0] * std::max<float>(0.0f, std::min<float>(fRec1[0] / fTemp0, std::max<float>((fTemp0 - fRec1[0]) / std::max<float>(1.0f, fConst0 * fRec3[0]) + 1.0f, 0.0f)) * fTemp1) * ftbl0synth_kick2SIG0[std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec6[0]), 65535))]));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fVec1[1] = fVec1[0];
			fRec1[1] = fRec1[0];
...
class faust_synth_kick2_tilde : public FaustExternal<synth_kick2> {
public:
    faust_synth_kick2_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(synth_kick2))
    {
    }
};
