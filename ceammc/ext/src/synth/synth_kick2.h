...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/ceammc_dsp_ext.cpp -lang cpp -i -cn synth_kick2 -scn synth_kick2_dsp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class synth_kick2 : public synth_kick2_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/ceammc_dsp_ext.cpp -lang cpp -i -cn synth_kick2 -scn synth_kick2_dsp -es 1 -mcd 16 -single -ftz 0");
...
// clang-format on
    ...
    template <class T>
    struct _synth_kick2_UI : public UI {
    static std::string name;
};

template <class T>
std::string _synth_kick2_UI<T>::name(sym(synth_kick2));

typedef _synth_kick2_UI<synth_kick2> synth_kick2_UI;

class faust_synth_kick2_tilde : public FaustExternal<synth_kick2, synth_kick2_UI> {
public:
