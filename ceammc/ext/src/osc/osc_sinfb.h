...
class osc_sinfbSIG0 {
  ...
  public:
	...
	void instanceInitosc_sinfbSIG0(int samplingFreq) {
	...
	void fillosc_sinfbSIG0(int count, float* output) {
...
class osc_sinfbSIG1 {
  ...
  public:
	...
	void instanceInitosc_sinfbSIG1(int samplingFreq) {
	...
	void fillosc_sinfbSIG1(int count, float* output) {
		for (int i = 0; (i < count); i = (i + 1)) {
			iRec4[0] = (iRec4[1] + 1);
			output[i] = std::cos((9.58738019e-05f * float((iRec4[0] + -1))));
			iRec4[1] = iRec4[0];
...
class osc_sinfb : public dsp {
 ...
 public:
	...
	static void classInit(int samplingFreq) {
		...
		sig0->instanceInitosc_sinfbSIG0(samplingFreq);
		sig0->fillosc_sinfbSIG0(65536, ftbl0osc_sinfbSIG0);
		osc_sinfbSIG1* sig1 = newosc_sinfbSIG1();
		sig1->instanceInitosc_sinfbSIG1(samplingFreq);
