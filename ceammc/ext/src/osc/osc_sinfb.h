...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn osc_sinfb -scn osc_sinfb_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __osc_sinfb_H__
#define  __osc_sinfb_H__
...
class FAUST_API osc_sinfb_dsp {

    public:

        osc_sinfb_dsp() = default;
        virtual ~osc_sinfb_dsp() = default;
...
class FAUST_API decorator_dsp : public ::osc_sinfb_dsp {
    ...
    public:
        ...
        decorator_dsp(::osc_sinfb_dsp* osc_sinfb_dsp = nullptr):fDSP(osc_sinfb_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::osc_sinfb_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in osc_sinfb_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct osc_sinfb : public osc_sinfb_dsp {
};
#endif
// clang-format on
  ...
  public:
	...
	void fillosc_sinfbSIG1(int count, float* table) {
		for (int i2 = 0; i2 < count; i2 = i2 + 1) {
			...
			table[i2] = std::cos(9.58738e-05f * static_cast<float>(iRec4[0]));
			iVec2[1] = iVec2[0];
			iRec4[1] = iRec4[0];
		}
	}
...
class osc_sinfb : public osc_sinfb_dsp {
 ...
 public:
	...
	osc_sinfb(const osc_sinfb&) = default;
	
	virtual ~osc_sinfb() = default;
	
	osc_sinfb& operator=(const osc_sinfb&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn osc_sinfb -scn osc_sinfb_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	static void classInit(int sample_rate) {
		osc_sinfbSIG0* sig0 = newosc_sinfbSIG0();
		sig0->instanceInitosc_sinfbSIG0(sample_rate);
		sig0->fillosc_sinfbSIG0(65536, ftbl0osc_sinfbSIG0);
		osc_sinfbSIG1* sig1 = newosc_sinfbSIG1();
		sig1->instanceInitosc_sinfbSIG1(sample_rate);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("feedback", &fHslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(6.2831855f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			iVec1[0] = 1;
			float fTemp0 = ((1 - iVec1[1]) ? 0.0f : fRec2[1] + fConst1 * static_cast<float>(input0[i0]));
			fRec2[0] = fTemp0 - std::floor(fTemp0);
			int iTemp1 = std::max<int>(0, std::min<int>(static_cast<int>(65536.0f * fRec2[0]), 65535));
...
class faust_osc_sinfb_tilde : public FaustExternal<osc_sinfb> {
public:
    faust_osc_sinfb_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(osc_sinfb))
    {
    }
};
