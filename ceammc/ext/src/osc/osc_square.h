...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn osc_square -scn osc_square_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __osc_square_H__
#define  __osc_square_H__
...
class FAUST_API osc_square_dsp {

    public:

        osc_square_dsp() = default;
        virtual ~osc_square_dsp() = default;
         ...
         */
        virtual ::osc_square_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::osc_square_dsp {
    ...
    public:
        ...
        decorator_dsp(::osc_square_dsp* osc_square_dsp = nullptr):fDSP(osc_square_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::osc_square_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in osc_square_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct osc_square : public osc_square_dsp {
};
#endif
// clang-format on
...
static float osc_square_faustpower2_f(float value) {
	return value * value;
}

class osc_square : public osc_square_dsp {
 ...
 public:
	...
	osc_square(const osc_square&) = default;
	
	virtual ~osc_square() = default;
	
	osc_square& operator=(const osc_square&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn osc_square -scn osc_square_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "osc_square.dsp");
	...
	virtual osc_square* clone() {
		return new osc_square(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp3 = ((1 - iVec0[1]) ? 0.0f : fRec0[1] + fConst2 * fTemp2);
			fRec0[0] = fTemp3 - std::floor(fTemp3);
			float fTemp4 = osc_square_faustpower2_f(2.0f * fRec0[0] + -1.0f);
			fVec1[0] = fTemp4;
			float fTemp5 = static_cast<float>(iVec0[1]) * (fTemp4 - fVec1[1]) / fTemp2;
			...
			output0[i0] = static_cast<FAUSTFLOAT>(((fTemp0 == 0.0f) ? 0.0f : fConst1 * (fTemp5 - fVec2[(IOTA0 - iTemp7) & 4095] * (fTemp8 + (1.0f - fTemp6)) - (fTemp6 - fTemp8) * fVec2[(IOTA0 - (iTemp7 + 1)) & 4095])));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fVec1[1] = fVec1[0];
			IOTA0 = IOTA0 + 1;
...
class faust_osc_square_tilde : public FaustExternal<osc_square> {
public:
    faust_osc_square_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(osc_square))
    {
    }
};
