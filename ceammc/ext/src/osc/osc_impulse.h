  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			iVec0[0] = 1;
			float fTemp0 = max(2e+01f, fabsf((float)input0[i]));
			float fTemp1 = ((fConst2 * fTemp0) + fRec0[1]);
			fRec0[0] = (fTemp1 - floorf(fTemp1));
			float fTemp2 = faustpower<2>(((2 * fRec0[0]) + -1));
			fVec1[0] = fTemp2;
			float fTemp3 = ((iVec0[1] * (fVec1[0] - fVec1[1])) / fTemp0);
			fVec2[0] = fTemp3;
			output0[i] = (FAUSTFLOAT)((0.5f * (0 - (fConst1 * (fVec2[0] - fVec2[1])))) + (1 - iVec0[1]));
			// post processing
			fVec2[1] = fVec2[0];
			fVec1[1] = fVec1[0];
			fRec0[1] = fRec0[0];
