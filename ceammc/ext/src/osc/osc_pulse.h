...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn osc_pulse -scn osc_pulse_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __osc_pulse_H__
#define  __osc_pulse_H__
...
class FAUST_API osc_pulse_dsp {

    public:

        osc_pulse_dsp() = default;
        virtual ~osc_pulse_dsp() = default;
...
class FAUST_API decorator_dsp : public ::osc_pulse_dsp {
    ...
    public:
        ...
        decorator_dsp(::osc_pulse_dsp* osc_pulse_dsp = nullptr):fDSP(osc_pulse_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::osc_pulse_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in osc_pulse_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct osc_pulse : public osc_pulse_dsp {
};
#endif
// clang-format on
...
static float osc_pulse_faustpower2_f(float value) {
	return value * value;
}

class osc_pulse : public osc_pulse_dsp {
 ...
 public:
	...
	osc_pulse(const osc_pulse&) = default;
	
	virtual ~osc_pulse() = default;
	
	osc_pulse& operator=(const osc_pulse&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn osc_pulse -scn osc_pulse_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "osc_pulse.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.9.0");
		m->declare("name", "osc_pulse");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("osc_pulse");
		ui_interface->addHorizontalSlider("duty", &fHslider0, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
...
class faust_osc_pulse_tilde : public FaustExternal<osc_pulse> {
public:
    faust_osc_pulse_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(osc_pulse))
    {
    }
};
