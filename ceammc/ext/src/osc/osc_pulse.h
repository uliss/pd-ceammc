  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp2 = (fRec0[1] + (fConst3 * fTemp1));
			...
			float fTemp5 = max((float)0, min((float)2047, (fConst1 * (fRec1[0] / fTemp0))));
			int iTemp6 = int(fTemp5);
			float fTemp7 = floorf(fTemp5);
			output0[i] = (FAUSTFLOAT)(fConst2 * (fVec2[IOTA&4095] - ((fVec2[(IOTA-iTemp6)&4095] * (fTemp7 + (1 - fTemp5))) + (fVec2[(IOTA-int((iTemp6 + 1)))&4095] * (fTemp5 - fTemp7)))));
			// post processing
			fRec1[1] = fRec1[0];
			IOTA = IOTA+1;
			fVec1[1] = fVec1[0];
