...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn osc_saw -scn osc_saw_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API osc_saw_dsp {

    public:

        osc_saw_dsp() = default;
        virtual ~osc_saw_dsp() = default;
...
class FAUST_API decorator_dsp : public ::osc_saw_dsp {
...
/**
 The base class of Meta handler to be used in osc_saw_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
class osc_saw : public osc_saw_dsp {
 ...
 public:
	...
	osc_saw(const osc_saw&) = default;
	
	virtual ~osc_saw() = default;
	
	osc_saw& operator=(const osc_saw&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn osc_saw -scn osc_saw_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "osc_saw.dsp");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = std::max<float>(1.1920929e-07f, std::fabs(fTemp0));
			...
			output0[i0] = static_cast<FAUSTFLOAT>(((fTemp0 == 0.0f) ? 0.0f : 2.0f * fRec1 + -1.0f));
			fRec0[1] = fRec0[0];
		}
	}
...
class faust_osc_saw_tilde : public FaustExternal<osc_saw> {
public:
    faust_osc_saw_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(osc_saw))
    {
    }
};
