 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fThen1 = (fTemp2 + ((1.0f - (fConst0 / fTemp1)) * fTemp3));
			float fRec1 = (iTemp4 ? fTemp2 : fThen1);
			float fThen2 = ((2.0f * fRec1) + -1.0f);
			output0[i0] = FAUSTFLOAT(((fTemp0 == 0.0f) ? 0.0f : fThen2));
			fRec0[1] = fRec0[0];
		}
	}
