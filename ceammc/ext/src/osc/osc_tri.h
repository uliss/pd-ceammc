  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp3 = ((fConst4 * fTemp2) + fRec1[1]);
			...
			float fTemp6 = max((float)0, min((float)2047, (fConst5 / fTemp1)));
			float fTemp7 = floorf(fTemp6);
			int iTemp8 = int(fTemp6);
			fRec0[0] = ((0.999f * fRec0[1]) + (fConst3 * (fVec2[IOTA&4095] - (((fTemp6 - fTemp7) * fVec2[(IOTA-int((iTemp8 + 1)))&4095]) + ((fTemp7 + (1 - fTemp6)) * fVec2[(IOTA-iTemp8)&4095])))));
