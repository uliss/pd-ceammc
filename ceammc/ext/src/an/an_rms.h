...
class decorator_dsp : public an_rms_dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			fRec0[(IOTA & 262143)] = (fRec0[((IOTA - 1) & 262143)] + an_rms_faustpower2_f(float(input0[i0])));
			output0[i0] = FAUSTFLOAT(std::sqrt((fSlow1 * (fRec0[((IOTA - 0) & 262143)] - fRec0[((IOTA - iSlow2) & 262143)]))));
			IOTA = (IOTA + 1);
		}
	}
