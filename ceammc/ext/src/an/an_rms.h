...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn an_rms -scn an_rms_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API an_rms_dsp {

    public:

        an_rms_dsp() = default;
        virtual ~an_rms_dsp() = default;
...
class FAUST_API decorator_dsp : public ::an_rms_dsp {
    ...
    public:
        ...
        decorator_dsp(::an_rms_dsp* an_rms_dsp = nullptr):fDSP(an_rms_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::an_rms_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in an_rms_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct an_rms : public an_rms_dsp {
};
#endif
// clang-format on
...
static float an_rms_faustpower2_f(float value) {
	return value * value;
}

class an_rms : public an_rms_dsp {
 ...
 public:
	...
	an_rms(const an_rms&) = default;
	
	virtual ~an_rms() = default;
	
	an_rms& operator=(const an_rms&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn an_rms -scn an_rms_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "an_rms.dsp");
	...
	virtual an_rms* clone() {
		return new an_rms(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = std::rint(fConst0 * static_cast<float>(fHslider0));
		float fSlow1 = 1.0f / fSlow0;
		int iSlow2 = static_cast<int>(std::max<float>(0.0f, fSlow0));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec0[IOTA0 & 262143] = fRec0[(IOTA0 - 1) & 262143] + an_rms_faustpower2_f(static_cast<float>(input0[i0]));
			output0[i0] = static_cast<FAUSTFLOAT>(std::sqrt(fSlow1 * (fRec0[IOTA0 & 262143] - fRec0[(IOTA0 - iSlow2) & 262143])));
			IOTA0 = IOTA0 + 1;
		}
	}
...
class faust_an_rms_tilde : public FaustExternal<an_rms> {
public:
    faust_an_rms_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(an_rms))
    {
    }
};
