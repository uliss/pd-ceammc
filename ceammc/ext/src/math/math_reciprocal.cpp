...
void setup_math_reciprocal()
{
    ...
    class_doaddfloat(math_reciprocal_class, reinterpret_cast<t_method>(math_reciprocal_float));
    class_addlist(math_reciprocal_class, reinterpret_cast<t_method>(math_reciprocal_list));
}
