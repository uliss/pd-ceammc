...
#ifndef YY_YY_SELECT_PARSER_HPP_INCLUDED
# define YY_YY_SELECT_PARSER_HPP_INCLUDED
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOK_OR = 259,                  // OR
    TOK_RANGE = 260,               // RANGE
    TOK_EPSILON = 261,             // EPSILON
    TOK_FLOAT = 262,               // FLOAT
    TOK_SYMBOL = 263,              // SYMBOL
    TOK_OPEN_BRACKET = 264,        // OPEN_BRACKET
    TOK_CLOSE_BRACKET = 265,       // CLOSE_BRACKET
    TOK_OPEN_PAR = 266,            // OPEN_PAR
    TOK_CLOSE_PAR = 267,           // CLOSE_PAR
    TOK_OP_LESS = 268,             // OP_LESS
    TOK_OP_LESS_EQ = 269,          // OP_LESS_EQ
    TOK_OP_GREATER = 270,          // OP_GREATER
    TOK_OP_GREATER_EQ = 271        // OP_GREATER_EQ
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_FLOAT = 7,                             // FLOAT
        S_SYMBOL = 8,                            // SYMBOL
        S_OPEN_BRACKET = 9,                      // OPEN_BRACKET
        S_CLOSE_BRACKET = 10,                    // CLOSE_BRACKET
        S_OPEN_PAR = 11,                         // OPEN_PAR
        S_CLOSE_PAR = 12,                        // CLOSE_PAR
        S_OP_LESS = 13,                          // OP_LESS
        S_OP_LESS_EQ = 14,                       // OP_LESS_EQ
        S_OP_GREATER = 15,                       // OP_GREATER
        S_OP_GREATER_EQ = 16,                    // OP_GREATER_EQ
        S_YYACCEPT = 17,                         // $accept
        S_OPEN_B = 18,                           // OPEN_B
        S_CLOSE_B = 19,                          // CLOSE_B
        S_ATOM0 = 20,                            // ATOM0
        S_ATOM = 21,                             // ATOM
        S_SET = 22,                              // SET
        S_COMPARE = 23,                          // COMPARE
        S_EXPR = 24,                             // EXPR
        S_EXPRLIST = 25                          // EXPRLIST
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      make_RANGE ()
      {
        return symbol_type (token::TOK_RANGE);
      }
#else
      static
      symbol_type
      ...
      make_EPSILON ()
      {
        return symbol_type (token::TOK_EPSILON);
      }
#else
      static
      symbol_type
      ...
      static
      symbol_type
      make_OPEN_BRACKET (int v)
      {
        return symbol_type (token::TOK_OPEN_BRACKET, std::move (v));
      }
#else
      static
      symbol_type
      make_OPEN_BRACKET (const int& v)
      {
        return symbol_type (token::TOK_OPEN_BRACKET, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CLOSE_BRACKET (int v)
      {
        return symbol_type (token::TOK_CLOSE_BRACKET, std::move (v));
      }
#else
      static
      symbol_type
      make_CLOSE_BRACKET (const int& v)
      {
        return symbol_type (token::TOK_CLOSE_BRACKET, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      make_OPEN_PAR (int v)
      {
        return symbol_type (token::TOK_OPEN_PAR, std::move (v));
      }
#else
      static
      symbol_type
      make_OPEN_PAR (const int& v)
      {
        return symbol_type (token::TOK_OPEN_PAR, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CLOSE_PAR (int v)
      {
        return symbol_type (token::TOK_CLOSE_PAR, std::move (v));
      }
#else
      static
      symbol_type
      make_CLOSE_PAR (const int& v)
      {
        return symbol_type (token::TOK_CLOSE_PAR, v);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      make_OP_LESS ()
      {
        return symbol_type (token::TOK_OP_LESS);
      }
#else
      static
      symbol_type
      ...
      make_OP_LESS_EQ ()
      {
        return symbol_type (token::TOK_OP_LESS_EQ);
      }
#else
      static
      symbol_type
      ...
      make_OP_GREATER ()
      {
        return symbol_type (token::TOK_OP_GREATER);
      }
#else
      static
      symbol_type
      ...
      make_OP_GREATER_EQ ()
      {
        return symbol_type (token::TOK_OP_GREATER_EQ);
      }
#else
      static
      symbol_type
...
#endif // !YY_YY_SELECT_PARSER_HPP_INCLUDED
