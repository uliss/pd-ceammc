...
#ifndef YY_YY_DATA_STRING_PARSER_HPP_INCLUDED
# define YY_YY_DATA_STRING_PARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 16 "data_string.y"
...
#line 71 "data_string.parser.hpp"
...
#line 207 "data_string.parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    {
      // pair
      char dummy1[sizeof (DictPair)];

      // pair_list
      char dummy2[sizeof (PairList)];

      // atom
      // data
      char dummy3[sizeof (ceammc::Atom)];

      // atom_list
      // function_call
      // expr
      char dummy4[sizeof (ceammc::AtomList)];
        ...
        switch (this->kind ())
    {
      case symbol_kind::S_pair: // pair
        value.move< DictPair > (std::move (that.value));
        break;

      case symbol_kind::S_pair_list: // pair_list
        value.move< PairList > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, DictPair&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const DictPair& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, PairList&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const PairList& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      case symbol_kind::S_pair: // pair
        value.template destroy< DictPair > ();
        break;

      case symbol_kind::S_pair_list: // pair_list
        value.template destroy< PairList > ();
        break;
      ...
      {
        return DataStringParser::symbol_name (this->kind ());
      }
...
#if 201103L <= YY_CPLUSPLUS
    /// Non copyable.
    DataStringParser (const DataStringParser&) = delete;
    /// Non copyable.
    DataStringParser& operator= (const DataStringParser&) = delete;
#endif
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_OPEN_DICT_BRACKET (location_type l)
      {
        return symbol_type (token::TOK_OPEN_DICT_BRACKET, std::move (l));
      }
#else
      static
      symbol_type
      make_OPEN_DICT_BRACKET (const location_type& l)
      {
        return symbol_type (token::TOK_OPEN_DICT_BRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CLOSE_DICT_BRACKET (location_type l)
      {
        return symbol_type (token::TOK_CLOSE_DICT_BRACKET, std::move (l));
      }
#else
      static
      symbol_type
      make_CLOSE_DICT_BRACKET (const location_type& l)
      {
        return symbol_type (token::TOK_CLOSE_DICT_BRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_OPEN_LIST_BRACKET (location_type l)
      {
        return symbol_type (token::TOK_OPEN_LIST_BRACKET, std::move (l));
      }
#else
      static
      symbol_type
      make_OPEN_LIST_BRACKET (const location_type& l)
      {
        return symbol_type (token::TOK_OPEN_LIST_BRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CLOSE_LIST_BRACKET (location_type l)
      {
        return symbol_type (token::TOK_CLOSE_LIST_BRACKET, std::move (l));
      }
#else
      static
      symbol_type
      make_CLOSE_LIST_BRACKET (const location_type& l)
      {
        return symbol_type (token::TOK_CLOSE_LIST_BRACKET, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::TOK_DATA_TYPE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_DATA_TYPE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    {
    public:
      context (const DataStringParser& yyparser, const symbol_type& yyla);
    ...
    private:
      const DataStringParser& yyparser_;
...
#if YY_CPLUSPLUS < 201103L
    /// Non copyable.
    DataStringParser (const DataStringParser&);
    /// Non copyable.
    DataStringParser& operator= (const DataStringParser&);
#endif
  ...
  DataStringParser::yytranslate_ (int t) YY_NOEXCEPT
  {
  ...
  // basic_symbol.
  template <typename Base>
  DataStringParser::basic_symbol<Base>::basic_symbol (const basic_symbol& that)
    : Base (that)
    , value ()
    , location (that.location)
  {
    ...
    {
      case symbol_kind::S_pair: // pair
        value.copy< DictPair > (YY_MOVE (that.value));
        break;

      case symbol_kind::S_pair_list: // pair_list
        value.copy< PairList > (YY_MOVE (that.value));
        break;
  ...
  template <typename Base>
  DataStringParser::symbol_kind_type
  DataStringParser::basic_symbol<Base>::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
  ...
  template <typename Base>
  bool
  DataStringParser::basic_symbol<Base>::empty () const YY_NOEXCEPT
  {
  ...
  template <typename Base>
  void
  DataStringParser::basic_symbol<Base>::move (basic_symbol& s)
  {
    super_type::move (s);
    switch (this->kind ())
    {
      case symbol_kind::S_pair: // pair
        value.move< DictPair > (YY_MOVE (s.value));
        break;

      case symbol_kind::S_pair_list: // pair_list
        value.move< PairList > (YY_MOVE (s.value));
        break;
  ...
  // by_kind.
  inline
  DataStringParser::by_kind::by_kind () YY_NOEXCEPT
    : kind_ (symbol_kind::S_YYEMPTY)
  {}

#if 201103L <= YY_CPLUSPLUS
  inline
  DataStringParser::by_kind::by_kind (by_kind&& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {
    that.clear ();
  }
  ...
  inline
  DataStringParser::by_kind::by_kind (const by_kind& that) YY_NOEXCEPT
    : kind_ (that.kind_)
  {}

  inline
  DataStringParser::by_kind::by_kind (token_kind_type t) YY_NOEXCEPT
  ...
  inline
  void
  DataStringParser::by_kind::clear () YY_NOEXCEPT
  {
    kind_ = symbol_kind::S_YYEMPTY;
  }
  ...
  inline
  void
  DataStringParser::by_kind::move (by_kind& that)
  {
    kind_ = that.kind_;
    that.clear ();
  }
  ...
  inline
  DataStringParser::symbol_kind_type
  DataStringParser::by_kind::kind () const YY_NOEXCEPT
  {
    return kind_;
  }
  ...
  inline
  DataStringParser::symbol_kind_type
  DataStringParser::by_kind::type_get () const YY_NOEXCEPT
  {
    return this->kind ();
  }
...
#line 1774 "data_string.parser.hpp"




#endif // !YY_YY_DATA_STRING_PARSER_HPP_INCLUDED
