      ...
      case INITIAL:
        ...
        switch (matcher().scan())
        {
          case 0:
            if (matcher().at_end())
            {
              if (debug()) std::cerr << "--\033[1;35mEOF rule at line 146\033[0m (start condition " << start() << ")\n";
...
{ return ArrayLoaderParser::make_STRING_END(location()); }
            ...
            break;
          case 1: // rule at line 112: @(?:(?:b|begin))
...
{ return ArrayLoaderParser::make_END(location()); }
            break;
          case 4: // rule at line 115: @(?:(?:aoff|aoffset|array_offset))
...
{ return ArrayLoaderParser::make_ARRAY_OFFSET(location()); }
            break;
          case 5: // rule at line 116: @(?:(?:c|ch|chan|channel|channels))
...
{ return ArrayLoaderParser::make_CHANNELS(location()); }
            break;
          case 6: // rule at line 117: @(?:(?:g|gain))
...
{ return ArrayLoaderParser::make_GAIN(location()); }
            break;
          case 7: // rule at line 118: @(?:(?:l|len|length))
...
{ return ArrayLoaderParser::make_LENGTH(location()); }
            break;
          case 8: // rule at line 119: @(?:(?:n|norm|normalize))
...
{ return ArrayLoaderParser::make_NORMALIZE(location()); }
            break;
          case 9: // rule at line 120: @(?:resample)
...
{ return ArrayLoaderParser::make_RESAMPLE(location()); }
            break;
          case 10: // rule at line 121: @(?:(?:r|resize))
...
{ start(SMPTE); matcher().less(0); /*push back smpte value and go to SMPTE*/ }
            break;
          case 14: // rule at line 128: (?:(?:0|[1-9][0-9]*))(?=-(?:(?:0|[1-9][0-9]*)))
...
{ start(RANGE); return ArrayLoaderParser::make_RANGE_BEGIN(std::stoi(text()), location()); }
            break;
          case 15: // rule at line 129: (?:[\x2b\x2d]?(?:0|[1-9][0-9]*))
...
{ return ArrayLoaderParser::make_INT(std::stoi(text()), location()); }
            break;
          case 16: // rule at line 130: (?:(?:[\x2b\x2d]?(?:0|[1-9][0-9]*))(?:\.[0-9]+)?)
...
{ return ArrayLoaderParser::make_FLOAT(std::stod(text()), location()); }
            break;
          case 17: // rule at line 131: (?:ms|msec)
...
{ return ArrayLoaderParser::make_MSEC(location()); }
            break;
          case 18: // rule at line 132: (?:s|sec)
...
{ return ArrayLoaderParser::make_DB(location()); }
            break;
          case 20: // rule at line 134: (?:samp|samples)
...
{ return ArrayLoaderParser::make_STRING_END(location()); }
            ...
            break;
          case 1: // rule at line 140: [0-9][0-9]
...
{ return ArrayLoaderParser::make_STRING_END(location()); }
            ...
            break;
          case 1: // rule at line 138: -(?:(?:0|[1-9][0-9]*))
