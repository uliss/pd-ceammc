...
S327:
  c1 = m.FSM_CHAR();
  if ('0' <= c1 && c1 <= '9') goto S360;
  return m.FSM_HALT(c1);

S329:
  c1 = m.FSM_CHAR();
  if ('0' <= c1 && c1 <= '9') goto S362;
  return m.FSM_HALT(c1);
