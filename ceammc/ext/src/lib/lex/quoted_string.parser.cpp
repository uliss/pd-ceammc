...
#line 127 "quoted_string.parser.cpp"
  ...
  QuotedAtomListParser::~QuotedAtomListParser ()
  {}
  ...
  template <typename Base>
  QuotedAtomListParser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t)
    : Base (t)
    , value ()
  {}
  ...
  template <typename Base>
  void
  QuotedAtomListParser::basic_symbol<Base>::move (basic_symbol& s)
  {
    super_type::move (s);
  ...
  // by_state.
  QuotedAtomListParser::by_state::by_state () YY_NOEXCEPT
    : state (empty_state)
  {}

  QuotedAtomListParser::by_state::by_state (const by_state& that) YY_NOEXCEPT
    : state (that.state)
  {}

  void
  QuotedAtomListParser::by_state::clear () YY_NOEXCEPT
  {
    state = empty_state;
  }

  void
  QuotedAtomListParser::by_state::move (by_state& that)
  {
    state = that.state;
    that.clear ();
  }

  QuotedAtomListParser::by_state::by_state (state_type s) YY_NOEXCEPT
    : state (s)
  {}
  ...
  QuotedAtomListParser::stack_symbol_type::stack_symbol_type (YY_RVREF (stack_symbol_type) that)
  ...
  QuotedAtomListParser::stack_symbol_type::stack_symbol_type (state_type s, YY_MOVE_REF (symbol_type) that)
  ...
  QuotedAtomListParser::stack_symbol_type&
  QuotedAtomListParser::stack_symbol_type::operator= (const stack_symbol_type& that)
  {
    state = that.state;
    value = that.value;
    return *this;
  ...
  QuotedAtomListParser::stack_symbol_type&
  QuotedAtomListParser::stack_symbol_type::operator= (stack_symbol_type& that)
  {
    state = that.state;
    value = that.value;
    // that is emptied.
  ...
  template <typename Base>
  void
  QuotedAtomListParser::yy_destroy_ (const char* yymsg, basic_symbol<Base>& yysym) const
  {
    if (yymsg)
  ...
  void
  QuotedAtomListParser::yypush_ (const char* m, YY_MOVE_REF (stack_symbol_type) sym)
  {
    if (m)
  ...
  void
  QuotedAtomListParser::yypush_ (const char* m, state_type s, YY_MOVE_REF (symbol_type) sym)
  {
#if 201103L <= YY_CPLUSPLUS
...
#if YYDEBUG
  std::ostream&
  QuotedAtomListParser::debug_stream () const
  {
    return *yycdebug_;
  }

  void
  QuotedAtomListParser::set_debug_stream (std::ostream& o)
  {
    yycdebug_ = &o;
  }


  QuotedAtomListParser::debug_level_type
  QuotedAtomListParser::debug_level () const
  {
    return yydebug_;
  }

  void
  QuotedAtomListParser::set_debug_level (debug_level_type l)
  {
    yydebug_ = l;
  }
#endif // YYDEBUG
  ...
  int
  QuotedAtomListParser::operator() ()
  {
    return parse ();
  }

  int
  QuotedAtomListParser::parse ()
  {
    int yyn;
...
#line 654 "quoted_string.parser.cpp"
  ...
  void
  QuotedAtomListParser::error (const syntax_error& yyexc)
  {
    error (yyexc.what ());
  }
...
#undef YYCASE_
  ...
  const signed char QuotedAtomListParser::yypact_ninf_ = -14;

  const signed char QuotedAtomListParser::yytable_ninf_ = -1;

  const signed char
  QuotedAtomListParser::yypact_[] =
  {
     -14,     0,   -14,   -14,   -14,   -14,   -14,   -14,    -7,     6,
     -14,   -14,   -14,   -14,   -14,     7,   -14,   -14
  };

  const signed char
  QuotedAtomListParser::yydefact_[] =
  {
      14,     0,     1,     5,     4,    10,    11,     2,    13,     0,
      12,    15,     3,     7,     6,     0,     8,     9
  };

  const signed char
  QuotedAtomListParser::yypgoto_[] =
  {
     -14,    -4,   -14,   -13,   -14,   -14,   -14
  };

  const signed char
  QuotedAtomListParser::yydefgoto_[] =
  {
      -1,     8,     9,    16,    10,    11,     1
  };

  const signed char
  QuotedAtomListParser::yytable_[] =
  {
       2,    12,    17,     3,     4,    15,     5,     6,     7,    13,
      13,    14,    14,     0,     7,    12
  };

  const signed char
  QuotedAtomListParser::yycheck_[] =
  {
       0,     8,    15,     3,     4,     9,     6,     7,     8,     3,
       3,     5,     5,    -1,     8,     8
  };

  const signed char
  QuotedAtomListParser::yystos_[] =
  {
       0,    15,     0,     3,     4,     6,     7,     8,    10,    11,
      13,    14,     8,     3,     5,    10,    12,    12
  };

  const signed char
  QuotedAtomListParser::yyr1_[] =
  {
