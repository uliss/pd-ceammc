...
#define YYSTYPE         CEAMMC_QUOTED_STRING_STYPE
/* Substitute the variable and function names.  */
#define yypush_parse    ceammc_quoted_string_push_parse
#define yypstate_new    ceammc_quoted_string_pstate_new
#define yypstate_delete ceammc_quoted_string_pstate_delete
#define yypstate        ceammc_quoted_string_pstate
#define yylex           ceammc_quoted_string_lex
#define yyerror         ceammc_quoted_string_error
#define yydebug         ceammc_quoted_string_debug
#define yynerrs         ceammc_quoted_string_nerrs
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined CEAMMC_QUOTED_STRING_STYPE_IS_TRIVIAL && CEAMMC_QUOTED_STRING_STYPE_IS_TRIVIAL)))
...
#if CEAMMC_QUOTED_STRING_DEBUG || YYERROR_VERBOSE || 1
/* YYTNAME[SYMBOL-NUM] -- String name of the symbol SYMBOL-NUM.
   First, the terminals, then, starting at YYNTOKENS, nonterminals.  */
static const char *const yytname[] =
{
  "\"end of string\"", "error", "$undefined", "DOUBLE_QUOTE",
  "DOUBLE_QUOTE_BEGIN", "DOUBLE_QUOTE_END", "QUOTED_ATOM", "SIMPLE_ATOM",
  "$accept", "SIMPLE_ATOM_LIST", "DQB", "DQE", "DOUBLE_QUOTED_STRING",
  "ATOMLIST", "EXPR", YY_NULLPTR
};
#endif
...
int yydebug;
#else /* !CEAMMC_QUOTED_STRING_DEBUG */
# define YYDPRINTF(Args)
# define YY_SYMBOL_PRINT(Title, Type, Value, Location)
# define YY_STACK_PRINT(Bottom, Top)
# define YY_REDUCE_PRINT(Rule)
#endif /* !CEAMMC_QUOTED_STRING_DEBUG */
...
#define ceammc_quoted_string_nerrs yyps->ceammc_quoted_string_nerrs
