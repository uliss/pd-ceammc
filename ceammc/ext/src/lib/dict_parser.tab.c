...
#define YYSTYPE         DICT_PARSER_STYPE
/* Substitute the variable and function names.  */
#define yyparse         dict_parser_parse
#define yylex           dict_parser_lex
#define yyerror         dict_parser_error
#define yydebug         dict_parser_debug
#define yynerrs         dict_parser_nerrs

#define yylval          dict_parser_lval
#define yychar          dict_parser_char

/* Copy the first part of user declarations.  */
#line 1 "dict_parser.y" /* yacc.c:339  */
...
#line 94 "dict_parser.tab.c" /* yacc.c:339  */
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined DICT_PARSER_STYPE_IS_TRIVIAL && DICT_PARSER_STYPE_IS_TRIVIAL)))
...
#if DICT_PARSER_DEBUG || YYERROR_VERBOSE || 0
...
do                                                              \
  if (yychar == YYEMPTY)                                        \
    ...
    {                                                           \
      yyerror (dict, YY_("syntax error: cannot back up")); \
      YYERROR;                                                  \
    }                                                           \
while (0)
...
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, t_dict *dict)
{
  FILE *yyo = yyoutput;
  YYUSE (yyo);
  YYUSE (dict);
...
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, t_dict *dict)
{
  YYFPRINTF (yyoutput, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyoutput, yytype, yyvaluep, dict);
  YYFPRINTF (yyoutput, ")");
}
...
do {                                    \
  if (yydebug)                          \
    yy_reduce_print (yyssp, yyvsp, Rule, dict); \
} while (0)

/* Nonzero means print parse trace.  It is left uninitialized so that
   multiple parsers can coexist.  */
int yydebug;
#else /* !DICT_PARSER_DEBUG */
# define YYDPRINTF(Args)
# define YY_SYMBOL_PRINT(Title, Type, Value, Location)
# define YY_STACK_PRINT(Bottom, Top)
# define YY_REDUCE_PRINT(Rule)
#endif /* !DICT_PARSER_DEBUG */
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, t_dict *dict)
{
  YYUSE (yyvaluep);
  YYUSE (dict);
  if (!yymsg)
...
`-------------------------------------------------*/
yyexhaustedlab:
  yyerror (dict, YY_("memory exhausted"));
  yyresult = 2;
  /* Fall through.  */
#endif
