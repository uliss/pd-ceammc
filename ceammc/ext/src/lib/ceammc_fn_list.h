...
namespace list {
    ...
    size_t shortestListSize(const std::vector<AtomList>& l);        ///> returns the size of the shortest list in vector of AtomLists
    size_t longestListSize(const std::vector<AtomList>& l);         ///> returns the size of the longest list in vector of AtomLists
    std::pair<size_t, size_t> minmaxListSize(const std::vector<AtomList>& l); ///> returns the minimum and maximum sizes of lists in vector of AtomLists
