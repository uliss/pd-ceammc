 ...
 */
constexpr uint32_t crc32_constexpr(char const* const str, int32_t const len, uint32_t const crc, int32_t const pos = 0)
{
 ...
 * @endcode
 */
constexpr uint32_t operator"" _hash(char const* const str, std::size_t const len)
{
