...
public:
    ...
    void m_clear(t_symbol* s, const AtomListView&);
    void m_col(t_symbol* s, const AtomListView& lv);
    void m_fill(t_symbol* s, const AtomListView& lv);
    void m_get_version(t_symbol* s, const AtomListView&);
    void m_invert(t_symbol* s, const AtomListView& lv);
    void m_mode(t_symbol* s, const AtomListView& lv);
    void m_pixel(t_symbol* s, const AtomListView& lv);
    void m_row(t_symbol* s, const AtomListView&);
    void m_str(t_symbol* s, const AtomListView& lv);
    void m_sync(t_symbol* s, const AtomListView&);
