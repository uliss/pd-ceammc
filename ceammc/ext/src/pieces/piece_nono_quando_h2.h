...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -ct 1 -cn piece_nono_quando_h2 -scn piece_nono_quando_h2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class piece_nono_quando_h2 : public piece_nono_quando_h2_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -ct 1 -cn piece_nono_quando_h2 -scn piece_nono_quando_h2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			output0[i0] = FAUSTFLOAT(fTemp0 * fRec0[0] + fTemp4 * fRec2[0]);
			...
			output1[i0] = FAUSTFLOAT(fTemp0 * fRec4[0] + fTemp4 * fRec5[0]);
			...
			output2[i0] = FAUSTFLOAT(fTemp0 * fRec6[0] + fTemp4 * fRec7[0]);
			...
			output3[i0] = FAUSTFLOAT(fTemp0 * fRec8[0] + fTemp4 * fRec9[0]);
			iVec0[1] = iVec0[0];
			fRec1[1] = fRec1[0];
			fRec0[1] = fRec0[0];
			fRec3[1] = fRec3[0];
