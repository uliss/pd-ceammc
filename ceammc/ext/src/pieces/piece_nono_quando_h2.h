...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn piece_nono_quando_h2 -scn piece_nono_quando_h2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API piece_nono_quando_h2_dsp {
    ...
    public:
        ...
        piece_nono_quando_h2_dsp() = default;
        virtual ~piece_nono_quando_h2_dsp() = default;
...
class piece_nono_quando_h2 : public piece_nono_quando_h2_dsp {
 ...
 public:
	piece_nono_quando_h2() {
	}
	
	piece_nono_quando_h2(const piece_nono_quando_h2&) = default;
	
	virtual ~piece_nono_quando_h2() = default;
	
	piece_nono_quando_h2& operator=(const piece_nono_quando_h2&) = default;
	
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn piece_nono_quando_h2 -scn piece_nono_quando_h2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual piece_nono_quando_h2* clone() {
		return new piece_nono_quando_h2(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp3 = fRec1[0] + std::floor(1.75f - fRec1[0]);
			fRec0[0] = 0.0001f * std::sqrt(std::max<float>(0.0f, 1.0f - 4.0f * std::fabs(std::fmod(3.25f - fTemp3, 1.0f) + -0.5f))) + 0.9999f * fRec0[1];
			float fTemp4 = static_cast<float>(input1[i0]);
			float fTemp5 = ((iTemp1) ? 0.0f : fConst2 + fRec3[1]);
			...
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec0[0] + fTemp4 * fRec2[0]);
			fRec4[0] = 0.0001f * std::sqrt(std::max<float>(0.0f, 1.0f - 4.0f * std::fabs(std::fmod(3.0f - fTemp3, 1.0f) + -0.5f))) + 0.9999f * fRec4[1];
			fRec5[0] = 0.0001f * std::sqrt(std::max<float>(0.0f, 1.0f - 4.0f * std::fabs(std::fmod(fRec3[0] + 1.25f, 1.0f) + -0.5f))) + 0.9999f * fRec5[1];
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec4[0] + fTemp4 * fRec5[0]);
			fRec6[0] = 0.0001f * std::sqrt(std::max<float>(0.0f, 1.0f - 4.0f * std::fabs(std::fmod(2.75f - fTemp3, 1.0f) + -0.5f))) + 0.9999f * fRec6[1];
			fRec7[0] = 0.0001f * std::sqrt(std::max<float>(0.0f, 1.0f - 4.0f * std::fabs(std::fmod(fRec3[0] + 1.0f, 1.0f) + -0.5f))) + 0.9999f * fRec7[1];
			output2[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec6[0] + fTemp4 * fRec7[0]);
			fRec8[0] = 0.0001f * std::sqrt(std::max<float>(0.0f, 1.0f - 4.0f * std::fabs(std::fmod(2.5f - fTemp3, 1.0f) + -0.5f))) + 0.9999f * fRec8[1];
			fRec9[0] = 0.0001f * std::sqrt(std::max<float>(0.0f, 1.0f - 4.0f * std::fabs(std::fmod(fRec3[0] + 0.75f, 1.0f) + -0.5f))) + 0.9999f * fRec9[1];
			output3[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec8[0] + fTemp4 * fRec9[0]);
			iVec0[1] = iVec0[0];
			fRec1[1] = fRec1[0];
			fRec0[1] = fRec0[0];
			fRec3[1] = fRec3[0];
...
class faust_piece_nono_quando_h2_tilde : public FaustExternal<piece_nono_quando_h2> {
public:
    faust_piece_nono_quando_h2_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(piece_nono_quando_h2))
    {
    }
};
