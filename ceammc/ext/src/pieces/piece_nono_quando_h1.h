...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn piece_nono_quando_h1 -scn piece_nono_quando_h1_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API piece_nono_quando_h1_dsp {
    ...
    public:
        ...
        piece_nono_quando_h1_dsp() = default;
        virtual ~piece_nono_quando_h1_dsp() = default;
...
class piece_nono_quando_h1 : public piece_nono_quando_h1_dsp {
 ...
 public:
	piece_nono_quando_h1() {
	}
	
	piece_nono_quando_h1(const piece_nono_quando_h1&) = default;
	
	virtual ~piece_nono_quando_h1() = default;
	
	piece_nono_quando_h1& operator=(const piece_nono_quando_h1&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn piece_nono_quando_h1 -scn piece_nono_quando_h1_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst5 = static_cast<int>(0.1f * fConst0);
	}
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider0 = static_cast<FAUSTFLOAT>(-55.0f);
	...
	virtual piece_nono_quando_h1* clone() {
		return new piece_nono_quando_h1(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow7 = static_cast<float>(fHslider5) - fSlow6;
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp5 = ((iTemp4) ? 0.0f : std::exp(-(fConst3 / ((iTemp4) ? 1.0f : fTemp3))));
			...
			iVec1[0] = iTemp6;
			iRec9[0] = std::max<int>(iConst5 * (iTemp6 < iVec1[1]), iRec9[1] + -1);
			float fTemp7 = std::fabs(std::max<float>(static_cast<float>(iTemp6), static_cast<float>(iRec9[0] > 0)));
			int iTemp8 = std::fabs(fRec7[0]) < 1.1920929e-07f;
			float fTemp9 = ((iTemp8) ? 0.0f : std::exp(-(fConst3 / ((iTemp8) ? 1.0f : fRec7[0]))));
			int iTemp10 = std::fabs(fRec6[0]) < 1.1920929e-07f;
			float fTemp11 = ((iTemp10) ? 0.0f : std::exp(-(fConst3 / ((iTemp10) ? 1.0f : fRec6[0]))));
			...
			float fTemp15 = ((1 - iVec0[1]) ? 0.0f : fRec2[1] + fConst3 / ((fRec3[0] <= 0.001f) ? 1e+03f : ((iSlow5) ? fSlow6 + fSlow7 * fRec3[0] : fSlow6 + fSlow9 * (1.0f - std::pow(fSlow8, fRec3[0])))));
			...
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec10[0]);
			...
			output2[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec11[0]);
			...
			output3[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec12[0]);
			iVec0[1] = iVec0[0];
			fRec1[1] = fRec1[0];
			fRec6[1] = fRec6[0];
			fRec7[1] = fRec7[0];
