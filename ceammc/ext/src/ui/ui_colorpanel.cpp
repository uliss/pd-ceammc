...
void UIColorPanel::setup()
{
    ...
    obj.addProperty("saturation", _("Saturation"), 1., &UIColorPanel::saturation_);
    obj.setPropertyRange("saturation", 0, 1);
    obj.setPropertyStep("saturation", 0.1);

    obj.addProperty("hue", _("First Hue"), 0., &UIColorPanel::hue_);
    obj.setPropertyRange("hue", 0, 1);
    obj.setPropertyStep("hue", 0.1);

    obj.addProperty("lightness", _("First Lightness"), 1., &UIColorPanel::lightness_);
