...
public:
    ...
    //??
    std::map<std::string,t_atom> ui_properties;
    ...
    // widget
     ...
     void w_displace(t_gobj *z, t_glist *glist, int dx, int dy);
     void w_select(t_gobj *z, t_glist *glist, int selected);
     void w_delete(t_gobj *z, t_glist *glist);
     void w_draw(t_gobj *z, t_glist *glist);
     void w_erase(t_gobj *z, t_glist *glist);
    
    //draw wrappers
     void dw_set_canvas(t_glist *glist);
    virtual void dw_set_object(t_object *obj);
    
     void dw_rect (std::string obj, int x, int y, int w, int h, std::string stroke_color, std::string fill_color, float line_width);
    virtual void dw_text (std::string obj, int x, int y, std::string text, std::string text_color);
    virtual void dw_move (std::string obj, int x, int y, int w, int h);
    virtual void dw_set_width (std::string obj, int w);
    virtual void dw_delete(std::string obj);
