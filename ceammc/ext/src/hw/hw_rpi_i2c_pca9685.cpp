...
{
    ceammc_hw_rpi_pca9685_free(pwm_);
}

void HwI2cPca8695::initDone()
{
    pwm_ = ceammc_hw_rpi_pca9685_new(1, //
...
{
    return ceammc_hw_rpi_pca9685_proc_reply(pwm_);
}
...
void HwI2cPca8695::m_on_off(t_symbol* s, const AtomListView& lv)
{
    ...
    ceammc_hw_rpi_pca9685_set_on_off(pwm_, chan, on, off);
}
...
void HwI2cPca8695::m_polarity(t_symbol* s, const AtomListView& lv)
{
    ...
    ceammc_hw_rpi_pca9685i_set_polarity(pwm_,
        lv.boolAt(0, true)
...
void HwI2cPca8695::m_enable(t_symbol* s, const AtomListView& lv)
{
    ...
    ceammc_hw_rpi_pca9685_enable(pwm_, lv.boolAt(0, true));
}
...
void HwI2cPca8695::m_freq(t_symbol* s, const AtomListView& lv)
{
    ...
    ceammc_hw_rpi_pca9685_set_freq(pwm_, freq);
}
