...
struct m_fill_bits_args {
    ...
    struct prop_bits_t {
        ...
        static const char* arg_list_info() {
            return "LIST+ (list of 0|1), bool";
        }
        static const char* info() {
            return "@bits LIST+ (bit list)";
        }
        bool parse_args(const AtomListView& lv, const BaseObject* obj, bool print_err) {
            int matched = 0;
            AtomListView left_args = lv.arguments();
            ...
            if (left_args.size()) {
                if (print_err) {
                    Error(obj) << "[fill_bits @bits( " << left_args.size() << " unexpected extra arguments were found: " << left_args;
                    output_usage(obj);
                }
                return false;
            }
    ...
    struct prop_offset_t {
        ...
        static const char* info() {
            return "@offset VALUE (bit list offset)";
        }
        bool parse_args(const AtomListView& lv, const BaseObject* obj, bool print_err) {
            int matched = 0;
            AtomListView left_args = lv.arguments();
            ...
            if (left_args.size()) {
                if (print_err) {
                    Error(obj) << "[fill_bits @offset( " << left_args.size() << " unexpected extra arguments were found: " << left_args;
                    output_usage(obj);
                }
                return false;
            }
    ...
    struct prop_color_t {
        ...
        bool parse_args(const AtomListView& lv, const BaseObject* obj, bool print_err) {
            ...
            if (left_args.size()) {
                if (print_err) {
                    Error(obj) << "[fill_bits @color( " << left_args.size() << " unexpected extra arguments were found: " << left_args;
                    output_usage(obj);
                }
                return false;
            }
    ...
    struct prop_color8_t {
        ...
        bool parse_args(const AtomListView& lv, const BaseObject* obj, bool print_err) {
            ...
            if (left_args.size()) {
                if (print_err) {
                    Error(obj) << "[fill_bits @color8( " << left_args.size() << " unexpected extra arguments were found: " << left_args;
                    output_usage(obj);
                }
                return false;
            }
    ...
    // vars
    prop_bits_t prop_bits; // bit list
    prop_offset_t prop_offset; // bit list offset
    prop_color_t prop_color; // RGB color
    prop_color8_t prop_color8; // int RGB color in [0..255] range
    // methods
    PropProcessState process_prop_bits (const AtomListView& lv, const BaseObject* obj, bool print_err) {
        AtomListView prop;
        if (!lv.getProperty(gensym("@bits"), prop)) {
            return PropProcessState::NotFound;
        }
        if (!prop_bits.parse_args(prop, obj, print_err)) {
            return PropProcessState::InvalidValue;
        }
        prop_bits._count++;
        return PropProcessState::Ok;
    ...
    static const char* usage() {
        return "usage: [fill_bits @bits @offset? ^@color ^@color8(";
    }
    static void output_usage(const BaseObject* obj) {
        Post(obj) << usage();
    }
    ...
    bool check_xor_props(const BaseObject* obj, bool print_err) const {
        if (prop_color8._count > 0 && prop_color._count > 0) {
            if (print_err) {
                Error(obj) << "[fill_bits( the properties @color8 and @color cannot be used at the same time";
            }
            return false;
        } else if (prop_color8._count == 0 && prop_color._count == 0) {
            if (print_err) {
                Error(obj) << "[fill_bits( one of this properties is required: @color8 or @color";
            }
            return false;
        }
        return true;
    ...
    bool parse_args(const AtomListView& lv, const BaseObject* obj, bool print_err = true) {
        ...
        if (left_args.size()) {
            if (print_err) {
                Error(obj) << "[fill_bits( " << left_args.size() << " unexpected extra arguments were found: " << left_args;
                output_usage(obj);
            }
            return false;
        }
        // check properties
        PropProcessState prop_st = PropProcessState::Ok;
        prop_st = process_prop_bits(lv, obj, print_err);
        if (prop_st == PropProcessState::NotFound) {
            if (prop_bits._count < 1) {
                if (print_err) {
                    Error(obj) << "[fill_bits( property @bits is required";;
                    Post(obj) << " - " << prop_bits_t::info();
                }
                return false;
            }
        ...
        if (prop_st == PropProcessState::InvalidValue) {
            if (print_err) {
                Error(obj) << "[fill_bits( invalid value for @bits property, expected:";
            }
            if (print_err) {
                Post(obj) << prop_bits_t::info();
            }
            ...
            if (prop_bits._count > 1) {
                if (print_err) {
                    Error(obj) << "too many @bits properties are specified";
                    Error(obj) << "only 1 entries for property @bits are expected";
                }
                return false;
            }
        }
        ...
        if (prop_st == PropProcessState::InvalidValue) {
            if (print_err) {
                Error(obj) << "[fill_bits( invalid value for @offset property, expected:";
            }
            if (print_err) {
                Post(obj) << prop_offset_t::info();
            }
        ...
        if (prop_st == PropProcessState::InvalidValue) {
            if (print_err) {
                Error(obj) << "[fill_bits( invalid value for @color property, expected:";
            }
            if (print_err) {
                Post(obj) << prop_color_t::info();
            }
        ...
        if (prop_st == PropProcessState::InvalidValue) {
            if (print_err) {
                Error(obj) << "[fill_bits( invalid value for @color8 property, expected:";
            }
            if (print_err) {
                Post(obj) << prop_color8_t::info();
            }
...
void m_fill_bits_args_info_output(const BaseObject* obj) {
    logpost(obj ? static_cast<void*>(obj->owner()) : nullptr,
        PD_NORMAL, "%s", m_fill_bits_args_info());
}
...
struct m_flush_args {
    ...
    bool parse_args(const AtomListView& lv, const BaseObject* obj, bool print_err = true) {
        ...
        if (left_args.size()) {
            if (print_err) {
                Error(obj) << "[flush( " << left_args.size() << " unexpected extra arguments were found: " << left_args;
                output_usage(obj);
            }
            return false;
        }
...
const char* m_flush_args_info() {
    return "send internal pixel buffer to the device";
}
void m_flush_args_info_output(const BaseObject* obj) {
    logpost(obj ? static_cast<void*>(obj->owner()) : nullptr,
        PD_NORMAL, "%s", m_flush_args_info());
}
struct m_fx_args {
    enum ArgProcessState { NOT_ENOUGH_ARGS = -3, INVALID_VALUE = -1 };
    // args
