...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn lfo_saw -scn lfo_saw_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __lfo_saw_H__
#define  __lfo_saw_H__
...
class FAUST_API lfo_saw_dsp {

    public:

        lfo_saw_dsp() = default;
        virtual ~lfo_saw_dsp() = default;
...
class FAUST_API decorator_dsp : public ::lfo_saw_dsp {
    ...
    public:
        ...
        decorator_dsp(::lfo_saw_dsp* lfo_saw_dsp = nullptr):fDSP(lfo_saw_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::lfo_saw_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in lfo_saw_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct lfo_saw : public lfo_saw_dsp {
};
#endif
// clang-format on
...
class lfo_saw : public lfo_saw_dsp {
 ...
 public:
	...
	lfo_saw(const lfo_saw&) = default;
	
	virtual ~lfo_saw() = default;
	
	lfo_saw& operator=(const lfo_saw&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_osc.lib/name", "CEAMMC faust oscillators");
		m->declare("ceammc_osc.lib/version", "0.1");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn lfo_saw -scn lfo_saw_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "lfo_saw.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.9.0");
		m->declare("name", "lfo.saw");
	...
	virtual lfo_saw* clone() {
		return new lfo_saw(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("lfo.saw");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow0 = static_cast<float>(2 * ((static_cast<float>(fCheckbox0) > 0.5f) == 0) + -1);
		float fSlow1 = static_cast<float>(fHslider0);
		float fSlow2 = fConst0 * static_cast<float>((static_cast<float>(fCheckbox1) > 0.5f) == 0);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fVec0[0] = fSlow1;
			float fTemp0 = fRec0[1] + fSlow2 * static_cast<float>(input0[i0]);
			fRec0[0] = fSlow1 + (fTemp0 - (fVec0[1] + std::floor(fSlow1 + (fTemp0 - fVec0[1]))));
			output0[i0] = static_cast<FAUSTFLOAT>(fSlow0 * (2.0f * fRec0[0] + -1.0f));
			fVec0[1] = fVec0[0];
			fRec0[1] = fRec0[0];
		}
	}
...
class faust_lfo_saw_tilde : public FaustExternal<lfo_saw> {
public:
    faust_lfo_saw_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(lfo_saw))
    {
    }
};
