...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn lfo_square_pos -scn lfo_square_pos_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __lfo_square_pos_H__
#define  __lfo_square_pos_H__
...
class FAUST_API lfo_square_pos_dsp {

    public:

        lfo_square_pos_dsp() = default;
        virtual ~lfo_square_pos_dsp() = default;
         ...
         */
        virtual ::lfo_square_pos_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::lfo_square_pos_dsp {

    protected:

        ::lfo_square_pos_dsp* fDSP;

    public:

        decorator_dsp(::lfo_square_pos_dsp* lfo_square_pos_dsp = nullptr):fDSP(lfo_square_pos_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::lfo_square_pos_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in lfo_square_pos_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct lfo_square_pos : public lfo_square_pos_dsp {
};
#endif
// clang-format on
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS lfo_square_pos
#endif
...
class lfo_square_pos : public lfo_square_pos_dsp {
 ...
 public:
	...
	lfo_square_pos(const lfo_square_pos&) = default;
	
	virtual ~lfo_square_pos() = default;
	
	lfo_square_pos& operator=(const lfo_square_pos&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_osc.lib/name", "CEAMMC faust oscillators");
		m->declare("ceammc_osc.lib/version", "0.1");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn lfo_square_pos -scn lfo_square_pos_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "lfo_square_pos.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.9.0");
		m->declare("name", "lfo.square_pos");
	...
	virtual lfo_square_pos* clone() {
		return new lfo_square_pos(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("lfo.square_pos");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			output0[i0] = static_cast<FAUSTFLOAT>(static_cast<float>(fRec0[0] <= 0.5f));
			fVec0[1] = fVec0[0];
			fRec0[1] = fRec0[0];
		}
	}
...
class faust_lfo_square_pos_tilde : public FaustExternal<lfo_square_pos> {
public:
    faust_lfo_square_pos_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(lfo_square_pos))
    {
    }
};
