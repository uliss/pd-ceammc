...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn lfo_pulse -scn lfo_pulse_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __lfo_pulse_H__
#define  __lfo_pulse_H__
...
class FAUST_API lfo_pulse_dsp {

    public:

        lfo_pulse_dsp() = default;
        virtual ~lfo_pulse_dsp() = default;
...
class FAUST_API decorator_dsp : public ::lfo_pulse_dsp {
    ...
    public:
        ...
        decorator_dsp(::lfo_pulse_dsp* lfo_pulse_dsp = nullptr):fDSP(lfo_pulse_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::lfo_pulse_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in lfo_pulse_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct lfo_pulse : public lfo_pulse_dsp {
};
#endif
// clang-format on
...
class lfo_pulse : public lfo_pulse_dsp {
 ...
 public:
	...
	lfo_pulse(const lfo_pulse&) = default;
	
	virtual ~lfo_pulse() = default;
	
	lfo_pulse& operator=(const lfo_pulse&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_osc.lib/name", "CEAMMC faust oscillators");
		m->declare("ceammc_osc.lib/version", "0.1");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn lfo_pulse -scn lfo_pulse_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual lfo_pulse* clone() {
		return new lfo_pulse(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			output0[i0] = static_cast<FAUSTFLOAT>(2.0f * static_cast<float>(fRec0[0] <= fSlow2) + -1.0f);
			fVec0[1] = fVec0[0];
			fRec0[1] = fRec0[0];
		}
	}
...
class faust_lfo_pulse_tilde : public FaustExternal<lfo_pulse> {
public:
    faust_lfo_pulse_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(lfo_pulse))
    {
    }
};
