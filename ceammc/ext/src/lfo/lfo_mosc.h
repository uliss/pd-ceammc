...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn lfo_mosc -scn lfo_mosc_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API lfo_mosc_dsp {

    public:

        lfo_mosc_dsp() = default;
        virtual ~lfo_mosc_dsp() = default;
...
class FAUST_API decorator_dsp : public ::lfo_mosc_dsp {
...
class lfo_mosc : public lfo_mosc_dsp {
 ...
 public:
	...
	lfo_mosc(const lfo_mosc&) = default;
	
	virtual ~lfo_mosc() = default;
	
	lfo_mosc& operator=(const lfo_mosc&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn lfo_mosc -scn lfo_mosc_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("duty", &fHslider1, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = static_cast<float>(fSlow0 >= 5.0f);
		float fSlow2 = static_cast<float>(fSlow0 >= 3.0f);
		float fSlow3 = static_cast<float>(fSlow0 >= 2.0f);
		float fSlow4 = static_cast<float>(fSlow0 >= 1.0f);
		float fSlow5 = static_cast<float>(fHslider0);
		float fSlow6 = fConst2 * static_cast<float>((static_cast<float>(fCheckbox0) > 0.5f) == 0);
		float fSlow7 = static_cast<float>(fSlow0 >= 4.0f);
		float fSlow8 = static_cast<float>(fHslider1);
		float fSlow9 = static_cast<float>(fSlow0 >= 8.0f);
		float fSlow10 = static_cast<float>(fSlow0 >= 7.0f);
		float fSlow11 = static_cast<float>(fSlow0 >= 6.0f);
		float fSlow12 = static_cast<float>(fSlow0 >= 9.0f);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec0[0] = fSlow5;
			float fTemp8 = fRec4[1] + fSlow6 * static_cast<float>(input0[i0]);
			fRec4[0] = fSlow5 + (fTemp8 - (fVec0[1] + std::floor(fSlow5 + (fTemp8 - fVec0[1]))));
			float fTemp9 = std::sin(6.2831855f * fRec4[0]);
			...
			float fTemp14 = static_cast<float>(fRec4[0] <= 0.5f);
			float fTemp15 = static_cast<float>(fRec4[0] <= fSlow8);
			...
			output0[i0] = static_cast<FAUSTFLOAT>((1.0f - fRec0[0]) * ((1.0f - fRec1[0]) * ((1.0f - fRec2[0]) * ((1.0f - fRec3[0]) * fTemp9 + fRec3[0] * fTemp10) + fRec2[0] * (2.0f * fTemp11 + -1.0f)) + fRec1[0] * ((1.0f - fRec5[0]) * (2.0f * fTemp14 + -1.0f) + fRec5[0] * (2.0f * fTemp15 + -1.0f))) + fRec0[0] * ((1.0f - fRec6[0]) * ((1.0f - fRec7[0]) * (fRec4[0] * fRec8[0] + 0.5f * (1.0f - fRec8[0]) * (fTemp9 + 1.0f)) + fRec7[0] * fTemp11) + fRec6[0] * (fTemp15 * fRec9[0] + fTemp14 * (1.0f - fRec9[0]))));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
...
class faust_lfo_mosc_tilde : public FaustExternal<lfo_mosc> {
public:
    faust_lfo_mosc_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(lfo_mosc))
    {
    }
};
