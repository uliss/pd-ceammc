...
class decorator_dsp : public lfo_tri_dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = FAUSTFLOAT(((2.0f * (1.0f - std::fabs(((2.0f * std::fmod(((std::fmod((fRec0[0] + (fSlow1 * fTemp1)), fTemp1) / std::fabs(fTemp1)) + 2.0f), 1.0f)) + -1.0f)))) + -1.0f));
			fRec0[1] = fRec0[0];
		}
	}
