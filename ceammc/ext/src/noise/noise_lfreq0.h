...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn noise_lfreq0 -scn noise_lfreq0_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __noise_lfreq0_H__
#define  __noise_lfreq0_H__
...
class FAUST_API noise_lfreq0_dsp {

    public:

        noise_lfreq0_dsp() = default;
        virtual ~noise_lfreq0_dsp() = default;
         ...
         */
        virtual ::noise_lfreq0_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::noise_lfreq0_dsp {

    protected:

        ::noise_lfreq0_dsp* fDSP;

    public:

        decorator_dsp(::noise_lfreq0_dsp* noise_lfreq0_dsp = nullptr):fDSP(noise_lfreq0_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::noise_lfreq0_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in noise_lfreq0_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct noise_lfreq0 : public noise_lfreq0_dsp {
};
#endif
// clang-format on
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS noise_lfreq0
#endif
...
class noise_lfreq0 : public noise_lfreq0_dsp {
 ...
 public:
	...
	noise_lfreq0(const noise_lfreq0&) = default;
	
	virtual ~noise_lfreq0() = default;
	
	noise_lfreq0& operator=(const noise_lfreq0&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn noise_lfreq0 -scn noise_lfreq0_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual noise_lfreq0* clone() {
		return new noise_lfreq0(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec2[0] = static_cast<float>(1 - iVec0[1]) + fSlow2 * fRec2[1] - fSlow1 * fRec1[1];
			int iTemp0 = (fRec1[1] <= 0.0f) & (fRec1[0] > 0.0f);
			iRec3[0] = 1103515245 * iRec3[1] + 12345;
			fRec0[0] = fRec0[1] * static_cast<float>(1 - iTemp0) + 4.656613e-10f * static_cast<float>(iRec3[0]) * static_cast<float>(iTemp0);
...
class faust_noise_lfreq0_tilde : public FaustExternal<noise_lfreq0> {
public:
    faust_noise_lfreq0_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(noise_lfreq0))
    {
    }
};
