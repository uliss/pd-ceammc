...
void* navierstokes_new(t_symbol* msg, short argc, t_atom* argv);
...
void navierstokes_reset(navierstokes* x, t_symbol* msg, short argc, t_atom* argv);
void navierstokes_set(navierstokes* x, t_symbol* msg, short argc, t_atom* argv);
...
void navierstokes_set(navierstokes* x, t_symbol* msg, short ac, t_atom* av) //input the args
{
    if (ac) {
