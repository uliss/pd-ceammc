...
static t_class* noise_baker_class;
...
{
    baker* x = (baker*)pd_new(noise_baker_class);
...
{
    noise_baker_class = class_new(gensym("noise.baker"),
        (t_newmethod)(baker_new),
        (t_method)(baker_free),
    ...
    class_addmethod(noise_baker_class, (t_method)baker_fold, gensym("fold"), A_FLOAT, 0);
    class_addmethod(noise_baker_class, (t_method)baker_cut, gensym("cut"), A_FLOAT, 0);
    class_addmethod(noise_baker_class, (t_method)baker_fold_cut, gensym("fold_cut"), A_FLOAT, 0);
    class_addmethod(noise_baker_class, (t_method)baker_om, gensym("om"), A_FLOAT, 0);
}
