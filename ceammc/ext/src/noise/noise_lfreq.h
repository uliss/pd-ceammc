...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn noise_lfreq -scn noise_lfreq_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __noise_lfreq_H__
#define  __noise_lfreq_H__
...
class FAUST_API noise_lfreq_dsp {

    public:

        noise_lfreq_dsp() = default;
        virtual ~noise_lfreq_dsp() = default;
         ...
         */
        virtual ::noise_lfreq_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::noise_lfreq_dsp {

    protected:

        ::noise_lfreq_dsp* fDSP;

    public:

        decorator_dsp(::noise_lfreq_dsp* noise_lfreq_dsp = nullptr):fDSP(noise_lfreq_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::noise_lfreq_dsp* createDSPInstance() = 0;
...
// clang-format off
#ifndef FAUST_MACRO
struct noise_lfreq : public noise_lfreq_dsp {
};
#endif
// clang-format on
...
class noise_lfreq : public noise_lfreq_dsp {
 ...
 public:
	...
	noise_lfreq(const noise_lfreq&) = default;
	
	virtual ~noise_lfreq() = default;
	
	noise_lfreq& operator=(const noise_lfreq&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn noise_lfreq -scn noise_lfreq_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual noise_lfreq* clone() {
		return new noise_lfreq(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("noise.lfreq");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = fConst4 * fRec1[0];
			float fTemp3 = std::sin(fTemp2);
			float fTemp4 = std::cos(fTemp2);
			fRec7[0] = fRec8[1] * fTemp3 + fRec7[1] * fTemp4;
			fRec8[0] = static_cast<float>(1 - iVec0[1]) + fRec8[1] * fTemp4 - fTemp3 * fRec7[1];
			int iTemp5 = (fRec7[1] <= 0.0f) & (fRec7[0] > 0.0f);
			iRec9[0] = 1103515245 * iRec9[1] + 12345;
			fRec6[0] = fRec6[1] * static_cast<float>(1 - iTemp5) + 4.656613e-10f * static_cast<float>(iRec9[0]) * static_cast<float>(iTemp5);
			float fTemp6 = fTemp0 + 1.0f;
			fRec5[0] = -((fTemp1 * fRec5[1] - (fRec6[0] + fRec6[1])) / fTemp6);
			fRec4[0] = -((fTemp1 * fRec4[1] - (fRec5[0] + fRec5[1])) / fTemp6);
			fRec3[0] = -((fTemp1 * fRec3[1] - (fRec4[0] + fRec4[1])) / fTemp6);
			fRec2[0] = -((fTemp1 * fRec2[1] - (fRec3[0] + fRec3[1])) / fTemp6);
			fRec0[0] = -((fRec0[1] * fTemp1 - (fRec2[0] + fRec2[1])) / fTemp6);
