...
class noise_colored : public noise_colored_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst36 = std::tan(413.39163f / fConst0);
		fConst37 = 125.663704f * (fConst36 / fConst4);
		fConst38 = 1.0f / (fConst3 + fConst37);
		fConst39 = std::tan(220.61469f / fConst0);
		fConst40 = 125.663704f * (fConst39 / fConst4);
		fConst41 = 1.0f / (fConst3 + fConst40);
		fConst42 = fConst40 - fConst3;
		fConst43 = std::tan(117.73542f / fConst0);
		fConst44 = 125.663704f * (fConst43 / fConst4);
		fConst45 = 1.0f / (fConst3 + fConst44);
		fConst46 = fConst44 - fConst3;
		fConst47 = 1.0f / (fConst3 + 125.663704f);
		fConst48 = 125.663704f - fConst3;
		fConst49 = fConst37 - fConst3;
		fConst50 = fConst34 - fConst3;
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow42 = fConst43 / fSlow31;
		float fSlow43 = fSlow27 - fConst3;
		float fSlow44 = fConst39 / fSlow28;
		float fSlow45 = fSlow24 - fConst3;
		float fSlow46 = fConst36 / fSlow25;
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec11[0] = -(fConst47 * (fConst48 * fRec11[1] - (fSlow37 * fRec12[0] + fSlow38 * fRec12[1])));
			fVec1[0] = fSlow40 * fRec11[0];
			fRec10[0] = -(fConst45 * (fConst46 * fRec10[1] - (fSlow35 * fRec11[0] + fSlow39 * fVec1[1])));
			fVec2[0] = fSlow42 * fRec10[0];
			fRec9[0] = -(fConst41 * (fConst42 * fRec9[1] - (fSlow32 * fRec10[0] + fSlow41 * fVec2[1])));
			fVec3[0] = fSlow44 * fRec9[0];
			fRec8[0] = fConst38 * (fSlow29 * fRec9[0] + fSlow43 * fVec3[1] - fConst49 * fRec8[1]);
			fVec4[0] = fSlow46 * fRec8[0];
			fRec7[0] = fConst35 * (fSlow26 * fRec8[0] + fSlow45 * fVec4[1] - fConst50 * fRec7[1]);
