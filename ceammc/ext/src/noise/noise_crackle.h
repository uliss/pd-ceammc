...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn noise_crackle -scn noise_crackle_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __noise_crackle_H__
#define  __noise_crackle_H__
...
class FAUST_API noise_crackle_dsp {

    public:

        noise_crackle_dsp() = default;
        virtual ~noise_crackle_dsp() = default;
...
class FAUST_API decorator_dsp : public ::noise_crackle_dsp {
...
/**
 The base class of Meta handler to be used in noise_crackle_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS noise_crackle
#endif
...
class noise_crackle : public noise_crackle_dsp {
 ...
 public:
	...
	noise_crackle(const noise_crackle&) = default;
	
	virtual ~noise_crackle() = default;
	
	noise_crackle& operator=(const noise_crackle&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn noise_crackle -scn noise_crackle_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "noise_crackle.dsp");
	...
	virtual noise_crackle* clone() {
		return new noise_crackle(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("noise.crackle");
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->declare(&fHslider0, "unit", "Hz");
		ui_interface->addHorizontalSlider("freq", &fHslider0, FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec1[0] = fTemp0;
			float fTemp1 = ((1 - iVec0[1]) ? 0.0f : fSlow0 + fRec1[1]);
			fRec1[0] = fTemp1 - std::floor(fTemp1);
			float fTemp2 = fRec1[0] - fRec1[1];
			fVec2[0] = fTemp2;
			int iTemp3 = (fVec2[1] <= 0.0f) & (fTemp2 > 0.0f);
			fRec2[0] = fRec2[1] * static_cast<float>(1 - iTemp3) + 4.656613e-10f * fTemp0 * static_cast<float>(iTemp3);
			float fTemp4 = 0.5f * (fRec2[0] + 1.0f);
			output0[i0] = static_cast<FAUSTFLOAT>(4.656613e-10f * fVec1[1] * static_cast<float>((fRec1[0] >= fTemp4) * (fRec1[1] < fTemp4)));
			iVec0[1] = iVec0[0];
			iRec0[1] = iRec0[0];
			fVec1[1] = fVec1[0];
			fRec1[1] = fRec1[0];
...
class faust_noise_crackle_tilde : public FaustExternal<noise_crackle> {
public:
    faust_noise_crackle_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(noise_crackle))
    {
    }
};
