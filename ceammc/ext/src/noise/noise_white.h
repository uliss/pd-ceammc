...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn noise_white -scn noise_white_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __noise_white_H__
#define  __noise_white_H__
...
class FAUST_API noise_white_dsp {

    public:

        noise_white_dsp() = default;
        virtual ~noise_white_dsp() = default;
...
class FAUST_API decorator_dsp : public ::noise_white_dsp {
...
/**
 The base class of Meta handler to be used in noise_white_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
class noise_white : public noise_white_dsp {
 ...
 public:
	...
	noise_white(const noise_white&) = default;
	
	virtual ~noise_white() = default;
	
	noise_white& operator=(const noise_white&) = default;
	
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn noise_white -scn noise_white_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "noise_white.dsp");
	...
	virtual noise_white* clone() {
		return new noise_white(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("noise_white");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			output0[i0] = static_cast<FAUSTFLOAT>(4.656613e-10f * static_cast<float>(iRec0[0]));
			iRec0[1] = iRec0[0];
		}
	}
...
class faust_noise_white_tilde : public FaustExternal<noise_white> {
public:
    faust_noise_white_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(noise_white))
    {
    }
};
