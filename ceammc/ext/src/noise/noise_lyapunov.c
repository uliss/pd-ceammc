...
void lyapunov_set(lyapunov* x, t_symbol* msg, short argc, t_atom* argv);
void lyapunov_reset(lyapunov* x, t_symbol* msg, short argc, t_atom* argv);
void lyapunov_info(lyapunov* x, t_symbol* msg, short argc, t_atom* argv);

void lyapunov_a(lyapunov* x, t_symbol* msg, short argc, t_atom* argv);
void lyapunov_b(lyapunov* x, t_symbol* msg, short argc, t_atom* argv);
...
void lyapunov_set(lyapunov* x, t_symbol* msg, short argc, t_atom* argv) //input the args
{
    if (argc) {

        if (argc > 13) {
            if (argv[13].a_type == A_FLOAT)
