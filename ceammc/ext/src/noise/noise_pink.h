...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn noise_pink -scn noise_pink_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __noise_pink_H__
#define  __noise_pink_H__
...
class FAUST_API noise_pink_dsp {

    public:

        noise_pink_dsp() = default;
        virtual ~noise_pink_dsp() = default;
         ...
         */
        virtual ::noise_pink_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::noise_pink_dsp {
    ...
    public:
        ...
        decorator_dsp(::noise_pink_dsp* noise_pink_dsp = nullptr):fDSP(noise_pink_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::noise_pink_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in noise_pink_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct noise_pink : public noise_pink_dsp {
};
#endif
// clang-format on
...
class noise_pink : public noise_pink_dsp {
 ...
 public:
	...
	noise_pink(const noise_pink&) = default;
	
	virtual ~noise_pink() = default;
	
	noise_pink& operator=(const noise_pink&) = default;
	
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn noise_pink -scn noise_pink_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual noise_pink* clone() {
		return new noise_pink(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			output0[i0] = static_cast<FAUSTFLOAT>(0.049922034f * fRec0[0] + 0.0506127f * fRec0[2] - (0.095993534f * fRec0[1] + 0.004408786f * fRec0[3]));
			iRec1[1] = iRec1[0];
...
class faust_noise_pink_tilde : public FaustExternal<noise_pink> {
public:
    faust_noise_pink_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(noise_pink))
    {
    }
};
