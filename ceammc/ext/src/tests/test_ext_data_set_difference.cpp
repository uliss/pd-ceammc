...
typedef TestExtension<SetDifference> SetDifferenceTest;
...
TEST_CASE("set.diff", "[externals]")
{
    ...
    SECTION("create")
    {
        ...
        {
            // {2,4} \ {1,2,3} = {4}
            SetDifferenceTest t("set.diff", L3(1, 2, 3));
            WHEN_SEND_TDATA_TO(0, t, DataTypeSet(L2(2, 4)));
            REQUIRE_SET_OUTPUT(t, DataTypeSet(L1(4)));
    ...
    SECTION("do")
    {
        ...
        REQUIRE_SET_OUTPUT(t, DataTypeSet(L2(3, 5)));
    }
    ...
    SECTION("do data")
    {
        ...
        REQUIRE_SET_OUTPUT(t, DataTypeSet(L2(DINT(2), DINT(4))));
        ...
        REQUIRE_SET_OUTPUT(t, DataTypeSet(L3(DINT(2), DINT(5), DINT(4))));
    }
    ...
    SECTION("do list")
    {
        ...
        REQUIRE_SET_OUTPUT(t, DataTypeSet(L1(3)));
