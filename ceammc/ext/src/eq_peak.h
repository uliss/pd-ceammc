...
#ifndef FAUSTCLASS 
#define FAUSTCLASS peak
#endif

class peak : public dsp {
  private:
	float 	fConst0;
	float 	fConst1;
	FAUSTFLOAT 	fslider0;
  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		float 	fSlow8 = (fConst3 * ((powf(10,(0.05f * fabsf(fSlow3))) * fSlow5) / fSlow6));
...
static void faust_init_label(t_faust* x, const char* obj_id) {
    x->label = new std::string(sym(peak) "~");
