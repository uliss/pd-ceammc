 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec55[0] = 0.99f * fRec41[1] - fConst57 * (fConst60 * fRec55[2] + fConst62 * fRec55[1]);
			fRec54[0] = fConst57 * (fConst59 * fRec55[1] + fConst61 * fRec55[0] + fConst61 * fRec55[2]) - fConst54 * (fConst63 * fRec54[2] + fConst64 * fRec54[1]);
