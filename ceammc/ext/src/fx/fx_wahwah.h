...
class fx_wahwahSIG0 {
  ...
  public:
	...
	void instanceInitfx_wahwahSIG0(int samplingFreq) {
		
	}
	
	void fillfx_wahwahSIG0(int count, float* output) {
...
fx_wahwahSIG0* newfx_wahwahSIG0() { return (fx_wahwahSIG0*)new fx_wahwahSIG0(); }
void deletefx_wahwahSIG0(fx_wahwahSIG0* dsp) { delete dsp; }
...
class fx_wahwah : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		sig0->instanceInitfx_wahwahSIG0(samplingFreq);
