...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_wahwah -scn fx_wahwah_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API fx_wahwah_dsp {

    public:

        fx_wahwah_dsp() = default;
        virtual ~fx_wahwah_dsp() = default;
...
class FAUST_API decorator_dsp : public ::fx_wahwah_dsp {
...
/**
 The base class of Meta handler to be used in fx_wahwah_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
class fx_wahwah : public fx_wahwah_dsp {
 ...
 public:
	...
	fx_wahwah(const fx_wahwah&) = default;
	
	virtual ~fx_wahwah() = default;
	
	fx_wahwah& operator=(const fx_wahwah&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_wahwah -scn fx_wahwah_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst4 = 1413.7167f / fConst0;
		fConst5 = 2827.4333f / fConst0;
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("angle", &fHslider2, FAUSTFLOAT(0.6f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		...
		ui_interface->addHorizontalSlider("speed", &fHslider1, FAUSTFLOAT(5.4e+02f), FAUSTFLOAT(3.6e+02f), FAUSTFLOAT(7.8e+02f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			iRec3[0] = (iVec0[1] + iRec3[1]) % static_cast<int>(fConst3 / static_cast<float>(static_cast<int>(fRec4[0])));
			int iTemp2 = iRec3[0] <= iRec3[1];
			iVec1[0] = iTemp2;
			fVec2[0] = fSlow3;
			fRec5[0] = ((iVec1[1]) ? 0.0f : std::fabs(fSlow3 - fVec2[1]) + fRec5[1]);
			iRec6[0] = (iTemp2 + iRec6[1]) % 15;
			ftbl0[std::max<int>(0, std::min<int>(((iTemp2 & ((fRec5[0] > 0.0f) | iSlow4)) ? iRec6[0] : 15), 15))] = fSlow3;
			float fTemp3 = ftbl0[std::max<int>(0, std::min<int>(iRec6[0], 15))];
			fRec2[0] = 0.0001f * std::pow(4.0f, fTemp3) + 0.999f * fRec2[1];
			float fTemp4 = std::pow(2.0f, 2.3f * fTemp3);
			float fTemp5 = 1.0f - fConst4 * (fTemp4 / std::pow(2.0f, 2.0f * (1.0f - fTemp3) + 1.0f));
			fRec7[0] = 0.999f * fRec7[1] - 0.002f * fTemp5 * std::cos(fConst5 * fTemp4);
			fRec8[0] = 0.001f * fx_wahwah_faustpower2_f(fTemp5) + 0.999f * fRec8[1];
			fRec1[0] = fRec2[0] * fTemp1 - (fRec7[0] * fRec1[1] + fRec8[0] * fRec1[2]);
			output0[i0] = static_cast<FAUSTFLOAT>(((iSlow0) ? fTemp0 : fTemp1 * (1.0f - fRec0[0]) + fRec0[0] * (fRec1[0] - fRec1[1])));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec4[1] = fRec4[0];
			iRec3[1] = iRec3[0];
...
class faust_fx_wahwah_tilde : public FaustExternal<fx_wahwah> {
public:
    faust_fx_wahwah_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(fx_wahwah))
    {
    }
};
