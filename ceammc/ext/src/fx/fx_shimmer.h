...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -ct 1 -cn fx_shimmer -scn fx_shimmer_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class fx_shimmer : public fx_shimmer_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -ct 1 -cn fx_shimmer -scn fx_shimmer_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst11 = std::floor(0.219991f * fConst0 + 0.5f);
		fConst12 = 6.9077554f * (fConst11 / fConst0);
		fConst13 = std::floor(0.019123f * fConst0 + 0.5f);
		...
		fConst16 = std::floor(0.256891f * fConst0 + 0.5f);
		fConst17 = 6.9077554f * (fConst16 / fConst0);
		fConst18 = std::floor(0.027333f * fConst0 + 0.5f);
		...
		fConst21 = std::floor(0.192303f * fConst0 + 0.5f);
		...
		fConst33 = std::floor(0.013458f * fConst0 + 0.5f);
		...
		fConst36 = std::floor(0.127837f * fConst0 + 0.5f);
		fConst37 = 6.9077554f * (fConst36 / fConst0);
		fConst38 = std::floor(0.031604f * fConst0 + 0.5f);
		...
		fConst41 = std::floor(0.174713f * fConst0 + 0.5f);
		fConst42 = 6.9077554f * (fConst41 / fConst0);
		fConst43 = std::floor(0.022904f * fConst0 + 0.5f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("envelope", &fHslider10, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.1f), FAUSTFLOAT(3.0f), FAUSTFLOAT(0.05f));
		...
		ui_interface->addHorizontalSlider("speed", &fHslider11, FAUSTFLOAT(0.1f), FAUSTFLOAT(0.1f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.05f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow25 = 0.083333336f * fSlow19 * (fSlow23 + fSlow24 * (0.4f * fSlow20 + 2.0f));
		...
		float fSlow31 = ((iSlow30) ? 0.0f : std::exp(-(fConst7 / ((iSlow30) ? 1.0f : fSlow29))));
		...
		float fSlow37 = 1.0f - fSlow7 * fSlow36;
		...
		float fSlow58 = 0.083333336f * fSlow19 * (fSlow57 + fSlow21 * (0.5f * fSlow20 + 2.0f));
		...
		float fSlow68 = 0.083333336f * fSlow19 * (fSlow21 * (0.25f * fSlow20 + 2.0f) + fSlow24 * (2.0f - fSlow44));
		float fSlow69 = std::exp(-(fConst27 / fSlow4));
		float fSlow70 = fx_shimmer_faustpower2_f(fSlow69);
		float fSlow71 = 1.0f - fSlow7 * fSlow70;
		...
		float fSlow78 = 0.083333336f * fSlow19 * (fSlow46 + fSlow57);
		float fSlow79 = std::exp(-(fConst32 / fSlow4));
		float fSlow80 = fx_shimmer_faustpower2_f(fSlow79);
		float fSlow81 = 1.0f - fSlow7 * fSlow80;
		...
		float fSlow88 = 0.083333336f * fSlow19 * (fSlow23 + fSlow24 * fSlow45);
		...
		float fSlow100 = 1.0f - fSlow7 * fSlow99;
		...
		float fSlow107 = 0.083333336f * fSlow19 * (fSlow23 + fSlow24 * (0.33333334f * fSlow20 + 2.0f));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec12[0] = -(fSlow16 * (fSlow17 * fRec12[1] - (fRec1[1] + fRec1[2])));
			...
			fRec14[0] = std::max<float>(fTemp4, fRec14[1] * fSlow31 + fTemp4 * fSlow32);
			float fTemp5 = ((1 - iVec0[1]) ? 0.0f : fSlow34 + fRec16[1]);
			fRec16[0] = fTemp5 - std::floor(fTemp5);
			float fTemp6 = fSlow33 * ftbl0fx_shimmerSIG0[std::max<int>(0, std::min<int>(int(65536.0f * fRec16[0]), 65535))];
			fRec13[0] = std::fmod(fRec13[1] + (2049.0f - std::pow(2.0f, fSlow25 * (fSlow26 * (fSlow28 * fRec14[0] + fTemp6) + 0.5f))), 2048.0f);
			int iTemp7 = int(fRec13[0]);
			...
			fVec3[IOTA0 & 32767] = fSlow3 * fTemp3 + fSlow2 * ((fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp7))) & 131071] * (fTemp8 + (1.0f - fRec13[0])) + (fRec13[0] - fTemp8) * fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp7 + 1))) & 131071]) * fTemp9 + (fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp11))) & 131071] * (fTemp12 + (-2047.0f - fRec13[0])) + (fRec13[0] + (2048.0f - fTemp12)) * fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp11 + 1))) & 131071]) * (1.0f - fTemp9));
			float fTemp13 = fTemp2 + fVec3[(IOTA0 - iConst9) & 32767] - 0.6f * fRec9[1];
			fVec4[IOTA0 & 4095] = fTemp13;
			fRec9[0] = fVec4[(IOTA0 - iConst10) & 4095];
			float fRec10 = 0.6f * fTemp13;
			float fTemp14 = float(input1[i0]);
			float fTemp15 = ((iSlow0) ? 0.0f : fTemp14);
			fRec20[0] = -(fSlow16 * (fSlow17 * fRec20[1] - (fRec8[1] + fRec8[2])));
			...
			fRec22[0] = std::max<float>(fTemp17, fSlow31 * fRec22[1] + fSlow32 * fTemp17);
			fRec21[0] = std::fmod(fRec21[1] + (2049.0f - std::pow(2.0f, fSlow47 * (fSlow26 * (fTemp6 + fSlow28 * fRec22[0]) + 0.5f))), 2048.0f);
			int iTemp18 = int(fRec21[0]);
			...
			float fTemp24 = fTemp15 + 0.6f * fRec17[1] + fVec6[(IOTA0 - iConst14) & 65535];
			fVec7[IOTA0 & 4095] = fTemp24;
			fRec17[0] = fVec7[(IOTA0 - iConst15) & 4095];
			float fRec18 = -(0.6f * fTemp24);
			fRec26[0] = -(fSlow16 * (fSlow17 * fRec26[1] - (fRec4[1] + fRec4[2])));
			...
			fRec28[0] = std::max<float>(fTemp26, fSlow31 * fRec28[1] + fSlow32 * fTemp26);
			fRec27[0] = std::fmod(fRec27[1] + (2049.0f - std::pow(2.0f, fSlow58 * (fSlow26 * (fTemp6 + fSlow28 * fRec28[0]) + 0.5f))), 2048.0f);
			int iTemp27 = int(fRec27[0]);
			...
			fVec9[IOTA0 & 65535] = fSlow3 * fTemp25 + fSlow2 * ((fVec8[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp27))) & 131071] * (fTemp28 + (1.0f - fRec27[0])) + (fRec27[0] - fTemp28) * fVec8[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp27 + 1))) & 131071]) * fTemp29 + (fVec8[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp31))) & 131071] * (fTemp32 + (-2047.0f - fRec27[0])) + (fRec27[0] + (2048.0f - fTemp32)) * fVec8[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp31 + 1))) & 131071]) * (1.0f - fTemp29));
			float fTemp33 = fTemp15 + 0.6f * fRec23[1] + fVec9[(IOTA0 - iConst19) & 65535];
			fVec10[IOTA0 & 8191] = fTemp33;
			fRec23[0] = fVec10[(IOTA0 - iConst20) & 8191];
			float fRec24 = -(0.6f * fTemp33);
			fRec32[0] = -(fSlow16 * (fSlow17 * fRec32[1] - (fRec6[1] + fRec6[2])));
			...
			fRec34[0] = std::max<float>(fTemp35, fSlow31 * fRec34[1] + fSlow32 * fTemp35);
			fRec33[0] = std::fmod(fRec33[1] + (2049.0f - std::pow(2.0f, fSlow68 * (fSlow26 * (fTemp6 + fSlow28 * fRec34[0]) + 0.5f))), 2048.0f);
			int iTemp36 = int(fRec33[0]);
			...
			fVec12[IOTA0 & 32767] = fSlow3 * fTemp34 + fSlow2 * ((fVec11[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp36))) & 131071] * (fTemp37 + (1.0f - fRec33[0])) + (fRec33[0] - fTemp37) * fVec11[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp36 + 1))) & 131071]) * fTemp38 + (fVec11[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp40))) & 131071] * (fTemp41 + (-2047.0f - fRec33[0])) + (fRec33[0] + (2048.0f - fTemp41)) * fVec11[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp40 + 1))) & 131071]) * (1.0f - fTemp38));
			float fTemp42 = fTemp15 + 0.6f * fRec29[1] + fVec12[(IOTA0 - iConst24) & 32767];
			fVec13[IOTA0 & 8191] = fTemp42;
			fRec29[0] = fVec13[(IOTA0 - iConst25) & 8191];
			float fRec30 = -(0.6f * fTemp42);
			fRec38[0] = -(fSlow16 * (fSlow17 * fRec38[1] - (fRec2[1] + fRec2[2])));
			...
			fRec40[0] = std::max<float>(fTemp44, fSlow31 * fRec40[1] + fSlow32 * fTemp44);
			fRec39[0] = std::fmod(fRec39[1] + (2049.0f - std::pow(2.0f, fSlow78 * (fSlow26 * (fTemp6 + fSlow28 * fRec40[0]) + 0.5f))), 2048.0f);
			int iTemp45 = int(fRec39[0]);
			...
			fVec15[IOTA0 & 65535] = fSlow3 * fTemp43 + fSlow2 * ((fVec14[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp45))) & 131071] * (fTemp46 + (1.0f - fRec39[0])) + (fRec39[0] - fTemp46) * fVec14[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp45 + 1))) & 131071]) * fTemp47 + (fVec14[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp49))) & 131071] * (fTemp50 + (-2047.0f - fRec39[0])) + (fRec39[0] + (2048.0f - fTemp50)) * fVec14[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp49 + 1))) & 131071]) * (1.0f - fTemp47));
			float fTemp51 = fTemp15 + 0.6f * fRec35[1] + fVec15[(IOTA0 - iConst29) & 65535];
			fVec16[IOTA0 & 8191] = fTemp51;
			fRec35[0] = fVec16[(IOTA0 - iConst30) & 8191];
			float fRec36 = -(0.6f * fTemp51);
			fRec44[0] = -(fSlow16 * (fSlow17 * fRec44[1] - (fRec7[1] + fRec7[2])));
			...
			fRec46[0] = std::max<float>(fTemp53, fSlow31 * fRec46[1] + fSlow32 * fTemp53);
			fRec45[0] = std::fmod(fRec45[1] + (2049.0f - std::pow(2.0f, fSlow88 * (fSlow26 * (fTemp6 + fSlow28 * fRec46[0]) + 0.5f))), 2048.0f);
			int iTemp54 = int(fRec45[0]);
			...
			fVec19[IOTA0 & 4095] = fTemp60;
			fRec41[0] = fVec19[(IOTA0 - iConst35) & 4095];
			float fRec42 = 0.6f * fTemp60;
			fRec50[0] = -(fSlow16 * (fSlow17 * fRec50[1] - (fRec3[1] + fRec3[2])));
			...
			fRec52[0] = std::max<float>(fTemp62, fSlow31 * fRec52[1] + fSlow32 * fTemp62);
			fRec51[0] = std::fmod(fRec51[1] + (2049.0f - std::pow(2.0f, fSlow88 * (fSlow26 * (fTemp6 + fSlow28 * fRec52[0]) + 0.5f))), 2048.0f);
			int iTemp63 = int(fRec51[0]);
			...
			fRec56[0] = -(fSlow16 * (fSlow17 * fRec56[1] - (fRec5[1] + fRec5[2])));
			...
			fRec58[0] = std::max<float>(fTemp71, fSlow31 * fRec58[1] + fSlow32 * fTemp71);
			fRec57[0] = std::fmod(fRec57[1] + (2049.0f - std::pow(2.0f, fSlow107 * (fSlow26 * (fTemp6 + fSlow28 * fRec58[0]) + 0.5f))), 2048.0f);
			int iTemp72 = int(fRec57[0]);
			...
			fVec25[IOTA0 & 8191] = fTemp78;
			fRec53[0] = fVec25[(IOTA0 - iConst45) & 8191];
			float fRec54 = 0.6f * fTemp78;
			float fTemp79 = fRec10 + fRec54;
			float fTemp80 = fRec42 + fRec48 + fTemp79;
			fRec1[0] = fRec9[1] + fRec17[1] + fRec23[1] + fRec29[1] + fRec35[1] + fRec41[1] + fRec47[1] + fRec53[1] + fRec18 + fRec24 + fRec30 + fRec36 + fTemp80;
			fRec2[0] = fRec9[1] + fRec41[1] + fRec47[1] + fRec53[1] + fTemp80 - (fRec17[1] + fRec23[1] + fRec29[1] + fRec35[1] + fRec18 + fRec24 + fRec36 + fRec30);
			float fTemp81 = fRec48 + fRec42;
			fRec3[0] = fRec9[1] + fRec29[1] + fRec35[1] + fRec53[1] + fRec30 + fRec36 + fTemp79 - (fRec17[1] + fRec23[1] + fRec41[1] + fRec47[1] + fRec18 + fRec24 + fTemp81);
			fRec4[0] = fRec9[1] + fRec17[1] + fRec23[1] + fRec53[1] + fRec18 + fRec24 + fTemp79 - (fRec29[1] + fRec35[1] + fRec41[1] + fRec47[1] + fRec30 + fRec36 + fTemp81);
			float fTemp82 = fRec10 + fRec48;
			float fTemp83 = fRec54 + fRec42;
			fRec5[0] = fRec9[1] + fRec23[1] + fRec35[1] + fRec47[1] + fRec24 + fRec36 + fTemp82 - (fRec17[1] + fRec29[1] + fRec41[1] + fRec53[1] + fRec18 + fRec30 + fTemp83);
			fRec6[0] = fRec9[1] + fRec17[1] + fRec29[1] + fRec47[1] + fRec18 + fRec30 + fTemp82 - (fRec23[1] + fRec35[1] + fRec41[1] + fRec53[1] + fRec24 + fRec36 + fTemp83);
			float fTemp84 = fRec10 + fRec42;
			float fTemp85 = fRec54 + fRec48;
			fRec7[0] = fRec9[1] + fRec17[1] + fRec35[1] + fRec41[1] + fRec18 + fRec36 + fTemp84 - (fRec23[1] + fRec29[1] + fRec47[1] + fRec53[1] + fRec24 + fRec30 + fTemp85);
			fRec8[0] = fRec9[1] + fRec23[1] + fRec29[1] + fRec41[1] + fRec24 + fRec30 + fTemp84 - (fRec17[1] + fRec35[1] + fRec47[1] + fRec53[1] + fRec18 + fRec36 + fTemp85);
			output0[i0] = FAUSTFLOAT(((iSlow0) ? fTemp1 : fTemp0 * fTemp2 + fRec0[0] * (fRec1[0] + fRec3[0] + fRec5[0] + fRec7[0])));
			output1[i0] = FAUSTFLOAT(((iSlow0) ? fTemp14 : fTemp0 * fTemp15 + fRec0[0] * (fRec2[0] + fRec4[0] + fRec6[0] + fRec8[0])));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec12[1] = fRec12[0];
			fRec11[1] = fRec11[0];
