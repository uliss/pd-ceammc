...
class fx_shimmer : public fx_shimmer_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst11 = std::floor(0.127837f * fConst0 + 0.5f);
		fConst12 = 6.9077554f * (fConst11 / fConst0);
		fConst13 = std::floor(0.031604f * fConst0 + 0.5f);
		...
		fConst16 = std::floor(0.125f * fConst0 + 0.5f);
		fConst17 = 6.9077554f * (fConst16 / fConst0);
		fConst18 = std::floor(0.013458f * fConst0 + 0.5f);
		...
		fConst26 = std::floor(0.192303f * fConst0 + 0.5f);
		fConst27 = 6.9077554f * (fConst26 / fConst0);
		fConst28 = std::floor(0.029291f * fConst0 + 0.5f);
		...
		fConst31 = std::floor(0.256891f * fConst0 + 0.5f);
		...
		fConst36 = std::floor(0.153129f * fConst0 + 0.5f);
		fConst37 = 6.9077554f * (fConst36 / fConst0);
		fConst38 = std::floor(0.020346f * fConst0 + 0.5f);
	...
	virtual void instanceClear() {
		...
		for (int l50 = 0; l50 < 65536; l50 = l50 + 1) {
			fVec18[l50] = 0.0f;
		}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow46 = fSlow21 * fSlow26;
		float fSlow47 = 0.083333336f * fSlow19 * (fSlow46 + fSlow25 * fSlow23);
		...
		float fSlow57 = std::exp(-(fConst22 / fSlow4));
		float fSlow58 = fx_shimmer_faustpower2_f(fSlow57);
		float fSlow59 = 1.0f - fSlow6 * fSlow58;
		float fSlow60 = 1.0f - fSlow58;
		float fSlow61 = std::sqrt(std::max<float>(0.0f, fx_shimmer_faustpower2_f(fSlow59) / fx_shimmer_faustpower2_f(fSlow60) + -1.0f));
		float fSlow62 = fSlow59 / fSlow60;
		float fSlow63 = fSlow57 * (fSlow61 + (1.0f - fSlow62));
		float fSlow64 = std::exp(-(fConst22 / fSlow13)) / fSlow57 + -1.0f;
		float fSlow65 = fSlow62 - fSlow61;
		float fSlow66 = fSlow25 * (2.0f - fSlow20);
		float fSlow67 = 0.083333336f * fSlow19 * (fSlow24 + fSlow66);
		...
		float fSlow77 = 0.083333336f * fSlow19 * (fSlow25 * (2.0f - fSlow22) + fSlow21 * (0.25f * fSlow20 + 2.0f));
		float fSlow78 = std::exp(-(fConst32 / fSlow4));
		float fSlow79 = fx_shimmer_faustpower2_f(fSlow78);
		float fSlow80 = 1.0f - fSlow6 * fSlow79;
		float fSlow81 = 1.0f - fSlow79;
		float fSlow82 = std::sqrt(std::max<float>(0.0f, fx_shimmer_faustpower2_f(fSlow80) / fx_shimmer_faustpower2_f(fSlow81) + -1.0f));
		float fSlow83 = fSlow80 / fSlow81;
		float fSlow84 = fSlow78 * (fSlow82 + (1.0f - fSlow83));
		float fSlow85 = std::exp(-(fConst32 / fSlow13)) / fSlow78 + -1.0f;
		float fSlow86 = fSlow83 - fSlow82;
		float fSlow87 = 0.083333336f * fSlow19 * (fSlow66 + fSlow21 * (0.5f * fSlow20 + 2.0f));
		float fSlow88 = std::exp(-(fConst37 / fSlow4));
		float fSlow89 = fx_shimmer_faustpower2_f(fSlow88);
		float fSlow90 = 1.0f - fSlow89 * fSlow6;
		...
		float fSlow97 = 0.083333336f * fSlow19 * (fSlow46 + fSlow25 * (0.4f * fSlow20 + 2.0f));
		float fSlow98 = std::exp(-(fConst42 / fSlow4));
		float fSlow99 = fx_shimmer_faustpower2_f(fSlow98);
		float fSlow100 = 1.0f - fSlow6 * fSlow99;
		...
		float fSlow107 = 0.083333336f * fSlow19 * (fSlow46 + fSlow25 * (0.33333334f * fSlow20 + 2.0f));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp5 = 0.35355338f * fRec11[0] + 1e-20f;
			fVec1[IOTA0 & 131071] = fTemp5;
			float fTemp6 = ((1 - iVec0[1]) ? 0.0f : fSlow31 + fRec15[1]);
			fRec15[0] = fTemp6 - std::floor(fTemp6);
			float fTemp7 = fSlow30 * ftbl0fx_shimmerSIG0[std::max<int>(0, std::min<int>(int(65536.0f * fRec15[0]), 65535))];
			float fTemp8 = std::fabs(fTemp5);
			fRec16[0] = std::max<float>(fTemp8, fSlow35 * fRec16[1] + fSlow36 * fTemp8);
			fRec13[0] = std::fmod(fRec13[1] + (2049.0f - std::pow(2.0f, fSlow27 * (fSlow28 * (fTemp7 + fSlow32 * fRec16[0]) + 0.5f))), 2048.0f);
			int iTemp9 = int(fRec13[0]);
			float fTemp10 = std::floor(fRec13[0]);
			float fTemp11 = std::min<float>(0.0009765625f * fRec13[0], 1.0f);
			float fTemp12 = fRec13[0] + 2048.0f;
			int iTemp13 = int(fTemp12);
			float fTemp14 = std::floor(fTemp12);
			fVec3[IOTA0 & 65535] = fSlow3 * fTemp5 + fSlow2 * ((fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp9))) & 131071] * (fTemp10 + (1.0f - fRec13[0])) + (fRec13[0] - fTemp10) * fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp9 + 1))) & 131071]) * fTemp11 + (fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp13))) & 131071] * (fTemp14 + (-2047.0f - fRec13[0])) + (fRec13[0] + (2048.0f - fTemp14)) * fVec1[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp13 + 1))) & 131071]) * (1.0f - fTemp11));
			float fTemp15 = 0.6f * fRec9[1] + fTemp4 + fVec3[(IOTA0 - iConst9) & 65535];
			fVec4[IOTA0 & 4095] = fTemp15;
			fRec9[0] = fVec4[(IOTA0 - iConst10) & 4095];
			float fRec10 = -(0.6f * fTemp15);
			fRec20[0] = -(fSlow16 * (fSlow17 * fRec20[1] - (fRec3[1] + fRec3[2])));
			fRec19[0] = fSlow43 * (fRec3[1] + fSlow44 * fRec20[0]) + fSlow45 * fRec19[1];
			...
			fRec21[0] = std::fmod(fRec21[1] + (2049.0f - std::pow(2.0f, fSlow47 * (fSlow28 * (fTemp7 + fSlow32 * fRec22[0]) + 0.5f))), 2048.0f);
			...
			fRec27[0] = std::fmod(fRec27[1] + (2049.0f - std::pow(2.0f, fSlow47 * (fSlow28 * (fTemp7 + fSlow32 * fRec28[0]) + 0.5f))), 2048.0f);
			...
			float fTemp33 = fTemp2 + fVec9[(IOTA0 - iConst19) & 32767] - 0.6f * fRec23[1];
			fVec10[IOTA0 & 4095] = fTemp33;
			fRec23[0] = fVec10[(IOTA0 - iConst20) & 4095];
			float fRec24 = 0.6f * fTemp33;
			fRec32[0] = -(fSlow16 * (fSlow17 * fRec32[1] - (fRec2[1] + fRec2[2])));
			fRec31[0] = fSlow63 * (fRec2[1] + fSlow64 * fRec32[0]) + fSlow65 * fRec31[1];
			...
			fRec33[0] = std::fmod(fRec33[1] + (2049.0f - std::pow(2.0f, fSlow67 * (fSlow28 * (fTemp7 + fSlow32 * fRec34[0]) + 0.5f))), 2048.0f);
			...
			float fTemp42 = 0.6f * fRec29[1] + fTemp4 + fVec12[(IOTA0 - iConst24) & 65535];
			fVec13[IOTA0 & 8191] = fTemp42;
			fRec29[0] = fVec13[(IOTA0 - iConst25) & 8191];
			float fRec30 = -(0.6f * fTemp42);
			fRec38[0] = -(fSlow16 * (fSlow17 * fRec38[1] - (fRec6[1] + fRec6[2])));
			fRec37[0] = fSlow74 * (fRec6[1] + fSlow75 * fRec38[0]) + fSlow76 * fRec37[1];
			...
			fRec39[0] = std::fmod(fRec39[1] + (2049.0f - std::pow(2.0f, fSlow77 * (fSlow28 * (fTemp7 + fSlow32 * fRec40[0]) + 0.5f))), 2048.0f);
			...
			float fTemp51 = 0.6f * fRec35[1] + fTemp4 + fVec15[(IOTA0 - iConst29) & 32767];
			fVec16[IOTA0 & 8191] = fTemp51;
			fRec35[0] = fVec16[(IOTA0 - iConst30) & 8191];
			float fRec36 = -(0.6f * fTemp51);
			fRec44[0] = -(fSlow16 * (fSlow17 * fRec44[1] - (fRec4[1] + fRec4[2])));
			fRec43[0] = fSlow84 * (fRec4[1] + fSlow85 * fRec44[0]) + fSlow86 * fRec43[1];
			...
			fRec45[0] = std::fmod(fRec45[1] + (2049.0f - std::pow(2.0f, fSlow87 * (fSlow28 * (fTemp7 + fSlow32 * fRec46[0]) + 0.5f))), 2048.0f);
			...
			fVec18[IOTA0 & 65535] = fSlow3 * fTemp52 + fSlow2 * ((fVec17[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp54))) & 131071] * (fTemp55 + (1.0f - fRec45[0])) + (fRec45[0] - fTemp55) * fVec17[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp54 + 1))) & 131071]) * fTemp56 + (fVec17[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp58))) & 131071] * (fTemp59 + (-2047.0f - fRec45[0])) + (fRec45[0] + (2048.0f - fTemp59)) * fVec17[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp58 + 1))) & 131071]) * (1.0f - fTemp56));
			float fTemp60 = fVec18[(IOTA0 - iConst34) & 65535] + fTemp4 + 0.6f * fRec41[1];
			fVec19[IOTA0 & 8191] = fTemp60;
			fRec41[0] = fVec19[(IOTA0 - iConst35) & 8191];
			float fRec42 = -(0.6f * fTemp60);
			fRec50[0] = fSlow16 * (fRec1[1] + fRec1[2] - fSlow17 * fRec50[1]);
			fRec49[0] = fSlow94 * (fRec1[1] + fSlow95 * fRec50[0]) + fSlow96 * fRec49[1];
			float fTemp61 = 0.35355338f * fRec49[0] + 1e-20f;
			fVec20[IOTA0 & 131071] = fTemp61;
			float fTemp62 = std::fabs(fTemp61);
			fRec52[0] = std::max<float>(fTemp62, fRec52[1] * fSlow35 + fTemp62 * fSlow36);
			fRec51[0] = std::fmod(fRec51[1] + (2049.0f - std::pow(2.0f, fSlow97 * (fSlow28 * (fSlow32 * fRec52[0] + fTemp7) + 0.5f))), 2048.0f);
			...
			fVec22[IOTA0 & 4095] = fTemp69;
			fRec47[0] = fVec22[(IOTA0 - iConst40) & 4095];
			...
			fRec58[0] = std::max<float>(fTemp71, fSlow35 * fRec58[1] + fSlow36 * fTemp71);
			fRec57[0] = std::fmod(fRec57[1] + (2049.0f - std::pow(2.0f, fSlow107 * (fSlow28 * (fTemp7 + fSlow32 * fRec58[0]) + 0.5f))), 2048.0f);
			...
			float fTemp79 = fRec47[1] + fRec53[1];
			float fTemp80 = fRec30 + fRec36 + fTemp79;
			fRec1[0] = fRec9[1] + fRec17[1] + fRec23[1] + fRec29[1] + fRec35[1] + fRec41[1] + fRec42 + fRec10 + fRec48 + fRec54 + fRec18 + fRec24 + fTemp80;
			float fTemp81 = fRec30 + fRec36;
			fRec2[0] = fRec17[1] + fRec23[1] + fRec48 + fRec54 + fRec18 + fRec24 + fTemp79 - (fRec9[1] + fRec29[1] + fRec35[1] + fRec41[1] + fRec42 + fRec10 + fTemp81);
			fRec3[0] = fRec29[1] + fRec35[1] + fRec48 + fRec54 + fTemp80 - (fRec9[1] + fRec17[1] + fRec23[1] + fRec41[1] + fRec42 + fRec10 + fRec18 + fRec24);
			fRec4[0] = fRec9[1] + fRec41[1] + fRec42 + fRec10 + fRec48 + fRec54 + fTemp79 - (fRec17[1] + fRec23[1] + fRec29[1] + fRec35[1] + fRec18 + fRec24 + fTemp81);
			float fTemp82 = fRec30 + fRec47[1];
			float fTemp83 = fRec36 + fRec53[1];
			fRec5[0] = fRec17[1] + fRec29[1] + fRec41[1] + fRec42 + fRec48 + fRec18 + fTemp82 - (fRec9[1] + fRec23[1] + fRec35[1] + fRec10 + fRec54 + fRec24 + fTemp83);
			float fTemp84 = fRec36 + fRec47[1];
			float fTemp85 = fRec30 + fRec53[1];
			fRec6[0] = fRec9[1] + fRec17[1] + fRec35[1] + fRec10 + fRec48 + fRec18 + fTemp84 - (fRec23[1] + fRec29[1] + fRec41[1] + fRec42 + fRec54 + fRec24 + fTemp85);
			fRec7[0] = fRec9[1] + fRec23[1] + fRec29[1] + fRec10 + fRec48 + fRec24 + fTemp82 - (fRec17[1] + fRec35[1] + fRec41[1] + fRec42 + fRec54 + fRec18 + fTemp83);
			fRec8[0] = fRec23[1] + fRec35[1] + fRec41[1] + fRec42 + fRec48 + fRec24 + fTemp84 - (fRec9[1] + fRec17[1] + fRec29[1] + fRec10 + fRec54 + fRec18 + fTemp85);
			output0[i0] = FAUSTFLOAT(((iSlow0) ? fTemp1 : fTemp0 * fTemp2 + fRec0[0] * (fRec1[0] + fRec3[0] + fRec5[0] + fRec7[0])));
			output1[i0] = FAUSTFLOAT(((iSlow0) ? fTemp3 : fTemp0 * fTemp4 + fRec0[0] * (fRec2[0] + fRec4[0] + fRec6[0] + fRec8[0])));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec12[1] = fRec12[0];
			fRec11[1] = fRec11[0];
