...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_distortion -scn fx_distortion_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __fx_distortion_H__
#define  __fx_distortion_H__
...
class FAUST_API fx_distortion_dsp {

    public:

        fx_distortion_dsp() = default;
        virtual ~fx_distortion_dsp() = default;
...
class FAUST_API decorator_dsp : public ::fx_distortion_dsp {
...
/**
 The base class of Meta handler to be used in fx_distortion_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS fx_distortion
#endif
...
static float fx_distortion_faustpower2_f(float value) {
	return value * value;
}
...
class fx_distortion : public fx_distortion_dsp {
 ...
 public:
	...
	fx_distortion(const fx_distortion&) = default;
	
	virtual ~fx_distortion() = default;
	
	fx_distortion& operator=(const fx_distortion&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_distortion -scn fx_distortion_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "fx_distortion.dsp");
	...
	virtual fx_distortion* clone() {
		return new fx_distortion(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("fx.distortion");
		ui_interface->addCheckButton("bypass", &fCheckbox0);
		ui_interface->addVerticalSlider("drive", &fVslider1, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		...
		ui_interface->addVerticalSlider("offset", &fVslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.5f), FAUSTFLOAT(0.001f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow3 = fConst0 * static_cast<float>(fVslider1);
...
class faust_fx_distortion_tilde : public FaustExternal<fx_distortion> {
public:
    faust_fx_distortion_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(fx_distortion))
    {
    }
};
