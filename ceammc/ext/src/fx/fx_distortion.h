...
class distortion : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("drive", &fslider2, 0.5f, 0.0f, 1.0f, 0.001f);
		ui_interface->declare(&fslider0, "style", "knob");
		ui_interface->addHorizontalSlider("drywet", &fslider0, 1.0f, 0.0f, 1.0f, 0.01f);
		ui_interface->addVerticalSlider("offset", &fslider1, 0.0f, 0.0f, 0.5f, 0.001f);
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			fRec3[0] = (fSlow3 + (0.999f * fRec3[1]));
			float fTemp2 = max((float)-1, min((float)1, (fRec2[0] + (fTemp1 * powf(1e+01f,(2 * fRec3[0]))))));
			float fTemp3 = (fTemp2 * (1 - (0.33333334f * faustpower<2>(fTemp2))));
			fVec0[0] = fTemp3;
			fRec1[0] = (((0.995f * fRec1[1]) + fVec0[0]) - fVec0[1]);
			output0[i] = (FAUSTFLOAT)((iSlow0)?fTemp0:((fTemp1 * (1 - fRec0[0])) + (fRec0[0] * fRec1[0])));
			// post processing
			fRec1[1] = fRec1[0];
			fVec0[1] = fVec0[0];
			fRec3[1] = fRec3[0];
