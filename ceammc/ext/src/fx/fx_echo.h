...
class fx_echo : public fx_echo_dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("c.attack", &fHslider6, FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.1f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fHslider7, "unit", "ms");
		ui_interface->addHorizontalSlider("c.release", &fHslider7, FAUSTFLOAT(5e+01f), FAUSTFLOAT(1.0f), FAUSTFLOAT(5e+02f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fHslider5, "unit", "db");
		ui_interface->addHorizontalSlider("c.threshold", &fHslider5, FAUSTFLOAT(0.0f), FAUSTFLOAT(-6e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.1f));
		...
		ui_interface->addHorizontalSlider("f.hpf", &fHslider8, FAUSTFLOAT(3e+02f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+04f), FAUSTFLOAT(0.01f));
		ui_interface->declare(&fHslider9, "unit", "hz");
		ui_interface->addHorizontalSlider("f.lpf", &fHslider9, FAUSTFLOAT(9e+03f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+04f), FAUSTFLOAT(0.01f));
...
// clang-format on
    ...
    template <class T>
    struct _fx_echo_UI : public UI {
    static std::string name;
};

template <class T>
std::string _fx_echo_UI<T>::name(sym(fx_echo));

typedef _fx_echo_UI<fx_echo> fx_echo_UI;

class faust_fx_echo_tilde : public FaustExternal<fx_echo, fx_echo_UI> {
public:
