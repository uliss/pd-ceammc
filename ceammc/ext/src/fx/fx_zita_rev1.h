 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp16 = (fRec39 + fRec10);
			float fTemp17 = (fRec35 + fTemp16);
			fRec1[0] = (fRec9[1] + (fRec14[1] + (fRec18[1] + (fRec22[1] + (fRec26[1] + (fRec30[1] + (fRec34[1] + (fRec38[1] + (fRec15 + (fRec19 + (fRec23 + (fRec27 + (fRec31 + fTemp17)))))))))))));
			float fTemp18 = (fRec39 + fRec35);
			fRec2[0] = ((fRec26[1] + (fRec30[1] + (fRec34[1] + (fRec38[1] + (fRec27 + (fRec31 + fTemp18)))))) - (fRec9[1] + (fRec14[1] + (fRec18[1] + (fRec22[1] + (fRec15 + (fRec19 + (fRec23 + fRec10))))))));
			fRec3[0] = ((fRec18[1] + (fRec22[1] + (fRec34[1] + (fRec38[1] + (fRec19 + (fRec23 + fTemp18)))))) - (fRec9[1] + (fRec14[1] + (fRec26[1] + (fRec30[1] + (fRec15 + (fRec27 + (fRec31 + fRec10))))))));
			fRec4[0] = ((fRec9[1] + (fRec14[1] + (fRec34[1] + (fRec38[1] + (fRec15 + fTemp17))))) - (fRec18[1] + (fRec22[1] + (fRec26[1] + (fRec30[1] + (fRec19 + (fRec23 + (fRec31 + fRec27))))))));
			float fTemp19 = (fRec35 + fRec10);
			fRec5[0] = ((fRec14[1] + (fRec22[1] + (fRec30[1] + (fRec38[1] + (fRec15 + (fRec23 + (fRec39 + fRec31))))))) - (fRec9[1] + (fRec18[1] + (fRec26[1] + (fRec34[1] + (fRec19 + (fRec27 + fTemp19)))))));
			fRec6[0] = ((fRec9[1] + (fRec18[1] + (fRec30[1] + (fRec38[1] + (fRec19 + (fRec31 + fTemp16)))))) - (fRec14[1] + (fRec22[1] + (fRec26[1] + (fRec34[1] + (fRec15 + (fRec23 + (fRec35 + fRec27))))))));
			fRec7[0] = ((fRec9[1] + (fRec22[1] + (fRec26[1] + (fRec38[1] + (fRec23 + (fRec27 + fTemp16)))))) - (fRec14[1] + (fRec18[1] + (fRec30[1] + (fRec34[1] + (fRec15 + (fRec19 + (fRec35 + fRec31))))))));
			fRec8[0] = ((fRec14[1] + (fRec18[1] + (fRec26[1] + (fRec38[1] + (fRec15 + (fRec19 + (fRec39 + fRec27))))))) - (fRec9[1] + (fRec22[1] + (fRec30[1] + (fRec34[1] + (fRec23 + (fRec31 + fTemp19)))))));
