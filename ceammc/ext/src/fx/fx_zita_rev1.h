...
class zita_rev1 : public dsp {
  ...
  public:
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst24 = floorf(((0.192303f * fConst0) + 0.5f));
		fConst25 = ((0 - (6.9077554f * fConst24)) / fConst0);
		fConst26 = floorf(((0.029291f * fConst0) + 0.5f));
		...
		fConst34 = floorf(((0.256891f * fConst0) + 0.5f));
		fConst35 = ((0 - (6.9077554f * fConst34)) / fConst0);
		fConst36 = floorf(((0.027333f * fConst0) + 0.5f));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("decay_low", &fslider4, 3.0f, 1.0f, 8.0f, 0.1f);
		ui_interface->declare(&fslider3, "scale", "log");
		ui_interface->declare(&fslider3, "style", "knob");
		ui_interface->declare(&fslider3, "unit", "s");
		ui_interface->addVerticalSlider("decay_mid", &fslider3, 2.0f, 1.0f, 8.0f, 0.1f);
		ui_interface->declare(&fslider1, "style", "knob");
		ui_interface->declare(&fslider1, "unit", "ms");
		ui_interface->addVerticalSlider("delay", &fslider1, 6e+01f, 2e+01f, 1e+02f, 1.0f);
		...
		ui_interface->addVerticalSlider("freq_low", &fslider5, 2e+02f, 5e+01f, 1e+03f, 1.0f);
		ui_interface->closeBox();
	}
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		int 	iSlow0 = int(float(fcheckbox0));
		float 	fSlow1 = (0.001f * float(fslider0));
		int 	iSlow2 = int((int((fConst1 * float(fslider1))) & 8191));
		float 	fSlow3 = cosf((fConst2 * float(fslider2)));
		float 	fSlow4 = float(fslider3);
		float 	fSlow5 = expf((fConst4 / fSlow4));
		float 	fSlow6 = faustpower<2>(fSlow5);
		float 	fSlow7 = (1.0f - (fSlow3 * fSlow6));
		float 	fSlow8 = (1.0f - fSlow6);
		float 	fSlow9 = (fSlow7 / fSlow8);
		float 	fSlow10 = sqrtf(max((float)0, ((faustpower<2>(fSlow7) / faustpower<2>(fSlow8)) + -1.0f)));
		float 	fSlow11 = (fSlow9 - fSlow10);
		float 	fSlow12 = (fSlow5 * (fSlow10 + (1.0f - fSlow9)));
		float 	fSlow13 = float(fslider4);
		float 	fSlow14 = ((expf((fConst4 / fSlow13)) / fSlow5) + -1);
		float 	fSlow15 = (1.0f / tanf((fConst5 * float(fslider5))));
		float 	fSlow16 = (fSlow15 + 1);
		float 	fSlow17 = (0 - ((1 - fSlow15) / fSlow16));
		float 	fSlow18 = (1.0f / fSlow16);
		float 	fSlow19 = expf((fConst10 / fSlow4));
		float 	fSlow20 = faustpower<2>(fSlow19);
		float 	fSlow21 = (1.0f - (fSlow3 * fSlow20));
		...
		float 	fSlow27 = ((expf((fConst10 / fSlow13)) / fSlow19) + -1);
		float 	fSlow28 = expf((fConst15 / fSlow4));
		float 	fSlow29 = faustpower<2>(fSlow28);
		float 	fSlow30 = (1.0f - (fSlow29 * fSlow3));
		...
		float 	fSlow36 = ((expf((fConst15 / fSlow13)) / fSlow28) + -1);
		float 	fSlow37 = expf((fConst20 / fSlow4));
		...
		float 	fSlow45 = ((expf((fConst20 / fSlow13)) / fSlow37) + -1);
		float 	fSlow46 = expf((fConst25 / fSlow4));
		...
		float 	fSlow54 = ((expf((fConst25 / fSlow13)) / fSlow46) + -1);
		float 	fSlow55 = expf((fConst30 / fSlow4));
		float 	fSlow56 = faustpower<2>(fSlow55);
		float 	fSlow57 = (1.0f - (fSlow3 * fSlow56));
		...
		float 	fSlow63 = ((expf((fConst30 / fSlow13)) / fSlow55) + -1);
		float 	fSlow64 = expf((fConst35 / fSlow4));
		...
		float 	fSlow72 = ((expf((fConst35 / fSlow13)) / fSlow64) + -1);
		float 	fSlow73 = expf((fConst40 / fSlow4));
		...
		float 	fSlow81 = ((expf((fConst40 / fSlow13)) / fSlow73) + -1);
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp3 = (0.3f * fVec0[(IOTA-iSlow2)&8191]);
			fRec12[0] = ((fSlow17 * fRec12[1]) + (fSlow18 * (fRec1[1] + fRec1[2])));
			fRec11[0] = ((fSlow11 * fRec11[1]) + (fSlow12 * ((fSlow14 * fRec12[0]) + fRec1[1])));
			fVec1[IOTA&8191] = ((0.35355338f * fRec11[0]) + 1e-20f);
			float fTemp4 = ((fTemp3 + fVec1[(IOTA-iConst7)&8191]) - (0.6f * fRec9[1]));
			fVec2[IOTA&1023] = fTemp4;
			fRec9[0] = fVec2[(IOTA-iConst8)&1023];
			float 	fRec10 = (0.6f * fVec2[IOTA&1023]);
			fRec16[0] = ((fSlow18 * (fRec3[1] + fRec3[2])) + (fSlow17 * fRec16[1]));
			fRec15[0] = ((fSlow25 * fRec15[1]) + (fSlow26 * (fRec3[1] + (fSlow27 * fRec16[0]))));
			...
			fRec13[0] = fVec4[(IOTA-iConst13)&2047];
			float 	fRec14 = (0.6f * fVec4[IOTA&2047]);
			fRec20[0] = ((fSlow18 * (fRec7[1] + fRec7[2])) + (fSlow17 * fRec20[1]));
			fRec19[0] = ((fSlow34 * fRec19[1]) + (fSlow35 * (fRec7[1] + (fSlow36 * fRec20[0]))));
			fVec5[IOTA&8191] = ((0.35355338f * fRec19[0]) + 1e-20f);
			float fTemp6 = (fVec5[(IOTA-iConst17)&8191] - (fTemp3 + (0.6f * fRec17[1])));
			fVec6[IOTA&1023] = fTemp6;
			fRec17[0] = fVec6[(IOTA-iConst18)&1023];
			float 	fRec18 = (0.6f * fVec6[IOTA&1023]);
			fRec24[0] = ((fSlow17 * fRec24[1]) + (fSlow18 * (fRec2[2] + fRec2[1])));
			fRec23[0] = ((fSlow43 * fRec23[1]) + (fSlow44 * ((fSlow45 * fRec24[0]) + fRec2[1])));
			fVec7[IOTA&16383] = ((0.35355338f * fRec23[0]) + 1e-20f);
			float fTemp7 = (float)input1[i];
			float fTemp8 = ((iSlow0)?0:fTemp7);
			fVec8[IOTA&8191] = fTemp8;
			float fTemp9 = (0.3f * fVec8[(IOTA-iSlow2)&8191]);
			float fTemp10 = (fVec7[(IOTA-iConst22)&16383] + (fTemp9 + (0.6f * fRec21[1])));
			fVec9[IOTA&2047] = fTemp10;
			fRec21[0] = fVec9[(IOTA-iConst23)&2047];
			float 	fRec22 = (0 - (0.6f * fVec9[IOTA&2047]));
			fRec28[0] = ((fSlow17 * fRec28[1]) + (fSlow18 * (fRec6[1] + fRec6[2])));
			fRec27[0] = ((fSlow52 * fRec27[1]) + (fSlow53 * ((fSlow54 * fRec28[0]) + fRec6[1])));
			fVec10[IOTA&8191] = ((0.35355338f * fRec27[0]) + 1e-20f);
			float fTemp11 = ((fTemp9 + (0.6f * fRec25[1])) + fVec10[(IOTA-iConst27)&8191]);
			fVec11[IOTA&2047] = fTemp11;
			fRec25[0] = fVec11[(IOTA-iConst28)&2047];
			float 	fRec26 = (0 - (0.6f * fVec11[IOTA&2047]));
			fRec32[0] = ((fSlow17 * fRec32[1]) + (fSlow18 * (fRec5[1] + fRec5[2])));
			fRec31[0] = ((fSlow61 * fRec31[1]) + (fSlow62 * ((fSlow63 * fRec32[0]) + fRec5[1])));
			fVec12[IOTA&8191] = ((0.35355338f * fRec31[0]) + 1e-20f);
			float fTemp12 = ((fTemp3 + fVec12[(IOTA-iConst32)&8191]) - (0.6f * fRec29[1]));
			fVec13[IOTA&2047] = fTemp12;
			fRec29[0] = fVec13[(IOTA-iConst33)&2047];
			float 	fRec30 = (0.6f * fVec13[IOTA&2047]);
			fRec36[0] = ((fSlow18 * (fRec4[1] + fRec4[2])) + (fSlow17 * fRec36[1]));
			fRec35[0] = ((fSlow70 * fRec35[1]) + (fSlow71 * (fRec4[1] + (fSlow72 * fRec36[0]))));
			fVec14[IOTA&16383] = ((0.35355338f * fRec35[0]) + 1e-20f);
			float fTemp13 = (((0.6f * fRec33[1]) + fVec14[(IOTA-iConst37)&16383]) - fTemp9);
			fVec15[IOTA&2047] = fTemp13;
			fRec33[0] = fVec15[(IOTA-iConst38)&2047];
			float 	fRec34 = (0 - (0.6f * fVec15[IOTA&2047]));
			fRec40[0] = ((fSlow18 * (fRec8[1] + fRec8[2])) + (fSlow17 * fRec40[1]));
			fRec39[0] = ((fSlow79 * fRec39[1]) + (fSlow80 * (fRec8[1] + (fSlow81 * fRec40[0]))));
			fVec16[IOTA&16383] = ((0.35355338f * fRec39[0]) + 1e-20f);
			float fTemp14 = (((0.6f * fRec37[1]) + fVec16[(IOTA-iConst42)&16383]) - fTemp9);
			fVec17[IOTA&1023] = fTemp14;
			fRec37[0] = fVec17[(IOTA-iConst43)&1023];
			float 	fRec38 = (0 - (0.6f * fVec17[IOTA&1023]));
			float fTemp15 = (fRec37[1] + fRec38);
			float fTemp16 = (fRec34 + (fRec33[1] + fTemp15));
			float fTemp17 = (fRec9[1] + (fRec30 + (fRec29[1] + fTemp16)));
			fRec1[0] = (fRec10 + (fRec14 + (fRec13[1] + (fRec18 + (fRec17[1] + (fRec22 + (fRec21[1] + (fRec26 + (fRec25[1] + fTemp17)))))))));
			float fTemp18 = (fRec9[1] + (fRec29[1] + fRec30));
			fRec2[0] = ((fRec10 + (fRec14 + (fRec13[1] + (fRec18 + (fRec17[1] + fTemp18))))) - (fRec22 + (fRec21[1] + (fRec26 + (fRec25[1] + fTemp16)))));
			fRec3[0] = ((fRec10 + (fRec22 + (fRec21[1] + (fRec26 + (fRec25[1] + fTemp18))))) - (fRec14 + (fRec13[1] + (fRec18 + (fRec17[1] + fTemp16)))));
			fRec4[0] = ((fRec10 + fTemp17) - (fRec14 + (fRec13[1] + (fRec18 + (fRec17[1] + (fRec22 + (fRec21[1] + (fRec25[1] + fRec26))))))));
			float fTemp19 = (fRec33[1] + fRec34);
			float fTemp20 = (fRec9[1] + fTemp19);
			float fTemp21 = (fRec30 + (fRec29[1] + fTemp15));
			fRec5[0] = ((fRec10 + (fRec14 + (fRec13[1] + (fRec22 + (fRec21[1] + fTemp20))))) - (fRec18 + (fRec17[1] + (fRec26 + (fRec25[1] + fTemp21)))));
			float fTemp22 = (fRec9[1] + fTemp15);
			float fTemp23 = (fRec30 + (fRec29[1] + fTemp19));
			fRec6[0] = ((fRec10 + (fRec14 + (fRec13[1] + (fRec26 + (fRec25[1] + fTemp22))))) - (fRec18 + (fRec17[1] + (fRec22 + (fRec21[1] + fTemp23)))));
			fRec7[0] = ((fRec10 + (fRec18 + (fRec17[1] + (fRec22 + (fRec21[1] + fTemp22))))) - (fRec14 + (fRec13[1] + (fRec26 + (fRec25[1] + fTemp23)))));
			fRec8[0] = ((fRec10 + (fRec18 + (fRec17[1] + (fRec26 + (fRec25[1] + fTemp20))))) - (fRec14 + (fRec13[1] + (fRec22 + (fRec21[1] + fTemp21)))));
			output0[i] = (FAUSTFLOAT)((iSlow0)?fTemp0:((fVec0[IOTA&8191] * fTemp2) + (0.37f * (fRec0[0] * (fRec2[0] + fRec3[0])))));
			output1[i] = (FAUSTFLOAT)((iSlow0)?fTemp7:((fVec8[IOTA&8191] * fTemp2) + (0.37f * (fRec0[0] * (fRec2[0] - fRec3[0])))));
			// post processing
