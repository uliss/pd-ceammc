...
class fx_zita_rev1 : public fx_zita_rev1_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst8 = int(std::min<float>(32768.0f, std::max<float>(0.0f, (fConst4 - fConst7))));
		...
		float fConst37 = std::floor(((0.210389003f * fConst0) + 0.5f));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("damp_hf", &fVslider0, FAUSTFLOAT(6000.0f), FAUSTFLOAT(1500.0f), FAUSTFLOAT(47040.0f), FAUSTFLOAT(1.0f));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = std::cos((fConst3 * float(fVslider0)));
		int iSlow3 = int(float(fCheckbox1));
		float fThen1 = float(fVslider1);
		float fElse1 = float(fHslider1);
		float fSlow4 = (iSlow3 ? fElse1 : fThen1);
		...
		float fSlow15 = (iSlow3 ? fElse2 : fThen2);
		float fSlow16 = ((std::exp((fConst5 / fSlow15)) / fSlow5) + -1.0f);
		...
		float fSlow23 = std::exp((fConst13 / fSlow4));
		...
		float fSlow32 = std::exp((fConst18 / fSlow4));
		...
		float fSlow41 = std::exp((fConst23 / fSlow4));
		...
		float fSlow50 = std::exp((fConst28 / fSlow4));
		...
		float fSlow59 = std::exp((fConst33 / fSlow4));
		...
		float fSlow68 = std::exp((fConst38 / fSlow4));
		...
		float fSlow77 = std::exp((fConst43 / fSlow4));
		...
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			...
			float fTemp7 = (((0.600000024f * fRec9[1]) + fVec0[((IOTA - iConst8) & 65535)]) - fTemp6);
			fVec2[(IOTA & 4095)] = fTemp7;
			fRec9[0] = fVec2[((IOTA - iConst11) & 4095)];
			...
			float fTemp8 = (((0.600000024f * fRec15[1]) + fVec3[((IOTA - iConst15) & 65535)]) - fTemp6);
			fVec4[(IOTA & 8191)] = fTemp8;
			fRec15[0] = fVec4[((IOTA - iConst16) & 8191)];
			...
			float fTemp9 = (fVec5[((IOTA - iConst20) & 32767)] + (fTemp6 + (0.600000024f * fRec19[1])));
			fVec6[(IOTA & 8191)] = fTemp9;
			fRec19[0] = fVec6[((IOTA - iConst21) & 8191)];
			...
			fVec8[(IOTA & 16383)] = (fRec13[0] * fTemp1);
			float fTemp10 = (0.300000012f * fVec8[((IOTA - iTemp5) & 16383)]);
			float fTemp11 = (fVec7[((IOTA - iConst25) & 32767)] - (fTemp10 + (0.600000024f * fRec23[1])));
			fVec9[(IOTA & 8191)] = fTemp11;
			fRec23[0] = fVec9[((IOTA - iConst26) & 8191)];
			...
			float fTemp12 = ((fTemp10 + fVec10[((IOTA - iConst30) & 32767)]) - (0.600000024f * fRec27[1]));
			fVec11[(IOTA & 8191)] = fTemp12;
			fRec27[0] = fVec11[((IOTA - iConst31) & 8191)];
			...
			float fTemp13 = ((fVec12[((IOTA - iConst35) & 32767)] + fTemp10) - (0.600000024f * fRec31[1]));
			fVec13[(IOTA & 4095)] = fTemp13;
			fRec31[0] = fVec13[((IOTA - iConst36) & 4095)];
			float fRec32 = (0.600000024f * fTemp13);
			fRec38[0] = (0.0f - (fSlow13 * ((fSlow14 * fRec38[1]) - (fRec2[1] + fRec2[2]))));
			fRec37[0] = ((fRec37[1] * fSlow74) + ((fSlow68 * (fRec2[1] + (fRec38[0] * fSlow75))) * fSlow76));
			fVec14[(IOTA & 65535)] = ((0.353553385f * fRec37[0]) + 9.99999968e-21f);
			float fTemp14 = (fTemp6 + ((0.600000024f * fRec35[1]) + fVec14[((IOTA - iConst40) & 65535)]));
			fVec15[(IOTA & 8191)] = fTemp14;
			fRec35[0] = fVec15[((IOTA - iConst41) & 8191)];
			float fRec36 = (0.0f - (0.600000024f * fTemp14));
			fRec42[0] = (0.0f - (fSlow13 * ((fSlow14 * fRec42[1]) - (fRec7[1] + fRec7[2]))));
			fRec41[0] = ((fRec41[1] * fSlow83) + ((fSlow77 * (fRec7[1] + (fRec42[0] * fSlow84))) * fSlow85));
			fVec16[(IOTA & 32767)] = ((0.353553385f * fRec41[0]) + 9.99999968e-21f);
			float fTemp15 = (fVec16[((IOTA - iConst45) & 32767)] - (fTemp10 + (0.600000024f * fRec39[1])));
			fVec17[(IOTA & 4095)] = fTemp15;
			fRec39[0] = fVec17[((IOTA - iConst46) & 4095)];
			float fRec40 = (0.600000024f * fTemp15);
			float fTemp16 = (fRec40 + fRec31[1]);
			float fTemp17 = (fRec36 + fTemp16);
			fRec1[0] = (fRec9[1] + (fRec15[1] + (fRec19[1] + (fRec24 + (fRec28 + (fRec32 + (fRec35[1] + (fRec39[1] + (fRec23[1] + (fRec27[1] + (fRec10 + (fRec16 + (fRec20 + fTemp17)))))))))))));
			fRec2[0] = ((fRec24 + (fRec28 + (fRec32 + (fRec39[1] + (fRec23[1] + (fRec27[1] + fTemp16)))))) - (fRec9[1] + (fRec15[1] + (fRec19[1] + (fRec35[1] + (fRec10 + (fRec16 + (fRec36 + fRec20))))))));
			float fTemp18 = (fRec36 + fRec31[1]);
			fRec3[0] = ((fRec19[1] + (fRec28 + (fRec32 + (fRec35[1] + (fRec27[1] + (fRec20 + fTemp18)))))) - (fRec9[1] + (fRec15[1] + (fRec24 + (fRec39[1] + (fRec23[1] + (fRec10 + (fRec40 + fRec16))))))));
			float fTemp19 = (fRec40 + fRec36);
			fRec4[0] = ((fRec9[1] + (fRec15[1] + (fRec28 + (fRec32 + (fRec27[1] + (fRec10 + (fRec16 + fRec31[1]))))))) - (fRec19[1] + (fRec24 + (fRec35[1] + (fRec39[1] + (fRec23[1] + (fRec20 + fTemp19)))))));
			fRec5[0] = ((fRec15[1] + (fRec24 + (fRec32 + (fRec35[1] + (fRec23[1] + (fRec16 + fTemp18)))))) - (fRec9[1] + (fRec19[1] + (fRec28 + (fRec39[1] + (fRec27[1] + (fRec10 + (fRec40 + fRec20))))))));
			fRec6[0] = ((fRec9[1] + (fRec19[1] + (fRec24 + (fRec32 + (fRec23[1] + (fRec10 + (fRec20 + fRec31[1]))))))) - (fRec15[1] + (fRec28 + (fRec35[1] + (fRec39[1] + (fRec27[1] + (fRec16 + fTemp19)))))));
			fRec7[0] = ((fRec9[1] + (fRec32 + (fRec35[1] + (fRec39[1] + (fRec10 + fTemp17))))) - (fRec15[1] + (fRec19[1] + (fRec24 + (fRec28 + (fRec23[1] + (fRec27[1] + (fRec20 + fRec16))))))));
			fRec8[0] = ((fRec15[1] + (fRec19[1] + (fRec32 + (fRec39[1] + (fRec16 + (fRec20 + fTemp16)))))) - (fRec9[1] + (fRec24 + (fRec28 + (fRec35[1] + (fRec23[1] + (fRec27[1] + (fRec36 + fRec10))))))));
