 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp16 = (fRec38[1] + fRec9[1]);
			float fTemp17 = (fRec34[1] + fTemp16);
			fRec1[0] = (fRec10 + (fRec15 + (fRec19 + (fRec23 + (fRec27 + (fRec31 + (fRec35 + (fRec39 + (fRec14[1] + (fRec18[1] + (fRec22[1] + (fRec26[1] + (fRec30[1] + fTemp17)))))))))))));
			float fTemp18 = (fRec38[1] + fRec34[1]);
			fRec2[0] = ((fRec27 + (fRec31 + (fRec35 + (fRec39 + (fRec26[1] + (fTemp18 + fRec30[1])))))) - (fRec10 + (fRec15 + (fRec19 + (fRec23 + (fRec14[1] + (fRec18[1] + (fRec22[1] + fRec9[1]))))))));
			fRec3[0] = ((fRec19 + (fRec23 + (fRec35 + (fRec39 + (fRec18[1] + (fTemp18 + fRec22[1])))))) - (fRec10 + (fRec15 + (fRec27 + (fRec31 + (fRec14[1] + (fRec26[1] + (fRec30[1] + fRec9[1]))))))));
			fRec4[0] = ((fRec10 + (fRec15 + (fRec35 + (fRec39 + (fRec14[1] + fTemp17))))) - (fRec19 + (fRec23 + (fRec27 + (fRec31 + (fRec18[1] + ((fRec30[1] + fRec26[1]) + fRec22[1])))))));
			float fTemp19 = (fRec34[1] + fRec9[1]);
			fRec5[0] = ((fRec15 + (fRec23 + (fRec31 + (fRec39 + (fRec14[1] + (fRec22[1] + (fRec38[1] + fRec30[1]))))))) - (fRec10 + (fRec19 + (fRec27 + (fRec35 + (fRec18[1] + (fRec26[1] + fTemp19)))))));
			fRec6[0] = ((fRec10 + (fRec19 + (fRec31 + (fRec39 + (fRec18[1] + (fRec30[1] + fTemp16)))))) - (fRec15 + (fRec23 + (fRec27 + (fRec35 + (fRec14[1] + (fRec22[1] + (fRec34[1] + fRec26[1]))))))));
			fRec7[0] = ((fRec10 + (fRec23 + (fRec27 + (fRec39 + (fRec22[1] + (fRec26[1] + fTemp16)))))) - (fRec15 + (fRec19 + (fRec31 + (fRec35 + (fRec14[1] + (fRec18[1] + (fRec34[1] + fRec30[1]))))))));
			fRec8[0] = ((fRec15 + (fRec19 + (fRec27 + (fRec39 + (fRec14[1] + (fRec18[1] + (fRec38[1] + fRec26[1]))))))) - (fRec10 + (fRec23 + (fRec31 + (fRec35 + (fRec22[1] + (fRec30[1] + fTemp19)))))));
