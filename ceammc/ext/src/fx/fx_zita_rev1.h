...
class fx_zita_rev1 : public fx_zita_rev1_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst2 = std::floor(((0.127837002f * fConst0) + 0.5f));
		fConst3 = ((0.0f - (6.90775537f * fConst2)) / fConst0);
		fConst4 = (3.14159274f / fConst0);
		float fConst5 = std::floor(((0.0316039994f * fConst0) + 0.5f));
		iConst6 = int(std::min<float>(16384.0f, std::max<float>(0.0f, (fConst2 - fConst5))));
		fConst7 = (1.0f / fConst0);
		fConst8 = (0.00100000005f * fConst0);
		iConst9 = int(std::min<float>(4096.0f, std::max<float>(0.0f, (fConst5 + -1.0f))));
		float fConst10 = std::floor(((0.174713001f * fConst0) + 0.5f));
		fConst11 = ((0.0f - (6.90775537f * fConst10)) / fConst0);
		float fConst12 = std::floor(((0.0229039993f * fConst0) + 0.5f));
		...
		float fConst15 = std::floor(((0.210389003f * fConst0) + 0.5f));
		fConst16 = ((0.0f - (6.90775537f * fConst15)) / fConst0);
		float fConst17 = std::floor(((0.0244210009f * fConst0) + 0.5f));
		iConst18 = int(std::min<float>(32768.0f, std::max<float>(0.0f, (fConst15 - fConst17))));
		...
		float fConst22 = std::floor(((0.0134579996f * fConst0) + 0.5f));
		iConst23 = int(std::min<float>(16384.0f, std::max<float>(0.0f, (fConst20 - fConst22))));
		iConst24 = int(std::min<float>(2048.0f, std::max<float>(0.0f, (fConst22 + -1.0f))));
		float fConst25 = std::floor(((0.153128996f * fConst0) + 0.5f));
		fConst26 = ((0.0f - (6.90775537f * fConst25)) / fConst0);
		float fConst27 = std::floor(((0.0203460008f * fConst0) + 0.5f));
		...
		float fConst30 = std::floor(((0.219990999f * fConst0) + 0.5f));
		fConst31 = ((0.0f - (6.90775537f * fConst30)) / fConst0);
		float fConst32 = std::floor(((0.0191229992f * fConst0) + 0.5f));
		iConst33 = int(std::min<float>(32768.0f, std::max<float>(0.0f, (fConst30 - fConst32))));
		...
		float fConst37 = std::floor(((0.0273330007f * fConst0) + 0.5f));
		...
		float fConst40 = std::floor(((0.192303002f * fConst0) + 0.5f));
		fConst41 = ((0.0f - (6.90775537f * fConst40)) / fConst0);
		float fConst42 = std::floor(((0.0292910002f * fConst0) + 0.5f));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("damp_hf", &fVslider0, 6000.0f, 1500.0f, 47040.0f, 1.0f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec12[0] = (fSlow13 * ((fRec3[1] + fRec3[2]) - (fSlow14 * fRec12[1])));
			fRec11[0] = ((fRec11[1] * fSlow11) + ((fSlow5 * (fRec3[1] + (fRec12[0] * fSlow16))) * fSlow17));
			fVec0[(IOTA & 32767)] = ((0.353553385f * fRec11[0]) + 9.99999968e-21f);
			fRec13[0] = ((fRec13[1] * fSlow20) + fSlow21);
			fVec1[(IOTA & 16383)] = (fRec13[0] * fTemp1);
			fRec14[0] = (fSlow22 + (0.999000013f * fRec14[1]));
			int iTemp3 = int(std::min<float>(8192.0f, std::max<float>(0.0f, (fConst8 * fRec14[0]))));
			float fTemp4 = (0.300000012f * fVec1[((IOTA - iTemp3) & 16383)]);
			float fTemp5 = (fVec0[((IOTA - iConst6) & 32767)] - (fTemp4 + (0.600000024f * fRec9[1])));
			...
			fRec17[0] = ((fRec17[1] * fSlow29) + ((fSlow23 * (fRec5[1] + (fRec18[0] * fSlow30))) * fSlow31));
			fVec3[(IOTA & 32767)] = ((0.353553385f * fRec17[0]) + 9.99999968e-21f);
			float fTemp6 = ((fTemp4 + fVec3[((IOTA - iConst13) & 32767)]) - (0.600000024f * fRec15[1]));
			...
			fVec5[(IOTA & 16383)] = (fRec13[0] * fTemp8);
			float fTemp9 = (0.300000012f * fVec5[((IOTA - iTemp3) & 16383)]);
			fRec22[0] = (0.0f - (fSlow13 * ((fSlow14 * fRec22[1]) - (fRec2[1] + fRec2[2]))));
			fRec21[0] = ((fRec21[1] * fSlow38) + ((fSlow32 * (fRec2[1] + (fRec22[0] * fSlow39))) * fSlow40));
			fVec6[(IOTA & 65535)] = ((0.353553385f * fRec21[0]) + 9.99999968e-21f);
			float fTemp10 = (fTemp9 + ((0.600000024f * fRec19[1]) + fVec6[((IOTA - iConst18) & 65535)]));
			fVec7[(IOTA & 8191)] = fTemp10;
			fRec19[0] = fVec7[((IOTA - iConst19) & 8191)];
			float fRec20 = (0.0f - (0.600000024f * fTemp10));
			fRec26[0] = (0.0f - (fSlow13 * ((fSlow14 * fRec26[1]) - (fRec7[1] + fRec7[2]))));
			fRec25[0] = ((fRec25[1] * fSlow47) + ((fSlow41 * (fRec7[1] + (fRec26[0] * fSlow48))) * fSlow49));
			fVec8[(IOTA & 32767)] = ((0.353553385f * fRec25[0]) + 9.99999968e-21f);
			float fTemp11 = (fVec8[((IOTA - iConst23) & 32767)] - (fTemp4 + (0.600000024f * fRec23[1])));
			fVec9[(IOTA & 4095)] = fTemp11;
			fRec23[0] = fVec9[((IOTA - iConst24) & 4095)];
			...
			float fTemp12 = ((fVec10[((IOTA - iConst28) & 32767)] + fTemp4) - (0.600000024f * fRec27[1]));
			fVec11[(IOTA & 4095)] = fTemp12;
			fRec27[0] = fVec11[((IOTA - iConst29) & 4095)];
			float fRec28 = (0.600000024f * fTemp12);
			fRec34[0] = (0.0f - (fSlow13 * ((fSlow14 * fRec34[1]) - (fRec8[1] + fRec8[2]))));
			fRec33[0] = ((fRec33[1] * fSlow65) + ((fSlow59 * (fRec8[1] + (fRec34[0] * fSlow66))) * fSlow67));
			fVec12[(IOTA & 65535)] = ((0.353553385f * fRec33[0]) + 9.99999968e-21f);
			float fTemp13 = (((0.600000024f * fRec31[1]) + fVec12[((IOTA - iConst33) & 65535)]) - fTemp9);
			fVec13[(IOTA & 4095)] = fTemp13;
			fRec31[0] = fVec13[((IOTA - iConst34) & 4095)];
			float fRec32 = (0.0f - (0.600000024f * fTemp13));
			fRec38[0] = (0.0f - (fSlow13 * ((fSlow14 * fRec38[1]) - (fRec4[1] + fRec4[2]))));
			fRec37[0] = ((fRec37[1] * fSlow74) + ((fSlow68 * (fRec4[1] + (fRec38[0] * fSlow75))) * fSlow76));
			fVec14[(IOTA & 65535)] = ((0.353553385f * fRec37[0]) + 9.99999968e-21f);
			float fTemp14 = (((0.600000024f * fRec35[1]) + fVec14[((IOTA - iConst38) & 65535)]) - fTemp9);
			fVec15[(IOTA & 8191)] = fTemp14;
			fRec35[0] = fVec15[((IOTA - iConst39) & 8191)];
			float fRec36 = (0.0f - (0.600000024f * fTemp14));
			fRec42[0] = (0.0f - (fSlow13 * ((fSlow14 * fRec42[1]) - (fRec6[1] + fRec6[2]))));
			fRec41[0] = ((fRec41[1] * fSlow83) + ((fSlow77 * (fRec6[1] + (fRec42[0] * fSlow84))) * fSlow85));
			fVec16[(IOTA & 32767)] = ((0.353553385f * fRec41[0]) + 9.99999968e-21f);
			float fTemp15 = (fVec16[((IOTA - iConst43) & 32767)] + (fTemp9 + (0.600000024f * fRec39[1])));
			fVec17[(IOTA & 8191)] = fTemp15;
			fRec39[0] = fVec17[((IOTA - iConst44) & 8191)];
			float fRec40 = (0.0f - (0.600000024f * fTemp15));
			float fTemp16 = (fRec40 + fRec36);
			float fTemp17 = (fRec32 + fTemp16);
			fRec1[0] = (fRec9[1] + (fRec15[1] + (fRec20 + (fRec24 + (fRec10 + (fRec16 + (fRec28 + (fRec31[1] + (fRec35[1] + (fRec39[1] + (fRec19[1] + (fRec23[1] + (fRec27[1] + fTemp17)))))))))))));
			fRec2[0] = ((fRec9[1] + (fRec15[1] + (fRec24 + (fRec10 + (fRec16 + (fRec28 + (fRec27[1] + fRec23[1]))))))) - (fRec20 + (fRec31[1] + (fRec35[1] + (fRec39[1] + (fRec19[1] + fTemp17))))));
			float fTemp18 = (fRec36 + fRec32);
			fRec3[0] = ((fRec15[1] + (fRec20 + (fRec16 + (fRec28 + (fRec39[1] + (fRec19[1] + (fRec40 + fRec27[1]))))))) - (fRec9[1] + (fRec24 + (fRec10 + (fRec31[1] + (fRec35[1] + (fRec23[1] + fTemp18)))))));
			fRec4[0] = ((fRec15[1] + (fRec16 + (fRec28 + (fRec31[1] + (fRec35[1] + (fRec27[1] + fTemp18)))))) - (fRec9[1] + (fRec20 + (fRec24 + (fRec10 + (fRec39[1] + (fRec19[1] + (fRec40 + fRec23[1]))))))));
			float fTemp19 = (fRec40 + fRec32);
			fRec5[0] = ((fRec9[1] + (fRec20 + (fRec10 + (fRec28 + (fRec35[1] + (fRec19[1] + (fRec36 + fRec27[1]))))))) - (fRec15[1] + (fRec24 + (fRec16 + (fRec31[1] + (fRec39[1] + (fRec23[1] + fTemp19)))))));
			fRec6[0] = ((fRec9[1] + (fRec10 + (fRec28 + (fRec31[1] + (fRec39[1] + (fRec27[1] + fTemp19)))))) - (fRec15[1] + (fRec20 + (fRec24 + (fRec16 + (fRec35[1] + (fRec19[1] + (fRec36 + fRec23[1]))))))));
			fRec7[0] = ((fRec20 + (fRec24 + (fRec28 + (fRec31[1] + (fRec19[1] + (fRec23[1] + (fRec32 + fRec27[1]))))))) - (fRec9[1] + (fRec15[1] + (fRec10 + (fRec16 + (fRec35[1] + (fRec39[1] + fTemp16)))))));
			fRec8[0] = ((fRec24 + (fRec28 + (fRec35[1] + (fRec39[1] + (fRec23[1] + (fRec27[1] + fTemp16)))))) - (fRec9[1] + (fRec15[1] + (fRec20 + (fRec10 + (fRec16 + (fRec31[1] + (fRec32 + fRec19[1]))))))));
			output0[i] = FAUSTFLOAT((iSlow0 ? fTemp0 : ((fTemp1 * fTemp2) + (0.370000005f * (fRec0[0] * (fRec2[0] + fRec3[0]))))));
			output1[i] = FAUSTFLOAT((iSlow0 ? fTemp7 : ((fTemp2 * fTemp8) + (0.370000005f * (fRec0[0] * (fRec2[0] - fRec3[0]))))));
			fRec0[1] = fRec0[0];
			fRec12[1] = fRec12[0];
			fRec11[1] = fRec11[0];
			IOTA = (IOTA + 1);
