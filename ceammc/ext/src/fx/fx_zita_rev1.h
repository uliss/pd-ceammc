...
class fx_zita_rev1 : public fx_zita_rev1_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst14 = std::floor(0.013458f * fConst0 + 0.5f);
		...
		float fConst17 = std::floor(0.174713f * fConst0 + 0.5f);
		fConst18 = (0.0f - 6.9077554f * fConst17) / fConst0;
		float fConst19 = std::floor(0.022904f * fConst0 + 0.5f);
		...
		float fConst24 = std::floor(0.019123f * fConst0 + 0.5f);
		...
		float fConst42 = std::floor(0.153129f * fConst0 + 0.5f);
		fConst43 = (0.0f - 6.9077554f * fConst42) / fConst0;
		float fConst44 = std::floor(0.020346f * fConst0 + 0.5f);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec13[0] = 0.0f - fSlow13 * (fSlow14 * fRec13[1] - (fRec4[1] + fRec4[2]));
			fRec12[0] = fSlow11 * (fRec4[1] + fRec13[0] * fSlow16) + fSlow17 * fRec12[1];
			fVec0[IOTA0 & 32767] = 0.35355338f * fRec12[0] + 1e-20f;
			fRec14[0] = fSlow21 + fSlow20 * fRec14[1];
			fVec1[IOTA0 & 16383] = fTemp3 * fRec14[0];
			...
			fRec19[0] = 0.0f - fSlow13 * (fSlow14 * fRec19[1] - (fRec8[1] + fRec8[2]));
			fRec18[0] = fSlow29 * (fRec8[1] + fRec19[0] * fSlow30) + fSlow31 * fRec18[1];
			...
			fRec23[0] = 0.0f - fSlow13 * (fSlow14 * fRec23[1] - (fRec6[1] + fRec6[2]));
			fRec22[0] = fSlow38 * (fRec6[1] + fRec23[0] * fSlow39) + fSlow40 * fRec22[1];
			fVec5[IOTA0 & 32767] = 0.35355338f * fRec22[0] + 1e-20f;
			float fTemp9 = fTemp6 + fVec5[(IOTA0 - iConst20) & 32767] - 0.6f * fRec20[1];
			fVec6[IOTA0 & 8191] = fTemp9;
			fRec20[0] = fVec6[(IOTA0 - iConst21) & 8191];
			float fRec21 = 0.6f * fTemp9;
			fRec27[0] = 0.0f - fSlow13 * (fSlow14 * fRec27[1] - (fRec9[1] + fRec9[2]));
			fRec26[0] = fSlow47 * (fRec9[1] + fRec27[0] * fSlow48) + fSlow49 * fRec26[1];
			fVec7[IOTA0 & 65535] = 0.35355338f * fRec26[0] + 1e-20f;
			float fTemp10 = float(input1[i0]);
			fVec8[IOTA0 & 16383] = fTemp10 * fRec14[0];
			float fTemp11 = 0.3f * fVec8[(IOTA0 - iTemp5) & 16383];
			float fTemp12 = 0.6f * fRec24[1] + fVec7[(IOTA0 - iConst25) & 65535] - fTemp11;
			fVec9[IOTA0 & 4095] = fTemp12;
			fRec24[0] = fVec9[(IOTA0 - iConst26) & 4095];
			float fRec25 = 0.0f - 0.6f * fTemp12;
			fRec31[0] = 0.0f - fSlow13 * (fSlow14 * fRec31[1] - (fRec7[1] + fRec7[2]));
			fRec30[0] = fSlow56 * (fRec7[1] + fRec31[0] * fSlow57) + fSlow58 * fRec30[1];
			fVec10[IOTA0 & 32767] = 0.35355338f * fRec30[0] + 1e-20f;
			float fTemp13 = 0.6f * fRec28[1] + fTemp11 + fVec10[(IOTA0 - iConst30) & 32767];
			fVec11[IOTA0 & 8191] = fTemp13;
			fRec28[0] = fVec11[(IOTA0 - iConst31) & 8191];
			float fRec29 = 0.0f - 0.6f * fTemp13;
			fRec35[0] = 0.0f - fSlow13 * (fSlow14 * fRec35[1] - (fRec3[1] + fRec3[2]));
			fRec34[0] = fSlow65 * (fRec3[1] + fRec35[0] * fSlow66) + fSlow67 * fRec34[1];
			fVec12[IOTA0 & 65535] = 0.35355338f * fRec34[0] + 1e-20f;
			float fTemp14 = fTemp11 + 0.6f * fRec32[1] + fVec12[(IOTA0 - iConst35) & 65535];
			fVec13[IOTA0 & 8191] = fTemp14;
			fRec32[0] = fVec13[(IOTA0 - iConst36) & 8191];
			float fRec33 = 0.0f - 0.6f * fTemp14;
			fRec39[0] = 0.0f - fSlow13 * (fSlow14 * fRec39[1] - (fRec5[1] + fRec5[2]));
			fRec38[0] = fSlow74 * (fRec5[1] + fRec39[0] * fSlow75) + fSlow76 * fRec38[1];
			fVec14[IOTA0 & 65535] = 0.35355338f * fRec38[0] + 1e-20f;
			float fTemp15 = 0.6f * fRec36[1] + fVec14[(IOTA0 - iConst40) & 65535] - fTemp11;
			fVec15[IOTA0 & 8191] = fTemp15;
			fRec36[0] = fVec15[(IOTA0 - iConst41) & 8191];
			float fRec37 = 0.0f - 0.6f * fTemp15;
			fRec43[0] = 0.0f - fSlow13 * (fSlow14 * fRec43[1] - (fRec2[1] + fRec2[2]));
			fRec42[0] = fSlow83 * (fRec2[1] + fRec43[0] * fSlow84) + fSlow85 * fRec42[1];
			fVec16[IOTA0 & 32767] = 0.35355338f * fRec42[0] + 1e-20f;
			float fTemp16 = fVec16[(IOTA0 - iConst45) & 32767] + fTemp6 - 0.6f * fRec40[1];
			fVec17[IOTA0 & 4095] = fTemp16;
			fRec40[0] = fVec17[(IOTA0 - iConst46) & 4095];
			float fRec41 = 0.6f * fTemp16;
			float fTemp17 = fRec25 + fRec40[1];
			float fTemp18 = fRec21 + fTemp17;
			fRec2[0] = fRec10[1] + fRec16[1] + fRec20[1] + fRec24[1] + fRec28[1] + fRec32[1] + fRec36[1] + fRec33 + fRec17 + fRec37 + fRec29 + fRec41 + fRec11 + fTemp18;
			float fTemp19 = fRec21 + fRec40[1];
			fRec3[0] = fRec10[1] + fRec16[1] + fRec20[1] + fRec17 + fRec41 + fRec11 + fTemp19 - (fRec24[1] + fRec28[1] + fRec32[1] + fRec36[1] + fRec33 + fRec37 + fRec29 + fRec25);
			fRec4[0] = fRec20[1] + fRec28[1] + fRec32[1] + fRec33 + fRec29 + fRec41 + fTemp19 - (fRec10[1] + fRec16[1] + fRec24[1] + fRec36[1] + fRec17 + fRec37 + fRec11 + fRec25);
			fRec5[0] = fRec20[1] + fRec24[1] + fRec36[1] + fRec37 + fRec41 + fTemp18 - (fRec10[1] + fRec16[1] + fRec28[1] + fRec32[1] + fRec33 + fRec17 + fRec11 + fRec29);
			float fTemp20 = fRec21 + fRec25;
			fRec6[0] = fRec10[1] + fRec32[1] + fRec36[1] + fRec33 + fRec37 + fRec41 + fRec11 + fRec40[1] - (fRec16[1] + fRec20[1] + fRec24[1] + fRec28[1] + fRec17 + fRec29 + fTemp20);
			fRec7[0] = fRec10[1] + fRec24[1] + fRec28[1] + fRec29 + fRec41 + fRec11 + fTemp17 - (fRec16[1] + fRec20[1] + fRec32[1] + fRec36[1] + fRec33 + fRec17 + fRec21 + fRec37);
			fRec8[0] = fRec16[1] + fRec24[1] + fRec32[1] + fRec33 + fRec17 + fRec41 + fTemp17 - (fRec10[1] + fRec20[1] + fRec28[1] + fRec36[1] + fRec37 + fRec29 + fRec21 + fRec11);
			fRec9[0] = fRec16[1] + fRec28[1] + fRec36[1] + fRec17 + fRec37 + fRec29 + fRec41 + fRec40[1] - (fRec10[1] + fRec20[1] + fRec24[1] + fRec32[1] + fRec33 + fRec11 + fTemp20);
			output0[i0] = FAUSTFLOAT(fTemp2 * (fTemp3 * fTemp4 + 0.37f * fRec1[0] * (fRec3[0] + fRec4[0])) + fTemp3 * fRec0[0]);
			output1[i0] = FAUSTFLOAT(fTemp2 * (fTemp10 * fTemp4 + 0.37f * fRec1[0] * (fRec3[0] - fRec4[0])) + fTemp10 * fRec0[0]);
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec13[1] = fRec13[0];
			fRec12[1] = fRec12[0];
