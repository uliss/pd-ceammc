...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_freqshift -scn fx_freqshift_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __fx_freqshift_H__
#define  __fx_freqshift_H__
...
class FAUST_API fx_freqshift_dsp {

    public:

        fx_freqshift_dsp() = default;
        virtual ~fx_freqshift_dsp() = default;
         ...
         */
        virtual ::fx_freqshift_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::fx_freqshift_dsp {
    ...
    protected:
        ...
        ::fx_freqshift_dsp* fDSP;

    public:

        decorator_dsp(::fx_freqshift_dsp* fx_freqshift_dsp = nullptr):fDSP(fx_freqshift_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::fx_freqshift_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in fx_freqshift_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS fx_freqshift
#endif
...
class fx_freqshift : public fx_freqshift_dsp {
 ...
 public:
	...
	fx_freqshift(const fx_freqshift&) = default;
	
	virtual ~fx_freqshift() = default;
	
	fx_freqshift& operator=(const fx_freqshift&) = default;
	
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_freqshift -scn fx_freqshift_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual fx_freqshift* clone() {
		return new fx_freqshift(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("fx.freqshift");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec0[0] = fTemp0;
			fRec3[0] = 0.161758f * (fTemp0 + fRec3[2]) - fVec0[2];
			fRec2[0] = 0.733029f * (fRec3[0] + fRec2[2]) - fRec3[2];
			fRec1[0] = 0.94535f * (fRec2[0] + fRec1[2]) - fRec2[2];
			fRec0[0] = 0.990598f * (fRec1[0] + fRec0[2]) - fRec1[2];
			float fTemp1 = static_cast<float>(input1[i0]);
			iRec4[0] = iRec4[1] + 1;
			float fTemp2 = fConst1 * fTemp1 * std::fmod(static_cast<float>(iRec4[0]), fConst0 / fTemp1);
			float fTemp3 = fRec0[0] * std::sin(fTemp2);
			fRec8[0] = 0.479401f * (fVec0[1] + fRec8[2]) - fVec0[3];
			fRec7[0] = 0.876218f * (fRec8[0] + fRec7[2]) - fRec8[2];
			fRec6[0] = 0.976599f * (fRec7[0] + fRec6[2]) - fRec7[2];
			fRec5[0] = 0.9975f * (fRec6[0] + fRec5[2]) - fRec6[2];
			float fTemp4 = fRec5[0] * std::cos(fTemp2);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp3 + fTemp4);
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp3 - fTemp4);
...
class faust_fx_freqshift_tilde : public FaustExternal<fx_freqshift> {
public:
    faust_fx_freqshift_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(fx_freqshift))
    {
    }
};
