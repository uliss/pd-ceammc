...
class fx_freeverb : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("filename", "fx_freeverb");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		iConst1 = int((0.0269387756f * fConst0));
		iConst2 = int((0.0289569162f * fConst0));
		iConst3 = int((0.0307482984f * fConst0));
		iConst4 = int((0.0322448984f * fConst0));
		iConst5 = int((0.033809524f * fConst0));
		iConst6 = int((0.0353061222f * fConst0));
		iConst7 = int((0.0366666652f * fConst0));
		iConst8 = int((0.0253061224f * fConst0));
		iConst9 = std::min(1024, std::max(0, (int((0.0126077095f * fConst0)) + -1)));
		iConst10 = std::min(1024, std::max(0, (int((0.00999999978f * fConst0)) + -1)));
		iConst11 = std::min(1024, std::max(0, (int((0.00773242628f * fConst0)) + -1)));
		iConst12 = std::min(1024, std::max(0, (int((0.00510204071f * fConst0)) + -1)));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("fx_freeverb");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec11[0] = ((fTemp2 * fRec9[1]) + (fRec12[0] * fRec11[1]));
			fVec0[(IOTA & 8191)] = (fTemp1 + (fRec10[0] * fRec11[0]));
			fRec9[0] = fVec0[((IOTA - iConst1) & 8191)];
			fRec14[0] = ((fTemp2 * fRec13[1]) + (fRec12[0] * fRec14[1]));
			fVec1[(IOTA & 8191)] = (fTemp1 + (fRec10[0] * fRec14[0]));
			fRec13[0] = fVec1[((IOTA - iConst2) & 8191)];
			fRec16[0] = ((fTemp2 * fRec15[1]) + (fRec12[0] * fRec16[1]));
			fVec2[(IOTA & 8191)] = (fTemp1 + (fRec10[0] * fRec16[0]));
			fRec15[0] = fVec2[((IOTA - iConst3) & 8191)];
			fRec18[0] = ((fTemp2 * fRec17[1]) + (fRec12[0] * fRec18[1]));
			fVec3[(IOTA & 8191)] = (fTemp1 + (fRec10[0] * fRec18[0]));
			fRec17[0] = fVec3[((IOTA - iConst4) & 8191)];
			fRec20[0] = ((fTemp2 * fRec19[1]) + (fRec12[0] * fRec20[1]));
			fVec4[(IOTA & 8191)] = (fTemp1 + (fRec10[0] * fRec20[0]));
			fRec19[0] = fVec4[((IOTA - iConst5) & 8191)];
			fRec22[0] = ((fTemp2 * fRec21[1]) + (fRec12[0] * fRec22[1]));
			fVec5[(IOTA & 8191)] = (fTemp1 + (fRec10[0] * fRec22[0]));
			fRec21[0] = fVec5[((IOTA - iConst6) & 8191)];
			fRec24[0] = ((fRec24[1] * fRec12[0]) + (fRec23[1] * fTemp2));
			fVec6[(IOTA & 8191)] = (fTemp1 + (fRec10[0] * fRec24[0]));
			fRec23[0] = fVec6[((IOTA - iConst7) & 8191)];
			fRec26[0] = ((fRec12[0] * fRec26[1]) + (fTemp2 * fRec25[1]));
			fVec7[(IOTA & 8191)] = (fTemp1 + (fRec10[0] * fRec26[0]));
			fRec25[0] = fVec7[((IOTA - iConst8) & 8191)];
			float fTemp3 = ((fRec9[0] + (fRec13[0] + (fRec15[0] + (fRec17[0] + (fRec19[0] + (fRec21[0] + ((0.5f * fRec7[1]) + fRec23[0]))))))) + fRec25[0]);
			fVec8[(IOTA & 2047)] = fTemp3;
			fRec7[0] = fVec8[((IOTA - iConst9) & 2047)];
			float fRec8 = (0.0f - (0.5f * fTemp3));
			float fTemp4 = (((0.5f * fRec5[1]) + fRec7[1]) + fRec8);
			fVec9[(IOTA & 2047)] = fTemp4;
			fRec5[0] = fVec9[((IOTA - iConst10) & 2047)];
			float fRec6 = (0.0f - (0.5f * fTemp4));
			float fTemp5 = (((0.5f * fRec3[1]) + fRec5[1]) + fRec6);
			fVec10[(IOTA & 2047)] = fTemp5;
			fRec3[0] = fVec10[((IOTA - iConst11) & 2047)];
			float fRec4 = (0.0f - (0.5f * fTemp5));
			float fTemp6 = (((0.5f * fRec1[1]) + fRec3[1]) + fRec4);
			fVec11[(IOTA & 1023)] = fTemp6;
			fRec1[0] = fVec11[((IOTA - iConst12) & 1023)];
			float fRec2 = (0.0f - (0.5f * fTemp6));
			output0[i] = FAUSTFLOAT((iSlow0?fTemp0:((fTemp1 * (1.0f - fRec0[0])) + (fRec0[0] * (fRec1[1] + fRec2)))));
			fRec0[1] = fRec0[0];
			fRec10[1] = fRec10[0];
			fRec12[1] = fRec12[0];
			fRec11[1] = fRec11[0];
