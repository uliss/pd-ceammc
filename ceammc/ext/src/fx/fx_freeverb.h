...
class fx_freeverb : public fx_freeverb_dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fHslider1, "stye", "knob");
