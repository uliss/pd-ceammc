...
class fx_vocoder : public fx_vocoder_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = std::tan((18437.4609f / fConst0));
		fConst2 = (1.0f / fConst1);
		fConst3 = (2.0f * (1.0f - (1.0f / fx_vocoder_faustpower2_f(fConst1))));
		fConst4 = (1.0f / fConst0);
		fConst5 = std::tan((15171.7754f / fConst0));
		...
		fConst95 = std::tan((3875.99854f / fConst0));
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow34 = ((fConst18 * (fConst18 + fSlow33)) + 1.0f);
		float fSlow35 = (fConst18 / fSlow34);
		float fSlow36 = (1.0f / fSlow34);
		float fSlow37 = ((fConst18 * (fConst18 - fSlow33)) + 1.0f);
		float fSlow38 = (0.0f - fSlow35);
		float fSlow39 = (0.177122265f * fSlow0);
		float fSlow40 = ((fConst21 * (fConst21 + fSlow39)) + 1.0f);
		float fSlow41 = (1.0f / fSlow40);
		float fSlow42 = ((fConst21 * (fConst21 - fSlow39)) + 1.0f);
		float fSlow43 = (fConst21 / fSlow40);
		float fSlow44 = (0.0f - fSlow43);
		float fSlow45 = ((fConst24 * (fConst24 + fSlow15)) + 1.0f);
		float fSlow46 = (1.0f / fSlow45);
		float fSlow47 = ((fConst24 * (fConst24 - fSlow15)) + 1.0f);
		float fSlow48 = (fConst24 / fSlow45);
		float fSlow49 = (0.0f - fSlow48);
		float fSlow50 = ((fConst27 * (fConst27 + fSlow15)) + 1.0f);
		float fSlow51 = (1.0f / fSlow50);
		float fSlow52 = ((fConst27 * (fConst27 - fSlow15)) + 1.0f);
		float fSlow53 = (fConst27 / fSlow50);
		float fSlow54 = (0.0f - fSlow53);
		float fSlow55 = (0.177122265f * fSlow0);
		float fSlow56 = ((fConst30 * (fConst30 + fSlow55)) + 1.0f);
		float fSlow57 = (1.0f / fSlow56);
		float fSlow58 = ((fConst30 * (fConst30 - fSlow55)) + 1.0f);
		float fSlow59 = (fConst30 / fSlow56);
		float fSlow60 = (0.0f - fSlow59);
		float fSlow61 = ((fConst33 * (fConst33 + fSlow9)) + 1.0f);
		float fSlow62 = (1.0f / fSlow61);
		float fSlow63 = ((fConst33 * (fConst33 - fSlow9)) + 1.0f);
		float fSlow64 = (fConst33 / fSlow61);
		float fSlow65 = (0.0f - fSlow64);
		float fSlow66 = ((fConst36 * (fConst36 + fSlow39)) + 1.0f);
		float fSlow67 = (1.0f / fSlow66);
		float fSlow68 = ((fConst36 * (fConst36 - fSlow39)) + 1.0f);
		float fSlow69 = (fConst36 / fSlow66);
		float fSlow70 = (0.0f - fSlow69);
		float fSlow71 = ((fConst39 * (fConst39 + fSlow27)) + 1.0f);
		float fSlow72 = (1.0f / fSlow71);
		float fSlow73 = ((fConst39 * (fConst39 - fSlow27)) + 1.0f);
		float fSlow74 = (fConst39 / fSlow71);
		float fSlow75 = (0.0f - fSlow74);
		float fSlow76 = (0.177122265f * fSlow0);
		float fSlow77 = ((fConst42 * (fConst42 + fSlow76)) + 1.0f);
		float fSlow78 = (1.0f / fSlow77);
		float fSlow79 = ((fConst42 * (fConst42 - fSlow76)) + 1.0f);
		float fSlow80 = (fConst42 / fSlow77);
		float fSlow81 = (0.0f - fSlow80);
		float fSlow82 = (0.177122265f * fSlow0);
		float fSlow83 = ((fConst45 * (fConst45 + fSlow82)) + 1.0f);
		float fSlow84 = (1.0f / fSlow83);
		float fSlow85 = ((fConst45 * (fConst45 - fSlow82)) + 1.0f);
		float fSlow86 = (fConst45 / fSlow83);
		float fSlow87 = (0.0f - fSlow86);
		float fSlow88 = ((fConst48 * (fConst48 + fSlow21)) + 1.0f);
		float fSlow89 = (1.0f / fSlow88);
		float fSlow90 = ((fConst48 * (fConst48 - fSlow21)) + 1.0f);
		float fSlow91 = (fConst48 / fSlow88);
		float fSlow92 = (0.0f - fSlow91);
		...
		float fSlow99 = ((fConst54 * (fConst54 + fSlow76)) + 1.0f);
		float fSlow100 = (1.0f / fSlow99);
		float fSlow101 = ((fConst54 * (fConst54 - fSlow76)) + 1.0f);
		float fSlow102 = (fConst54 / fSlow99);
		float fSlow103 = (0.0f - fSlow102);
		float fSlow104 = ((fConst57 * (fConst57 + fSlow76)) + 1.0f);
		float fSlow105 = (1.0f / fSlow104);
		float fSlow106 = ((fConst57 * (fConst57 - fSlow76)) + 1.0f);
		float fSlow107 = (fConst57 / fSlow104);
		float fSlow108 = (0.0f - fSlow107);
		float fSlow109 = (0.177122265f * fSlow0);
		float fSlow110 = ((fConst60 * (fConst60 + fSlow109)) + 1.0f);
		float fSlow111 = (1.0f / fSlow110);
		float fSlow112 = ((fConst60 * (fConst60 - fSlow109)) + 1.0f);
		float fSlow113 = (fConst60 / fSlow110);
		float fSlow114 = (0.0f - fSlow113);
		float fSlow115 = ((fConst63 * (fConst63 + fSlow82)) + 1.0f);
		float fSlow116 = (1.0f / fSlow115);
		float fSlow117 = ((fConst63 * (fConst63 - fSlow82)) + 1.0f);
		float fSlow118 = (fConst63 / fSlow115);
		float fSlow119 = (0.0f - fSlow118);
		float fSlow120 = ((fConst66 * (fConst66 + fSlow93)) + 1.0f);
		float fSlow121 = (1.0f / fSlow120);
		float fSlow122 = ((fConst66 * (fConst66 - fSlow93)) + 1.0f);
		float fSlow123 = (fConst66 / fSlow120);
		float fSlow124 = (0.0f - fSlow123);
		float fSlow125 = ((fConst69 * (fConst69 + fSlow9)) + 1.0f);
		float fSlow126 = (1.0f / fSlow125);
		float fSlow127 = ((fConst69 * (fConst69 - fSlow9)) + 1.0f);
		float fSlow128 = (fConst69 / fSlow125);
		float fSlow129 = (0.0f - fSlow128);
		float fSlow130 = (0.177122265f * fSlow0);
		float fSlow131 = ((fConst72 * (fConst72 + fSlow130)) + 1.0f);
		float fSlow132 = (1.0f / fSlow131);
		float fSlow133 = ((fConst72 * (fConst72 - fSlow130)) + 1.0f);
		float fSlow134 = (fConst72 / fSlow131);
		float fSlow135 = (0.0f - fSlow134);
		float fSlow136 = ((fConst75 * (fConst75 + fSlow27)) + 1.0f);
		float fSlow137 = (1.0f / fSlow136);
		float fSlow138 = ((fConst75 * (fConst75 - fSlow27)) + 1.0f);
		float fSlow139 = (fConst75 / fSlow136);
		float fSlow140 = (0.0f - fSlow139);
		float fSlow141 = ((fConst78 * (fConst78 + fSlow15)) + 1.0f);
		float fSlow142 = (1.0f / fSlow141);
		float fSlow143 = ((fConst78 * (fConst78 - fSlow15)) + 1.0f);
		float fSlow144 = (fConst78 / fSlow141);
		float fSlow145 = (0.0f - fSlow144);
		float fSlow146 = ((fConst81 * (fConst81 + fSlow39)) + 1.0f);
		float fSlow147 = (1.0f / fSlow146);
		float fSlow148 = ((fConst81 * (fConst81 - fSlow39)) + 1.0f);
		float fSlow149 = (fConst81 / fSlow146);
		float fSlow150 = (0.0f - fSlow149);
		float fSlow151 = ((fConst84 * (fConst84 + fSlow76)) + 1.0f);
		float fSlow152 = (fConst84 / fSlow151);
		float fSlow153 = (1.0f / fSlow151);
		float fSlow154 = ((fConst84 * (fConst84 - fSlow76)) + 1.0f);
		float fSlow155 = (0.0f - fSlow152);
		float fSlow156 = ((fConst87 * (fConst87 + fSlow76)) + 1.0f);
		float fSlow157 = (1.0f / fSlow156);
		float fSlow158 = ((fConst87 * (fConst87 - fSlow76)) + 1.0f);
		float fSlow159 = (fConst87 / fSlow156);
		float fSlow160 = (0.0f - fSlow159);
		float fSlow161 = ((fConst90 * (fConst90 + fSlow93)) + 1.0f);
		float fSlow162 = (1.0f / fSlow161);
		float fSlow163 = ((fConst90 * (fConst90 - fSlow93)) + 1.0f);
		float fSlow164 = (fConst90 / fSlow161);
		float fSlow165 = (0.0f - fSlow164);
		float fSlow166 = ((fConst93 * (fConst93 + fSlow82)) + 1.0f);
		float fSlow167 = (1.0f / fSlow166);
		float fSlow168 = ((fConst93 * (fConst93 - fSlow82)) + 1.0f);
		float fSlow169 = (fConst93 / fSlow166);
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec15[0] = fRec16[0];
			fRec18[0] = (fTemp0 - (fSlow29 * ((fSlow30 * fRec18[2]) + (fConst16 * fRec18[1]))));
			fRec21[0] = (fTemp1 - (fSlow29 * ((fSlow30 * fRec21[2]) + (fConst16 * fRec21[1]))));
			...
			fRec19[0] = fRec20[0];
			fRec22[0] = (fTemp0 - (fSlow36 * ((fSlow37 * fRec22[2]) + (fConst19 * fRec22[1]))));
			fRec25[0] = (fTemp1 - (fSlow36 * ((fSlow37 * fRec25[2]) + (fConst19 * fRec25[1]))));
			float fTemp16 = std::fabs(((fSlow35 * fRec25[0]) + (fSlow38 * fRec25[2])));
			float fTemp17 = ((fRec23[1] > fTemp16) ? fTemp6 : fTemp4);
			fRec24[0] = ((fRec24[1] * fTemp17) + (fTemp16 * (1.0f - fTemp17)));
			fRec23[0] = fRec24[0];
			fRec26[0] = (fTemp0 - (fSlow41 * ((fSlow42 * fRec26[2]) + (fConst22 * fRec26[1]))));
			fRec29[0] = (fTemp1 - (fSlow41 * ((fSlow42 * fRec29[2]) + (fConst22 * fRec29[1]))));
			...
			fRec27[0] = fRec28[0];
			fRec30[0] = (fTemp0 - (fSlow46 * ((fSlow47 * fRec30[2]) + (fConst25 * fRec30[1]))));
			...
			fRec37[0] = (fTemp1 - (fSlow51 * ((fSlow52 * fRec37[2]) + (fConst28 * fRec37[1]))));
			float fTemp22 = std::fabs(((fSlow53 * fRec37[0]) + (fSlow54 * fRec37[2])));
			float fTemp23 = ((fRec35[1] > fTemp22) ? fTemp6 : fTemp4);
			fRec36[0] = ((fRec36[1] * fTemp23) + (fTemp22 * (1.0f - fTemp23)));
			fRec35[0] = fRec36[0];
			fRec38[0] = (fTemp0 - (fSlow57 * ((fSlow58 * fRec38[2]) + (fConst31 * fRec38[1]))));
			fRec41[0] = (fTemp1 - (fSlow57 * ((fSlow58 * fRec41[2]) + (fConst31 * fRec41[1]))));
			...
			fRec39[0] = fRec40[0];
			fRec42[0] = (fTemp0 - (fSlow62 * ((fSlow63 * fRec42[2]) + (fConst34 * fRec42[1]))));
			fRec45[0] = (fTemp1 - (fSlow62 * ((fSlow63 * fRec45[2]) + (fConst34 * fRec45[1]))));
			...
			fRec43[0] = fRec44[0];
			fRec46[0] = (fTemp0 - (fSlow67 * ((fSlow68 * fRec46[2]) + (fConst37 * fRec46[1]))));
			fRec49[0] = (fTemp1 - (fSlow67 * ((fSlow68 * fRec49[2]) + (fConst37 * fRec49[1]))));
			float fTemp28 = std::fabs(((fSlow69 * fRec49[0]) + (fSlow70 * fRec49[2])));
			float fTemp29 = ((fRec47[1] > fTemp28) ? fTemp6 : fTemp4);
			fRec48[0] = ((fRec48[1] * fTemp29) + (fTemp28 * (1.0f - fTemp29)));
			fRec47[0] = fRec48[0];
			fRec50[0] = (fTemp0 - (fSlow72 * ((fSlow73 * fRec50[2]) + (fConst40 * fRec50[1]))));
			fRec53[0] = (fTemp1 - (fSlow72 * ((fSlow73 * fRec53[2]) + (fConst40 * fRec53[1]))));
			float fTemp30 = std::fabs(((fSlow74 * fRec53[0]) + (fSlow75 * fRec53[2])));
			float fTemp31 = ((fRec51[1] > fTemp30) ? fTemp6 : fTemp4);
			fRec52[0] = ((fRec52[1] * fTemp31) + (fTemp30 * (1.0f - fTemp31)));
			fRec51[0] = fRec52[0];
			fRec54[0] = (fTemp0 - (fSlow78 * ((fSlow79 * fRec54[2]) + (fConst43 * fRec54[1]))));
			fRec57[0] = (fTemp1 - (fSlow78 * ((fSlow79 * fRec57[2]) + (fConst43 * fRec57[1]))));
			float fTemp32 = std::fabs(((fSlow80 * fRec57[0]) + (fSlow81 * fRec57[2])));
			...
			fRec61[0] = (fTemp1 - (fSlow84 * ((fSlow85 * fRec61[2]) + (fConst46 * fRec61[1]))));
			float fTemp34 = std::fabs(((fSlow86 * fRec61[0]) + (fSlow87 * fRec61[2])));
			float fTemp35 = ((fRec59[1] > fTemp34) ? fTemp6 : fTemp4);
			fRec60[0] = ((fRec60[1] * fTemp35) + (fTemp34 * (1.0f - fTemp35)));
			fRec59[0] = fRec60[0];
			fRec62[0] = (fTemp0 - (fSlow89 * ((fSlow90 * fRec62[2]) + (fConst49 * fRec62[1]))));
			fRec65[0] = (fTemp1 - (fSlow89 * ((fSlow90 * fRec65[2]) + (fConst49 * fRec65[1]))));
			float fTemp36 = std::fabs(((fSlow91 * fRec65[0]) + (fSlow92 * fRec65[2])));
			...
			fRec67[0] = fRec68[0];
			fRec70[0] = (fTemp0 - (fSlow100 * ((fSlow101 * fRec70[2]) + (fConst55 * fRec70[1]))));
			fRec73[0] = (fTemp1 - (fSlow100 * ((fSlow101 * fRec73[2]) + (fConst55 * fRec73[1]))));
			...
			fRec71[0] = fRec72[0];
			fRec74[0] = (fTemp0 - (fSlow105 * ((fSlow106 * fRec74[2]) + (fConst58 * fRec74[1]))));
			fRec77[0] = (fTemp1 - (fSlow105 * ((fSlow106 * fRec77[2]) + (fConst58 * fRec77[1]))));
			...
			fRec75[0] = fRec76[0];
			fRec78[0] = (fTemp0 - (fSlow111 * ((fSlow112 * fRec78[2]) + (fConst61 * fRec78[1]))));
			fRec81[0] = (fTemp1 - (fSlow111 * ((fSlow112 * fRec81[2]) + (fConst61 * fRec81[1]))));
			float fTemp44 = std::fabs(((fSlow113 * fRec81[0]) + (fSlow114 * fRec81[2])));
			float fTemp45 = ((fRec79[1] > fTemp44) ? fTemp6 : fTemp4);
			fRec80[0] = ((fRec80[1] * fTemp45) + (fTemp44 * (1.0f - fTemp45)));
			fRec79[0] = fRec80[0];
			fRec82[0] = (fTemp0 - (fSlow116 * ((fSlow117 * fRec82[2]) + (fConst64 * fRec82[1]))));
			fRec85[0] = (fTemp1 - (fSlow116 * ((fSlow117 * fRec85[2]) + (fConst64 * fRec85[1]))));
			float fTemp46 = std::fabs(((fSlow118 * fRec85[0]) + (fSlow119 * fRec85[2])));
			float fTemp47 = ((fRec83[1] > fTemp46) ? fTemp6 : fTemp4);
			fRec84[0] = ((fRec84[1] * fTemp47) + (fTemp46 * (1.0f - fTemp47)));
			fRec83[0] = fRec84[0];
			fRec86[0] = (fTemp0 - (fSlow121 * ((fSlow122 * fRec86[2]) + (fConst67 * fRec86[1]))));
			fRec89[0] = (fTemp1 - (fSlow121 * ((fSlow122 * fRec89[2]) + (fConst67 * fRec89[1]))));
			float fTemp48 = std::fabs(((fSlow123 * fRec89[0]) + (fSlow124 * fRec89[2])));
			float fTemp49 = ((fRec87[1] > fTemp48) ? fTemp6 : fTemp4);
			fRec88[0] = ((fRec88[1] * fTemp49) + (fTemp48 * (1.0f - fTemp49)));
			fRec87[0] = fRec88[0];
			fRec90[0] = (fTemp0 - (fSlow126 * ((fSlow127 * fRec90[2]) + (fConst70 * fRec90[1]))));
			fRec93[0] = (fTemp1 - (fSlow126 * ((fSlow127 * fRec93[2]) + (fConst70 * fRec93[1]))));
			float fTemp50 = std::fabs(((fSlow128 * fRec93[0]) + (fSlow129 * fRec93[2])));
			float fTemp51 = ((fRec91[1] > fTemp50) ? fTemp6 : fTemp4);
			fRec92[0] = ((fRec92[1] * fTemp51) + (fTemp50 * (1.0f - fTemp51)));
			fRec91[0] = fRec92[0];
			fRec94[0] = (fTemp0 - (fSlow132 * ((fSlow133 * fRec94[2]) + (fConst73 * fRec94[1]))));
			fRec97[0] = (fTemp1 - (fSlow132 * ((fSlow133 * fRec97[2]) + (fConst73 * fRec97[1]))));
			float fTemp52 = std::fabs(((fSlow134 * fRec97[0]) + (fSlow135 * fRec97[2])));
			...
			float fTemp54 = std::fabs(((fSlow139 * fRec101[0]) + (fSlow140 * fRec101[2])));
			...
			float fTemp56 = std::fabs(((fSlow144 * fRec105[0]) + (fSlow145 * fRec105[2])));
			...
			fRec109[0] = (fTemp1 - (fSlow147 * ((fSlow148 * fRec109[2]) + (fConst82 * fRec109[1]))));
			float fTemp58 = std::fabs(((fSlow149 * fRec109[0]) + (fSlow150 * fRec109[2])));
			...
			fRec113[0] = (fTemp1 - (fSlow153 * ((fSlow154 * fRec113[2]) + (fConst85 * fRec113[1]))));
			float fTemp60 = std::fabs(((fSlow152 * fRec113[0]) + (fSlow155 * fRec113[2])));
			...
			float fTemp62 = std::fabs(((fSlow159 * fRec117[0]) + (fSlow160 * fRec117[2])));
			float fTemp63 = ((fRec115[1] > fTemp62) ? fTemp6 : fTemp4);
			fRec116[0] = ((fRec116[1] * fTemp63) + (fTemp62 * (1.0f - fTemp63)));
			fRec115[0] = fRec116[0];
			fRec118[0] = (fTemp0 - (fSlow162 * ((fSlow163 * fRec118[2]) + (fConst91 * fRec118[1]))));
			fRec121[0] = (fTemp1 - (fSlow162 * ((fSlow163 * fRec121[2]) + (fConst91 * fRec121[1]))));
			float fTemp64 = std::fabs(((fSlow164 * fRec121[0]) + (fSlow165 * fRec121[2])));
			float fTemp65 = ((fRec119[1] > fTemp64) ? fTemp6 : fTemp4);
			fRec120[0] = ((fRec120[1] * fTemp65) + (fTemp64 * (1.0f - fTemp65)));
			fRec119[0] = fRec120[0];
			fRec122[0] = (fTemp0 - (fSlow167 * ((fSlow168 * fRec122[2]) + (fConst94 * fRec122[1]))));
			fRec125[0] = (fTemp1 - (fSlow167 * ((fSlow168 * fRec125[2]) + (fConst94 * fRec125[1]))));
			...
			fRec127[0] = fRec128[0];
			output0[i] = FAUSTFLOAT(((fRec0[2] * (0.0f - (fSlow5 * fRec1[0]))) + ((fSlow5 * (fRec0[0] * fRec1[0])) + ((fRec6[2] * (0.0f - (fSlow13 * fRec7[0]))) + ((fSlow13 * (fRec6[0] * fRec7[0])) + ((fRec10[2] * (0.0f - (fSlow19 * fRec11[0]))) + ((fSlow19 * (fRec10[0] * fRec11[0])) + ((fRec14[2] * (0.0f - (fSlow25 * fRec15[0]))) + ((fSlow25 * (fRec14[0] * fRec15[0])) + ((fRec18[2] * (0.0f - (fSlow31 * fRec19[0]))) + ((fSlow31 * (fRec18[0] * fRec19[0])) + ((fSlow35 * (fRec22[0] * fRec23[0])) + ((fRec26[2] * (0.0f - (fSlow43 * fRec27[0]))) + ((fSlow43 * (fRec26[0] * fRec27[0])) + ((fRec30[2] * (0.0f - (fSlow48 * fRec31[0]))) + ((fSlow48 * (fRec30[0] * fRec31[0])) + ((fRec34[2] * (0.0f - (fSlow53 * fRec35[0]))) + ((fSlow53 * (fRec34[0] * fRec35[0])) + ((fRec38[2] * (0.0f - (fSlow59 * fRec39[0]))) + ((fSlow59 * (fRec38[0] * fRec39[0])) + ((fRec42[2] * (0.0f - (fSlow64 * fRec43[0]))) + ((fSlow64 * (fRec42[0] * fRec43[0])) + ((fRec46[2] * (0.0f - (fSlow69 * fRec47[0]))) + ((fSlow69 * (fRec46[0] * fRec47[0])) + ((fRec50[2] * (0.0f - (fSlow74 * fRec51[0]))) + ((fSlow74 * (fRec50[0] * fRec51[0])) + ((fRec54[2] * (0.0f - (fSlow80 * fRec55[0]))) + ((fSlow80 * (fRec54[0] * fRec55[0])) + ((fRec58[2] * (0.0f - (fSlow86 * fRec59[0]))) + ((fSlow86 * (fRec58[0] * fRec59[0])) + ((fRec62[2] * (0.0f - (fSlow91 * fRec63[0]))) + (((fRec66[2] * (0.0f - (fSlow97 * fRec67[0]))) + ((fSlow97 * (fRec66[0] * fRec67[0])) + ((fRec70[2] * (0.0f - (fSlow102 * fRec71[0]))) + ((fSlow102 * (fRec70[0] * fRec71[0])) + ((fRec74[2] * (0.0f - (fSlow107 * fRec75[0]))) + ((fSlow107 * (fRec74[0] * fRec75[0])) + ((fRec22[2] * (0.0f - (fSlow35 * fRec23[0]))) + ((fRec78[2] * (0.0f - (fSlow113 * fRec79[0]))) + (((fRec82[2] * (0.0f - (fSlow118 * fRec83[0]))) + (((fRec86[2] * (0.0f - (fSlow123 * fRec87[0]))) + ((fSlow123 * (fRec86[0] * fRec87[0])) + ((fRec90[2] * (0.0f - (fSlow128 * fRec91[0]))) + ((fSlow128 * (fRec90[0] * fRec91[0])) + ((fRec94[2] * (0.0f - (fSlow134 * fRec95[0]))) + ((fSlow134 * (fRec94[0] * fRec95[0])) + ((fRec98[2] * (0.0f - (fSlow139 * fRec99[0]))) + ((fSlow139 * (fRec98[0] * fRec99[0])) + ((fRec102[2] * (0.0f - (fSlow144 * fRec103[0]))) + ((fSlow144 * (fRec102[0] * fRec103[0])) + ((fRec106[2] * (0.0f - (fSlow149 * fRec107[0]))) + ((fSlow152 * (fRec110[0] * fRec111[0])) + ((fRec110[2] * (0.0f - (fSlow152 * fRec111[0]))) + ((fSlow149 * (fRec106[0] * fRec107[0])) + ((fRec114[2] * (0.0f - (fSlow159 * fRec115[0]))) + ((fSlow159 * (fRec114[0] * fRec115[0])) + ((fRec118[2] * (0.0f - (fSlow164 * fRec119[0]))) + (((fRec122[2] * (0.0f - (fSlow169 * fRec123[0]))) + (((fSlow172 * (fRec126[0] * fRec127[0])) + (fRec126[2] * (0.0f - (fSlow172 * fRec127[0])))) + (fSlow169 * (fRec122[0] * fRec123[0])))) + (fSlow164 * (fRec118[0] * fRec119[0])))))))))))))))))))) + (fSlow118 * (fRec82[0] * fRec83[0])))) + (fSlow113 * (fRec78[0] * fRec79[0]))))))))))) + (fSlow91 * (fRec62[0] * fRec63[0]))))))))))))))))))))))))))))))))));
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
			fRec3[2] = fRec3[1];
			fRec3[1] = fRec3[0];
