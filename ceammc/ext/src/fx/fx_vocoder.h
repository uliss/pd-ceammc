...
class fx_vocoder : public fx_vocoder_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = std::tan(12484.517f / fConst0);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow8 = fConst8 * (fConst8 + fSlow1) + 1.0f;
		float fSlow9 = fConst8 / fSlow8;
		float fSlow10 = 1.0f / fSlow8;
		float fSlow11 = fConst8 * (fConst8 - fSlow1) + 1.0f;
		float fSlow12 = 0.17712227f * fSlow0;
		float fSlow13 = fConst11 * (fConst11 + fSlow12) + 1.0f;
		float fSlow14 = fConst11 / fSlow13;
		float fSlow15 = 1.0f / fSlow13;
		float fSlow16 = fConst11 * (fConst11 - fSlow12) + 1.0f;
		float fSlow17 = fConst14 * (fConst14 + fSlow1) + 1.0f;
		float fSlow18 = fConst14 / fSlow17;
		float fSlow19 = 1.0f / fSlow17;
		float fSlow20 = fConst14 * (fConst14 - fSlow1) + 1.0f;
		float fSlow21 = 0.17712227f * fSlow0;
		float fSlow22 = fConst17 * (fConst17 + fSlow21) + 1.0f;
		float fSlow23 = fConst17 / fSlow22;
		float fSlow24 = 1.0f / fSlow22;
		float fSlow25 = fConst17 * (fConst17 - fSlow21) + 1.0f;
		float fSlow26 = 0.17712227f * fSlow0;
		float fSlow27 = fConst20 * (fConst20 + fSlow26) + 1.0f;
		float fSlow28 = fConst20 / fSlow27;
		float fSlow29 = 1.0f / fSlow27;
		float fSlow30 = fConst20 * (fConst20 - fSlow26) + 1.0f;
		float fSlow31 = 0.17712227f * fSlow0;
		float fSlow32 = fConst23 * (fConst23 + fSlow31) + 1.0f;
		float fSlow33 = fConst23 / fSlow32;
		float fSlow34 = 1.0f / fSlow32;
		float fSlow35 = fConst23 * (fConst23 - fSlow31) + 1.0f;
		float fSlow36 = 0.17712227f * fSlow0;
		float fSlow37 = fConst26 * (fConst26 + fSlow36) + 1.0f;
		float fSlow38 = fConst26 / fSlow37;
		float fSlow39 = 1.0f / fSlow37;
		float fSlow40 = fConst26 * (fConst26 - fSlow36) + 1.0f;
		float fSlow41 = fConst29 * (fConst29 + fSlow1) + 1.0f;
		float fSlow42 = fConst29 / fSlow41;
		float fSlow43 = 1.0f / fSlow41;
		float fSlow44 = fConst29 * (fConst29 - fSlow1) + 1.0f;
		float fSlow45 = fConst32 * (fConst32 + fSlow26) + 1.0f;
		float fSlow46 = fConst32 / fSlow45;
		float fSlow47 = 1.0f / fSlow45;
		float fSlow48 = fConst32 * (fConst32 - fSlow26) + 1.0f;
		float fSlow49 = fConst35 * (fConst35 + fSlow21) + 1.0f;
		float fSlow50 = fConst35 / fSlow49;
		float fSlow51 = 1.0f / fSlow49;
		float fSlow52 = fConst35 * (fConst35 - fSlow21) + 1.0f;
		float fSlow53 = 0.17712227f * fSlow0;
		float fSlow54 = fConst38 * (fConst38 + fSlow53) + 1.0f;
		float fSlow55 = fConst38 / fSlow54;
		float fSlow56 = 1.0f / fSlow54;
		float fSlow57 = fConst38 * (fConst38 - fSlow53) + 1.0f;
		float fSlow58 = 0.17712227f * fSlow0;
		float fSlow59 = fConst41 * (fConst41 + fSlow58) + 1.0f;
		float fSlow60 = fConst41 / fSlow59;
		float fSlow61 = 1.0f / fSlow59;
		float fSlow62 = fConst41 * (fConst41 - fSlow58) + 1.0f;
		float fSlow63 = fConst44 * (fConst44 + fSlow53) + 1.0f;
		float fSlow64 = fConst44 / fSlow63;
		float fSlow65 = 1.0f / fSlow63;
		float fSlow66 = fConst44 * (fConst44 - fSlow53) + 1.0f;
		float fSlow67 = 0.17712227f * fSlow0;
		float fSlow68 = fConst47 * (fConst47 + fSlow67) + 1.0f;
		float fSlow69 = fConst47 / fSlow68;
		float fSlow70 = 1.0f / fSlow68;
		float fSlow71 = fConst47 * (fConst47 - fSlow67) + 1.0f;
		float fSlow72 = fConst50 * (fConst50 + fSlow12) + 1.0f;
		float fSlow73 = fConst50 / fSlow72;
		float fSlow74 = 1.0f / fSlow72;
		float fSlow75 = fConst50 * (fConst50 - fSlow12) + 1.0f;
		float fSlow76 = fConst53 * (fConst53 + fSlow12) + 1.0f;
		float fSlow77 = fConst53 / fSlow76;
		float fSlow78 = 1.0f / fSlow76;
		float fSlow79 = fConst53 * (fConst53 - fSlow12) + 1.0f;
		float fSlow80 = fConst56 * (fConst56 + fSlow21) + 1.0f;
		float fSlow81 = fConst56 / fSlow80;
		float fSlow82 = 1.0f / fSlow80;
		float fSlow83 = fConst56 * (fConst56 - fSlow21) + 1.0f;
		float fSlow84 = 0.17712227f * fSlow0;
		float fSlow85 = fConst59 * (fConst59 + fSlow84) + 1.0f;
		float fSlow86 = fConst59 / fSlow85;
		float fSlow87 = 1.0f / fSlow85;
		float fSlow88 = fConst59 * (fConst59 - fSlow84) + 1.0f;
		float fSlow89 = fConst62 * (fConst62 + fSlow26) + 1.0f;
		float fSlow90 = fConst62 / fSlow89;
		float fSlow91 = 1.0f / fSlow89;
		float fSlow92 = fConst62 * (fConst62 - fSlow26) + 1.0f;
		float fSlow93 = fConst65 * (fConst65 + fSlow67) + 1.0f;
		float fSlow94 = fConst65 / fSlow93;
		float fSlow95 = 1.0f / fSlow93;
		float fSlow96 = fConst65 * (fConst65 - fSlow67) + 1.0f;
		float fSlow97 = fConst68 * (fConst68 + fSlow36) + 1.0f;
		float fSlow98 = fConst68 / fSlow97;
		float fSlow99 = 1.0f / fSlow97;
		float fSlow100 = fConst68 * (fConst68 - fSlow36) + 1.0f;
		float fSlow101 = fConst71 * (fConst71 + fSlow67) + 1.0f;
		float fSlow102 = fConst71 / fSlow101;
		float fSlow103 = 1.0f / fSlow101;
		float fSlow104 = fConst71 * (fConst71 - fSlow67) + 1.0f;
		float fSlow105 = fConst74 * (fConst74 + fSlow36) + 1.0f;
		float fSlow106 = fConst74 / fSlow105;
		float fSlow107 = 1.0f / fSlow105;
		float fSlow108 = fConst74 * (fConst74 - fSlow36) + 1.0f;
		float fSlow109 = 0.17712227f * fSlow0;
		float fSlow110 = fConst77 * (fConst77 + fSlow109) + 1.0f;
		float fSlow111 = fConst77 / fSlow110;
		float fSlow112 = 1.0f / fSlow110;
		float fSlow113 = fConst77 * (fConst77 - fSlow109) + 1.0f;
		float fSlow114 = fConst80 * (fConst80 + fSlow12) + 1.0f;
		float fSlow115 = fConst80 / fSlow114;
		float fSlow116 = 1.0f / fSlow114;
		float fSlow117 = fConst80 * (fConst80 - fSlow12) + 1.0f;
		float fSlow118 = fConst83 * (fConst83 + fSlow53) + 1.0f;
		float fSlow119 = fConst83 / fSlow118;
		float fSlow120 = 1.0f / fSlow118;
		float fSlow121 = fConst83 * (fConst83 - fSlow53) + 1.0f;
		float fSlow122 = 0.17712227f * fSlow0;
		float fSlow123 = fConst86 * (fConst86 + fSlow122) + 1.0f;
		float fSlow124 = fConst86 / fSlow123;
		float fSlow125 = 1.0f / fSlow123;
		float fSlow126 = fConst86 * (fConst86 - fSlow122) + 1.0f;
		float fSlow127 = fConst89 * (fConst89 + fSlow1) + 1.0f;
		float fSlow128 = fConst89 / fSlow127;
		float fSlow129 = 1.0f / fSlow127;
		float fSlow130 = fConst89 * (fConst89 - fSlow1) + 1.0f;
		float fSlow131 = fConst92 * (fConst92 + fSlow67) + 1.0f;
		float fSlow132 = fConst92 / fSlow131;
		float fSlow133 = 1.0f / fSlow131;
		float fSlow134 = fConst92 * (fConst92 - fSlow67) + 1.0f;
		float fSlow135 = 0.17712227f * fSlow0;
		float fSlow136 = fConst95 * (fConst95 + fSlow135) + 1.0f;
		float fSlow137 = fConst95 / fSlow136;
		float fSlow138 = 1.0f / fSlow136;
		float fSlow139 = fConst95 * (fConst95 - fSlow135) + 1.0f;
		float fSlow140 = fConst98 * (fConst98 + fSlow109) + 1.0f;
		float fSlow141 = fConst98 / fSlow140;
		float fSlow142 = 1.0f / fSlow140;
		float fSlow143 = fConst98 * (fConst98 - fSlow109) + 1.0f;
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec6[0] = fTemp0 - fSlow10 * (fSlow11 * fRec6[2] + fConst9 * fRec6[1]);
			float fTemp8 = std::fabs(fSlow9 * (fRec6[0] - fRec6[2]));
			float fTemp9 = ((fTemp8 > fRec5[1]) ? fTemp5 : fTemp3);
			fRec5[0] = fTemp8 * (1.0f - fTemp9) + fRec5[1] * fTemp9;
			fRec7[0] = fTemp7 - fSlow10 * (fSlow11 * fRec7[2] + fConst9 * fRec7[1]);
			fRec9[0] = fTemp0 - fSlow15 * (fSlow16 * fRec9[2] + fConst12 * fRec9[1]);
			float fTemp10 = std::fabs(fSlow14 * (fRec9[0] - fRec9[2]));
			float fTemp11 = ((fTemp10 > fRec8[1]) ? fTemp5 : fTemp3);
			fRec8[0] = fTemp10 * (1.0f - fTemp11) + fRec8[1] * fTemp11;
			fRec10[0] = fTemp7 - fSlow15 * (fSlow16 * fRec10[2] + fConst12 * fRec10[1]);
			fRec12[0] = fTemp0 - fSlow19 * (fSlow20 * fRec12[2] + fConst15 * fRec12[1]);
			float fTemp12 = std::fabs(fSlow18 * (fRec12[0] - fRec12[2]));
			float fTemp13 = ((fTemp12 > fRec11[1]) ? fTemp5 : fTemp3);
			fRec11[0] = fTemp12 * (1.0f - fTemp13) + fRec11[1] * fTemp13;
			fRec13[0] = fTemp7 - fSlow19 * (fSlow20 * fRec13[2] + fConst15 * fRec13[1]);
			fRec15[0] = fTemp0 - fSlow24 * (fSlow25 * fRec15[2] + fConst18 * fRec15[1]);
			float fTemp14 = std::fabs(fSlow23 * (fRec15[0] - fRec15[2]));
			float fTemp15 = ((fTemp14 > fRec14[1]) ? fTemp5 : fTemp3);
			fRec14[0] = fTemp14 * (1.0f - fTemp15) + fRec14[1] * fTemp15;
			fRec16[0] = fTemp7 - fSlow24 * (fSlow25 * fRec16[2] + fConst18 * fRec16[1]);
			...
			fRec21[0] = fTemp0 - fSlow34 * (fSlow35 * fRec21[2] + fConst24 * fRec21[1]);
			float fTemp18 = std::fabs(fSlow33 * (fRec21[0] - fRec21[2]));
			float fTemp19 = ((fTemp18 > fRec20[1]) ? fTemp5 : fTemp3);
			fRec20[0] = fTemp18 * (1.0f - fTemp19) + fRec20[1] * fTemp19;
			fRec22[0] = fTemp7 - fSlow34 * (fSlow35 * fRec22[2] + fConst24 * fRec22[1]);
			fRec24[0] = fTemp0 - fSlow39 * (fSlow40 * fRec24[2] + fConst27 * fRec24[1]);
			float fTemp20 = std::fabs(fSlow38 * (fRec24[0] - fRec24[2]));
			float fTemp21 = ((fTemp20 > fRec23[1]) ? fTemp5 : fTemp3);
			fRec23[0] = fTemp20 * (1.0f - fTemp21) + fRec23[1] * fTemp21;
			fRec25[0] = fTemp7 - fSlow39 * (fSlow40 * fRec25[2] + fConst27 * fRec25[1]);
			...
			fRec30[0] = fTemp0 - fSlow47 * (fSlow48 * fRec30[2] + fConst33 * fRec30[1]);
			float fTemp24 = std::fabs(fSlow46 * (fRec30[0] - fRec30[2]));
			float fTemp25 = ((fTemp24 > fRec29[1]) ? fTemp5 : fTemp3);
			fRec29[0] = fTemp24 * (1.0f - fTemp25) + fRec29[1] * fTemp25;
			fRec31[0] = fTemp7 - fSlow47 * (fSlow48 * fRec31[2] + fConst33 * fRec31[1]);
			fRec33[0] = fTemp0 - fSlow51 * (fSlow52 * fRec33[2] + fConst36 * fRec33[1]);
			float fTemp26 = std::fabs(fSlow50 * (fRec33[0] - fRec33[2]));
			float fTemp27 = ((fTemp26 > fRec32[1]) ? fTemp5 : fTemp3);
			fRec32[0] = fTemp26 * (1.0f - fTemp27) + fRec32[1] * fTemp27;
			fRec34[0] = fTemp7 - fSlow51 * (fSlow52 * fRec34[2] + fConst36 * fRec34[1]);
			fRec36[0] = fTemp0 - fSlow56 * (fSlow57 * fRec36[2] + fConst39 * fRec36[1]);
			float fTemp28 = std::fabs(fSlow55 * (fRec36[0] - fRec36[2]));
			float fTemp29 = ((fTemp28 > fRec35[1]) ? fTemp5 : fTemp3);
			fRec35[0] = fTemp28 * (1.0f - fTemp29) + fRec35[1] * fTemp29;
			fRec37[0] = fTemp7 - fSlow56 * (fSlow57 * fRec37[2] + fConst39 * fRec37[1]);
			...
			fRec45[0] = fTemp0 - fSlow70 * (fSlow71 * fRec45[2] + fConst48 * fRec45[1]);
			float fTemp34 = std::fabs(fSlow69 * (fRec45[0] - fRec45[2]));
			float fTemp35 = ((fTemp34 > fRec44[1]) ? fTemp5 : fTemp3);
			fRec44[0] = fTemp34 * (1.0f - fTemp35) + fRec44[1] * fTemp35;
			fRec46[0] = fTemp7 - fSlow70 * (fSlow71 * fRec46[2] + fConst48 * fRec46[1]);
			...
			fRec54[0] = fTemp0 - fSlow82 * (fSlow83 * fRec54[2] + fConst57 * fRec54[1]);
			float fTemp40 = std::fabs(fSlow81 * (fRec54[0] - fRec54[2]));
			float fTemp41 = ((fTemp40 > fRec53[1]) ? fTemp5 : fTemp3);
			fRec53[0] = fTemp40 * (1.0f - fTemp41) + fRec53[1] * fTemp41;
			fRec55[0] = fTemp7 - fSlow82 * (fSlow83 * fRec55[2] + fConst57 * fRec55[1]);
			...
			fRec72[0] = fTemp0 - fSlow107 * (fSlow108 * fRec72[2] + fConst75 * fRec72[1]);
			float fTemp52 = std::fabs(fSlow106 * (fRec72[0] - fRec72[2]));
			float fTemp53 = ((fTemp52 > fRec71[1]) ? fTemp5 : fTemp3);
			fRec71[0] = fTemp52 * (1.0f - fTemp53) + fRec71[1] * fTemp53;
			fRec73[0] = fTemp7 - fSlow107 * (fSlow108 * fRec73[2] + fConst75 * fRec73[1]);
			...
			fRec78[0] = fTemp0 - fSlow116 * (fSlow117 * fRec78[2] + fConst81 * fRec78[1]);
			float fTemp56 = std::fabs(fSlow115 * (fRec78[0] - fRec78[2]));
			float fTemp57 = ((fTemp56 > fRec77[1]) ? fTemp5 : fTemp3);
			fRec77[0] = fTemp56 * (1.0f - fTemp57) + fRec77[1] * fTemp57;
			fRec79[0] = fTemp7 - fSlow116 * (fSlow117 * fRec79[2] + fConst81 * fRec79[1]);
			fRec81[0] = fTemp0 - fSlow120 * (fSlow121 * fRec81[2] + fConst84 * fRec81[1]);
			float fTemp58 = std::fabs(fSlow119 * (fRec81[0] - fRec81[2]));
			float fTemp59 = ((fTemp58 > fRec80[1]) ? fTemp5 : fTemp3);
			fRec80[0] = fTemp58 * (1.0f - fTemp59) + fRec80[1] * fTemp59;
			fRec82[0] = fTemp7 - fSlow120 * (fSlow121 * fRec82[2] + fConst84 * fRec82[1]);
			...
			fRec93[0] = fTemp0 - fSlow138 * (fSlow139 * fRec93[2] + fConst96 * fRec93[1]);
			float fTemp66 = std::fabs(fSlow137 * (fRec93[0] - fRec93[2]));
			float fTemp67 = ((fTemp66 > fRec92[1]) ? fTemp5 : fTemp3);
			fRec92[0] = fTemp66 * (1.0f - fTemp67) + fRec92[1] * fTemp67;
			fRec94[0] = fTemp7 - fSlow138 * (fSlow139 * fRec94[2] + fConst96 * fRec94[1]);
			...
			output0[i0] = FAUSTFLOAT(fSlow3 * fRec0[0] * (fRec4[0] - fRec4[2]) + fSlow9 * fRec5[0] * (fRec7[0] - fRec7[2]) + fSlow14 * fRec8[0] * (fRec10[0] - fRec10[2]) + fSlow18 * fRec11[0] * (fRec13[0] - fRec13[2]) + fSlow23 * fRec14[0] * (fRec16[0] - fRec16[2]) + fSlow28 * fRec17[0] * (fRec19[0] - fRec19[2]) + fSlow33 * fRec20[0] * (fRec22[0] - fRec22[2]) + fSlow38 * fRec23[0] * (fRec25[0] - fRec25[2]) + fSlow42 * fRec26[0] * (fRec28[0] - fRec28[2]) + fSlow46 * fRec29[0] * (fRec31[0] - fRec31[2]) + fSlow50 * fRec32[0] * (fRec34[0] - fRec34[2]) + fSlow55 * fRec35[0] * (fRec37[0] - fRec37[2]) + fSlow60 * fRec38[0] * (fRec40[0] - fRec40[2]) + fSlow64 * fRec41[0] * (fRec43[0] - fRec43[2]) + fSlow69 * fRec44[0] * (fRec46[0] - fRec46[2]) + fSlow73 * fRec47[0] * (fRec49[0] - fRec49[2]) + fSlow77 * fRec50[0] * (fRec52[0] - fRec52[2]) + fSlow81 * fRec53[0] * (fRec55[0] - fRec55[2]) + fSlow86 * fRec56[0] * (fRec58[0] - fRec58[2]) + fSlow90 * fRec59[0] * (fRec61[0] - fRec61[2]) + fSlow94 * fRec62[0] * (fRec64[0] - fRec64[2]) + fSlow98 * fRec65[0] * (fRec67[0] - fRec67[2]) + fSlow102 * fRec68[0] * (fRec70[0] - fRec70[2]) + fSlow106 * fRec71[0] * (fRec73[0] - fRec73[2]) + fSlow111 * fRec74[0] * (fRec76[0] - fRec76[2]) + fSlow115 * fRec77[0] * (fRec79[0] - fRec79[2]) + fSlow119 * fRec80[0] * (fRec82[0] - fRec82[2]) + fSlow124 * fRec83[0] * (fRec85[0] - fRec85[2]) + fSlow128 * fRec86[0] * (fRec88[0] - fRec88[2]) + fSlow132 * fRec89[0] * (fRec91[0] - fRec91[2]) + fSlow137 * fRec92[0] * (fRec94[0] - fRec94[2]) + fSlow141 * fRec95[0] * (fRec97[0] - fRec97[2]));
			fRec1[2] = fRec1[1];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
