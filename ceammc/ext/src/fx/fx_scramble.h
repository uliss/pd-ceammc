...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_scramble -scn fx_scramble_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API fx_scramble_dsp {
    ...
    public:
        ...
        fx_scramble_dsp() = default;
        virtual ~fx_scramble_dsp() = default;
...
class fx_scramble : public fx_scramble_dsp {
 ...
 public:
	...
	fx_scramble(const fx_scramble&) = default;
	
	virtual ~fx_scramble() = default;
	
	fx_scramble& operator=(const fx_scramble&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_scramble -scn fx_scramble_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider5 = static_cast<FAUSTFLOAT>(0.25f);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow4 = 0.99f * static_cast<float>(fHslider3);
		float fSlow5 = fConst5 * static_cast<float>(fHslider4);
		float fSlow6 = std::sin(fSlow5);
		float fSlow7 = std::cos(fSlow5);
		float fSlow8 = static_cast<float>(fHslider5);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp8 = static_cast<float>(iRec9[0]);
			fRec6[0] = fRec6[1] * static_cast<float>(1 - iTemp7) + 4.656613e-10f * fTemp8 * static_cast<float>(iTemp7);
			...
			fRec3[0] = fRec3[1] * static_cast<float>(1 - iTemp12) + 4.656613e-10f * fTemp8 * static_cast<float>(iTemp12);
			...
			int iTemp23 = static_cast<int>(fTemp14);
			float fTemp24 = fTemp13 + (-1.0f - fTemp15);
			float fTemp25 = fTemp17 * fTemp24;
			fRec2[0] = (fTemp13 + (-3.0f - fTemp15)) * (fTemp16 * (0.5f * fTemp17 * fVec1[(IOTA0 - static_cast<int>(std::min<float>(fConst3, static_cast<float>(std::max<int>(0, iTemp23 + 1))))) & 2097151] - 0.16666667f * fVec1[(IOTA0 - static_cast<int>(std::min<float>(fConst3, static_cast<float>(std::max<int>(0, iTemp23))))) & 2097151] * fTemp24) - 0.5f * fTemp25 * fVec1[(IOTA0 - static_cast<int>(std::min<float>(fConst3, static_cast<float>(std::max<int>(0, iTemp23 + 2))))) & 2097151]) + 0.16666667f * fTemp25 * fTemp16 * fVec1[(IOTA0 - static_cast<int>(std::min<float>(fConst3, static_cast<float>(std::max<int>(0, iTemp23 + 3))))) & 2097151];
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp3 + fTemp4 * (fTemp5 + fRec1[0] * fRec2[0]));
			...
			fRec15[0] = fRec15[1] * static_cast<float>(1 - iTemp26) + 4.656613e-10f * fTemp8 * static_cast<float>(iTemp26);
			...
			fRec12[0] = fRec12[1] * static_cast<float>(1 - iTemp30) + 4.656613e-10f * fTemp8 * static_cast<float>(iTemp30);
			...
			int iTemp41 = static_cast<int>(fTemp32);
			float fTemp42 = fTemp31 + (-1.0f - fTemp33);
			float fTemp43 = fTemp35 * fTemp42;
			fRec11[0] = (fTemp31 + (-3.0f - fTemp33)) * (fTemp34 * (0.5f * fTemp35 * fVec2[(IOTA0 - static_cast<int>(std::min<float>(fConst3, static_cast<float>(std::max<int>(0, iTemp41 + 1))))) & 2097151] - 0.16666667f * fVec2[(IOTA0 - static_cast<int>(std::min<float>(fConst3, static_cast<float>(std::max<int>(0, iTemp41))))) & 2097151] * fTemp42) - 0.5f * fTemp43 * fVec2[(IOTA0 - static_cast<int>(std::min<float>(fConst3, static_cast<float>(std::max<int>(0, iTemp41 + 2))))) & 2097151]) + 0.16666667f * fTemp43 * fTemp34 * fVec2[(IOTA0 - static_cast<int>(std::min<float>(fConst3, static_cast<float>(std::max<int>(0, iTemp41 + 3))))) & 2097151];
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp3 + fTemp4 * (fTemp5 + fRec1[0] * fRec11[0]));
			iVec0[1] = iVec0[0];
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec7[1] = fRec7[0];
