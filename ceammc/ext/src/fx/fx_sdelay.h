 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec2[0] = fTemp3;
			fRec3[0] = std::max(0.0f, std::min(1.0f, (fRec3[1] + fTemp3)));
			fRec4[0] = (((fRec3[1] >= 1.0f) & (fRec5[1] != fRec6[0]))?fRec6[0]:fRec4[1]);
			fRec5[0] = (((fRec3[1] <= 0.0f) & (fRec4[1] != fRec6[0]))?fRec6[0]:fRec5[1]);
			fRec1[0] = ((fVec0[((IOTA - int(std::min(float(iConst1), std::max(0.0f, fRec4[0])))) & 2097151)] * (1.0f - fRec3[0])) + (fRec3[0] * fVec0[((IOTA - int(std::min(float(iConst1), std::max(0.0f, fRec5[0])))) & 2097151)]));
