...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_echo2 -scn fx_echo2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __fx_echo2_H__
#define  __fx_echo2_H__
...
class FAUST_API fx_echo2_dsp {

    public:

        fx_echo2_dsp() = default;
        virtual ~fx_echo2_dsp() = default;
...
class FAUST_API decorator_dsp : public ::fx_echo2_dsp {
    ...
    public:
        ...
        decorator_dsp(::fx_echo2_dsp* fx_echo2_dsp = nullptr):fDSP(fx_echo2_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::fx_echo2_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in fx_echo2_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct fx_echo2 : public fx_echo2_dsp {
};
#endif
// clang-format on
...
class fx_echo2 : public fx_echo2_dsp {
 ...
 public:
	...
	fx_echo2(const fx_echo2&) = default;
	
	virtual ~fx_echo2() = default;
	
	fx_echo2& operator=(const fx_echo2&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_echo2 -scn fx_echo2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("delays.lib/name", "Faust Delay Library");
		m->declare("delays.lib/version", "1.2.0");
		m->declare("filename", "fx_echo2.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.9.0");
		m->declare("name", "fx.echo2");
	...
	virtual fx_echo2* clone() {
		return new fx_echo2(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("fx.echo2");
		ui_interface->addCheckButton("bypass", &fCheckbox0);
		ui_interface->declare(&fHslider2, "unit", "ms");
		ui_interface->addHorizontalSlider("delay", &fHslider2, FAUSTFLOAT(5e+02f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addHorizontalSlider("feedback", &fHslider3, FAUSTFLOAT(0.3f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.99f), FAUSTFLOAT(0.001f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow3 = fConst3 * static_cast<float>(fHslider2);
		float fSlow4 = std::floor(fSlow3);
		float fSlow5 = fSlow4 + (1.0f - fSlow3);
		float fSlow6 = fConst1 * static_cast<float>(fHslider3);
		int iSlow7 = static_cast<int>(fSlow3);
		int iSlow8 = static_cast<int>(std::min<float>(fConst4, static_cast<float>(std::max<int>(0, iSlow7))));
		float fSlow9 = fSlow3 - fSlow4;
		int iSlow10 = static_cast<int>(std::min<float>(fConst4, static_cast<float>(std::max<int>(0, iSlow7 + 1))));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp6 = fTemp0 + fRec5[0] * (fTemp5 * fRec3[1] + fRec2[0] * fRec4[1]);
			fVec0[IOTA0 & 1048575] = fTemp6;
			fRec3[0] = fSlow5 * fVec0[(IOTA0 - iSlow8) & 1048575] + fSlow9 * fVec0[(IOTA0 - iSlow10) & 1048575];
			float fTemp7 = static_cast<float>(input1[i0]);
			float fTemp8 = fTemp7 + fRec5[0] * (fTemp5 * fRec4[1] + fRec2[0] * fRec3[1]);
			fVec1[IOTA0 & 1048575] = fTemp8;
			fRec4[0] = fSlow5 * fVec1[(IOTA0 - iSlow8) & 1048575] + fSlow9 * fVec1[(IOTA0 - iSlow10) & 1048575];
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec0[0] + fTemp3 * (fTemp0 * fTemp4 + 0.5f * fRec1[0] * (fRec2[0] * fRec4[0] + fTemp0 + fRec3[0] * fTemp5)));
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp7 * fRec0[0] + fTemp3 * (fTemp7 * fTemp4 + 0.5f * fRec1[0] * (fRec2[0] * fRec3[0] + fTemp7 + fRec4[0] * fTemp5)));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec5[1] = fRec5[0];
...
class faust_fx_echo2_tilde : public FaustExternal<fx_echo2> {
public:
    faust_fx_echo2_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(fx_echo2))
    {
    }
};
