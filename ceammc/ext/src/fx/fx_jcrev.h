...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_jcrev -scn fx_jcrev_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __fx_jcrev_H__
#define  __fx_jcrev_H__
...
class FAUST_API fx_jcrev_dsp {

    public:

        fx_jcrev_dsp() = default;
        virtual ~fx_jcrev_dsp() = default;
...
class FAUST_API decorator_dsp : public ::fx_jcrev_dsp {
    ...
    public:
        ...
        decorator_dsp(::fx_jcrev_dsp* fx_jcrev_dsp = nullptr):fDSP(fx_jcrev_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::fx_jcrev_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in fx_jcrev_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct fx_jcrev : public fx_jcrev_dsp {
};
#endif
// clang-format on
...
class fx_jcrev : public fx_jcrev_dsp {
 ...
 public:
	...
	fx_jcrev(const fx_jcrev&) = default;
	
	virtual ~fx_jcrev() = default;
	
	fx_jcrev& operator=(const fx_jcrev&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_jcrev -scn fx_jcrev_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("delays.lib/name", "Faust Delay Library");
		m->declare("delays.lib/version", "1.2.0");
		m->declare("filename", "fx_jcrev.dsp");
	...
	virtual fx_jcrev* clone() {
		return new fx_jcrev(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("fx.jcrev");
		ui_interface->addCheckButton("bypass", &fCheckbox0);
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->addHorizontalSlider("drywet", &fHslider0, FAUSTFLOAT(0.4f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = fConst2 * static_cast<float>(fHslider0);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = static_cast<float>(input0[i0]);
			float fTemp1 = fConst1 + fRec0[1];
			float fTemp2 = fRec0[1] - fConst1;
			...
			float fTemp6 = fTemp5 * (1.0f - fRec1[0]);
			float fTemp7 = 0.7f * fRec7[1] + 0.06f * fTemp5;
			fVec0[IOTA0 & 511] = fTemp7;
			fRec7[0] = fVec0[(IOTA0 - 346) & 511];
			float fRec8 = -(0.7f * fTemp7);
			float fTemp8 = fRec7[1] + fRec8 + 0.7f * fRec5[1];
			fVec1[IOTA0 & 127] = fTemp8;
			fRec5[0] = fVec1[(IOTA0 - 112) & 127];
			float fRec6 = -(0.7f * fTemp8);
			float fTemp9 = fRec5[1] + fRec6 + 0.7f * fRec3[1];
			fVec2[IOTA0 & 63] = fTemp9;
			fRec3[0] = fVec2[(IOTA0 - 36) & 63];
			float fRec4 = -(0.7f * fTemp9);
			fRec2[IOTA0 & 2047] = fRec3[1] + fRec4 + 0.802f * fRec2[(IOTA0 - 1601) & 2047];
			float fTemp10 = fRec2[(IOTA0 - 1) & 2047];
			float fTemp11 = fRec4 + fRec3[1];
			fRec9[IOTA0 & 2047] = fTemp11 + 0.773f * fRec9[(IOTA0 - 1867) & 2047];
			float fTemp12 = fRec9[(IOTA0 - 1) & 2047];
			fRec10[IOTA0 & 4095] = fTemp11 + 0.753f * fRec10[(IOTA0 - 2053) & 4095];
			float fTemp13 = fRec10[(IOTA0 - 1) & 4095];
			fRec11[IOTA0 & 4095] = fTemp11 + 0.733f * fRec11[(IOTA0 - 2251) & 4095];
			float fTemp14 = fRec11[(IOTA0 - 1) & 4095];
			float fTemp15 = fRec1[0] * (fTemp10 + fTemp12 + fTemp13 + fTemp14);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp3 + fTemp4 * (fTemp6 + fTemp15));
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp3 + fTemp4 * (fTemp6 - fTemp15));
			float fTemp16 = fRec1[0] * (fTemp12 + fTemp14 - (fTemp10 + fTemp13));
			output2[i0] = static_cast<FAUSTFLOAT>(fTemp3 + fTemp4 * (fTemp6 + fTemp16));
			output3[i0] = static_cast<FAUSTFLOAT>(fTemp3 + fTemp4 * (fTemp6 - fTemp16));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			IOTA0 = IOTA0 + 1;
			fRec7[1] = fRec7[0];
...
class faust_fx_jcrev_tilde : public FaustExternal<fx_jcrev> {
public:
    faust_fx_jcrev_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(fx_jcrev))
    {
    }
};
