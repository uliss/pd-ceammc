...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_distortion3 -scn fx_distortion3_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API fx_distortion3_dsp {

    public:

        fx_distortion3_dsp() = default;
        virtual ~fx_distortion3_dsp() = default;
...
class FAUST_API decorator_dsp : public ::fx_distortion3_dsp {
...
class fx_distortion3 : public fx_distortion3_dsp {
 ...
 public:
	...
	fx_distortion3(const fx_distortion3&) = default;
	
	virtual ~fx_distortion3() = default;
	
	fx_distortion3& operator=(const fx_distortion3&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_distortion3 -scn fx_distortion3_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider0 = static_cast<FAUSTFLOAT>(1e+04f);
		fVslider1 = static_cast<FAUSTFLOAT>(3e+01f);
	...
	virtual fx_distortion3* clone() {
		return new fx_distortion3(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("drive", &fVslider3, FAUSTFLOAT(0.5f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addVerticalSlider("gain", &fVslider2, FAUSTFLOAT(0.0f), FAUSTFLOAT(-3e+01f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fVslider1, "unit", "Hz");
		ui_interface->addVerticalSlider("hp_freq", &fVslider1, FAUSTFLOAT(3e+01f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+03f), FAUSTFLOAT(1.08f));
		ui_interface->declare(&fVslider0, "unit", "Hz");
		ui_interface->addVerticalSlider("lp_freq", &fVslider0, FAUSTFLOAT(1e+04f), FAUSTFLOAT(1e+03f), FAUSTFLOAT(2e+04f), FAUSTFLOAT(1.08f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = std::tan(fConst3 * static_cast<float>(fVslider0));
		float fSlow3 = 1.0f / fSlow2;
		float fSlow4 = 1.0f / ((fSlow3 + 1.4142135f) / fSlow2 + 1.0f);
		float fSlow5 = std::tan(fConst3 * static_cast<float>(fVslider1));
		...
		float fSlow13 = fConst1 * std::pow(1e+01f, 0.05f * static_cast<float>(fVslider2));
		float fSlow14 = fConst1 * static_cast<float>(fVslider3);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp4 = std::sin(1.5399964f * (fRec6[0] + 0.01f));
			...
			output0[i0] = static_cast<FAUSTFLOAT>(((iSlow0) ? fTemp0 : fTemp1 * (1.0f - fRec0[0]) + fSlow4 * fRec0[0] * (fRec1[2] + fRec1[0] + 2.0f * fRec1[1])));
			fRec0[1] = fRec0[0];
			fRec4[2] = fRec4[1];
			fRec4[1] = fRec4[0];
			fVec0[1] = fVec0[0];
...
class faust_fx_distortion3_tilde : public FaustExternal<fx_distortion3> {
public:
    faust_fx_distortion3_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(fx_distortion3))
    {
    }
};
