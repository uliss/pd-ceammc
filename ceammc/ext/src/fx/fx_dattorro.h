...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_dattorro -scn fx_dattorro_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API fx_dattorro_dsp {
    ...
    public:
        ...
        fx_dattorro_dsp() = default;
        virtual ~fx_dattorro_dsp() = default;
...
class fx_dattorro : public fx_dattorro_dsp {
 ...
 public:
	...
	fx_dattorro(const fx_dattorro&) = default;
	
	virtual ~fx_dattorro() = default;
	
	fx_dattorro& operator=(const fx_dattorro&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_dattorro -scn fx_dattorro_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider0 = static_cast<FAUSTFLOAT>(0.9995f);
		fVslider1 = static_cast<FAUSTFLOAT>(4e+01f);
		fVslider2 = static_cast<FAUSTFLOAT>(0.625f);
		fVslider3 = static_cast<FAUSTFLOAT>(0.75f);
		fVslider4 = static_cast<FAUSTFLOAT>(0.5f);
		fVslider5 = static_cast<FAUSTFLOAT>(0.0005f);
		fVslider6 = static_cast<FAUSTFLOAT>(0.5f);
		fVslider7 = static_cast<FAUSTFLOAT>(0.7f);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = fConst1 * static_cast<float>(fVslider0);
		float fSlow3 = fConst4 * static_cast<float>(fVslider1);
		float fSlow4 = fConst1 * static_cast<float>(fVslider2);
		float fSlow5 = fConst1 * static_cast<float>(fVslider3);
		float fSlow6 = fConst1 * static_cast<float>(fVslider4);
		float fSlow7 = fConst1 * static_cast<float>(fVslider5);
		float fSlow8 = fConst1 * static_cast<float>(fVslider6);
		float fSlow9 = fConst1 * static_cast<float>(fVslider7);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec12[0] = (1.0f - fRec13[0]) * fRec12[2] + 0.5f * fRec13[0] * (fVec0[(IOTA0 - static_cast<int>(std::min<float>(fConst3, static_cast<float>(std::max<int>(0, iTemp8))))) & 32767] * (fTemp9 + (1.0f - fTemp7)) + (fTemp7 - fTemp9) * fVec0[(IOTA0 - static_cast<int>(std::min<float>(fConst3, static_cast<float>(std::max<int>(0, iTemp8 + 1))))) & 32767]);
			...
			fRec2[0] = fRec4[1] + fRec5 + fRec17[0] * fVec8[(IOTA0 - 2656) & 4095];
			...
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec0[0] + fTemp3 * (fTemp0 * fTemp4 + fRec1[0] * fRec2[0]));
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp5 * fRec0[0] + fTemp3 * (fTemp5 * fTemp4 + fRec1[0] * fRec3[0]));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec13[1] = fRec13[0];
			IOTA0 = IOTA0 + 1;
