...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_pitchshift_sig -scn fx_pitchshift_sig_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API fx_pitchshift_sig_dsp {

    public:

        fx_pitchshift_sig_dsp() = default;
        virtual ~fx_pitchshift_sig_dsp() = default;
...
class FAUST_API decorator_dsp : public ::fx_pitchshift_sig_dsp {
...
class fx_pitchshift_sig : public fx_pitchshift_sig_dsp {
 ...
 public:
	...
	fx_pitchshift_sig(const fx_pitchshift_sig&) = default;
	
	virtual ~fx_pitchshift_sig() = default;
	
	fx_pitchshift_sig& operator=(const fx_pitchshift_sig&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_pitchshift_sig -scn fx_pitchshift_sig_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual fx_pitchshift_sig* clone() {
		return new fx_pitchshift_sig(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("fade", &fVslider1, FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+03f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow3 = fConst4 / static_cast<float>(fVslider1);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = static_cast<float>(input0[i0]);
			float fTemp1 = ((iSlow0) ? 0.0f : fTemp0);
			fVec0[IOTA0 & 131071] = fTemp1;
			fRec0[0] = fSlow1 + fConst2 * fRec0[1];
			fRec1[0] = std::fmod(fSlow2 + fRec1[1] + (1.0f - std::pow(2.0f, 0.083333336f * static_cast<float>(input1[i0]))), fSlow2);
...
class faust_fx_pitchshift_sig_tilde : public FaustExternal<fx_pitchshift_sig> {
public:
    faust_fx_pitchshift_sig_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(fx_pitchshift_sig))
    {
    }
};
