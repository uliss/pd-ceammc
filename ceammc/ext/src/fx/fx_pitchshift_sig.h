...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -cn fx_pitchshift_sig -scn fx_pitchshift_sig_dsp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class fx_pitchshift_sig : public fx_pitchshift_sig_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -cn fx_pitchshift_sig -scn fx_pitchshift_sig_dsp -es 1 -mcd 16 -single -ftz 0");
