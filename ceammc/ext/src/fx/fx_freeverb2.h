...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_freeverb2 -scn fx_freeverb2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API fx_freeverb2_dsp {
    ...
    public:
        ...
        fx_freeverb2_dsp() = default;
        virtual ~fx_freeverb2_dsp() = default;
...
class fx_freeverb2 : public fx_freeverb2_dsp {
 ...
 public:
	...
	fx_freeverb2(const fx_freeverb2&) = default;
	
	virtual ~fx_freeverb2() = default;
	
	fx_freeverb2& operator=(const fx_freeverb2&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_freeverb2 -scn fx_freeverb2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst4 = static_cast<int>(0.036666665f * fConst0);
		iConst5 = std::max<int>(0, iConst4 + -1);
		iConst6 = static_cast<int>(0.035306122f * fConst0);
		iConst7 = std::max<int>(0, iConst6 + -1);
		iConst8 = static_cast<int>(0.033809524f * fConst0);
		iConst9 = std::max<int>(0, iConst8 + -1);
		iConst10 = static_cast<int>(0.0322449f * fConst0);
		iConst11 = std::max<int>(0, iConst10 + -1);
		iConst12 = static_cast<int>(0.030748298f * fConst0);
		iConst13 = std::max<int>(0, iConst12 + -1);
		iConst14 = static_cast<int>(0.028956916f * fConst0);
		iConst15 = std::max<int>(0, iConst14 + -1);
		iConst16 = static_cast<int>(0.026938776f * fConst0);
		iConst17 = std::max<int>(0, iConst16 + -1);
		iConst18 = static_cast<int>(0.025306122f * fConst0);
		...
		fConst28 = 0.0010430838f * fConst0;
	}
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider3 = static_cast<FAUSTFLOAT>(0.999f);
		fHslider4 = static_cast<FAUSTFLOAT>(0.5f);
		fHslider5 = static_cast<FAUSTFLOAT>(0.0001f);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		int iSlow12 = static_cast<int>(fConst28 * static_cast<float>(fHslider6)) + -1;
		int iSlow13 = std::max<int>(0, iConst4 + iSlow12);
		int iSlow14 = std::max<int>(0, iConst6 + iSlow12);
		int iSlow15 = std::max<int>(0, iConst8 + iSlow12);
		int iSlow16 = std::max<int>(0, iConst10 + iSlow12);
		int iSlow17 = std::max<int>(0, iConst12 + iSlow12);
		int iSlow18 = std::max<int>(0, iConst14 + iSlow12);
		int iSlow19 = std::max<int>(0, iConst16 + iSlow12);
		int iSlow20 = std::max<int>(0, iConst18 + iSlow12);
		int iSlow21 = std::min<int>(1024, std::max<int>(0, iConst20 + iSlow12));
		int iSlow22 = std::min<int>(1024, std::max<int>(0, iConst22 + iSlow12));
		int iSlow23 = std::min<int>(1024, std::max<int>(0, iConst24 + iSlow12));
		int iSlow24 = std::min<int>(1024, std::max<int>(0, iConst26 + iSlow12));
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp5 = static_cast<float>(input1[i0]);
			float fTemp6 = fRec11[0] * (fTemp0 + fTemp5);
			...
			fRec10[0] = fVec0[(IOTA0 - iConst5) & 8191];
			fRec18[0] = fRec15[0] * fRec18[1] + fTemp7 * fRec17[1];
			fVec1[IOTA0 & 8191] = fTemp6 + fRec12[0] * fRec18[0];
			fRec17[0] = fVec1[(IOTA0 - iConst7) & 8191];
			fRec20[0] = fRec15[0] * fRec20[1] + fTemp7 * fRec19[1];
			fVec2[IOTA0 & 8191] = fTemp6 + fRec12[0] * fRec20[0];
			fRec19[0] = fVec2[(IOTA0 - iConst9) & 8191];
			fRec22[0] = fRec15[0] * fRec22[1] + fTemp7 * fRec21[1];
			fVec3[IOTA0 & 8191] = fTemp6 + fRec12[0] * fRec22[0];
			fRec21[0] = fVec3[(IOTA0 - iConst11) & 8191];
			fRec24[0] = fRec15[0] * fRec24[1] + fTemp7 * fRec23[1];
			fVec4[IOTA0 & 8191] = fTemp6 + fRec12[0] * fRec24[0];
			fRec23[0] = fVec4[(IOTA0 - iConst13) & 8191];
			fRec26[0] = fRec15[0] * fRec26[1] + fTemp7 * fRec25[1];
			fVec5[IOTA0 & 8191] = fTemp6 + fRec12[0] * fRec26[0];
			fRec25[0] = fVec5[(IOTA0 - iConst15) & 8191];
			fRec28[0] = fRec15[0] * fRec28[1] + fTemp7 * fRec27[1];
			fVec6[IOTA0 & 8191] = fTemp6 + fRec12[0] * fRec28[0];
			fRec27[0] = fVec6[(IOTA0 - iConst17) & 8191];
			fRec30[0] = fRec15[0] * fRec30[1] + fTemp7 * fRec29[1];
			fVec7[IOTA0 & 8191] = fRec30[0] * fRec12[0] + fTemp6;
			fRec29[0] = fVec7[(IOTA0 - iConst19) & 8191];
			float fTemp8 = fRec10[1] + fRec17[1] + fRec19[1] + fRec21[1] + fRec23[1] + fRec25[1] + fRec27[1] + 0.5f * fRec8[1] + fRec29[1];
			fVec8[IOTA0 & 2047] = fTemp8;
			fRec8[0] = fVec8[(IOTA0 - iConst21) & 2047];
			float fRec9 = -(0.5f * fTemp8);
			float fTemp9 = fRec8[1] + fRec9 + 0.5f * fRec6[1];
			fVec9[IOTA0 & 2047] = fTemp9;
			fRec6[0] = fVec9[(IOTA0 - iConst23) & 2047];
			float fRec7 = -(0.5f * fTemp9);
			float fTemp10 = fRec6[1] + fRec7 + 0.5f * fRec4[1];
			fVec10[IOTA0 & 2047] = fTemp10;
			fRec4[0] = fVec10[(IOTA0 - iConst25) & 2047];
			float fRec5 = -(0.5f * fTemp10);
			float fTemp11 = fRec4[1] + fRec5 + 0.5f * fRec2[1];
			fVec11[IOTA0 & 1023] = fTemp11;
			fRec2[0] = fVec11[(IOTA0 - iConst27) & 1023];
			float fRec3 = -(0.5f * fTemp11);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * fRec0[0] + fTemp3 * (fTemp0 * fTemp4 + fRec1[0] * (fRec3 + fRec2[1])));
			...
			float fTemp12 = fRec39[1] + fRec41[1] + fRec43[1] + fRec45[1] + fRec47[1] + fRec49[1] + fRec51[1] + 0.5f * fRec37[1] + fRec53[1];
			fVec20[IOTA0 & 2047] = fTemp12;
			fRec37[0] = fVec20[(IOTA0 - iSlow21) & 2047];
			float fRec38 = -(0.5f * fTemp12);
			float fTemp13 = fRec37[1] + fRec38 + 0.5f * fRec35[1];
			fVec21[IOTA0 & 2047] = fTemp13;
			fRec35[0] = fVec21[(IOTA0 - iSlow22) & 2047];
			float fRec36 = -(0.5f * fTemp13);
			float fTemp14 = fRec35[1] + fRec36 + 0.5f * fRec33[1];
			fVec22[IOTA0 & 2047] = fTemp14;
			fRec33[0] = fVec22[(IOTA0 - iSlow23) & 2047];
			float fRec34 = -(0.5f * fTemp14);
			float fTemp15 = fRec33[1] + fRec34 + 0.5f * fRec31[1];
			fVec23[IOTA0 & 2047] = fTemp15;
			fRec31[0] = fVec23[(IOTA0 - iSlow24) & 2047];
			float fRec32 = -(0.5f * fTemp15);
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp5 * fRec0[0] + fTemp3 * (fTemp5 * fTemp4 + fRec1[0] * (fRec32 + fRec31[1])));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec11[1] = fRec11[0];
			fRec13[1] = fRec13[0];
