...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_chorus -scn fx_chorus_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API fx_chorus_dsp {

    public:

        fx_chorus_dsp() = default;
        virtual ~fx_chorus_dsp() = default;
...
class FAUST_API decorator_dsp : public ::fx_chorus_dsp {
    ...
    public:
        ...
        decorator_dsp(::fx_chorus_dsp* fx_chorus_dsp = nullptr):fDSP(fx_chorus_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::fx_chorus_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in fx_chorus_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct fx_chorus : public fx_chorus_dsp {
};
#endif
// clang-format on
  ...
  public:
	...
	void fillfx_chorusSIG0(int count, float* table) {
		for (int i1 = 0; i1 < count; i1 = i1 + 1) {
			iRec5[0] = iRec5[1] + 1;
			table[i1] = std::sin(9.58738e-05f * static_cast<float>(iRec5[1]));
			iRec5[1] = iRec5[0];
		}
	}
...
static fx_chorusSIG0* newfx_chorusSIG0() { return (fx_chorusSIG0*)new fx_chorusSIG0(); }
static void deletefx_chorusSIG0(fx_chorusSIG0* dsp) { delete dsp; }

static float ftbl0fx_chorusSIG0[65536];

class fx_chorus : public fx_chorus_dsp {
 ...
 public:
	...
	fx_chorus(const fx_chorus&) = default;
	
	virtual ~fx_chorus() = default;
	
	fx_chorus& operator=(const fx_chorus&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_chorus -scn fx_chorus_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("delays.lib/name", "Faust Delay Library");
		m->declare("delays.lib/version", "1.2.0");
		m->declare("filename", "fx_chorus.dsp");
	...
	static void classInit(int sample_rate) {
		fx_chorusSIG0* sig0 = newfx_chorusSIG0();
		sig0->instanceInitfx_chorusSIG0(sample_rate);
		sig0->fillfx_chorusSIG0(65536, ftbl0fx_chorusSIG0);
		deletefx_chorusSIG0(sig0);
	}
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider2 = static_cast<FAUSTFLOAT>(0.02f);
	...
	virtual fx_chorus* clone() {
		return new fx_chorus(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("delay", &fHslider1, FAUSTFLOAT(25.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(2e+02f), FAUSTFLOAT(0.001f));
		ui_interface->declare(&fHslider2, "style", "knob");
		ui_interface->addHorizontalSlider("depth", &fHslider2, FAUSTFLOAT(0.02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		...
		ui_interface->addHorizontalSlider("freq", &fHslider3, FAUSTFLOAT(3.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = fConst4 * static_cast<float>(fHslider1);
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = fRec3[1] + fConst5 * fRec4[0];
			fRec3[0] = fTemp2 - std::floor(fTemp2);
			float fTemp3 = 65536.0f * (fRec3[0] - std::floor(fRec3[0]));
			float fTemp4 = std::floor(fTemp3);
			int iTemp5 = static_cast<int>(fTemp4);
			float fTemp6 = fConst3 * fRec1[0] * (fRec2[0] * ((fTemp4 + (1.0f - fTemp3)) * ftbl0fx_chorusSIG0[iTemp5 & 65535] + (fTemp3 - fTemp4) * ftbl0fx_chorusSIG0[(iTemp5 + 1) & 65535]) + 1.0f);
			int iTemp7 = static_cast<int>(fTemp6);
			float fTemp8 = std::floor(fTemp6);
			output0[i0] = static_cast<FAUSTFLOAT>(((iSlow0) ? fTemp0 : fTemp1 * (1.0f - fRec0[0]) + fRec0[0] * (fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp7))) & 131071] * (fTemp8 + (1.0f - fTemp6)) + (fTemp6 - fTemp8) * fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp7 + 1))) & 131071])));
			IOTA0 = IOTA0 + 1;
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
...
class faust_fx_chorus_tilde : public FaustExternal<fx_chorus> {
public:
    faust_fx_chorus_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(fx_chorus))
    {
    }
};
