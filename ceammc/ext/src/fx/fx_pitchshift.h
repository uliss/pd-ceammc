...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_pitchshift -scn fx_pitchshift_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API fx_pitchshift_dsp {

    public:

        fx_pitchshift_dsp() = default;
        virtual ~fx_pitchshift_dsp() = default;
...
class FAUST_API decorator_dsp : public ::fx_pitchshift_dsp {
...
/**
 The base class of Meta handler to be used in fx_pitchshift_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
class fx_pitchshift : public fx_pitchshift_dsp {
 ...
 public:
	...
	fx_pitchshift(const fx_pitchshift&) = default;
	
	virtual ~fx_pitchshift() = default;
	
	fx_pitchshift& operator=(const fx_pitchshift&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_pitchshift -scn fx_pitchshift_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider0 = static_cast<FAUSTFLOAT>(2e+02f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("fade", &fVslider2, FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1e+03f), FAUSTFLOAT(0.1f));
		ui_interface->addVerticalSlider("pitch", &fVslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(-38.0f), FAUSTFLOAT(6e+01f), FAUSTFLOAT(0.001f));
		ui_interface->declare(&fVslider0, "unit", "ms");
		ui_interface->addVerticalSlider("window", &fVslider0, FAUSTFLOAT(2e+02f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(2e+03f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = fConst3 * static_cast<float>(fVslider0);
		float fSlow3 = fConst1 * static_cast<float>(fVslider1);
		float fSlow4 = fConst4 / static_cast<float>(fVslider2);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec1[0] = std::fmod(fSlow2 + fRec1[1] + (1.0f - std::pow(2.0f, 0.083333336f * fRec2[0])), fSlow2);
			int iTemp2 = static_cast<int>(fRec1[0]);
			...
			output0[i0] = static_cast<FAUSTFLOAT>(((iSlow0) ? fTemp0 : fTemp1 * (1.0f - fRec0[0]) + fRec0[0] * ((fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp2))) & 131071] * (fTemp3 + fTemp4) + (fRec1[0] - fTemp3) * fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp2 + 1))) & 131071]) * fTemp5 + (fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp7))) & 131071] * (fTemp8 + fTemp4 - fSlow2) + (fSlow2 + (fRec1[0] - fTemp8)) * fVec0[(IOTA0 - std::min<int>(65537, std::max<int>(0, iTemp7 + 1))) & 131071]) * (1.0f - fTemp5))));
			IOTA0 = IOTA0 + 1;
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fRec1[1] = fRec1[0];
...
class faust_fx_pitchshift_tilde : public FaustExternal<fx_pitchshift> {
public:
    faust_fx_pitchshift_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(fx_pitchshift))
    {
    }
};
