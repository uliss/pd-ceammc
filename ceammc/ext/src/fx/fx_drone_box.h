...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_drone_box -scn fx_drone_box_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __fx_drone_box_H__
#define  __fx_drone_box_H__
...
class FAUST_API fx_drone_box_dsp {

    public:

        fx_drone_box_dsp() = default;
        virtual ~fx_drone_box_dsp() = default;
         ...
         */
        virtual ::fx_drone_box_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::fx_drone_box_dsp {

    protected:

        ::fx_drone_box_dsp* fDSP;

    public:

        decorator_dsp(::fx_drone_box_dsp* fx_drone_box_dsp = nullptr):fDSP(fx_drone_box_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::fx_drone_box_dsp* createDSPInstance() = 0;
...
// clang-format off
#ifndef FAUST_MACRO
struct fx_drone_box : public fx_drone_box_dsp {
};
#endif
// clang-format on
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS fx_drone_box
#endif
...
class fx_drone_box : public fx_drone_box_dsp {
 ...
 public:
	...
	fx_drone_box(const fx_drone_box&) = default;
	
	virtual ~fx_drone_box() = default;
	
	fx_drone_box& operator=(const fx_drone_box&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_drone_box -scn fx_drone_box_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("copyright", "Oliver Larkin");
		m->declare("delays.lib/name", "Faust Delay Library");
		m->declare("delays.lib/version", "1.2.0");
		m->declare("description", "Mono Sympathetic Resonance Generator");
		m->declare("filename", "fx_drone_box.dsp");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst5 = 4.4e+02f * fConst4;
		fConst6 = 0.001f * fConst4;
		fConst7 = 0.6666667f * fConst0;
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider2 = static_cast<FAUSTFLOAT>(4e+03f);
	}
	...
	virtual fx_drone_box* clone() {
		return new fx_drone_box(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("fx.drone_box");
		ui_interface->addCheckButton("bypass", &fCheckbox0);
		ui_interface->declare(&fHslider2, "unit", "ms");
		ui_interface->addHorizontalSlider("decay", &fHslider2, FAUSTFLOAT(4e+03f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(1.2e+05f), FAUSTFLOAT(1.0f));
		...
		ui_interface->addHorizontalSlider("pitch", &fHslider1, FAUSTFLOAT(48.0f), FAUSTFLOAT(36.0f), FAUSTFLOAT(6e+01f), FAUSTFLOAT(0.001f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow2 = fConst5 * std::pow(2.0f, 0.083333336f * (static_cast<float>(fHslider1) + -69.0f));
		float fSlow3 = fConst6 * static_cast<float>(fHslider2);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp3 = fTemp1 + fRec1[1] * std::pow(0.001f, 1.0f / fTemp2);
			fVec0[IOTA0 & 8191] = fTemp3;
			float fTemp4 = fConst0 / fRec2[0];
			float fTemp5 = fTemp4 + -2.0f;
			int iTemp6 = static_cast<int>(fTemp5);
			float fTemp7 = std::floor(fTemp5);
			fRec1[0] = fVec0[(IOTA0 - std::min<int>(4097, std::max<int>(0, iTemp6))) & 8191] * (fTemp7 + (3.0f - fTemp4)) + (fTemp4 + (-2.0f - fTemp7)) * fVec0[(IOTA0 - std::min<int>(4097, std::max<int>(0, iTemp6 + 1))) & 8191];
			float fTemp8 = fTemp1 + fRec4[1] * std::pow(0.001f, 0.6666667f / fTemp2);
			fVec1[IOTA0 & 8191] = fTemp8;
			float fTemp9 = fConst7 / fRec2[0];
			float fTemp10 = fTemp9 + -2.0f;
			int iTemp11 = static_cast<int>(fTemp10);
			float fTemp12 = std::floor(fTemp10);
			fRec4[0] = fVec1[(IOTA0 - std::min<int>(4097, std::max<int>(0, iTemp11))) & 8191] * (fTemp12 + (3.0f - fTemp9)) + (fTemp9 + (-2.0f - fTemp12)) * fVec1[(IOTA0 - std::min<int>(4097, std::max<int>(0, iTemp11 + 1))) & 8191];
			float fTemp13 = fTemp1 + fRec5[1] * std::pow(0.001f, 0.5f / fTemp2);
			fVec2[IOTA0 & 8191] = fTemp13;
			float fTemp14 = fConst8 / fRec2[0];
			float fTemp15 = fTemp14 + -2.0f;
			int iTemp16 = static_cast<int>(fTemp15);
			float fTemp17 = std::floor(fTemp15);
			fRec5[0] = fVec2[(IOTA0 - std::min<int>(4097, std::max<int>(0, iTemp16))) & 8191] * (fTemp17 + (3.0f - fTemp14)) + (fTemp14 + (-2.0f - fTemp17)) * fVec2[(IOTA0 - std::min<int>(4097, std::max<int>(0, iTemp16 + 1))) & 8191];
			float fTemp18 = fTemp1 + fRec6[1] * std::pow(0.001f, 0.33333334f / fTemp2);
			fVec3[IOTA0 & 8191] = fTemp18;
			float fTemp19 = fConst9 / fRec2[0];
			float fTemp20 = fTemp19 + -2.0f;
			int iTemp21 = static_cast<int>(fTemp20);
			float fTemp22 = std::floor(fTemp20);
			fRec6[0] = fVec3[(IOTA0 - std::min<int>(4097, std::max<int>(0, iTemp21))) & 8191] * (fTemp22 + (3.0f - fTemp19)) + (fTemp19 + (-2.0f - fTemp22)) * fVec3[(IOTA0 - std::min<int>(4097, std::max<int>(0, iTemp21 + 1))) & 8191];
			output0[i0] = static_cast<FAUSTFLOAT>(((iSlow0) ? fTemp0 : fTemp1 * (1.0f - fRec0[0]) + 0.25f * fRec0[0] * (fRec1[0] + fRec4[0] + fRec5[0] + fRec6[0])));
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			IOTA0 = IOTA0 + 1;
...
class faust_fx_drone_box_tilde : public FaustExternal<fx_drone_box> {
public:
    faust_fx_drone_box_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(fx_drone_box))
    {
    }
};
