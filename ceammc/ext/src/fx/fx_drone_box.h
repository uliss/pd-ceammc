...
#ifndef  __drone_box_H__
#define  __drone_box_H__
...
class drone_box : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("description", "Mono Sympathetic Resonance Generator");
		m->declare("filename", "fx_drone_box");
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst1 = (0.666666687f * fConst0);
		fConst2 = std::exp((0.0f - (200.0f / fConst0)));
		fConst3 = (1.0f - fConst2);
		fConst4 = (440.0f * fConst3);
		fConst5 = (0.00100000005f * fConst3);
	...
	virtual drone_box* clone() {
		return new drone_box();
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("DroneBox");
		ui_interface->addCheckButton("bypass", &fCheckbox0);
		ui_interface->declare(&fHslider2, "unit", "ms");
		ui_interface->addHorizontalSlider("decay", &fHslider2, 4000.0f, 100.0f, 120000.0f, 1.0f);
		ui_interface->declare(&fHslider0, "style", "knob");
		ui_interface->addHorizontalSlider("drywet", &fHslider0, 0.5f, 0.0f, 1.0f, 0.00999999978f);
		ui_interface->declare(&fHslider1, "unit", "semitones");
		ui_interface->addHorizontalSlider("pitch", &fHslider1, 48.0f, 36.0f, 60.0f, 0.00100000005f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow2 = (fConst4 * std::pow(2.0f, (0.0833333358f * (float(fHslider1) + -69.0f))));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp2 = (fConst1 / fRec2[0]);
			float fTemp3 = (fTemp2 + -2.0f);
			float fTemp4 = std::floor(fTemp3);
			fRec3[0] = (fSlow3 + (fConst2 * fRec3[1]));
			float fTemp5 = (fRec2[0] * fRec3[0]);
			float fTemp6 = ((fRec1[1] * std::pow(0.00100000005f, (0.666666687f / fTemp5))) + fTemp1);
			fVec0[(IOTA & 8191)] = fTemp6;
			int iTemp7 = int(fTemp3);
			fRec1[0] = (((fTemp4 + (3.0f - fTemp2)) * fVec0[((IOTA - std::min(4097, std::max(0, iTemp7))) & 8191)]) + ((fTemp2 + (-2.0f - fTemp4)) * fVec0[((IOTA - std::min(4097, std::max(0, (iTemp7 + 1)))) & 8191)]));
			float fTemp8 = (fConst0 / fRec2[0]);
			float fTemp9 = (fTemp8 + -2.0f);
			float fTemp10 = std::floor(fTemp9);
			float fTemp11 = ((fRec4[1] * std::pow(0.00100000005f, (1.0f / fTemp5))) + fTemp1);
			fVec1[(IOTA & 8191)] = fTemp11;
			int iTemp12 = int(fTemp9);
			fRec4[0] = (((fTemp10 + (3.0f - fTemp8)) * fVec1[((IOTA - std::min(4097, std::max(0, iTemp12))) & 8191)]) + ((fTemp8 + (-2.0f - fTemp10)) * fVec1[((IOTA - std::min(4097, std::max(0, (iTemp12 + 1)))) & 8191)]));
			float fTemp13 = (fConst6 / fRec2[0]);
			float fTemp14 = (fTemp13 + -2.0f);
			float fTemp15 = std::floor(fTemp14);
			float fTemp16 = ((fRec5[1] * std::pow(0.00100000005f, (0.333333343f / fTemp5))) + fTemp1);
			fVec2[(IOTA & 8191)] = fTemp16;
			int iTemp17 = int(fTemp14);
			fRec5[0] = (((fTemp15 + (3.0f - fTemp13)) * fVec2[((IOTA - std::min(4097, std::max(0, iTemp17))) & 8191)]) + ((fTemp13 + (-2.0f - fTemp15)) * fVec2[((IOTA - std::min(4097, std::max(0, (iTemp17 + 1)))) & 8191)]));
			float fTemp18 = (fConst7 / fRec2[0]);
			float fTemp19 = (fTemp18 + -2.0f);
			float fTemp20 = std::floor(fTemp19);
			float fTemp21 = ((fRec6[1] * std::pow(0.00100000005f, (0.5f / fTemp5))) + fTemp1);
			fVec3[(IOTA & 8191)] = fTemp21;
			int iTemp22 = int(fTemp19);
			fRec6[0] = (((fTemp20 + (3.0f - fTemp18)) * fVec3[((IOTA - std::min(4097, std::max(0, iTemp22))) & 8191)]) + ((fTemp18 + (-2.0f - fTemp20)) * fVec3[((IOTA - std::min(4097, std::max(0, (iTemp22 + 1)))) & 8191)]));
			output0[i] = FAUSTFLOAT((iSlow0?fTemp0:(((1.0f - fRec0[0]) * fTemp1) + (0.25f * (fRec0[0] * (fRec1[0] + (fRec4[0] + (fRec5[0] + fRec6[0]))))))));
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			IOTA = (IOTA + 1);
...
static t_class* drone_box_faust_class;
#define FAUST_EXT t_faust_drone_box
#define FAUST_EXT_CLASS drone_box_faust_class
// clang-format on

template <class T>
class _drone_box_UI : public UI {
};
typedef _drone_box_UI<drone_box> drone_box_UI;

struct t_faust_drone_box {
    t_object x_obj;
#ifdef __MINGW32__
...
{
    t_faust_drone_box* x = reinterpret_cast<t_faust_drone_box*>(w[1]);
...
static void drone_box_faust_dsp(t_faust_drone_box* x, t_signal** sp)
{
...
static void drone_box_dump_to_console(t_faust_drone_box* x)
{
...
static void drone_box_faust_any(t_faust_drone_box* x, t_symbol* s, int argc, t_atom* argv)
{
    if (!x->dsp)
        return;
...
static void faust_free_dsp(t_faust_drone_box* x)
{
    delete x->dsp;
    x->dsp = NULL;
}

static void faust_free_ui(t_faust_drone_box* x)
{
    delete x->ui;
    x->ui = NULL;
}

static void faust_free_inputs(t_faust_drone_box* x)
{
    if (x->inputs)
        free(x->inputs);
    x->inputs = NULL;
...
static void faust_free_outputs(t_faust_drone_box* x)
{
    if (x->outputs)
        free(x->outputs);
    x->outputs = NULL;
...
static void faust_free_buf(t_faust_drone_box* x)
{
    if (x->buf) {
        for (int i = 0; i < x->n_out; i++) {
            if (x->buf[i])
...
static void drone_box_faust_free(t_faust_drone_box* x)
{
    faust_free_dsp(x);
    faust_free_ui(x);
    faust_free_inputs(x);
...
static bool faust_init_inputs(t_faust_drone_box* x)
{
    x->inputs = NULL;
    ...
    if (x->n_in > 0) {
        ...
        if (x->inputs == NULL) {
            error("[%s] faust_init_inputs failed", sym(drone_box));
            return false;
        }
    }
...
static bool faust_init_outputs(t_faust_drone_box* x, bool info_outlet)
{
    x->outputs = NULL;
    x->buf = NULL;
    ...
    if (x->n_out > 0) {
        ...
        if (x->outputs == NULL) {
            error("[%s] faust_init_outputs failed", sym(drone_box));
            return false;
        }
...
static bool faust_new_internal(t_faust_drone_box* x, const std::string& objId = "", bool info_outlet = true)
{
    int sr = 44100;
    x->active = 1;
    x->xfade = 0;
    ...
    x->dsp = new drone_box();
    x->ui = new PdUI<drone_box_UI>(sym(drone_box), objId);

    if (!faust_init_inputs(x)) {
        drone_box_faust_free(x);
        return false;
    }
...
public:
     ...
     * @param argv pointer to argument vector
     */
    PdArgParser(t_faust_drone_box* x, int argc, t_atom* argv, bool info_outlet = true)
        : x_(x)
        , argc_(0)
        , argv_(argv)
    ...
    t_faust_drone_box* pd_obj()
    {
        return this->x_;
    }
};

static void* drone_box_faust_new(t_symbol* s, int argc, t_atom* argv);

static void internal_setup(t_symbol* s, bool soundIn = true)
{
    drone_box_faust_class = class_new(s, reinterpret_cast<t_newmethod>(drone_box_faust_new),
        reinterpret_cast<t_method>(drone_box_faust_free),
        sizeof(t_faust_drone_box),
        CLASS_DEFAULT,
        A_GIMME, A_NULL);

    if (soundIn) {
        class_addmethod(drone_box_faust_class, nullfn, &s_signal, A_NULL);
        CLASS_MAINSIGNALIN(drone_box_faust_class, t_faust_drone_box, f);
    }

    class_addmethod(drone_box_faust_class, reinterpret_cast<t_method>(drone_box_faust_dsp), gensym("dsp"), A_NULL);
    class_addmethod(drone_box_faust_class, reinterpret_cast<t_method>(drone_box_dump_to_console), gensym("dump"), A_NULL);
    class_addanything(drone_box_faust_class, drone_box_faust_any);
    ceammc::register_faust_external(drone_box_faust_class);
}

#define EXTERNAL_NEW void* drone_box_faust_new(t_symbol*, int argc, t_atom* argv)

#define EXTERNAL_SIMPLE_NEW()                                                           \
    static void* drone_box_faust_new(t_symbol*, int argc, t_atom* argv)                     \
    {                                                                                   \
        t_faust_drone_box* x = reinterpret_cast<t_faust_drone_box*>(pd_new(drone_box_faust_class)); \
        PdArgParser p(x, argc, argv, false);                                            \
        return p.pd_obj();                                                              \
    }

#define EXTERNAL_SETUP(MOD)                        \
    extern "C" void setup_##MOD##0x2edrone_box_tilde() \
    {                                              \
        internal_setup(gensym(#MOD ".drone_box~"));    \
    }

#define EXTERNAL_SETUP_NO_IN(MOD)                      \
    extern "C" void setup_##MOD##0x2edrone_box_tilde()     \
    {                                                  \
        internal_setup(gensym(#MOD ".drone_box~"), false); \
    }
