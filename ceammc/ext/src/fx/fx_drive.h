...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_drive -scn fx_drive_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __fx_drive_H__
#define  __fx_drive_H__
...
class FAUST_API fx_drive_dsp {

    public:

        fx_drive_dsp() = default;
        virtual ~fx_drive_dsp() = default;
...
class FAUST_API decorator_dsp : public ::fx_drive_dsp {
    ...
    public:
        ...
        decorator_dsp(::fx_drive_dsp* fx_drive_dsp = nullptr):fDSP(fx_drive_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::fx_drive_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in fx_drive_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct fx_drive : public fx_drive_dsp {
};
#endif
// clang-format on
...
class fx_drive : public fx_drive_dsp {
 ...
 public:
	...
	fx_drive(const fx_drive&) = default;
	
	virtual ~fx_drive() = default;
	
	fx_drive& operator=(const fx_drive&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn fx_drive -scn fx_drive_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "fx_drive.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.9.0");
		m->declare("name", "fx.drive");
	...
	virtual fx_drive* clone() {
		return new fx_drive(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("fx.drive");
		ui_interface->addCheckButton("bypass", &fCheckbox0);
		ui_interface->addVerticalSlider("drive", &fVslider0, FAUSTFLOAT(1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+01f), FAUSTFLOAT(1.0f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = fConst0 * static_cast<float>(fVslider0);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = static_cast<float>(input0[i0]);
			float fTemp1 = ((iSlow0) ? 0.0f : fTemp0);
			fRec0[0] = fSlow1 + fConst1 * fRec0[1];
			output0[i0] = static_cast<FAUSTFLOAT>(((iSlow0) ? fTemp0 : std::max<float>(-0.7f, std::min<float>(0.7f, fTemp1 * (0.0625f * fRec0[0] * (4.0f * (1.0f - std::fabs(fTemp1)) + -1.0f) + 1.0f)))));
			fRec0[1] = fRec0[0];
		}
	}
...
class faust_fx_drive_tilde : public FaustExternal<fx_drive> {
public:
    faust_fx_drive_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(fx_drive))
    {
    }
};
