...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/ceammc_dsp_ext.cpp -lang cpp -i -cn fx_ringmod -scn fx_ringmod_dsp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class fx_ringmod : public fx_ringmod_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/ceammc_dsp_ext.cpp -lang cpp -i -cn fx_ringmod -scn fx_ringmod_dsp -es 1 -mcd 16 -single -ftz 0");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addCheckButton("internal", &fCheckbox1);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		int iSlow5 = float(fCheckbox1) >= 1.0f;
		float fSlow6 = fConst1 * float(fVslider0);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec1[0] = fSlow2 + fConst2 * fRec1[1];
			float fTemp0 = float(input0[i0]);
			fRec2[0] = fSlow4 + fConst2 * fRec2[1];
			fRec5[0] = fSlow6 + fConst2 * fRec5[1];
			float fTemp1 = fRec4[1] + fConst3 * fRec5[0];
			fRec4[0] = fTemp1 - std::floor(fTemp1);
			float fTemp2 = fSlow1 * (fRec1[0] * tanhf(fSlow3 * fTemp0 * (fRec2[0] + ((iSlow5) ? ftbl0fx_ringmodSIG0[int(65536.0f * fRec4[0])] : float(input1[i0])))) + fTemp0 * (1.0f - fRec1[0]));
			float fTemp3 = fSlow0 * fTemp0;
			fVec1[0] = fTemp3 + fTemp2;
			fRec0[0] = fTemp2 + fTemp3 + 0.995f * fRec0[1] - fVec1[1];
...
// clang-format on
    ...
    template <class T>
    struct _fx_ringmod_UI : public UI {
    static std::string name;
};

template <class T>
std::string _fx_ringmod_UI<T>::name(sym(fx_ringmod));

typedef _fx_ringmod_UI<fx_ringmod> fx_ringmod_UI;

class faust_fx_ringmod_tilde : public FaustExternal<fx_ringmod, fx_ringmod_UI> {
public:
