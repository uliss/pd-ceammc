...
class fx_ringmod : public fx_ringmod_dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("offset", &fHslider1, FAUSTFLOAT(0.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			output0[i0] = FAUSTFLOAT(((iSlow0) ? fTemp0 : ((iSlow0) ? 0.0f : fTemp0) * (1.0f - fRec0[0]) + float(input0[i0]) * fRec0[0] * (float(input1[i0]) + fRec1[0])));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
		}
	}
