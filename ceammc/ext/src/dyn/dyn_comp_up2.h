...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_comp_up2 -scn dyn_comp_up2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API dyn_comp_up2_dsp {
    ...
    public:
        ...
        dyn_comp_up2_dsp() = default;
        virtual ~dyn_comp_up2_dsp() = default;
...
class dyn_comp_up2 : public dyn_comp_up2_dsp {
 ...
 public:
	...
	dyn_comp_up2(const dyn_comp_up2&) = default;
	
	virtual ~dyn_comp_up2() = default;
	
	dyn_comp_up2& operator=(const dyn_comp_up2&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_comp_up2 -scn dyn_comp_up2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider2 = static_cast<FAUSTFLOAT>(128.0f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("hold", &fHslider2, FAUSTFLOAT(128.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(255.0f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fHslider4, "unit", "db");
		ui_interface->addHorizontalSlider("knee", &fHslider4, FAUSTFLOAT(3.0f), FAUSTFLOAT(0.0f), FAUSTFLOAT(24.0f), FAUSTFLOAT(0.01f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		int iSlow4 = static_cast<int>(std::floor(fSlow3)) % 2;
		int iSlow5 = static_cast<int>(std::floor(0.5f * fSlow3)) % 2;
		int iSlow6 = static_cast<int>(std::floor(0.25f * fSlow3)) % 2;
		int iSlow7 = iSlow4 + 2 * iSlow5;
		int iSlow8 = static_cast<int>(std::floor(0.125f * fSlow3)) % 2;
		int iSlow9 = iSlow7 + 4 * iSlow6;
		int iSlow10 = static_cast<int>(std::floor(0.0625f * fSlow3)) % 2;
		int iSlow11 = iSlow9 + 8 * iSlow8;
		int iSlow12 = static_cast<int>(std::floor(0.03125f * fSlow3)) % 2;
		int iSlow13 = iSlow11 + 16 * iSlow10;
		int iSlow14 = static_cast<int>(std::floor(0.015625f * fSlow3)) % 2;
		int iSlow15 = iSlow13 + 32 * iSlow12;
		int iSlow16 = static_cast<int>(std::floor(0.0078125f * fSlow3)) % 2;
		int iSlow17 = iSlow15 + 64 * iSlow14;
		float fSlow18 = static_cast<float>(fHslider3);
		...
		float fSlow24 = 0.001f * static_cast<float>(fHslider5);
		float fSlow25 = 0.001f * static_cast<float>(fHslider6);
		float fSlow26 = static_cast<float>(fHslider7);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			int iTemp14 = fRec3[0] > 0.0f;
			float fTemp15 = static_cast<float>(2 * iTemp14 + -1);
			float fTemp16 = std::max<float>(fRec2[0], fTemp4 * ((iTemp13 == 0) ? fTemp12 - fSlow18 : ((iTemp13 == 1) ? fSlow23 * dyn_comp_up2_faustpower2_f(fTemp12 - fSlow22) : 0.0f))) * fTemp15;
			float fTemp17 = ((iTemp14) ? fSlow25 : fSlow24);
			int iTemp18 = std::fabs(fTemp17) < 1.1920929e-07f;
			float fTemp19 = ((iTemp18) ? 0.0f : std::exp(-(fConst3 / ((iTemp18) ? 1.0f : fTemp17))));
			float fTemp20 = ((iTemp14) ? fSlow24 : fSlow25);
			int iTemp21 = std::fabs(fTemp20) < 1.1920929e-07f;
			float fTemp22 = ((iTemp21) ? 0.0f : std::exp(-(fConst3 / ((iTemp21) ? 1.0f : fTemp20))));
			...
			float fTemp34 = fTemp15 * std::max<float>(fRec2[0], fTemp4 * ((iTemp33 == 0) ? fTemp32 - fSlow18 : ((iTemp33 == 1) ? fSlow23 * dyn_comp_up2_faustpower2_f(fTemp32 - fSlow22) : 0.0f)));
			float fTemp35 = ((fTemp34 > fRec4[1]) ? fTemp22 : fTemp19);
			fRec4[0] = fTemp34 * (1.0f - fTemp35) + fRec4[1] * fTemp35;
			float fTemp36 = std::max<float>(fRec1[0], fRec4[0]);
			float fTemp37 = fRec1[0] + fSlow26 * (fTemp36 - fRec1[0]);
			fHbargraph0 = static_cast<FAUSTFLOAT>(fTemp37);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fRec0[0] + fTemp3 * std::pow(1e+01f, 0.05f * fTemp37)));
			float fTemp38 = fRec4[0] + fSlow26 * (fTemp36 - fRec4[0]);
			fHbargraph1 = static_cast<FAUSTFLOAT>(fTemp38);
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp24 * (fRec0[0] + fTemp3 * std::pow(1e+01f, 0.05f * fTemp38)));
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			fVec0[1] = fVec0[0];
...
class faust_dyn_comp_up2_tilde : public FaustExternal<dyn_comp_up2> {
public:
    faust_dyn_comp_up2_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(dyn_comp_up2))
    {
    }
};
