...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_comp_peak -scn dyn_comp_peak_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API dyn_comp_peak_dsp {
    ...
    public:
        ...
        dyn_comp_peak_dsp() = default;
        virtual ~dyn_comp_peak_dsp() = default;
...
class dyn_comp_peak : public dyn_comp_peak_dsp {
 ...
 public:
	...
	dyn_comp_peak(const dyn_comp_peak&) = default;
	
	virtual ~dyn_comp_peak() = default;
	
	dyn_comp_peak& operator=(const dyn_comp_peak&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_comp_peak -scn dyn_comp_peak_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp6 = std::max<float>(0.0f, ((iTemp4 == 0) ? 0.0f : ((iTemp4 == 1) ? fSlow8 * dyn_comp_peak_faustpower2_f(fSlow5 + fTemp5) : fTemp5)));
			float fTemp7 = ((-(fSlow2 * fTemp6) > fRec2[1]) ? fSlow14 : fSlow11);
			fRec2[0] = fRec2[1] * fTemp7 - fSlow2 * fTemp6 * (1.0f - fTemp7);
			fHbargraph0 = static_cast<FAUSTFLOAT>(1.0f - std::pow(1e+01f, 0.05f * fRec2[0]));
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fRec0[0] + fRec1[0] * (1.0f - fRec0[0]) * std::pow(1e+01f, 0.05f * fRec2[0])));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
		}
...
class faust_dyn_comp_peak_tilde : public FaustExternal<dyn_comp_peak> {
public:
    faust_dyn_comp_peak_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(dyn_comp_peak))
    {
    }
};
