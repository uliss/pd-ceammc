...
class dyn_comp_up : public dyn_comp_up_dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("hold", &fHslider2, FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.1f), FAUSTFLOAT(5e+02f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		int iSlow22 = iSlow19 + 64 * iSlow18;
		int iSlow23 = iSlow16 + iSlow13 + iSlow10 + iSlow7 + iSlow4 + iSlow22;
		int iSlow24 = int(std::floor(fConst11 * fSlow3)) % 2;
		int iSlow25 = iSlow22 + 128 * iSlow21;
		int iSlow26 = iSlow16 + iSlow13 + iSlow10 + iSlow7 + iSlow4 + iSlow25;
		int iSlow27 = int(std::floor(fConst12 * fSlow3)) % 2;
		int iSlow28 = iSlow25 + 256 * iSlow24;
		int iSlow29 = iSlow16 + iSlow13 + iSlow10 + iSlow7 + iSlow4 + iSlow28;
		int iSlow30 = int(std::floor(fConst13 * fSlow3)) % 2;
		int iSlow31 = iSlow28 + 512 * iSlow27;
		int iSlow32 = iSlow16 + iSlow13 + iSlow10 + iSlow7 + iSlow4 + iSlow31;
		int iSlow33 = int(std::floor(fConst14 * fSlow3)) % 2;
		int iSlow34 = iSlow31 + 1024 * iSlow30;
		int iSlow35 = iSlow16 + iSlow13 + iSlow10 + iSlow7 + iSlow4 + iSlow34;
		int iSlow36 = int(std::floor(fConst15 * fSlow3)) % 2;
		int iSlow37 = iSlow34 + 2048 * iSlow33;
		int iSlow38 = iSlow16 + iSlow13 + iSlow10 + iSlow7 + iSlow4 + iSlow37;
		int iSlow39 = int(std::floor(fConst16 * fSlow3)) % 2;
		int iSlow40 = iSlow37 + 4096 * iSlow36;
		int iSlow41 = iSlow16 + iSlow13 + iSlow10 + iSlow7 + iSlow4 + iSlow40;
		int iSlow42 = int(std::floor(fConst17 * fSlow3)) % 2;
		int iSlow43 = iSlow40 + 8192 * iSlow39;
		int iSlow44 = iSlow16 + iSlow13 + iSlow10 + iSlow7 + iSlow4 + iSlow43;
		int iSlow45 = int(std::floor(fConst18 * fSlow3)) % 2;
		int iSlow46 = iSlow43 + 16384 * iSlow42;
		int iSlow47 = iSlow16 + iSlow13 + iSlow10 + iSlow7 + iSlow4 + iSlow46;
		int iSlow48 = int(std::floor(fConst19 * fSlow3)) % 2;
		int iSlow49 = iSlow16 + iSlow13 + iSlow10 + iSlow7 + iSlow4 + iSlow46 + 32768 * iSlow45;
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			int iTemp20 = (fTemp19 > fSlow53) + (fTemp19 > fSlow54);
			int iTemp21 = fRec3[0] > 0.0f;
			float fTemp22 = std::max<float>(fRec2[0], std::fabs(fRec3[0]) * ((iTemp20 == 0) ? fTemp19 - fSlow50 : ((iTemp20 == 1) ? fSlow55 * dyn_comp_up_faustpower2_f(fTemp19 - fSlow54) : 0.0f))) * float(2 * iTemp21 + -1);
			float fTemp23 = ((iTemp21) ? fSlow57 : fSlow56);
			int iTemp24 = std::fabs(fTemp23) < 1.1920929e-07f;
			float fTemp25 = ((iTemp21) ? fSlow56 : fSlow57);
