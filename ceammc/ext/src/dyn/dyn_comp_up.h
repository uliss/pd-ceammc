...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_comp_up -scn dyn_comp_up_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API dyn_comp_up_dsp {
    ...
    public:
        ...
        dyn_comp_up_dsp() = default;
        virtual ~dyn_comp_up_dsp() = default;
...
class dyn_comp_up : public dyn_comp_up_dsp {
 ...
 public:
	...
	dyn_comp_up(const dyn_comp_up&) = default;
	
	virtual ~dyn_comp_up() = default;
	
	dyn_comp_up& operator=(const dyn_comp_up&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_comp_up -scn dyn_comp_up_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider0 = static_cast<FAUSTFLOAT>(32.0f);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp13 = std::max<float>(fRec2[0], std::fabs(fRec3[0]) * ((iTemp11 == 0) ? fTemp10 - fSlow18 : ((iTemp11 == 1) ? fSlow23 * dyn_comp_up_faustpower2_f(fTemp10 - fSlow22) : 0.0f))) * static_cast<float>(2 * iTemp12 + -1);
			...
			fHbargraph0 = static_cast<FAUSTFLOAT>(fRec1[0]);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fRec0[0] + (1.0f - fRec0[0]) * std::pow(1e+01f, 0.05f * fRec1[0])));
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
			fVec0[1] = fVec0[0];
