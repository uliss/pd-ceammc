...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_limit -scn dyn_limit_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API dyn_limit_dsp {
    ...
    public:
        ...
        dyn_limit_dsp() = default;
        virtual ~dyn_limit_dsp() = default;
...
class dyn_limit : public dyn_limit_dsp {
 ...
 public:
	...
	dyn_limit(const dyn_limit&) = default;
	
	virtual ~dyn_limit() = default;
	
	dyn_limit& operator=(const dyn_limit&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_limit -scn dyn_limit_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
