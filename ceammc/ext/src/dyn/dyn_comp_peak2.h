...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_comp_peak2 -scn dyn_comp_peak2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API dyn_comp_peak2_dsp {
    ...
    public:
        ...
        dyn_comp_peak2_dsp() = default;
        virtual ~dyn_comp_peak2_dsp() = default;
...
class dyn_comp_peak2 : public dyn_comp_peak2_dsp {
 ...
 public:
	...
	dyn_comp_peak2(const dyn_comp_peak2&) = default;
	
	virtual ~dyn_comp_peak2() = default;
	
	dyn_comp_peak2& operator=(const dyn_comp_peak2&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_comp_peak2 -scn dyn_comp_peak2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual dyn_comp_peak2* clone() {
		return new dyn_comp_peak2(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("threshold", &fHslider1, FAUSTFLOAT(-1e+01f), FAUSTFLOAT(-6e+01f), FAUSTFLOAT(0.0f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		float fSlow1 = fConst1 * std::pow(1e+01f, 0.05f * static_cast<float>(fVslider0));
		...
		float fSlow9 = 0.001f * static_cast<float>(fHslider3);
		int iSlow10 = std::fabs(fSlow9) < 1.1920929e-07f;
		float fSlow11 = ((iSlow10) ? 0.0f : std::exp(-(fConst3 / ((iSlow10) ? 1.0f : fSlow9))));
		float fSlow12 = 0.001f * static_cast<float>(fHslider4);
		int iSlow13 = std::fabs(fSlow12) < 1.1920929e-07f;
		float fSlow14 = ((iSlow13) ? 0.0f : std::exp(-(fConst3 / ((iSlow13) ? 1.0f : fSlow12))));
		float fSlow15 = static_cast<float>(fHslider5);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp7 = std::max<float>(0.0f, ((iTemp5 == 0) ? 0.0f : ((iTemp5 == 1) ? fSlow8 * dyn_comp_peak2_faustpower2_f(fSlow5 + fTemp6) : fTemp6)));
			float fTemp8 = ((-(fSlow2 * fTemp7) > fRec2[1]) ? fSlow14 : fSlow11);
			fRec2[0] = fRec2[1] * fTemp8 - fSlow2 * fTemp7 * (1.0f - fTemp8);
			...
			float fTemp13 = std::max<float>(0.0f, ((iTemp11 == 0) ? 0.0f : ((iTemp11 == 1) ? fSlow8 * dyn_comp_peak2_faustpower2_f(fSlow5 + fTemp12) : fTemp12)));
			float fTemp14 = ((-(fSlow2 * fTemp13) > fRec3[1]) ? fSlow14 : fSlow11);
			fRec3[0] = fRec3[1] * fTemp14 - fSlow2 * fTemp13 * (1.0f - fTemp14);
			float fTemp15 = std::min<float>(fRec2[0], fRec3[0]);
			float fTemp16 = fRec2[0] + fSlow15 * (fTemp15 - fRec2[0]);
			fHbargraph0 = static_cast<FAUSTFLOAT>(1.0f - std::pow(1e+01f, 0.05f * fTemp16));
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fRec0[0] + fTemp3 * std::pow(1e+01f, 0.05f * fTemp16)));
			float fTemp17 = fRec3[0] + fSlow15 * (fTemp15 - fRec3[0]);
			fHbargraph1 = static_cast<FAUSTFLOAT>(1.0f - std::pow(1e+01f, 0.05f * fTemp17));
			output1[i0] = static_cast<FAUSTFLOAT>(fTemp9 * (fRec0[0] + fTemp3 * std::pow(1e+01f, 0.05f * fTemp17)));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[1] = fRec3[0];
...
class faust_dyn_comp_peak2_tilde : public FaustExternal<dyn_comp_peak2> {
public:
    faust_dyn_comp_peak2_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(dyn_comp_peak2))
    {
    }
};
