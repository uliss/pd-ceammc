...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_expand -scn dyn_expand_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __dyn_expand_H__
#define  __dyn_expand_H__
...
class FAUST_API dyn_expand_dsp {

    public:

        dyn_expand_dsp() = default;
        virtual ~dyn_expand_dsp() = default;
         ...
         */
        virtual ::dyn_expand_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::dyn_expand_dsp {
    ...
    public:
        ...
        decorator_dsp(::dyn_expand_dsp* dyn_expand_dsp = nullptr):fDSP(dyn_expand_dsp) {}
...
/**
 The base class of Meta handler to be used in dyn_expand_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct dyn_expand : public dyn_expand_dsp {
};
#endif
// clang-format on
...
static float dyn_expand_faustpower2_f(float value) {
	return value * value;
}

class dyn_expand : public dyn_expand_dsp {
 ...
 public:
	...
	dyn_expand(const dyn_expand&) = default;
	
	virtual ~dyn_expand() = default;
	
	dyn_expand& operator=(const dyn_expand&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_expand -scn dyn_expand_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider0 = static_cast<FAUSTFLOAT>(-1.2e+02f);
	...
	virtual dyn_expand* clone() {
		return new dyn_expand(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("dyn.expand");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp13 = std::max<float>(fSlow1, std::fabs(fRec2[0]) * ((iTemp11 == 0) ? fTemp10 - fSlow18 : ((iTemp11 == 1) ? fSlow23 * dyn_expand_faustpower2_f(fTemp10 - fSlow22) : 0.0f))) * static_cast<float>(2 * iTemp12 + -1);
...
class faust_dyn_expand_tilde : public FaustExternal<dyn_expand> {
public:
    faust_dyn_expand_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(dyn_expand))
    {
    }
};
