...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/ceammc_dsp_ext.cpp -lang cpp -i -cn dyn_expand -scn dyn_expand_dsp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class dyn_expand : public dyn_expand_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/ceammc_dsp_ext.cpp -lang cpp -i -cn dyn_expand -scn dyn_expand_dsp -es 1 -mcd 16 -single -ftz 0");
...
// clang-format on
    ...
    template <class T>
    struct _dyn_expand_UI : public UI {
    static std::string name;
};

template <class T>
std::string _dyn_expand_UI<T>::name(sym(dyn_expand));

typedef _dyn_expand_UI<dyn_expand> dyn_expand_UI;

class faust_dyn_expand_tilde : public FaustExternal<dyn_expand, dyn_expand_UI> {
public:
