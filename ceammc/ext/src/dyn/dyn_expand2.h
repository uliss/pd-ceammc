...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_expand2 -scn dyn_expand2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API dyn_expand2_dsp {
    ...
    public:
        ...
        dyn_expand2_dsp() = default;
        virtual ~dyn_expand2_dsp() = default;
...
class dyn_expand2 : public dyn_expand2_dsp {
 ...
 public:
	...
	dyn_expand2(const dyn_expand2&) = default;
	
	virtual ~dyn_expand2() = default;
	
	dyn_expand2& operator=(const dyn_expand2&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_expand2 -scn dyn_expand2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
...
class faust_dyn_expand2_tilde : public FaustExternal<dyn_expand2> {
public:
    faust_dyn_expand2_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(dyn_expand2))
    {
    }
};
