...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_comp -scn dyn_comp_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API dyn_comp_dsp {
    ...
    public:
        ...
        dyn_comp_dsp() = default;
        virtual ~dyn_comp_dsp() = default;
...
class dyn_comp : public dyn_comp_dsp {
 ...
 public:
	...
	dyn_comp(const dyn_comp&) = default;
	
	virtual ~dyn_comp() = default;
	
	dyn_comp& operator=(const dyn_comp&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_comp -scn dyn_comp_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVbargraph0 = static_cast<FAUSTFLOAT>(1.0f - fTemp5);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fRec0[0] + fRec1[0] * (1.0f - fRec0[0]) * fTemp5));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec3[1] = fRec3[0];
			fRec2[1] = fRec2[0];
...
class faust_dyn_comp_tilde : public FaustExternal<dyn_comp> {
public:
    faust_dyn_comp_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(dyn_comp))
    {
    }
};
