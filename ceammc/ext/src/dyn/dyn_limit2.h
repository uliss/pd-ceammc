...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -cn dyn_limit2 -scn dyn_limit2_dsp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */
...
class dyn_limit2 : public dyn_limit2_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -cn dyn_limit2 -scn dyn_limit2_dsp -es 1 -mcd 16 -single -ftz 0");
...
class faust_dyn_limit2_tilde : public FaustExternal<dyn_limit2> {
public:
    faust_dyn_limit2_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(dyn_limit2))
    {
    }
};
