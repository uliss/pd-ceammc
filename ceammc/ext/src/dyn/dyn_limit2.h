...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/ceammc_dsp_ext.cpp -lang cpp -i -cn dyn_limit2 -scn dyn_limit2_dsp -es 1 -mcd 16 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __dyn_limit2_H__
#define  __dyn_limit2_H__
...
class FAUST_API dyn_limit2_dsp {
...
/**
 The base class of Meta handler to be used in dyn_limit2_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct dyn_limit2 : public dyn_limit2_dsp {
};
#endif
// clang-format on
...
class dyn_limit2 : public dyn_limit2_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/ceammc_dsp_ext.cpp -lang cpp -i -cn dyn_limit2 -scn dyn_limit2_dsp -es 1 -mcd 16 -single -ftz 0");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("dyn.limit2");
...
// clang-format on
    ...
    template <class T>
    struct _dyn_limit2_UI : public UI {
    static std::string name;
};

template <class T>
std::string _dyn_limit2_UI<T>::name(sym(dyn_limit2));

typedef _dyn_limit2_UI<dyn_limit2> dyn_limit2_UI;

class faust_dyn_limit2_tilde : public FaustExternal<dyn_limit2, dyn_limit2_UI> {
public:
    faust_dyn_limit2_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args)
    {
    }
};
