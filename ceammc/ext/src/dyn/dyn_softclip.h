...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_softclip -scn dyn_softclip_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __dyn_softclip_H__
#define  __dyn_softclip_H__
...
class FAUST_API dyn_softclip_dsp {

    public:

        dyn_softclip_dsp() = default;
        virtual ~dyn_softclip_dsp() = default;
         ...
         */
        virtual ::dyn_softclip_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::dyn_softclip_dsp {
    ...
    protected:
        ...
        ::dyn_softclip_dsp* fDSP;

    public:

        decorator_dsp(::dyn_softclip_dsp* dyn_softclip_dsp = nullptr):fDSP(dyn_softclip_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::dyn_softclip_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in dyn_softclip_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct dyn_softclip : public dyn_softclip_dsp {
};
#endif
// clang-format on
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS dyn_softclip
#endif
...
static float dyn_softclip_faustpower2_f(float value) {
	return value * value;
}

class dyn_softclip : public dyn_softclip_dsp {
 ...
 public:
	...
	dyn_softclip(const dyn_softclip&) = default;
	
	virtual ~dyn_softclip() = default;
	
	dyn_softclip& operator=(const dyn_softclip&) = default;
	
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn dyn_softclip -scn dyn_softclip_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "dyn_softclip.dsp");
		m->declare("name", "dyn.softclip");
	}
	...
	virtual dyn_softclip* clone() {
		return new dyn_softclip(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("dyn.softclip");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			float fTemp0 = std::fabs(2.0f * (std::max<float>(-0.25f, std::min<float>(0.25f, 0.1588f * static_cast<float>(input0[i0]))) + -0.25f)) + -0.5f;
			float fTemp1 = dyn_softclip_faustpower2_f(fTemp0);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fTemp1 * (2.26548f * fTemp1 + -5.13274f) + 3.14159f));
		}
	}
...
class faust_dyn_softclip_tilde : public FaustExternal<dyn_softclip> {
public:
    faust_dyn_softclip_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(dyn_softclip))
    {
    }
};
