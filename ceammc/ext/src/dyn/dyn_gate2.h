...
// clang-format on
    ...
    template <class T>
    struct _dyn_gate2_UI : public UI {
    static std::string name;
};

template <class T>
std::string _dyn_gate2_UI<T>::name(sym(dyn_gate2));

typedef _dyn_gate2_UI<dyn_gate2> dyn_gate2_UI;

class faust_dyn_gate2_tilde : public FaustExternal<dyn_gate2, dyn_gate2_UI> {
public:
