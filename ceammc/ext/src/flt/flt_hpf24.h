...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_hpf24 -scn flt_hpf24_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_hpf24_H__
#define  __flt_hpf24_H__
...
class FAUST_API flt_hpf24_dsp {

    public:

        flt_hpf24_dsp() = default;
        virtual ~flt_hpf24_dsp() = default;
...
class FAUST_API decorator_dsp : public ::flt_hpf24_dsp {
    ...
    public:
        ...
        decorator_dsp(::flt_hpf24_dsp* flt_hpf24_dsp = nullptr):fDSP(flt_hpf24_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_hpf24_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_hpf24_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_hpf24 : public flt_hpf24_dsp {
};
#endif
// clang-format on
...
static double flt_hpf24_faustpower2_f(double value) {
	return value * value;
}

class flt_hpf24 : public flt_hpf24_dsp {
 ...
 public:
	...
	flt_hpf24(const flt_hpf24&) = default;
	
	virtual ~flt_hpf24() = default;
	
	flt_hpf24& operator=(const flt_hpf24&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_hpf24 -scn flt_hpf24_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "flt_hpf24.dsp");
	...
	virtual void instanceResetUserInterface() {
		fVslider0 = static_cast<FAUSTFLOAT>(1e+04);
	}
	...
	virtual flt_hpf24* clone() {
		return new flt_hpf24(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("flt.hpf24");
		ui_interface->declare(&fVslider0, "unit", "Hz");
		ui_interface->addVerticalSlider("freq", &fVslider0, FAUSTFLOAT(1e+04), FAUSTFLOAT(2e+01), FAUSTFLOAT(2e+04), FAUSTFLOAT(0.1));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			double fTemp2 = flt_hpf24_faustpower2_f(fTemp0);
			double fTemp3 = 1.0 - 1.0 / fTemp2;
			double fTemp4 = (fTemp1 + 1.8477590650225735) / fTemp0 + 1.0;
			fRec1[0] = static_cast<double>(input0[i0]) - (fRec1[2] * ((fTemp1 + -1.8477590650225735) / fTemp0 + 1.0) + 2.0 * fRec1[1] * fTemp3) / fTemp4;
			double fTemp5 = (fTemp1 + 0.7653668647301795) / fTemp0 + 1.0;
			fRec0[0] = (fRec1[2] + (fRec1[0] - 2.0 * fRec1[1])) / (fTemp2 * fTemp4) - (fRec0[2] * ((fTemp1 + -0.7653668647301795) / fTemp0 + 1.0) + 2.0 * fTemp3 * fRec0[1]) / fTemp5;
			output0[i0] = static_cast<FAUSTFLOAT>((fRec0[2] + (fRec0[0] - 2.0 * fRec0[1])) / (fTemp2 * fTemp5));
			fRec2[1] = fRec2[0];
			fRec1[2] = fRec1[1];
			fRec1[1] = fRec1[0];
			fRec0[2] = fRec0[1];
...
class faust_flt_hpf24_tilde : public FaustExternal<flt_hpf24> {
public:
    faust_flt_hpf24_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_hpf24))
    {
    }
};
