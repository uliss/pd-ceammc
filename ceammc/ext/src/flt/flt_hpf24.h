  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp3 = (0.5f * (sinf(fTemp0) / max(0.001f, fRec7[0])));
			float fTemp4 = (fTemp3 + 1);
			float fTemp5 = (0 - ((0 - (2 * fTemp1)) / fTemp4));
			float fTemp6 = (0 - ((1 - fTemp3) / fTemp4));
			fRec6[0] = ((fTemp5 * fRec6[1]) + ((float)input0[i] + (fTemp6 * fRec4[1])));
			fRec4[0] = fRec6[1];
			float fTemp7 = (fTemp1 + 1);
			float 	fRec5 = (0.5f * ((fTemp7 * fRec6[0]) / fTemp4));
			fRec2[0] = ((((fTemp2 * fRec4[0]) + (0.5f * (fRec4[1] * fTemp7))) / fTemp4) + (((fRec2[1] * fTemp5) + (fRec0[1] * fTemp6)) + fRec5));
			fRec0[0] = fRec2[1];
			float 	fRec1 = (0.5f * ((fTemp7 * fRec2[0]) / fTemp4));
			output0[i] = (FAUSTFLOAT)(fRec1 + (((fTemp2 * fRec0[0]) + (0.5f * (fRec0[1] * fTemp7))) / fTemp4));
			// post processing
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fRec4[1] = fRec4[0];
