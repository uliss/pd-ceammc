  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp4 = (0 - ((0 - (2 * fTemp1)) / fTemp3));
			float fTemp5 = (0 - ((1 - fTemp2) / fTemp3));
			float fTemp6 = (-1 - fTemp1);
			float fTemp7 = (float)input0[i];
			fVec0[0] = fTemp7;
			float fTemp8 = (fTemp1 + 1);
			fRec3[0] = (((fRec3[1] * fTemp4) + (fRec3[2] * fTemp5)) + (((fTemp6 * fVec0[1]) + (0.5f * (fTemp8 * (fVec0[0] + fVec0[2])))) / fTemp3));
			fRec0[0] = (((fRec0[1] * fTemp4) + (fRec0[2] * fTemp5)) + (((fRec3[1] * fTemp6) + (0.5f * (fTemp8 * (fRec3[2] + fRec3[0])))) / fTemp3));
