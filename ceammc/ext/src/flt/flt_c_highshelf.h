...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_c_highshelf -scn flt_c_highshelf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_c_highshelf_H__
#define  __flt_c_highshelf_H__
...
class FAUST_API flt_c_highshelf_dsp {

    public:

        flt_c_highshelf_dsp() = default;
        virtual ~flt_c_highshelf_dsp() = default;
         ...
         */
        virtual ::flt_c_highshelf_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::flt_c_highshelf_dsp {

    protected:

        ::flt_c_highshelf_dsp* fDSP;

    public:

        decorator_dsp(::flt_c_highshelf_dsp* flt_c_highshelf_dsp = nullptr):fDSP(flt_c_highshelf_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_c_highshelf_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_c_highshelf_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_c_highshelf : public flt_c_highshelf_dsp {
};
#endif
// clang-format on
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS flt_c_highshelf
#endif
...
class flt_c_highshelf : public flt_c_highshelf_dsp {
 ...
 public:
	...
	flt_c_highshelf(const flt_c_highshelf&) = default;
	
	virtual ~flt_c_highshelf() = default;
	
	flt_c_highshelf& operator=(const flt_c_highshelf&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_c_highshelf -scn flt_c_highshelf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "flt_c_highshelf.dsp");
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider1 = static_cast<FAUSTFLOAT>(1e+04f);
	...
	virtual flt_c_highshelf* clone() {
		return new flt_c_highshelf(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("freq", &fVslider1, FAUSTFLOAT(1e+04f), FAUSTFLOAT(2e+01f), FAUSTFLOAT(2e+04f), FAUSTFLOAT(0.1f));
		ui_interface->declare(&fVslider0, "unit", "db");
		ui_interface->addVerticalSlider("gain", &fVslider0, FAUSTFLOAT(0.0f), FAUSTFLOAT(-15.0f), FAUSTFLOAT(15.0f), FAUSTFLOAT(0.1f));
		ui_interface->addHorizontalSlider("q", &fHslider0, FAUSTFLOAT(1.0f), FAUSTFLOAT(0.5f), FAUSTFLOAT(2.0f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp5 = std::sqrt(fTemp0) * std::sin(fTemp1) / std::max<float>(0.001f, fRec2[0]);
			float fTemp6 = fTemp0 + fTemp5 + (1.0f - fTemp3);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fTemp4 + fTemp5 + 1.0f) / fTemp6);
			float fTemp7 = (fTemp0 + 1.0f) * fTemp2;
			output1[i0] = static_cast<FAUSTFLOAT>(-(2.0f * (fTemp0 * (fTemp0 + fTemp7 + -1.0f) / fTemp6)));
			output2[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fTemp4 + (1.0f - fTemp5)) / fTemp6);
			output3[i0] = static_cast<FAUSTFLOAT>(2.0f * ((fTemp0 + (-1.0f - fTemp7)) / fTemp6));
			output4[i0] = static_cast<FAUSTFLOAT>((fTemp0 + (1.0f - (fTemp3 + fTemp5))) / fTemp6);
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
		}
...
class faust_flt_c_highshelf_tilde : public FaustExternal<flt_c_highshelf> {
public:
    faust_flt_c_highshelf_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_c_highshelf))
    {
    }
};
