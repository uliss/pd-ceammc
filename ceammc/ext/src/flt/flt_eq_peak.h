...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_eq_peak -scn flt_eq_peak_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_eq_peak_H__
#define  __flt_eq_peak_H__
...
class FAUST_API flt_eq_peak_dsp {

    public:

        flt_eq_peak_dsp() = default;
        virtual ~flt_eq_peak_dsp() = default;
         ...
         */
        virtual ::flt_eq_peak_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::flt_eq_peak_dsp {

    protected:

        ::flt_eq_peak_dsp* fDSP;

    public:

        decorator_dsp(::flt_eq_peak_dsp* flt_eq_peak_dsp = nullptr):fDSP(flt_eq_peak_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_eq_peak_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_eq_peak_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_eq_peak : public flt_eq_peak_dsp {
};
#endif
// clang-format on
...
static float flt_eq_peak_faustpower2_f(float value) {
	return value * value;
}

class flt_eq_peak : public flt_eq_peak_dsp {
 ...
 public:
	...
	flt_eq_peak(const flt_eq_peak&) = default;
	
	virtual ~flt_eq_peak() = default;
	
	flt_eq_peak& operator=(const flt_eq_peak&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_eq_peak -scn flt_eq_peak_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("bandwidth", &fVslider2, FAUSTFLOAT(1e+02f), FAUSTFLOAT(1.0f), FAUSTFLOAT(5e+03f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp4 = fConst1 * (fRec3[0] * std::pow(1e+01f, 0.05f * std::fabs(fRec2[0])) / fTemp3);
...
class faust_flt_eq_peak_tilde : public FaustExternal<flt_eq_peak> {
public:
    faust_flt_eq_peak_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_eq_peak))
    {
    }
};
