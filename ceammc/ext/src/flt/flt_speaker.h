...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_speaker -scn flt_speaker_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_speaker_H__
#define  __flt_speaker_H__
...
class FAUST_API flt_speaker_dsp {

    public:

        flt_speaker_dsp() = default;
        virtual ~flt_speaker_dsp() = default;
         ...
         */
        virtual ::flt_speaker_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::flt_speaker_dsp {

    protected:

        ::flt_speaker_dsp* fDSP;

    public:

        decorator_dsp(::flt_speaker_dsp* flt_speaker_dsp = nullptr):fDSP(flt_speaker_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_speaker_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_speaker_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_speaker : public flt_speaker_dsp {
};
#endif
// clang-format on
...
static double flt_speaker_faustpower2_f(double value) {
	return value * value;
}

class flt_speaker : public flt_speaker_dsp {
 ...
 public:
	...
	flt_speaker(const flt_speaker&) = default;
	
	virtual ~flt_speaker() = default;
	
	flt_speaker& operator=(const flt_speaker&) = default;
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_speaker -scn flt_speaker_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "flt_speaker.dsp");
	...
	virtual void instanceResetUserInterface() {
		...
		fHslider2 = static_cast<FAUSTFLOAT>(1.3e+02);
	...
	virtual flt_speaker* clone() {
		return new flt_speaker(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("flt.speaker");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow2 = fConst1 * std::pow(1e+01, 0.05 * static_cast<double>(fHslider1));
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			double fTemp1 = ((iSlow0) ? 0.0 : fTemp0);
			fRec0[0] = fSlow1 + fConst2 * fRec0[1];
			fRec1[0] = fSlow2 + fConst2 * fRec1[1];
			fRec6[0] = fSlow3 + fConst2 * fRec6[1];
			double fTemp2 = fConst3 * fRec6[0];
			double fTemp3 = 1.0 - fTemp2;
			double fTemp4 = fTemp2 + 1.0;
			fVec0[0] = fTemp1 / fTemp4;
			fRec5[0] = (fTemp1 + fTemp3 * fRec5[1]) / fTemp4 - fVec0[1];
			fVec1[0] = fRec5[0] / fTemp4;
			fRec4[0] = (fRec5[0] + fRec4[1] * fTemp3) / fTemp4 - fVec1[1];
			fRec7[0] = fSlow4 + fConst2 * fRec7[1];
			double fTemp5 = std::tan(fConst3 * fRec7[0]);
			double fTemp6 = 1.0 / fTemp5;
			double fTemp7 = 1.0 - 1.0 / flt_speaker_faustpower2_f(fTemp5);
			double fTemp8 = (fTemp6 + 1.8477590650225735) / fTemp5 + 1.0;
			fRec3[0] = fRec4[0] - (fRec3[2] * ((fTemp6 + -1.8477590650225735) / fTemp5 + 1.0) + 2.0 * fRec3[1] * fTemp7) / fTemp8;
			double fTemp9 = (fTemp6 + 0.7653668647301795) / fTemp5 + 1.0;
			fRec2[0] = (fRec3[2] + fRec3[0] + 2.0 * fRec3[1]) / fTemp8 - (fRec2[2] * ((fTemp6 + -0.7653668647301795) / fTemp5 + 1.0) + 2.0 * fTemp7 * fRec2[1]) / fTemp9;
			output0[i0] = static_cast<FAUSTFLOAT>(((iSlow0) ? fTemp0 : fTemp1 * (1.0 - fRec0[0]) + fRec0[0] * fRec1[0] * (fRec2[2] + fRec2[0] + 2.0 * fRec2[1]) / fTemp9));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec6[1] = fRec6[0];
			fVec0[1] = fVec0[0];
...
class faust_flt_speaker_tilde : public FaustExternal<flt_speaker> {
public:
    faust_flt_speaker_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_speaker))
    {
    }
};
