...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_c_bpf -scn flt_c_bpf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API flt_c_bpf_dsp {

    public:

        flt_c_bpf_dsp() = default;
        virtual ~flt_c_bpf_dsp() = default;
...
class FAUST_API decorator_dsp : public ::flt_c_bpf_dsp {
    ...
    public:
        ...
        decorator_dsp(::flt_c_bpf_dsp* flt_c_bpf_dsp = nullptr):fDSP(flt_c_bpf_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_c_bpf_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_c_bpf_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_c_bpf : public flt_c_bpf_dsp {
};
#endif
// clang-format on
...
class flt_c_bpf : public flt_c_bpf_dsp {
 ...
 public:
	...
	flt_c_bpf(const flt_c_bpf&) = default;
	
	virtual ~flt_c_bpf() = default;
	
	flt_c_bpf& operator=(const flt_c_bpf&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_c_bpf -scn flt_c_bpf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "flt_c_bpf.dsp");
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider1 = static_cast<FAUSTFLOAT>(0.1f);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("q", &fVslider1, FAUSTFLOAT(0.1f), FAUSTFLOAT(0.01f), FAUSTFLOAT(1e+02f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = std::max<float>(0.001f, fRec1[0]);
			...
			output1[i0] = static_cast<FAUSTFLOAT>(0.0f);
			output2[i0] = static_cast<FAUSTFLOAT>(-fTemp5);
			output3[i0] = static_cast<FAUSTFLOAT>(-(2.0f * (std::cos(fTemp0) / fTemp4)));
			output4[i0] = static_cast<FAUSTFLOAT>((1.0f - fTemp3) / fTemp4);
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
		}
	}
...
class faust_flt_c_bpf_tilde : public FaustExternal<flt_c_bpf> {
public:
    faust_flt_c_bpf_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_c_bpf))
    {
    }
};
