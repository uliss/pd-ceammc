...
// clang-format on
    ...
    template <class T>
    struct _flt_ff_comb_UI : public UI {
    static std::string name;
};

template <class T>
std::string _flt_ff_comb_UI<T>::name(sym(flt_ff_comb));

typedef _flt_ff_comb_UI<flt_ff_comb> flt_ff_comb_UI;

class faust_flt_ff_comb_tilde : public FaustExternal<flt_ff_comb, flt_ff_comb_UI> {
public:
