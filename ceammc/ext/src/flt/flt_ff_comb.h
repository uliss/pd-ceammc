...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_ff_comb -scn flt_ff_comb_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_ff_comb_H__
#define  __flt_ff_comb_H__
...
class FAUST_API flt_ff_comb_dsp {
    ...
    public:
        ...
        flt_ff_comb_dsp() = default;
        virtual ~flt_ff_comb_dsp() = default;
         ...
         */
        virtual ::flt_ff_comb_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::flt_ff_comb_dsp {
    ...
    protected:
        ...
        ::flt_ff_comb_dsp* fDSP;

    public:

        decorator_dsp(::flt_ff_comb_dsp* flt_ff_comb_dsp = nullptr):fDSP(flt_ff_comb_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_ff_comb_dsp* createDSPInstance() = 0;
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_ff_comb : public flt_ff_comb_dsp {
};
#endif
// clang-format on
...
class flt_ff_comb : public flt_ff_comb_dsp {
 ...
 public:
	...
	flt_ff_comb(const flt_ff_comb&) = default;
	
	virtual ~flt_ff_comb() = default;
	
	flt_ff_comb& operator=(const flt_ff_comb&) = default;
	
	void metadata(Meta* m) { 
		m->declare("basics.lib/name", "Faust Basic Element Library");
		m->declare("basics.lib/version", "1.22.0");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_ff_comb -scn flt_ff_comb_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual flt_ff_comb* clone() {
		return new flt_ff_comb(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("a", &fHslider0, FAUSTFLOAT(1.0f), FAUSTFLOAT(-1.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.0001f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = fConst0 / std::max<float>(std::min<float>(2e+04f, static_cast<float>(input1[i0])), 2e+01f);
			int iTemp2 = static_cast<int>(fTemp1);
			float fTemp3 = std::floor(fTemp1);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 + fRec0[0] * (fVec0[(IOTA0 - std::min<int>(iConst8, std::max<int>(0, iTemp2))) & 16383] * (fTemp3 + (1.0f - fTemp1)) + (fTemp1 - fTemp3) * fVec0[(IOTA0 - std::min<int>(iConst8, std::max<int>(0, iTemp2 + 1))) & 16383]));
			IOTA0 = IOTA0 + 1;
			fRec0[1] = fRec0[0];
		}
	}
...
class faust_flt_ff_comb_tilde : public FaustExternal<flt_ff_comb> {
public:
    faust_flt_ff_comb_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_ff_comb))
    {
    }
};
