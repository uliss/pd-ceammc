...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_c_hpf -scn flt_c_hpf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_c_hpf_H__
#define  __flt_c_hpf_H__
...
class FAUST_API flt_c_hpf_dsp {

    public:

        flt_c_hpf_dsp() = default;
        virtual ~flt_c_hpf_dsp() = default;
...
class FAUST_API decorator_dsp : public ::flt_c_hpf_dsp {
    ...
    public:
        ...
        decorator_dsp(::flt_c_hpf_dsp* flt_c_hpf_dsp = nullptr):fDSP(flt_c_hpf_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_c_hpf_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_c_hpf_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_c_hpf : public flt_c_hpf_dsp {
};
#endif
// clang-format on
...
class flt_c_hpf : public flt_c_hpf_dsp {
 ...
 public:
	...
	flt_c_hpf(const flt_c_hpf&) = default;
	
	virtual ~flt_c_hpf() = default;
	
	flt_c_hpf& operator=(const flt_c_hpf&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_c_hpf -scn flt_c_hpf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "flt_c_hpf.dsp");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = 0.5f * (std::sin(fTemp0) / std::max<float>(0.001f, fRec1[0]));
			float fTemp3 = fTemp2 + 1.0f;
			float fTemp4 = 0.5f * ((fTemp1 + 1.0f) / fTemp3);
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp4);
			output1[i0] = static_cast<FAUSTFLOAT>((-1.0f - fTemp1) / fTemp3);
			output2[i0] = static_cast<FAUSTFLOAT>(fTemp4);
			output3[i0] = static_cast<FAUSTFLOAT>(-(2.0f * (fTemp1 / fTemp3)));
			output4[i0] = static_cast<FAUSTFLOAT>((1.0f - fTemp2) / fTemp3);
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
		}
	}
...
class faust_flt_c_hpf_tilde : public FaustExternal<flt_c_hpf> {
public:
    faust_flt_c_hpf_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_c_hpf))
    {
    }
};
