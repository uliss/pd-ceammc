...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_highshelf -scn flt_highshelf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_highshelf_H__
#define  __flt_highshelf_H__
...
class FAUST_API flt_highshelf_dsp {

    public:

        flt_highshelf_dsp() = default;
        virtual ~flt_highshelf_dsp() = default;
         ...
         */
        virtual ::flt_highshelf_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::flt_highshelf_dsp {

    protected:

        ::flt_highshelf_dsp* fDSP;

    public:

        decorator_dsp(::flt_highshelf_dsp* flt_highshelf_dsp = nullptr):fDSP(flt_highshelf_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_highshelf_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_highshelf_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_highshelf : public flt_highshelf_dsp {
};
#endif
// clang-format on
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS flt_highshelf
#endif
...
class flt_highshelf : public flt_highshelf_dsp {
 ...
 public:
	...
	flt_highshelf(const flt_highshelf&) = default;
	
	virtual ~flt_highshelf() = default;
	
	flt_highshelf& operator=(const flt_highshelf&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_highshelf -scn flt_highshelf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "flt_highshelf.dsp");
	...
	virtual flt_highshelf* clone() {
		return new flt_highshelf(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("flt.highshelf");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = fConst3 * std::max<float>(0.0f, fRec2[0]);
			...
			fRec1[0] = static_cast<float>(input0[i0]) - ((fTemp0 + (1.0f - (fTemp3 + fTemp4))) * fRec1[2] + 2.0f * (fTemp0 + (-1.0f - fTemp5)) * fRec1[1]) / fTemp6;
			float fTemp7 = fTemp0 + fTemp3;
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fRec1[0] * (fTemp7 + fTemp4 + 1.0f) - 2.0f * fRec1[1] * (fTemp0 + fTemp5 + -1.0f) + fRec1[2] * (fTemp7 + (1.0f - fTemp4))) / fTemp6);
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fRec1[2] = fRec1[1];
			fRec1[1] = fRec1[0];
...
class faust_flt_highshelf_tilde : public FaustExternal<flt_highshelf> {
public:
    faust_flt_highshelf_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_highshelf))
    {
    }
};
