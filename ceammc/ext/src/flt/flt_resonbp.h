...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_resonbp -scn flt_resonbp_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_resonbp_H__
#define  __flt_resonbp_H__
...
class FAUST_API flt_resonbp_dsp {

    public:

        flt_resonbp_dsp() = default;
        virtual ~flt_resonbp_dsp() = default;
         ...
         */
        virtual ::flt_resonbp_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::flt_resonbp_dsp {

    protected:

        ::flt_resonbp_dsp* fDSP;

    public:

        decorator_dsp(::flt_resonbp_dsp* flt_resonbp_dsp = nullptr):fDSP(flt_resonbp_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_resonbp_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_resonbp_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_resonbp : public flt_resonbp_dsp {
};
#endif
// clang-format on
...
class flt_resonbp : public flt_resonbp_dsp {
 ...
 public:
	...
	flt_resonbp(const flt_resonbp&) = default;
	
	virtual ~flt_resonbp() = default;
	
	flt_resonbp& operator=(const flt_resonbp&) = default;
	
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_resonbp -scn flt_resonbp_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider1 = static_cast<FAUSTFLOAT>(8e+01);
	}
	...
	virtual flt_resonbp* clone() {
		return new flt_resonbp(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec0[0] = static_cast<double>(input0[i0]) - (fRec0[2] * ((fTemp1 - fTemp2) / fTemp0 + 1.0) + 2.0 * fRec0[1] * (1.0 - 1.0 / flt_resonbp_faustpower2_f(fTemp0))) / fTemp3;
			output0[i0] = static_cast<FAUSTFLOAT>((fRec0[0] - fRec0[2]) / (fTemp0 * fTemp3));
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
...
class faust_flt_resonbp_tilde : public FaustExternal<flt_resonbp> {
public:
    faust_flt_resonbp_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_resonbp))
    {
    }
};
