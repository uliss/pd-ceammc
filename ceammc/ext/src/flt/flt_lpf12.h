...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_lpf12 -scn flt_lpf12_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_lpf12_H__
#define  __flt_lpf12_H__
...
class FAUST_API flt_lpf12_dsp {

    public:

        flt_lpf12_dsp() = default;
        virtual ~flt_lpf12_dsp() = default;
...
class FAUST_API decorator_dsp : public ::flt_lpf12_dsp {
    ...
    public:
        ...
        decorator_dsp(::flt_lpf12_dsp* flt_lpf12_dsp = nullptr):fDSP(flt_lpf12_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_lpf12_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_lpf12_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_lpf12 : public flt_lpf12_dsp {
};
#endif
// clang-format on
...
static float flt_lpf12_faustpower2_f(float value) {
	return value * value;
}

class flt_lpf12 : public flt_lpf12_dsp {
 ...
 public:
	...
	flt_lpf12(const flt_lpf12&) = default;
	
	virtual ~flt_lpf12() = default;
	
	flt_lpf12& operator=(const flt_lpf12&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_lpf12 -scn flt_lpf12_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "flt_lpf12.dsp");
	...
	virtual flt_lpf12* clone() {
		return new flt_lpf12(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("flt.lpf12");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec0[0] = static_cast<float>(input0[i0]) - (fRec0[2] * ((fTemp1 + -1.4142135f) / fTemp0 + 1.0f) + 2.0f * fRec0[1] * (1.0f - 1.0f / flt_lpf12_faustpower2_f(fTemp0))) / fTemp2;
			output0[i0] = static_cast<FAUSTFLOAT>((fRec0[2] + fRec0[0] + 2.0f * fRec0[1]) / fTemp2);
			fRec1[1] = fRec1[0];
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
		}
...
class faust_flt_lpf12_tilde : public FaustExternal<flt_lpf12> {
public:
    faust_flt_lpf12_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_lpf12))
    {
    }
};
