...
float hpf12_faustpower2_f(float value) {
	return (value * value);
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			output0[i] = FAUSTFLOAT(((((2.0f * (fRec0[1] * (0.0f - fTemp3))) + (fRec0[0] / fTemp2)) + (fRec0[2] / fTemp2)) / fTemp4));
			fRec1[1] = fRec1[0];
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
...
static bool faust_new_internal(t_faust_hpf12* x, const std::string& objId = "", bool info_outlet = true)
{
    ...
    x->dsp = new hpf12();
    x->ui = new PdUI<UI>(sym(hpf12), objId);
