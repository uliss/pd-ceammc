...
class hpf12 : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("freq", &fslider0, 1e+04f, 2e+01f, 2e+04f, 0.1f);
		ui_interface->addVerticalSlider("q", &fslider1, 0.01f, 0.01f, 1e+02f, 0.1f);
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			float fTemp0 = (fConst0 * max((float)0, fRec3[0]));
			float fTemp1 = cosf(fTemp0);
			fRec4[0] = (fSlow1 + (0.999f * fRec4[1]));
			float fTemp2 = (0.5f * (sinf(fTemp0) / max(0.001f, fRec4[0])));
			float fTemp3 = (fTemp2 + 1);
			fRec2[0] = ((fRec2[1] * (0 - ((0 - (2 * fTemp1)) / fTemp3))) + ((float)input0[i] + (fRec0[1] * (0 - ((1 - fTemp2) / fTemp3)))));
			fRec0[0] = fRec2[1];
			float fTemp4 = (fTemp1 + 1);
			float 	fRec1 = (0.5f * ((fTemp4 * fRec2[0]) / fTemp3));
			output0[i] = (FAUSTFLOAT)(fRec1 + ((((-1 - fTemp1) * fRec0[0]) + (0.5f * (fRec0[1] * fTemp4))) / fTemp3));
			// post processing
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fRec4[1] = fRec4[0];
