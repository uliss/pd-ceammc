...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_hpf12 -scn flt_hpf12_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */
...
class FAUST_API flt_hpf12_dsp {
    ...
    public:
        ...
        flt_hpf12_dsp() = default;
        virtual ~flt_hpf12_dsp() = default;
...
class flt_hpf12 : public flt_hpf12_dsp {
 ...
 public:
	...
	flt_hpf12(const flt_hpf12&) = default;
	
	virtual ~flt_hpf12() = default;
	
	flt_hpf12& operator=(const flt_hpf12&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_hpf12 -scn flt_hpf12_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec0[0] = static_cast<float>(input0[i0]) - (fRec0[2] * ((fTemp1 + -1.4142135f) / fTemp0 + 1.0f) + 2.0f * fRec0[1] * (1.0f - 1.0f / fTemp2)) / fTemp3;
			output0[i0] = static_cast<FAUSTFLOAT>((fRec0[2] + (fRec0[0] - 2.0f * fRec0[1])) / (fTemp2 * fTemp3));
			fRec1[1] = fRec1[0];
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
		}
