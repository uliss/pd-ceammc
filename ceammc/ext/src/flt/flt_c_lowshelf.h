...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_c_lowshelf -scn flt_c_lowshelf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_c_lowshelf_H__
#define  __flt_c_lowshelf_H__
...
class FAUST_API flt_c_lowshelf_dsp {

    public:

        flt_c_lowshelf_dsp() = default;
        virtual ~flt_c_lowshelf_dsp() = default;
         ...
         */
        virtual ::flt_c_lowshelf_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::flt_c_lowshelf_dsp {
    ...
    protected:
        ...
        ::flt_c_lowshelf_dsp* fDSP;

    public:

        decorator_dsp(::flt_c_lowshelf_dsp* flt_c_lowshelf_dsp = nullptr):fDSP(flt_c_lowshelf_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_c_lowshelf_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_c_lowshelf_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS flt_c_lowshelf
#endif
...
class flt_c_lowshelf : public flt_c_lowshelf_dsp {
 ...
 public:
	...
	flt_c_lowshelf(const flt_c_lowshelf&) = default;
	
	virtual ~flt_c_lowshelf() = default;
	
	flt_c_lowshelf& operator=(const flt_c_lowshelf&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_c_lowshelf -scn flt_c_lowshelf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual flt_c_lowshelf* clone() {
		return new flt_c_lowshelf(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp2 = std::sqrt(fTemp0) * std::sin(fTemp1) / std::max<float>(0.001f, fRec2[0]);
			float fTemp3 = std::cos(fTemp1);
			float fTemp4 = (fTemp0 + -1.0f) * fTemp3;
			float fTemp5 = fTemp0 + fTemp4;
			float fTemp6 = fTemp2 + fTemp5 + 1.0f;
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fTemp0 + fTemp2 + (1.0f - fTemp4)) / fTemp6);
			float fTemp7 = (fTemp0 + 1.0f) * fTemp3;
			output1[i0] = static_cast<FAUSTFLOAT>(2.0f * (fTemp0 * (fTemp0 + (-1.0f - fTemp7)) / fTemp6));
			output2[i0] = static_cast<FAUSTFLOAT>(fTemp0 * (fTemp0 + (1.0f - (fTemp4 + fTemp2))) / fTemp6);
			output3[i0] = static_cast<FAUSTFLOAT>(-(2.0f * ((fTemp0 + fTemp7 + -1.0f) / fTemp6)));
			output4[i0] = static_cast<FAUSTFLOAT>((fTemp5 + (1.0f - fTemp2)) / fTemp6);
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
		}
...
class faust_flt_c_lowshelf_tilde : public FaustExternal<flt_c_lowshelf> {
public:
    faust_flt_c_lowshelf_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_c_lowshelf))
    {
    }
};
