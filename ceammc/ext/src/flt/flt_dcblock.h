...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_dcblock -scn flt_dcblock_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_dcblock_H__
#define  __flt_dcblock_H__
...
class FAUST_API flt_dcblock_dsp {

    public:

        flt_dcblock_dsp() = default;
        virtual ~flt_dcblock_dsp() = default;
         ...
         */
        virtual ::flt_dcblock_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::flt_dcblock_dsp {

    protected:

        ::flt_dcblock_dsp* fDSP;

    public:

        decorator_dsp(::flt_dcblock_dsp* flt_dcblock_dsp = nullptr):fDSP(flt_dcblock_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_dcblock_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_dcblock_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_dcblock : public flt_dcblock_dsp {
};
#endif
// clang-format on
...
class flt_dcblock : public flt_dcblock_dsp {
 ...
 public:
	...
	flt_dcblock(const flt_dcblock&) = default;
	
	virtual ~flt_dcblock() = default;
	
	flt_dcblock& operator=(const flt_dcblock&) = default;
	
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_dcblock -scn flt_dcblock_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual flt_dcblock* clone() {
		return new flt_dcblock(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("flt.dcblock");
...
class faust_flt_dcblock_tilde : public FaustExternal<flt_dcblock> {
public:
    faust_flt_dcblock_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_dcblock))
    {
    }
};
