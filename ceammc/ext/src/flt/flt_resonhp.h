...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_resonhp -scn flt_resonhp_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_resonhp_H__
#define  __flt_resonhp_H__
...
class FAUST_API flt_resonhp_dsp {

    public:

        flt_resonhp_dsp() = default;
        virtual ~flt_resonhp_dsp() = default;
         ...
         */
        virtual ::flt_resonhp_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::flt_resonhp_dsp {

    protected:

        ::flt_resonhp_dsp* fDSP;

    public:

        decorator_dsp(::flt_resonhp_dsp* flt_resonhp_dsp = nullptr):fDSP(flt_resonhp_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_resonhp_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_resonhp_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_resonhp : public flt_resonhp_dsp {
};
#endif
// clang-format on
...
static double flt_resonhp_faustpower2_f(double value) {
	return value * value;
}

class flt_resonhp : public flt_resonhp_dsp {
 ...
 public:
	...
	flt_resonhp(const flt_resonhp&) = default;
	
	virtual ~flt_resonhp() = default;
	
	flt_resonhp& operator=(const flt_resonhp&) = default;
	
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_resonhp -scn flt_resonhp_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
		m->declare("filename", "flt_resonhp.dsp");
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider1 = static_cast<FAUSTFLOAT>(2e+01);
	}
	...
	virtual flt_resonhp* clone() {
		return new flt_resonhp(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow1 = fConst2 * static_cast<double>(fVslider1);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			double fTemp0 = static_cast<double>(input0[i0]);
			fRec1[0] = fSlow0 + fConst3 * fRec1[1];
			double fTemp1 = std::tan(fConst1 * fRec1[0]);
			double fTemp2 = 1.0 / fTemp1;
			fRec2[0] = fSlow1 + fConst3 * fRec2[1];
			double fTemp3 = 1.0 / fRec2[0];
			double fTemp4 = (fTemp3 + fTemp2) / fTemp1 + 1.0;
			fRec0[0] = fTemp0 - (fRec0[2] * ((fTemp2 - fTemp3) / fTemp1 + 1.0) + 2.0 * fRec0[1] * (1.0 - 1.0 / flt_resonhp_faustpower2_f(fTemp1))) / fTemp4;
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp0 - (fRec0[2] + fRec0[0] + 2.0 * fRec0[1]) / fTemp4);
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec0[2] = fRec0[1];
			fRec0[1] = fRec0[0];
...
class faust_flt_resonhp_tilde : public FaustExternal<flt_resonhp> {
public:
    faust_flt_resonhp_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_resonhp))
    {
    }
};
