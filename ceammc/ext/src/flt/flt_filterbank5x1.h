...
class flt_filterbank5x1 : public flt_filterbank5x1_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst14 = fConst11 + 1.0f;
		fConst15 = 1.0f / fConst14;
		fConst16 = 1.0f - fConst11;
		fConst17 = std::tan(6283.1855f / fConst0);
		fConst18 = 1.0f / fConst17;
		fConst19 = (fConst18 + 1.0f) / fConst17 + 1.0f;
		fConst20 = 1.0f / fConst19;
		fConst21 = fConst18 + 1.0f;
		fConst22 = 1.0f / fConst21;
		fConst23 = 1.0f - fConst18;
		fConst24 = std::tan(12566.371f / fConst0);
		fConst25 = 1.0f / fConst24;
		fConst26 = (fConst25 + 1.0f) / fConst24 + 1.0f;
		fConst27 = 1.0f / fConst26;
		fConst28 = 1.0f / (fConst25 + 1.0f);
		fConst29 = 1.0f - fConst25;
		fConst30 = (fConst25 + -1.0f) / fConst24 + 1.0f;
		fConst31 = flt_filterbank5x1_faustpower2_f(fConst24);
		fConst32 = 2.0f * (1.0f - 1.0f / fConst31);
		fConst33 = (fConst18 + -1.0f) / fConst17 + 1.0f;
		fConst34 = flt_filterbank5x1_faustpower2_f(fConst17);
		fConst35 = 2.0f * (1.0f - 1.0f / fConst34);
		fConst36 = (fConst11 + -1.0f) / fConst10 + 1.0f;
		fConst37 = flt_filterbank5x1_faustpower2_f(fConst10);
		fConst38 = 2.0f * (1.0f - 1.0f / fConst37);
		...
		fConst43 = 1.0f / (fConst1 * fConst12);
		fConst44 = 1.0f / (fConst37 * fConst12);
		fConst45 = 1.0f / (fConst10 * fConst19);
		fConst46 = 1.0f / (fConst7 / fConst1 + 1.0f);
		fConst47 = 1.0f - fConst9 / fConst1;
		fConst48 = 1.0f / (fConst34 * fConst19);
		fConst49 = 1.0f / (fConst17 * fConst26);
		fConst50 = 1.0f / (fConst14 / fConst10 + 1.0f);
		fConst51 = 1.0f - fConst16 / fConst10;
		fConst52 = 1.0f / (fConst31 * fConst26);
		fConst53 = 1.0f / (fConst21 / fConst17 + 1.0f);
		fConst54 = 1.0f - fConst23 / fConst17;
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec1[0] = fTemp1;
			fRec6[0] = -(fConst22 * (fConst23 * fRec6[1] - fConst27 * (fTemp1 + fVec1[1])));
			fRec5[0] = fRec6[0] - fConst20 * (fConst33 * fRec5[2] + fConst35 * fRec5[1]);
			float fTemp2 = fRec5[2] + fRec5[0] + 2.0f * fRec5[1];
			fVec2[0] = fTemp2;
			fRec4[0] = -(fConst15 * (fConst16 * fRec4[1] - fConst20 * (fTemp2 + fVec2[1])));
			fRec3[0] = fRec4[0] - fConst13 * (fConst36 * fRec3[2] + fConst38 * fRec3[1]);
