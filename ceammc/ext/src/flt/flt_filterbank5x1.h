...
class flt_filterbank5x1 : public flt_filterbank5x1_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst55 = fConst29 / fConst17;
		fConst56 = 0.0f - 2.0f / fConst31;
		fConst57 = 1.0f / (fConst12 / fConst9 + 1.0f);
		fConst58 = 1.0f - fConst34 / fConst9;
		fConst59 = 0.0f - 1.0f / (fConst19 * fConst22);
		fConst60 = 0.0f - 2.0f / fConst26;
		fConst61 = 1.0f / (fConst17 / fConst14 + 1.0f);
		fConst62 = 1.0f - fConst29 / fConst14;
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec1[0] = fTemp1;
			fRec6[0] = fConst18 * (fConst21 * (fTemp1 + fVec1[1]) - fConst29 * fRec6[1]);
			fRec5[0] = fRec6[0] - fConst16 * (fConst30 * fRec5[2] + fConst33 * fRec5[1]);
			float fTemp2 = fRec5[2] + fRec5[0] + 2.0f * fRec5[1];
			fVec2[0] = fTemp2;
			fRec4[0] = fConst13 * (fConst16 * (fTemp2 + fVec2[1]) - fConst34 * fRec4[1]);
			...
			fRec20[0] = fConst21 * (fConst53 * fTemp1 + fConst54 * fVec1[1]) - fConst55 * fRec20[1];
			...
			fRec26[0] = fConst59 * fVec0[1] - fConst23 * (fConst24 * fRec26[1] - fConst20 * fTemp0);
			fRec25[0] = fRec26[0] - fConst21 * (fConst25 * fRec25[2] + fConst28 * fRec25[1]);
			float fTemp7 = fConst42 * fRec24[1];
			fRec24[0] = fConst21 * (fConst27 * fRec25[0] + fConst60 * fRec25[1] + fConst27 * fRec25[2]) - fConst51 * (fConst52 * fRec24[2] + fTemp7);
