...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_notch -scn flt_notch_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_notch_H__
#define  __flt_notch_H__
...
class FAUST_API flt_notch_dsp {

    public:

        flt_notch_dsp() = default;
        virtual ~flt_notch_dsp() = default;
...
class FAUST_API decorator_dsp : public ::flt_notch_dsp {
    ...
    public:
        ...
        decorator_dsp(::flt_notch_dsp* flt_notch_dsp = nullptr):fDSP(flt_notch_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_notch_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_notch_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_notch : public flt_notch_dsp {
};
#endif
// clang-format on
...
static float flt_notch_faustpower2_f(float value) {
	return value * value;
}

class flt_notch : public flt_notch_dsp {
 ...
 public:
	...
	flt_notch(const flt_notch&) = default;
	
	virtual ~flt_notch() = default;
	
	flt_notch& operator=(const flt_notch&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_notch -scn flt_notch_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
		m->declare("filename", "flt_notch.dsp");
		...
		m->declare("filters.lib/notchw:license", "MIT-style STK-4.3 license");
	...
	virtual void instanceResetUserInterface() {
		fVslider0 = static_cast<FAUSTFLOAT>(5e+01f);
	...
	virtual flt_notch* clone() {
		return new flt_notch(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("width", &fVslider0, FAUSTFLOAT(5e+01f), FAUSTFLOAT(1.0f), FAUSTFLOAT(1e+04f), FAUSTFLOAT(0.1f));
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp1 = flt_notch_faustpower2_f(1.0f - fTemp0);
			float fTemp2 = flt_notch_faustpower2_f(fTemp0 + 1.0f);
			float fTemp3 = fTemp1 / fTemp2 + 1.0f;
			fRec2[0] = fSlow1 + fConst3 * fRec2[1];
			float fTemp4 = std::cos(fConst4 * fRec2[0]);
			fRec1[0] = static_cast<float>(input0[i0]) + fRec1[1] * fTemp3 * fTemp4 - fTemp1 * fRec1[2] / fTemp2;
			output0[i0] = static_cast<FAUSTFLOAT>(fTemp3 * (0.5f * fRec1[0] - fRec1[1] * fTemp4 + 0.5f * fRec1[2]));
			fRec0[1] = fRec0[0];
			fRec2[1] = fRec2[0];
			fRec1[2] = fRec1[1];
			fRec1[1] = fRec1[0];
...
class faust_flt_notch_tilde : public FaustExternal<flt_notch> {
public:
    faust_flt_notch_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_notch))
    {
    }
};
