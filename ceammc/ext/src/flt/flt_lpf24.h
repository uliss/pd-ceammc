  ...
  public:
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		for (int i=0; i<count; i++) {
			...
			fRec6[0] = ((fRec6[1] * fTemp5) + ((float)input0[i] + (fRec4[1] * fTemp6)));
			fRec4[0] = fRec6[1];
			float 	fRec5 = (0.5f * ((fTemp2 * fRec6[0]) / fTemp4));
			fRec3[0] = (((((fTemp2 * (fRec4[0] + (0.5f * fRec4[1]))) / fTemp4) + (fRec3[1] * fTemp5)) + (fRec1[1] * fTemp6)) + fRec5);
			fRec1[0] = fRec3[1];
			float 	fRec2 = (0.5f * ((fTemp2 * fRec3[0]) / fTemp4));
			output0[i] = (FAUSTFLOAT)(((fTemp2 * (fRec1[0] + (0.5f * fRec1[1]))) / fTemp4) + fRec2);
			// post processing
			fRec1[1] = fRec1[0];
			fRec3[1] = fRec3[0];
			fRec4[1] = fRec4[0];
