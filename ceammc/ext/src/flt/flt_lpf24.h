...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_lpf24 -scn flt_lpf24_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_lpf24_H__
#define  __flt_lpf24_H__
...
class FAUST_API flt_lpf24_dsp {
    ...
    public:
        ...
        flt_lpf24_dsp() = default;
        virtual ~flt_lpf24_dsp() = default;
...
class FAUST_API decorator_dsp : public ::flt_lpf24_dsp {
    ...
    public:
        ...
        decorator_dsp(::flt_lpf24_dsp* flt_lpf24_dsp = nullptr):fDSP(flt_lpf24_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_lpf24_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_lpf24_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_lpf24 : public flt_lpf24_dsp {
};
#endif
// clang-format on
...
class flt_lpf24 : public flt_lpf24_dsp {
 ...
 public:
	...
	flt_lpf24(const flt_lpf24&) = default;
	
	virtual ~flt_lpf24() = default;
	
	flt_lpf24& operator=(const flt_lpf24&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_lpf24 -scn flt_lpf24_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
	...
	virtual flt_lpf24* clone() {
		return new flt_lpf24(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec1[0] = static_cast<double>(input0[i0]) - (fRec1[2] * ((fTemp1 + -1.8477590650225735) / fTemp0 + 1.0) + 2.0 * fRec1[1] * fTemp2) / fTemp3;
			...
			output0[i0] = static_cast<FAUSTFLOAT>((fRec0[2] + fRec0[0] + 2.0 * fRec0[1]) / fTemp4);
			fRec2[1] = fRec2[0];
			fRec1[2] = fRec1[1];
			fRec1[1] = fRec1[0];
			fRec0[2] = fRec0[1];
