...
float eq_peak_cq_faustpower2_f(float value) {
	return (value * value);
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp3 = (fRec3[0] * sinf((fConst4 * fRec1[0])));
			float fTemp4 = (fConst3 * ((fRec1[0] * powf(10.0f, (0.0500000007f * fabsf(fRec2[0])))) / fTemp3));
			float fTemp5 = (fConst3 * (fRec1[0] / fTemp3));
			float fTemp6 = (iTemp2?fTemp5:fTemp4);
			float fTemp7 = (2.0f * (fRec0[1] * (1.0f - (1.0f / eq_peak_cq_faustpower2_f(fTemp0)))));
...
static bool faust_new_internal(t_faust_eq_peak_cq* x, const std::string& objId = "", bool info_outlet = true)
{
    ...
    x->ui = new PdUI<UI>(sym(eq_peak_cq), objId);
