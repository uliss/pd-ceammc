...
class decorator_dsp : public flt_eq_peak_cq_dsp {
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_eq_peak_cq : public flt_eq_peak_cq_dsp {
};
#endif
// clang-format on
...
class flt_eq_peak_cq : public flt_eq_peak_cq_dsp {
