...
// clang-format off
#ifndef FAUST_MACRO
struct flt_eq_peak_cq : public dsp {
};
#endif
// clang-format on
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS flt_eq_peak_cq
#endif
#ifdef __APPLE__ 
...
class flt_eq_peak_cq : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			int iTemp0 = (fRec0[0] > 0.0f);
			fRec1[0] = (fSlow1 + (0.999000013f * fRec1[1]));
			fRec2[0] = (fSlow2 + (0.999000013f * fRec2[1]));
			float fTemp1 = (fRec2[0] * std::sin((fConst2 * fRec1[0])));
			float fTemp2 = (fConst1 * (fRec1[0] / fTemp1));
			float fTemp3 = (fConst1 * ((fRec1[0] * std::pow(10.0f, (0.0500000007f * std::fabs(fRec0[0])))) / fTemp1));
			float fTemp4 = (iTemp0?fTemp3:fTemp2);
			float fTemp5 = std::tan((fConst1 * fRec1[0]));
			float fTemp6 = (1.0f / fTemp5);
			float fTemp7 = (iTemp0?fTemp2:fTemp3);
			float fTemp8 = (2.0f * (fRec3[1] * (1.0f - (1.0f / flt_eq_peak_cq_faustpower2_f(fTemp5)))));
			float fTemp9 = (((fTemp6 + fTemp7) / fTemp5) + 1.0f);
			fRec3[0] = (float(input0[i]) - (((fRec3[2] * (((fTemp6 - fTemp7) / fTemp5) + 1.0f)) + fTemp8) / fTemp9));
			output0[i] = FAUSTFLOAT((((((((fTemp4 + fTemp6) / fTemp5) + 1.0f) * fRec3[0]) + fTemp8) + ((1.0f - ((fTemp4 - fTemp6) / fTemp5)) * fRec3[2])) / fTemp9));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[1] = fRec2[0];
			fRec3[2] = fRec3[1];
