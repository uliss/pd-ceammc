...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -ct 1 -cn flt_bpf24 -scn flt_bpf24_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */
...
class flt_bpf24 : public flt_bpf24_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -ct 1 -cn flt_bpf24 -scn flt_bpf24_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow0 = fConst5 * double(fVslider0);
		double fSlow1 = fConst5 * double(fVslider1);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec2[0] = double(input0[i0]) - (fRec2[1] * (fTemp7 + fTemp4 * (fTemp8 - fConst14) + -64.0) + fRec2[2] * (fConst15 * fTemp6 + (96.0 - fConst2 * (8.0 * fTemp5 + 16.0 * fTemp3))) + fRec2[3] * (fTemp7 + fTemp4 * (fConst14 - fTemp8) + -64.0) + fRec2[4] * (fTemp9 + (16.0 - fTemp10))) / fTemp11;
			output0[i0] = FAUSTFLOAT(fConst2 * (fTemp5 * (4.0 * (fRec2[0] + fRec2[4]) - 8.0 * fRec2[2]) / fTemp11));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
