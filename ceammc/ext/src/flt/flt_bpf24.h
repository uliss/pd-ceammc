...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_bpf24 -scn flt_bpf24_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */
...
class FAUST_API flt_bpf24_dsp {
    ...
    public:
        ...
        flt_bpf24_dsp() = default;
        virtual ~flt_bpf24_dsp() = default;
...
class flt_bpf24 : public flt_bpf24_dsp {
 ...
 public:
	...
	flt_bpf24(const flt_bpf24&) = default;
	
	virtual ~flt_bpf24() = default;
	
	flt_bpf24& operator=(const flt_bpf24&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_bpf24 -scn flt_bpf24_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst5 = 44.1 / fConst0;
		fConst6 = 1.0 - fConst5;
		fConst7 = 0.499 * fConst0;
		fConst8 = 0.5 / fConst0;
		fConst9 = 4.0 * flt_bpf24_faustpower2_f(fConst0);
		fConst10 = flt_bpf24_faustpower4_f(fConst1);
		fConst11 = 4.0 * fConst10;
		fConst12 = flt_bpf24_faustpower3_f(fConst1);
		fConst13 = 5.65685424949238 * fConst12;
		fConst14 = 22.62741699796952 / fConst0;
		fConst15 = 6.0 * fConst10;
		fConst16 = 11.31370849898476 / fConst0;
		fConst17 = 2.82842712474619 * fConst12;
	}
	
	virtual void instanceResetUserInterface() {
		fVslider0 = static_cast<FAUSTFLOAT>(1e+03);
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow0 = fConst5 * static_cast<double>(fVslider0);
		double fSlow1 = fConst5 * static_cast<double>(fVslider1);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			fRec0[0] = fSlow0 + fConst6 * fRec0[1];
			fRec1[0] = fSlow1 + fConst6 * fRec1[1];
			double fTemp0 = 0.5 / fRec1[0];
			double fTemp1 = std::tan(fConst4 * std::min<double>(fRec0[0] * (fTemp0 + 1.0), fConst7));
			double fTemp2 = std::sqrt(fConst9 * std::tan(fConst4 * std::max<double>(fRec0[0] * (1.0 - fTemp0), 2e+01)) * fTemp1);
			double fTemp3 = flt_bpf24_faustpower2_f(fTemp2);
			double fTemp4 = fConst3 * fTemp1 - fConst8 * (fTemp3 / fTemp1);
			double fTemp5 = flt_bpf24_faustpower2_f(fTemp4);
			double fTemp6 = flt_bpf24_faustpower4_f(fTemp2);
			double fTemp7 = fConst11 * fTemp6;
			double fTemp8 = fConst13 * fTemp3;
			double fTemp9 = fConst10 * fTemp6 + fConst2 * (4.0 * fTemp5 + 8.0 * fTemp3);
			double fTemp10 = fTemp4 * (fConst16 + fConst17 * fTemp3);
			double fTemp11 = fTemp10 + fTemp9 + 16.0;
			fRec2[0] = static_cast<double>(input0[i0]) - (fRec2[1] * (fTemp7 + fTemp4 * (fTemp8 - fConst14) + -64.0) + fRec2[2] * (fConst15 * fTemp6 + (96.0 - fConst2 * (8.0 * fTemp5 + 16.0 * fTemp3))) + fRec2[3] * (fTemp7 + fTemp4 * (fConst14 - fTemp8) + -64.0) + fRec2[4] * (fTemp9 + (16.0 - fTemp10))) / fTemp11;
			output0[i0] = static_cast<FAUSTFLOAT>(fConst2 * (fTemp5 * (4.0 * fRec2[0] - 8.0 * fRec2[2] + 4.0 * fRec2[4]) / fTemp11));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
...
class faust_flt_bpf24_tilde : public FaustExternal<flt_bpf24> {
public:
    faust_flt_bpf24_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_bpf24))
    {
    }
};
