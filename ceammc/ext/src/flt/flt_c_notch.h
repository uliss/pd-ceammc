...
class c_notch : public dsp {
  ...
  public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("q", &fslider1, 1.0f, 0.01f, 1e+02f, 0.1f);
