...
class flt_biquad : public flt_biquad_dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/ceammc_dsp_ext.cpp -lang cpp -i -cn flt_biquad -scn flt_biquad_dsp -es 1 -mcd 16 -single -ftz 0");
