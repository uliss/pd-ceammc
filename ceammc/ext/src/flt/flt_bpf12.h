...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_bpf12 -scn flt_bpf12_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_bpf12_H__
#define  __flt_bpf12_H__
...
class FAUST_API flt_bpf12_dsp {

    public:

        flt_bpf12_dsp() = default;
        virtual ~flt_bpf12_dsp() = default;
...
class FAUST_API decorator_dsp : public ::flt_bpf12_dsp {
...
/**
 The base class of Meta handler to be used in flt_bpf12_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
class flt_bpf12 : public flt_bpf12_dsp {
 ...
 public:
	...
	flt_bpf12(const flt_bpf12&) = default;
	
	virtual ~flt_bpf12() = default;
	
	flt_bpf12& operator=(const flt_bpf12&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_bpf12 -scn flt_bpf12_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -double -ftz 0");
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		double fSlow0 = fConst4 * static_cast<double>(fVslider0);
		double fSlow1 = fConst4 * static_cast<double>(fVslider1);
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fRec2[0] = static_cast<double>(input0[i0]) - (fRec2[1] * (fConst10 * fTemp2 + -8.0) + fRec2[2] * (fTemp4 + (4.0 - fTemp5))) / fTemp6;
			output0[i0] = static_cast<FAUSTFLOAT>(fConst1 * (fTemp3 * (fRec2[0] - fRec2[2]) / fTemp6));
			fRec0[1] = fRec0[0];
			fRec1[1] = fRec1[0];
			fRec2[2] = fRec2[1];
			fRec2[1] = fRec2[0];
...
class faust_flt_bpf12_tilde : public FaustExternal<flt_bpf12> {
public:
    faust_flt_bpf12_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_bpf12))
    {
    }
};
