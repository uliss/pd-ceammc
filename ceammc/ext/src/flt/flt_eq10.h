...
class flt_eq10 : public flt_eq10_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst102 = (1.0f / (fConst23 * fConst27));
		fConst103 = (0.0f - fConst102);
		fConst104 = (fConst29 / fConst27);
		fConst105 = (0.0f - (2.0f / fConst67));
		...
		fConst112 = (1.0f / (fConst37 * fConst41));
		fConst113 = (0.0f - fConst112);
		fConst114 = (fConst43 / fConst41);
		fConst115 = (0.0f - (2.0f / fConst57));
		fConst116 = (1.0f / (((fConst24 + 1.61803401f) / fConst23) + 1.0f));
		fConst117 = (((fConst24 + -1.61803401f) / fConst23) + 1.0f);
		fConst118 = (1.0f / (((fConst31 + 1.61803401f) / fConst30) + 1.0f));
		fConst119 = (((fConst31 + -1.61803401f) / fConst30) + 1.0f);
		fConst120 = (0.0f - (1.0f / (fConst44 * fConst48)));
		fConst121 = (0.0f - (2.0f / fConst52));
		fConst122 = (1.0f / (((fConst38 + 1.61803401f) / fConst37) + 1.0f));
		fConst123 = (((fConst38 + -1.61803401f) / fConst37) + 1.0f);
		fConst124 = (1.0f / (fConst30 * fConst34));
		fConst125 = (0.0f - fConst124);
		fConst126 = (fConst36 / fConst34);
		fConst127 = (0.0f - (2.0f / fConst62));
		fConst128 = (1.0f / (fConst16 * fConst20));
		fConst129 = (0.0f - fConst128);
		fConst130 = (fConst22 / fConst20);
		fConst131 = (0.0f - (2.0f / fConst72));
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("f1000", &fVslider5, 0.0f, -70.0f, 10.0f, 0.100000001f);
		...
		ui_interface->addVerticalSlider("f8000", &fVslider2, 0.0f, -70.0f, 10.0f, 0.100000001f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec31[0] = ((fConst32 * ((fConst102 * fTemp3) + (fConst103 * fVec3[1]))) - (fConst104 * fRec31[1]));
			fRec30[0] = (fRec31[0] - (fConst26 * ((fConst66 * fRec30[2]) + (fConst69 * fRec30[1]))));
			fRec29[0] = ((fConst26 * (((fConst68 * fRec30[0]) + (fConst105 * fRec30[1])) + (fConst68 * fRec30[2]))) - (fConst25 * ((fConst70 * fRec29[2]) + (fConst69 * fRec29[1]))));
			float fTemp9 = (fConst94 * fRec28[1]);
			fRec28[0] = ((fConst25 * (((fConst68 * fRec29[0]) + (fConst105 * fRec29[1])) + (fConst68 * fRec29[2]))) - (fConst90 * ((fConst91 * fRec28[2]) + fTemp9)));
			float fTemp10 = (fConst101 * fRec27[1]);
			fRec27[0] = ((fRec28[2] + (fConst90 * (fTemp9 + (fConst91 * fRec28[0])))) - (fConst97 * ((fConst98 * fRec27[2]) + fTemp10)));
			float fTemp11 = (fConst85 * fRec26[1]);
			fRec26[0] = ((fRec27[2] + (fConst97 * (fTemp10 + (fConst98 * fRec27[0])))) - (fConst106 * ((fConst107 * fRec26[2]) + fTemp11)));
			float fTemp12 = (fConst79 * fRec25[1]);
			fRec25[0] = ((fRec26[2] + (fConst106 * (fTemp11 + (fConst107 * fRec26[0])))) - (fConst108 * ((fConst109 * fRec25[2]) + fTemp12)));
			float fTemp13 = (fConst74 * fRec24[1]);
			fRec24[0] = ((fRec25[2] + (fConst108 * (fTemp12 + (fConst109 * fRec25[0])))) - (fConst110 * ((fConst111 * fRec24[2]) + fTemp13)));
			fRec32[0] = (fSlow1 + (0.999000013f * fRec32[1]));
			fRec42[0] = ((fConst46 * ((fConst112 * fTemp1) + (fConst113 * fVec1[1]))) - (fConst114 * fRec42[1]));
			fRec41[0] = (fRec42[0] - (fConst40 * ((fConst56 * fRec41[2]) + (fConst59 * fRec41[1]))));
			fRec40[0] = ((fConst40 * (((fConst58 * fRec41[0]) + (fConst115 * fRec41[1])) + (fConst58 * fRec41[2]))) - (fConst39 * ((fConst60 * fRec40[2]) + (fConst59 * fRec40[1]))));
			float fTemp14 = (fConst94 * fRec39[1]);
			fRec39[0] = ((fConst39 * (((fConst58 * fRec40[0]) + (fConst115 * fRec40[1])) + (fConst58 * fRec40[2]))) - (fConst90 * ((fConst91 * fRec39[2]) + fTemp14)));
			float fTemp15 = (fConst101 * fRec38[1]);
			fRec38[0] = ((fRec39[2] + (fConst90 * (fTemp14 + (fConst91 * fRec39[0])))) - (fConst97 * ((fConst98 * fRec38[2]) + fTemp15)));
			float fTemp16 = (fConst85 * fRec37[1]);
			fRec37[0] = ((fRec38[2] + (fConst97 * (fTemp15 + (fConst98 * fRec38[0])))) - (fConst106 * ((fConst107 * fRec37[2]) + fTemp16)));
			float fTemp17 = (fConst79 * fRec36[1]);
			fRec36[0] = ((fRec37[2] + (fConst106 * (fTemp16 + (fConst107 * fRec37[0])))) - (fConst108 * ((fConst109 * fRec36[2]) + fTemp17)));
			float fTemp18 = (fConst74 * fRec35[1]);
			fRec35[0] = ((fRec36[2] + (fConst108 * (fTemp17 + (fConst109 * fRec36[0])))) - (fConst110 * ((fConst111 * fRec35[2]) + fTemp18)));
			float fTemp19 = (fConst69 * fRec34[1]);
			fRec34[0] = ((fRec35[2] + (fConst110 * (fTemp18 + (fConst111 * fRec35[0])))) - (fConst116 * ((fConst117 * fRec34[2]) + fTemp19)));
			float fTemp20 = (fConst64 * fRec33[1]);
			fRec33[0] = ((fRec34[2] + (fConst116 * (fTemp19 + (fConst117 * fRec34[0])))) - (fConst118 * ((fConst119 * fRec33[2]) + fTemp20)));
			fRec43[0] = (fSlow2 + (0.999000013f * fRec43[1]));
			fRec54[0] = ((fConst120 * fVec0[1]) - (fConst49 * ((fConst50 * fRec54[1]) - (fConst45 * fTemp0))));
			fRec53[0] = (fRec54[0] - (fConst47 * ((fConst51 * fRec53[2]) + (fConst54 * fRec53[1]))));
			fRec52[0] = ((fConst47 * (((fConst53 * fRec53[0]) + (fConst121 * fRec53[1])) + (fConst53 * fRec53[2]))) - (fConst46 * ((fConst55 * fRec52[2]) + (fConst54 * fRec52[1]))));
			float fTemp21 = (fConst94 * fRec51[1]);
			fRec51[0] = ((fConst46 * (((fConst53 * fRec52[0]) + (fConst121 * fRec52[1])) + (fConst53 * fRec52[2]))) - (fConst90 * ((fConst91 * fRec51[2]) + fTemp21)));
			float fTemp22 = (fConst101 * fRec50[1]);
			fRec50[0] = ((fRec51[2] + (fConst90 * (fTemp21 + (fConst91 * fRec51[0])))) - (fConst97 * ((fConst98 * fRec50[2]) + fTemp22)));
			float fTemp23 = (fConst85 * fRec49[1]);
			fRec49[0] = ((fRec50[2] + (fConst97 * (fTemp22 + (fConst98 * fRec50[0])))) - (fConst106 * ((fConst107 * fRec49[2]) + fTemp23)));
			float fTemp24 = (fConst79 * fRec48[1]);
			fRec48[0] = ((fRec49[2] + (fConst106 * (fTemp23 + (fConst107 * fRec49[0])))) - (fConst108 * ((fConst109 * fRec48[2]) + fTemp24)));
			float fTemp25 = (fConst74 * fRec47[1]);
			fRec47[0] = ((fRec48[2] + (fConst108 * (fTemp24 + (fConst109 * fRec48[0])))) - (fConst110 * ((fConst111 * fRec47[2]) + fTemp25)));
			float fTemp26 = (fConst69 * fRec46[1]);
			fRec46[0] = ((fRec47[2] + (fConst110 * (fTemp25 + (fConst111 * fRec47[0])))) - (fConst116 * ((fConst117 * fRec46[2]) + fTemp26)));
			float fTemp27 = (fConst64 * fRec45[1]);
			fRec45[0] = ((fRec46[2] + (fConst116 * (fTemp26 + (fConst117 * fRec46[0])))) - (fConst118 * ((fConst119 * fRec45[2]) + fTemp27)));
			float fTemp28 = (fConst59 * fRec44[1]);
			fRec44[0] = ((fRec45[2] + (fConst118 * (fTemp27 + (fConst119 * fRec45[0])))) - (fConst122 * ((fConst123 * fRec44[2]) + fTemp28)));
			fRec55[0] = (fSlow3 + (0.999000013f * fRec55[1]));
			fRec64[0] = ((fConst39 * ((fConst124 * fTemp2) + (fConst125 * fVec2[1]))) - (fConst126 * fRec64[1]));
			fRec63[0] = (fRec64[0] - (fConst33 * ((fConst61 * fRec63[2]) + (fConst64 * fRec63[1]))));
			fRec62[0] = ((fConst33 * (((fConst63 * fRec63[0]) + (fConst127 * fRec63[1])) + (fConst63 * fRec63[2]))) - (fConst32 * ((fConst65 * fRec62[2]) + (fConst64 * fRec62[1]))));
			float fTemp29 = (fConst94 * fRec61[1]);
			fRec61[0] = ((fConst32 * (((fConst63 * fRec62[0]) + (fConst127 * fRec62[1])) + (fConst63 * fRec62[2]))) - (fConst90 * ((fConst91 * fRec61[2]) + fTemp29)));
			float fTemp30 = (fConst101 * fRec60[1]);
			fRec60[0] = ((fRec61[2] + (fConst90 * (fTemp29 + (fConst91 * fRec61[0])))) - (fConst97 * ((fConst98 * fRec60[2]) + fTemp30)));
			float fTemp31 = (fConst85 * fRec59[1]);
			fRec59[0] = ((fRec60[2] + (fConst97 * (fTemp30 + (fConst98 * fRec60[0])))) - (fConst106 * ((fConst107 * fRec59[2]) + fTemp31)));
			float fTemp32 = (fConst79 * fRec58[1]);
			fRec58[0] = ((fRec59[2] + (fConst106 * (fTemp31 + (fConst107 * fRec59[0])))) - (fConst108 * ((fConst109 * fRec58[2]) + fTemp32)));
			float fTemp33 = (fConst74 * fRec57[1]);
			fRec57[0] = ((fRec58[2] + (fConst108 * (fTemp32 + (fConst109 * fRec58[0])))) - (fConst110 * ((fConst111 * fRec57[2]) + fTemp33)));
			float fTemp34 = (fConst69 * fRec56[1]);
			fRec56[0] = ((fRec57[2] + (fConst110 * (fTemp33 + (fConst111 * fRec57[0])))) - (fConst116 * ((fConst117 * fRec56[2]) + fTemp34)));
			fRec65[0] = (fSlow4 + (0.999000013f * fRec65[1]));
			fRec72[0] = ((fConst25 * ((fConst128 * fTemp4) + (fConst129 * fVec4[1]))) - (fConst130 * fRec72[1]));
			fRec71[0] = (fRec72[0] - (fConst19 * ((fConst71 * fRec71[2]) + (fConst74 * fRec71[1]))));
			fRec70[0] = ((fConst19 * (((fConst73 * fRec71[0]) + (fConst131 * fRec71[1])) + (fConst73 * fRec71[2]))) - (fConst18 * ((fConst75 * fRec70[2]) + (fConst74 * fRec70[1]))));
			float fTemp35 = (fConst94 * fRec69[1]);
			fRec69[0] = ((fConst18 * (((fConst73 * fRec70[0]) + (fConst131 * fRec70[1])) + (fConst73 * fRec70[2]))) - (fConst90 * ((fConst91 * fRec69[2]) + fTemp35)));
			float fTemp36 = (fConst101 * fRec68[1]);
			fRec68[0] = ((fRec69[2] + (fConst90 * (fTemp35 + (fConst91 * fRec69[0])))) - (fConst97 * ((fConst98 * fRec68[2]) + fTemp36)));
			float fTemp37 = (fConst85 * fRec67[1]);
			fRec67[0] = ((fRec68[2] + (fConst97 * (fTemp36 + (fConst98 * fRec68[0])))) - (fConst106 * ((fConst107 * fRec67[2]) + fTemp37)));
			float fTemp38 = (fConst79 * fRec66[1]);
			fRec66[0] = ((fRec67[2] + (fConst106 * (fTemp37 + (fConst107 * fRec67[0])))) - (fConst108 * ((fConst109 * fRec66[2]) + fTemp38)));
			...
			fRec87[0] = (0.0f - (fConst140 * ((fConst82 * fRec87[1]) - (fConst9 * (fTemp6 + fVec6[1])))));
			...
			output0[i] = FAUSTFLOAT((((fRec0[2] + (fConst97 * (fTemp8 + (fConst98 * fRec0[0])))) * std::pow(10.0f, (0.0500000007f * fRec23[0]))) + ((((fRec24[2] + (fConst110 * (fTemp13 + (fConst111 * fRec24[0])))) * std::pow(10.0f, (0.0500000007f * fRec32[0]))) + (((fRec33[2] + (fConst118 * (fTemp20 + (fConst119 * fRec33[0])))) * std::pow(10.0f, (0.0500000007f * fRec43[0]))) + (((fRec44[2] + (fConst122 * (fTemp28 + (fConst123 * fRec44[0])))) * std::pow(10.0f, (0.0500000007f * fRec55[0]))) + (((fRec56[2] + (fConst116 * (fTemp34 + (fConst117 * fRec56[0])))) * std::pow(10.0f, (0.0500000007f * fRec65[0]))) + ((((fRec66[2] + (fConst108 * (fTemp38 + (fConst109 * fRec66[0])))) * std::pow(10.0f, (0.0500000007f * fRec73[0]))) + ((fRec74[2] + (fConst106 * (fTemp41 + (fConst107 * fRec74[0])))) * std::pow(10.0f, (0.0500000007f * fRec80[0])))) + ((fRec81[2] + (fConst90 * (fTemp43 + (fConst91 * fRec81[0])))) * std::pow(10.0f, (0.0500000007f * fRec88[0])))))))) + (fConst147 * (((((fConst93 * fRec89[0]) + (fConst156 * fRec89[1])) + (fConst93 * fRec89[2])) * std::pow(10.0f, (0.0500000007f * fRec95[0]))) + ((fRec96[2] + (fRec96[0] + (2.0f * fRec96[1]))) * std::pow(10.0f, (0.0500000007f * fRec99[0]))))))));
			fVec0[1] = fVec0[0];
			fRec22[1] = fRec22[0];
			fRec21[2] = fRec21[1];
			fRec21[1] = fRec21[0];
