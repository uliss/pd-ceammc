...
class flt_eq10 : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst103 = (1.0f / (fConst16 * fConst20));
		fConst104 = (0.0f - fConst103);
		fConst105 = (fConst22 / fConst20);
		fConst106 = (0.0f - (2.0f / fConst60));
		fConst107 = (1.0f / (((fConst8 + 1.61803401f) / fConst7) + 1.0f));
		fConst108 = (((fConst8 + -1.61803401f) / fConst7) + 1.0f);
		fConst109 = (1.0f / (fConst23 * fConst27));
		fConst110 = (0.0f - fConst109);
		fConst111 = (fConst29 / fConst27);
		fConst112 = (0.0f - (2.0f / fConst55));
		fConst113 = (1.0f / (((fConst17 + 1.61803401f) / fConst16) + 1.0f));
		fConst114 = (((fConst17 + -1.61803401f) / fConst16) + 1.0f);
		fConst115 = (1.0f / (fConst30 * fConst34));
		fConst116 = (0.0f - fConst115);
		fConst117 = (fConst36 / fConst34);
		fConst118 = (0.0f - (2.0f / fConst50));
		fConst119 = (1.0f / (((fConst24 + 1.61803401f) / fConst23) + 1.0f));
		fConst120 = (((fConst24 + -1.61803401f) / fConst23) + 1.0f);
		fConst121 = (0.0f - (1.0f / (fConst37 * fConst41)));
		fConst122 = (0.0f - (2.0f / fConst45));
		fConst123 = (1.0f / (((fConst31 + 1.61803401f) / fConst30) + 1.0f));
		fConst124 = (((fConst31 + -1.61803401f) / fConst30) + 1.0f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("f16000", &fVslider5, 0.0f, -70.0f, 10.0f, 0.100000001f);
		...
		ui_interface->addVerticalSlider("f4000", &fVslider3, 0.0f, -70.0f, 10.0f, 0.100000001f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec37[0] = ((fConst25 * ((fConst103 * fTemp3) + (fConst104 * fVec3[1]))) - (fConst105 * fRec37[1]));
			fRec36[0] = (fRec37[0] - (fConst19 * ((fConst59 * fRec36[2]) + (fConst62 * fRec36[1]))));
			fRec35[0] = ((fConst19 * (((fConst61 * fRec36[0]) + (fConst106 * fRec36[1])) + (fConst61 * fRec36[2]))) - (fConst18 * ((fConst63 * fRec35[2]) + (fConst62 * fRec35[1]))));
			float fTemp13 = (fConst82 * fRec34[1]);
			fRec34[0] = ((fConst18 * (((fConst61 * fRec35[0]) + (fConst106 * fRec35[1])) + (fConst61 * fRec35[2]))) - (fConst78 * ((fConst79 * fRec34[2]) + fTemp13)));
			float fTemp14 = (fConst89 * fRec33[1]);
			fRec33[0] = ((fRec34[2] + (fConst78 * (fTemp13 + (fConst79 * fRec34[0])))) - (fConst85 * ((fConst86 * fRec33[2]) + fTemp14)));
			float fTemp15 = (fConst96 * fRec32[1]);
			fRec32[0] = ((fRec33[2] + (fConst85 * (fTemp14 + (fConst86 * fRec33[0])))) - (fConst92 * ((fConst93 * fRec32[2]) + fTemp15)));
			float fTemp16 = (fConst73 * fRec31[1]);
			fRec31[0] = ((fRec32[2] + (fConst92 * (fTemp15 + (fConst93 * fRec32[0])))) - (fConst101 * ((fConst102 * fRec31[2]) + fTemp16)));
			float fTemp17 = (fConst67 * fRec30[1]);
			fRec30[0] = ((fRec31[2] + (fConst101 * (fTemp16 + (fConst102 * fRec31[0])))) - (fConst107 * ((fConst108 * fRec30[2]) + fTemp17)));
			fRec38[0] = (fSlow2 + (0.999000013f * fRec38[1]));
			fRec47[0] = ((fConst32 * ((fConst109 * fTemp2) + (fConst110 * fVec2[1]))) - (fConst111 * fRec47[1]));
			fRec46[0] = (fRec47[0] - (fConst26 * ((fConst54 * fRec46[2]) + (fConst57 * fRec46[1]))));
			fRec45[0] = ((fConst26 * (((fConst56 * fRec46[0]) + (fConst112 * fRec46[1])) + (fConst56 * fRec46[2]))) - (fConst25 * ((fConst58 * fRec45[2]) + (fConst57 * fRec45[1]))));
			float fTemp18 = (fConst82 * fRec44[1]);
			fRec44[0] = ((fConst25 * (((fConst56 * fRec45[0]) + (fConst112 * fRec45[1])) + (fConst56 * fRec45[2]))) - (fConst78 * ((fConst79 * fRec44[2]) + fTemp18)));
			float fTemp19 = (fConst89 * fRec43[1]);
			fRec43[0] = ((fRec44[2] + (fConst78 * (fTemp18 + (fConst79 * fRec44[0])))) - (fConst85 * ((fConst86 * fRec43[2]) + fTemp19)));
			float fTemp20 = (fConst96 * fRec42[1]);
			fRec42[0] = ((fRec43[2] + (fConst85 * (fTemp19 + (fConst86 * fRec43[0])))) - (fConst92 * ((fConst93 * fRec42[2]) + fTemp20)));
			float fTemp21 = (fConst73 * fRec41[1]);
			fRec41[0] = ((fRec42[2] + (fConst92 * (fTemp20 + (fConst93 * fRec42[0])))) - (fConst101 * ((fConst102 * fRec41[2]) + fTemp21)));
			float fTemp22 = (fConst67 * fRec40[1]);
			fRec40[0] = ((fRec41[2] + (fConst101 * (fTemp21 + (fConst102 * fRec41[0])))) - (fConst107 * ((fConst108 * fRec40[2]) + fTemp22)));
			float fTemp23 = (fConst62 * fRec39[1]);
			fRec39[0] = ((fRec40[2] + (fConst107 * (fTemp22 + (fConst108 * fRec40[0])))) - (fConst113 * ((fConst114 * fRec39[2]) + fTemp23)));
			fRec48[0] = (fSlow3 + (0.999000013f * fRec48[1]));
			fRec58[0] = ((fConst39 * ((fConst115 * fTemp1) + (fConst116 * fVec1[1]))) - (fConst117 * fRec58[1]));
			fRec57[0] = (fRec58[0] - (fConst33 * ((fConst49 * fRec57[2]) + (fConst52 * fRec57[1]))));
			fRec56[0] = ((fConst33 * (((fConst51 * fRec57[0]) + (fConst118 * fRec57[1])) + (fConst51 * fRec57[2]))) - (fConst32 * ((fConst53 * fRec56[2]) + (fConst52 * fRec56[1]))));
			float fTemp24 = (fConst82 * fRec55[1]);
			fRec55[0] = ((fConst32 * (((fConst51 * fRec56[0]) + (fConst118 * fRec56[1])) + (fConst51 * fRec56[2]))) - (fConst78 * ((fConst79 * fRec55[2]) + fTemp24)));
			float fTemp25 = (fConst89 * fRec54[1]);
			fRec54[0] = ((fRec55[2] + (fConst78 * (fTemp24 + (fConst79 * fRec55[0])))) - (fConst85 * ((fConst86 * fRec54[2]) + fTemp25)));
			float fTemp26 = (fConst96 * fRec53[1]);
			fRec53[0] = ((fRec54[2] + (fConst85 * (fTemp25 + (fConst86 * fRec54[0])))) - (fConst92 * ((fConst93 * fRec53[2]) + fTemp26)));
			float fTemp27 = (fConst73 * fRec52[1]);
			fRec52[0] = ((fRec53[2] + (fConst92 * (fTemp26 + (fConst93 * fRec53[0])))) - (fConst101 * ((fConst102 * fRec52[2]) + fTemp27)));
			float fTemp28 = (fConst67 * fRec51[1]);
			fRec51[0] = ((fRec52[2] + (fConst101 * (fTemp27 + (fConst102 * fRec52[0])))) - (fConst107 * ((fConst108 * fRec51[2]) + fTemp28)));
			float fTemp29 = (fConst62 * fRec50[1]);
			fRec50[0] = ((fRec51[2] + (fConst107 * (fTemp28 + (fConst108 * fRec51[0])))) - (fConst113 * ((fConst114 * fRec50[2]) + fTemp29)));
			float fTemp30 = (fConst57 * fRec49[1]);
			fRec49[0] = ((fRec50[2] + (fConst113 * (fTemp29 + (fConst114 * fRec50[0])))) - (fConst119 * ((fConst120 * fRec49[2]) + fTemp30)));
			fRec59[0] = (fSlow4 + (0.999000013f * fRec59[1]));
			fRec70[0] = ((fConst121 * fVec0[1]) - (fConst42 * ((fConst43 * fRec70[1]) - (fConst38 * fTemp0))));
			fRec69[0] = (fRec70[0] - (fConst40 * ((fConst44 * fRec69[2]) + (fConst47 * fRec69[1]))));
			fRec68[0] = ((fConst40 * (((fConst46 * fRec69[0]) + (fConst122 * fRec69[1])) + (fConst46 * fRec69[2]))) - (fConst39 * ((fConst48 * fRec68[2]) + (fConst47 * fRec68[1]))));
			float fTemp31 = (fConst82 * fRec67[1]);
			fRec67[0] = ((fConst39 * (((fConst46 * fRec68[0]) + (fConst122 * fRec68[1])) + (fConst46 * fRec68[2]))) - (fConst78 * ((fConst79 * fRec67[2]) + fTemp31)));
			float fTemp32 = (fConst89 * fRec66[1]);
			fRec66[0] = ((fRec67[2] + (fConst78 * (fTemp31 + (fConst79 * fRec67[0])))) - (fConst85 * ((fConst86 * fRec66[2]) + fTemp32)));
			float fTemp33 = (fConst96 * fRec65[1]);
			fRec65[0] = ((fRec66[2] + (fConst85 * (fTemp32 + (fConst86 * fRec66[0])))) - (fConst92 * ((fConst93 * fRec65[2]) + fTemp33)));
			float fTemp34 = (fConst73 * fRec64[1]);
			fRec64[0] = ((fRec65[2] + (fConst92 * (fTemp33 + (fConst93 * fRec65[0])))) - (fConst101 * ((fConst102 * fRec64[2]) + fTemp34)));
			float fTemp35 = (fConst67 * fRec63[1]);
			fRec63[0] = ((fRec64[2] + (fConst101 * (fTemp34 + (fConst102 * fRec64[0])))) - (fConst107 * ((fConst108 * fRec63[2]) + fTemp35)));
			float fTemp36 = (fConst62 * fRec62[1]);
			fRec62[0] = ((fRec63[2] + (fConst107 * (fTemp35 + (fConst108 * fRec63[0])))) - (fConst113 * ((fConst114 * fRec62[2]) + fTemp36)));
			float fTemp37 = (fConst57 * fRec61[1]);
			fRec61[0] = ((fRec62[2] + (fConst113 * (fTemp36 + (fConst114 * fRec62[0])))) - (fConst119 * ((fConst120 * fRec61[2]) + fTemp37)));
			float fTemp38 = (fConst52 * fRec60[1]);
			fRec60[0] = ((fRec61[2] + (fConst119 * (fTemp37 + (fConst120 * fRec61[0])))) - (fConst123 * ((fConst124 * fRec60[2]) + fTemp38)));
			fRec71[0] = (fSlow5 + (0.999000013f * fRec71[1]));
			fRec79[0] = (0.0f - (fConst129 * ((fConst70 * fRec79[1]) - (fConst9 * (fTemp5 + fVec5[1])))));
			...
			output0[i] = FAUSTFLOAT((((fRec0[2] + (fConst92 * (fTemp8 + (fConst93 * fRec0[0])))) * std::pow(10.0f, (0.0500000007f * fRec21[0]))) + (((fRec22[2] + (fConst101 * (fTemp12 + (fConst102 * fRec22[0])))) * std::pow(10.0f, (0.0500000007f * fRec29[0]))) + (((fRec30[2] + (fConst107 * (fTemp17 + (fConst108 * fRec30[0])))) * std::pow(10.0f, (0.0500000007f * fRec38[0]))) + (((fRec39[2] + (fConst113 * (fTemp23 + (fConst114 * fRec39[0])))) * std::pow(10.0f, (0.0500000007f * fRec48[0]))) + (((fRec49[2] + (fConst119 * (fTemp30 + (fConst120 * fRec49[0])))) * std::pow(10.0f, (0.0500000007f * fRec59[0]))) + (((fRec60[2] + (fConst123 * (fTemp38 + (fConst124 * fRec60[0])))) * std::pow(10.0f, (0.0500000007f * fRec71[0]))) + ((((fRec72[2] + (fConst85 * (fTemp41 + (fConst86 * fRec72[0])))) * std::pow(10.0f, (0.0500000007f * fRec80[0]))) + ((fRec81[2] + (fConst78 * (fTemp43 + (fConst79 * fRec81[0])))) * std::pow(10.0f, (0.0500000007f * fRec88[0])))) + (fConst147 * (((((fConst81 * fRec89[0]) + (fConst156 * fRec89[1])) + (fConst81 * fRec89[2])) * std::pow(10.0f, (0.0500000007f * fRec95[0]))) + ((fRec96[2] + (fRec96[0] + (2.0f * fRec96[1]))) * std::pow(10.0f, (0.0500000007f * fRec99[0])))))))))))));
			fVec0[1] = fVec0[0];
			fRec20[1] = fRec20[0];
			fRec19[2] = fRec19[1];
			fRec19[1] = fRec19[0];
