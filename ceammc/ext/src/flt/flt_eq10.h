...
class flt_eq10 : public flt_eq10_dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		fConst1 = std::tan((50265.4844f / fConst0));
		...
		fConst15 = std::tan((196.349548f / fConst0));
		...
		fConst22 = std::tan((392.699097f / fConst0));
