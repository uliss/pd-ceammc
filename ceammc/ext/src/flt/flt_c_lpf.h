...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_c_lpf -scn flt_c_lpf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_c_lpf_H__
#define  __flt_c_lpf_H__
...
class FAUST_API flt_c_lpf_dsp {

    public:

        flt_c_lpf_dsp() = default;
        virtual ~flt_c_lpf_dsp() = default;
...
class FAUST_API decorator_dsp : public ::flt_c_lpf_dsp {
    ...
    public:
        ...
        decorator_dsp(::flt_c_lpf_dsp* flt_c_lpf_dsp = nullptr):fDSP(flt_c_lpf_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_c_lpf_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_c_lpf_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
class flt_c_lpf : public flt_c_lpf_dsp {
 ...
 public:
	...
	flt_c_lpf(const flt_c_lpf&) = default;
	
	virtual ~flt_c_lpf() = default;
	
	flt_c_lpf& operator=(const flt_c_lpf&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc_ui.lib/name", "CEAMMC faust default UI elements");
		m->declare("ceammc_ui.lib/version", "0.1.2");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_c_lpf -scn flt_c_lpf_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual flt_c_lpf* clone() {
		return new flt_c_lpf(*this);
	}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("flt_c_lpf");
...
class faust_flt_c_lpf_tilde : public FaustExternal<flt_c_lpf> {
public:
    faust_flt_c_lpf_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_c_lpf))
    {
    }
};
