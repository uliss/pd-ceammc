...
Compilation options: -a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_dcblock2 -scn flt_dcblock2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0
------------------------------------------------------------ */

#ifndef  __flt_dcblock2_H__
#define  __flt_dcblock2_H__
...
class FAUST_API flt_dcblock2_dsp {

    public:

        flt_dcblock2_dsp() = default;
        virtual ~flt_dcblock2_dsp() = default;
         ...
         */
        virtual ::flt_dcblock2_dsp* clone() = 0;
...
class FAUST_API decorator_dsp : public ::flt_dcblock2_dsp {
    ...
    protected:
        ...
        ::flt_dcblock2_dsp* fDSP;

    public:

        decorator_dsp(::flt_dcblock2_dsp* flt_dcblock2_dsp = nullptr):fDSP(flt_dcblock2_dsp) {}
...
class FAUST_API dsp_factory {
    ...
    public:
        ...
        virtual ::flt_dcblock2_dsp* createDSPInstance() = 0;
...
/**
 The base class of Meta handler to be used in flt_dcblock2_dsp::metadata(Meta* m) method to retrieve (key, value) metadata.
 */
struct FAUST_API Meta {
    virtual ~Meta() {}
...
// clang-format off
#ifndef FAUST_MACRO
struct flt_dcblock2 : public flt_dcblock2_dsp {
};
#endif
// clang-format on
...
#ifndef FAUSTCLASS 
#define FAUSTCLASS flt_dcblock2
#endif
...
class flt_dcblock2 : public flt_dcblock2_dsp {
 ...
 public:
	...
	flt_dcblock2(const flt_dcblock2&) = default;
	
	virtual ~flt_dcblock2() = default;
	
	flt_dcblock2& operator=(const flt_dcblock2&) = default;
	
	void metadata(Meta* m) { 
		m->declare("ceammc.lib/name", "Ceammc PureData misc utils");
		m->declare("ceammc.lib/version", "0.1.4");
		m->declare("compile_options", "-a /Users/serge/work/music/pure-data/ceammc/faust/faust_arch_ceammc.cpp -lang cpp -i -fpga-mem-th 4 -ct 1 -cn flt_dcblock2 -scn flt_dcblock2_dsp -es 1 -mcd 16 -mdd 1024 -mdy 33 -single -ftz 0");
	...
	virtual flt_dcblock2* clone() {
		return new flt_dcblock2(*this);
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			fVec1[0] = fTemp1;
			fRec1[0] = fTemp1 + 0.995f * fRec1[1] - fVec1[1];
...
class faust_flt_dcblock2_tilde : public FaustExternal<flt_dcblock2> {
public:
    faust_flt_dcblock2_tilde(const ceammc::PdArgs& args)
        : FaustExternal(args, sym(flt_dcblock2))
    {
    }
};
