...
macro(ceammc_add_core_test title name)
    ...
    target_link_libraries(${name} tests_main_lib1  ceammc_core puredata-core ceammc_core)
    set_test_command(${title} ${name})
endmacro()

macro(ceammc_add_test title name)
    add_executable(${name} "${name}.cpp")
    target_link_libraries(${name} tests_main_lib1  ceammc_core ceammc_base puredata-core ceammc_core)
    set_test_command(${title} ${name})
endmacro()
...
macro(ceammc_add_test_linked)
    ...
    target_link_libraries(${name} ${_TEST_LINK} tests_main_lib1   ceammc_core)
...
macro(ceammc_add_extension_test name extpath)
    ...
    target_link_libraries(${_target}
        tests_main_lib1   puredata-core ceammc_core puredata-core ceammc_sound)
