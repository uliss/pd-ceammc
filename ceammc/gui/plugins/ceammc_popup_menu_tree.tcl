...
{ceammc
    ...
    {conv {
        array.p2s array.s2p conv.amp2dbfs conv.amp2dbfs~ conv.bits2int
        conv.bits2pos conv.bpm2hz conv.bpm2ms conv.bpm2sec conv.car2pol
        conv.cc2amp conv.dbfs2amp conv.dbfs2amp~ conv.degree2key conv.hex2int
