{ceammc
    ...
    {fx {
        fx.bitdown~ fx.chorus~ fx.distortion1~ fx.distortion~ fx.drive~
        fx.drone_box~ fx.echo~ fx.flanger~ fx.freeverb2~ fx.freeverb~
        fx.freqshift~ fx.granulator~ fx.greyhole~ fx.looper~ fx.pitchshift~
