{ceammc
    ...
    {spat {
        ...
        hoa.3d.exchanger~ hoa.3d.optim~ hoa.3d.scope~ hoa.3d.wider~
        hoa.@process hoa.in hoa.in~ hoa.map.ui hoa.out hoa.out~ hoa.process~
        hoa.scope~ pan.cos~ pan.linsig~ pan.lin~ pan.spread~ pan.sqrt~
        spat.pan4~ spat.pan8~ spat.zita6x8~ spat.zita8~
    }}
    {string {
