...
#define MyAppName "PureData CEAMMC"
#define MyAppID "F480F394-5E58-47F7-A329-BD83FA4B953B-${CEAMMC_DISTRIB_ARCH}"
#define MyAppVerName "PureData CEAMMC (${CEAMMC_DISTRIB_ARCH})"
...
#define MyAppInstallerName "PureData-ceammc-${CEAMMC_DISTRIB_VERSION}-${CEAMMC_DISTRIB_ARCH}-setup"
