...
#define MyAppName "PureData CEAMMC${CEAMMC_APP_SUFFIX}"
#define MyAppID "F480F394-5E58-47F7-A329-BD83FA4B953B-${CEAMMC_DISTRIB_ARCH}-${CEAMMC_PRECISION}"
#define MyAppVerName "PureData CEAMMC (${CEAMMC_DISTRIB_ARCH} ${CEAMMC_PRECISION})"
#define MyAppArch "${CEAMMC_DISTRIB_ARCH}"
#define MyAppVersion "${CEAMMC_DISTRIB_VERSION}-${CEAMMC_DISTRIB_ARCH}-${CEAMMC_PRECISION}"
