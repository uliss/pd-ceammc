...
mkdir -p "${BUNDLE_TCL}/Img1.4.16"
for dll in ${INSTALL_DIR}/lib/pd_ceammc/tcl/Img1.4.16/*.dylib
do
    copy_and_fix_exe ${dll} "${BUNDLE_TCL}/Img1.4.16"
done
copy ${INSTALL_DIR}/lib/pd_ceammc/tcl/Img1.4.16/*.tcl "${BUNDLE_TCL}/Img1.4.16"
