...
//-speaker emulation
sbp1    		= vslider("sp_low_freq[name:low freq][tooltip:low-freq cutoff Hz]",130,20,1000,10);
sbp2    		= vslider("sp_high_freq[name:high freq][tooltip:high-freq cutoff Hz]",5000,1000,12000,10);
...
switch2       	= checkbox("resonator[name:resonat]");
