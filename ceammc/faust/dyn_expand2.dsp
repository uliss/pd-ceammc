declare name "dyn.expand2";

import("stdfaust.lib");
cm = library("ceammc.lib");
ui = library("ceammc_ui.lib");

process = _,_ : cm.bypass_stereo(ui.bypass, expand) : _,_ with {
    N = 2;
    pre = 1;
    max_hold_samp = 255;

    expand  = co.expander_N_chan(strength, thresh, range, att, hold, rel, knee, pre, link, meter, max_hold_samp, N);
    strength = hslider("strength", 0, 0, 10, 0.01) : si.smoo;
